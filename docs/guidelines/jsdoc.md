...
| `@deprecated` | Adds the version in which an entity was deprecated | `@deprecated As of version 1.28, replaced by {@link class name}.`</br>**or**</br>`@deprecated As of version 1.28, the concept has been discarded.` | Be as specific as possible (without mentioning patch levels) since this information is useful even for internal purposes. Indicate either what replaces the deprecated entity or mention that the concept has been discarded. |
