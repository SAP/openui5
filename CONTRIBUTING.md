...
3.  **Not all proposed contributions can be accepted**. Some features may e.g. just fit a third-party add-on better. The code must fit the overall direction of OpenUI5 and really improve it, so there should be some "bang for the byte". For most bug fixes this is a given, but major feature implementation must first be discussed with one of the [OpenUI5 committers](https://github.com/SAP/openui5/graphs/contributors). The more effort you invest, the better you should clarify in advance whether the contribution fits: open an enhancement ticket in the issue tracker to discuss the feature you plan to implement, this avoids disappointment.
