...
public interface Resource {
	...
	/**
	 * Count image amount form "NeedVerifyImages" folder
	 * @param parentPath the parent path of NeedVerifyImages
	 * @return
	 */
	int getFailedImageCountByVerifyFolder(String parentPath);
