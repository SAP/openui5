...
describe("Generator.js", function () {
	...
	it("getResourceBundle: recursive call", function () {
		...
		ofsMock.expects("existsSync").withExactArgs(resolve("./lib/i18n/i18n_~a_~b.properties")).returns(false);
	...
	it("getResourceBundle: no resource bundle", function () {
		...
		sinon.mock(fs).expects("existsSync").withExactArgs(resolve("./lib/i18n/i18n_~a.properties")).returns(false);
	...
	it("getResourceBundle: load resource bundle and parse", function () {
		...
		const sFilename = resolve("./lib/i18n/i18n_~sUI5Tag.properties");
