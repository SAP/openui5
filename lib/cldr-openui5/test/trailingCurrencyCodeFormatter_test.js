...
import * as formatter from "../lib/trailingCurrencyCodeFormatter.js";
...
describe("trailingCurrencyCodeFormatter", function() {
	...
	it("transformShortCurrencyPattern: do not modify", function() {
		assert.strictEqual(formatter.transformShortCurrencyPattern("## \u00a4", " "), "## \u00a4",
			"do not transform pattern");
		assert.strictEqual(formatter.transformShortCurrencyPattern("#.00 \u00a4", " "), "#.00 \u00a4",
			"do not transform pattern");
		assert.strictEqual(formatter.transformShortCurrencyPattern("# \u00a4", " "), "# \u00a4",
			"do not transform pattern");
		assert.strictEqual(formatter.transformShortCurrencyPattern("Mio. # \u00a4", " "), "Mio. # \u00a4",
			"do not transform pattern");
		assert.strictEqual(formatter.transformShortCurrencyPattern("000K \u00a4", " "), "000K \u00a4",
			"do not transform pattern");
		assert.strictEqual(formatter.transformShortCurrencyPattern("0", " "), "0", "do not transform pattern");

		// RTL
		assert.strictEqual(
			formatter.transformShortCurrencyPattern("\u200e000K\u202b\u00a4\u202c", " "),
			"\u200e000K\u202b\u00a4\u202c",
	...
	it("transformShortCurrencyPattern: modify", function() {
		...
		assert.strictEqual(
			formatter.transformShortCurrencyPattern("\u200e\u202b\u00a4\u202c000K", " "),
			"\u200e\u202b\u202c000K \u00a4",
			"rtl transform pattern");
		assert.strictEqual(
			formatter.transformShortCurrencyPattern("\u200f\u202b\u00a4\u202c000K", " "),
			"\u200f\u202b\u202c000K \u00a4",
			"ltr transform pattern");
	});
	...
	it("transformCurrencyPattern: do not modify", function() {
		assert.strictEqual(formatter.transformCurrencyPattern("## \u00a4", " "), "## \u00a4",
			"do not transform pattern");
		assert.strictEqual(formatter.transformCurrencyPattern("#.00 \u00a4", " "), "#.00 \u00a4",
			"do not transform pattern");
		assert.strictEqual(formatter.transformCurrencyPattern("# \u00a4", " "), "# \u00a4", "do not transform pattern");
		assert.strictEqual(formatter.transformCurrencyPattern("# \u00a4", " "), "# \u00a4", "do not transform pattern");
		assert.strictEqual(formatter.transformCurrencyPattern("000 \u00a4", " "), "000 \u00a4",
			"do not transform pattern");
		...
		// RTL
		assert.strictEqual(
			formatter.transformCurrencyPattern("\u200e000K\u202b\u00a4\u202c", " "),
			"\u200e000K\u202b\u00a4\u202c",
			"rtl do not transform pattern");
		assert.strictEqual(
			formatter.transformCurrencyPattern("\u200f000K\u202b\u00a4\u202c", " "),
	...
	it("transformCurrencyPattern: modify", function() {
		assert.strictEqual(formatter.transformCurrencyPattern("\u00a4\u00a0#,##0.00", " "), "#,##0.00 \u00a4",
			"transform pattern");
		...
		// RTL
		assert.strictEqual(
			formatter.transformCurrencyPattern("\u200e\u202b\u00a4\u202c000", " "),
			"\u200e\u202b\u202c000\u00a4",
			"rtl transform pattern");
		assert.strictEqual(
			formatter.transformCurrencyPattern("\u200f\u202b\u00a4\u202c000", " "),
