...
export default class Generator extends EventEmitter {
	 ...
	 *   The language tag (e.g. "en" or "de-CH")
	 ...
	 *
	 * @param {string} sUI5Tag The UI5 language tag (e.g. "en_US", "de", "zh_CN")
	 * @returns {string} The corresponding CLDR language tag (e.g. "en-US", "de", "zh-Hans-CN")
	 */
