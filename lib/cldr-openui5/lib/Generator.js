...
export default class Generator extends EventEmitter {
	...
	/**
	 * Checks whether the time zone IDs for the current locale are the same as for the previous locale.
	 *
	 * @param {string} sCLDRTag
	 *   The language tag (e.g. "en" or "de_CH")
	 * @param {Object<string, object>} oTimezoneNames
	 *   The resulting <code>timezoneNames</code> object of the currently processed locale
	 * @throws {Error} If time zones are inconsistent over all languages
	 */
	...
	generateLocaleFile(sUI5Tag) {
		...
		this.checkTimezonesConsistency(sCLDRTag, oTimezoneNames);
