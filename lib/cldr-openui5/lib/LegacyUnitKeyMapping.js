...
export default class LegacyUnitKeyMapping {
	 ...
	 *   The object of a unit which does no longer exist in the new units; <code>undefined</code>
	 *   if a unit is newly introduced to the locale
	 * @param {object} oNewUnits
	 *   The new units
	 * @returns {string|undefined}
	 *   The renamed unit key to the <code>oOldUnit</code>; <code>undefined</code> if no target unit was found or
	 *   <code>oOldUnit</code> is <code>undefined</code>
	 */
