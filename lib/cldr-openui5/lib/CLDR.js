...
/**
 * Generate UI5 CLDR JSON file for each suppported locale using from the modern JSON version CLDR file provided by
 * unicode.org.
...
export default class CLDR extends EventEmitter {
	...
	start() {
		...
		new Generator(oOptions.source, oOptions.output, oOptions.prettyPrint, oOptions.version)
			.start()
