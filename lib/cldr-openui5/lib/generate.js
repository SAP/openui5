...
const sTerritoriesPath = new URL("./resources/territories.json", import.meta.url);
const mTerritories = JSON.parse(readFileSync(sTerritoriesPath));

const aUI5Tags = ["ar", "ar_EG", "ar_SA", "bg", "ca", "cy", "cs", "da", "de", "de_AT", "de_CH", "el", "el_CY",
...
Generator.prototype.start = function() {
	...
	aUI5Tags.forEach(function(sUI5Tag) {
		...
		const mLocaleTerritory = mTerritories[sUI5Tag];
		if (mLocaleTerritory) {
