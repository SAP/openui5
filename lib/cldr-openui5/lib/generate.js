...
var aUI5Tags = ["ar", "ar_EG", "ar_SA", "bg", "ca", "cy", "cs", "da", "de", "de_AT", "de_CH", "el", "el_CY",
				...
				"th", "tr", "uk", "ur", "vi", "zh_CN", "zh_HK", "zh_SG", "zh_TW"];
...
Generator.prototype.start = function() {
	...
	aUI5Tags.forEach(function(sUI5Tag) {
		...
		// FIX from CLDR v40
		if (["es-BO", "es-CL", "es-MX", "es-PE", "es-UY", "es-VE"].includes(sCLDRTag)) {
			oResult["ca-gregorian"]["dateTimeFormats"]["availableFormats"]["yMMM"] = "MMM y";
			oResult["ca-gregorian"]["dateTimeFormats"]["availableFormats"]["yMMMd"] = "d MMM y";
			if (sCLDRTag === "es-MX") {
				oResult["ca-gregorian"]["dateTimeFormats"]["availableFormats"]["yMMMEd"] = "EEE, d 'de' MMM 'de' y";
			} else {
				oResult["ca-gregorian"]["dateTimeFormats"]["availableFormats"]["yMMMEd"] = "E, d MMM y";
			}
		}
