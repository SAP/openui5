...
module.exports = {
	...
	getWeekData: function(sTag) {
		...
		// the Australian calendar has Monday as official start of the week (this has been fixed with CLDR 40)
		// see: https://unicode-org.atlassian.net/browse/CLDR-14795
		if (sTag === "en-AU") {
			res["weekData-firstDay"] = 1;
		}
		return res;
	},
	...
	getDayPeriodRules : function (sTag) {
		var sDayPeriodKey,
			mDayPeriodRuleSet = fileContent.getContent(
				path.join(sFilePathSupple, "dayPeriods.json")).supplemental.dayPeriodRuleSet,
