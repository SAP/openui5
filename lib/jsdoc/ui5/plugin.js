...
function convertDragDropValue(node, cardinality) {
	...
	return Object.assign(mDefaults[cardinality || "self"], mDragDropValue);
}
...
exports.astNodeVisitor = {
	...
	visitNode: function(node, e, parser, currentSourceName) {
		...
		} else if ( node.type === Syntax.ExpressionStatement && node.expression.type === Syntax.AssignmentExpression && isCreateDataTypeCall(node.expression.right) ) {
