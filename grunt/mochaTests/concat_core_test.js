...
describe('openui5_concat_core', function() {
	...
	it('should create the concatinated sap-ui-core.js', function() {
		...
		var coreJsContent = grunt.file.read('target/openui5/resources/sap-ui-core.js');
	...
	it('should create the concatinated sap-ui-coreNoJQuery.js', function() {
		...
		var coreNoQueryJsContent = grunt.file.read('target/openui5/resources/sap-ui-core-noJQuery.js');
	...
	it('should create the sap-ui-debug.js', function() {
		...
		var sapUiDebugContent = grunt.file.read('target/openui5/resources/sap-ui-debug.js');
		assert.ok(sapUiDebugContent.indexOf("sap.ui.define('sap/ui/debug/ControlTree'") !== -1, 'Did contain the Control Tree');
