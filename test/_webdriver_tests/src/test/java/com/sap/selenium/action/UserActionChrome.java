...
public class UserActionChrome extends UserActionCommon {
    ...
    public Point getElementLocation(WebDriver driver, String elementId) {
        ...
        Point elementScreenLocation = new Point(browserViewBoxLocation.x + relativeLocation.x, browserViewBoxLocation.y
                + relativeLocation.y);
    ...
    public Point getBrowserViewBoxLocation(WebDriver driver) {
        ...
        int screenX = ((Long) ((JavascriptExecutor) driver).executeScript("var e = window.screenX;" + "return e;")).intValue();

        // The Location Y of the browser in the screen.
        int screenY = ((Long) ((JavascriptExecutor) driver).executeScript("var e = window.screenY;" + "return e;")).intValue();

        // The width of browser.
        int outerWidth = ((Long) ((JavascriptExecutor) driver).executeScript("var e = window.outerWidth;" + "return e;")).intValue();

        // The height of browser.
        int outerHeight = ((Long) ((JavascriptExecutor) driver).executeScript("var e = window.outerHeight;" + "return e;")).intValue();
    ...
    protected Point getRelativeLocation(WebDriver driver, String elementId) {
        ...
        Double relativeLocationX = Double.parseDouble(((JavascriptExecutor) driver).executeScript(
                                   ...
                                   + "var elementX = element.getBoundingClientRect().left;" + "return elementX;").toString());

        Double relativeLocationY = Double.parseDouble(((JavascriptExecutor) driver).executeScript(
                                   "var element = document.getElementById('" + elementId + "');"
                                   + "var elementY = element.getBoundingClientRect().top;" + "return elementY;").toString());
    ...
    public Dimension getBrowserViewBoxDimension(WebDriver driver) {
        ...
        int innerWidth = ((Long) ((JavascriptExecutor) driver).executeScript(
                         "var e = window.innerWidth;" + "return e;")).intValue();

        // The height of body including scroll bar.
        int innerHeight = ((Long) ((JavascriptExecutor) driver).executeScript(
                          "var e = window.innerHeight;" + "return e;")).intValue();
    ...
    protected int getScrollTop(WebDriver driver) {
        ...
        int scrollTop = ((Long) ((JavascriptExecutor) driver).executeScript(
                         "var e = document.documentElement.scrollTop;" + "return e;")).intValue();
        return scrollTop;
    }
    ...
    protected int getScrollLeft(WebDriver driver) {
        ...
        int scrollLeft = ((Long) ((JavascriptExecutor) driver).executeScript(
                         "var e = document.documentElement.scrollLeft;" + "return e;")).intValue();
        return scrollLeft;
    }
