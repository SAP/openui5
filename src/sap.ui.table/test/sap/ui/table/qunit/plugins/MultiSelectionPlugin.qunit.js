...
sap.ui.define([
	...
	QUnit.test("Selection using addSelectionInterval: Number of items in range below limit", function(assert) {
		...
		return oSelectionPlugin.addSelectionInterval(0, 4).then(function() {
			assert.ok(fnGetContexts.calledWithExactly(0, 5, 0, undefined, true), "getContexts was called with the correct parameters");
			...
			return oSelectionPlugin.addSelectionInterval(-1, 5).then(function() {
				assert.ok(fnGetContexts.calledWithExactly(1, 5, 0, undefined, true), "getContexts was called with the correct parameters");
				assert.ok(fnGetContexts.calledOnce, "getContexts was called once");
			...
			return new Promise(function(resolve) {
				...
				setTimeout(function () {
					assert.ok(fnGetContexts.calledWithExactly(5, 1, 0, undefined, true), "getContexts was called with the correct parameters");
					assert.ok(fnGetContexts.calledOnce, "getContexts was called once");
					assert.deepEqual(oSelectionPlugin.getSelectedIndices(), [0, 1, 2, 3, 4, 5],
			...
			return oSelectionPlugin.addSelectionInterval(iSelectableCount - 1, iSelectableCount + 100).then(function() {
				assert.ok(fnGetContexts.calledWithExactly(iSelectableCount - 1, 1, 0, undefined, true), "getContexts was called with the correct parameters");
				assert.ok(fnGetContexts.calledOnce, "getContexts was called once");
	...
	QUnit.test("Reverse selection using addSelectionInterval: Number of items in range below limit", function(assert) {
		...
		return new Promise(function(resolve) {
			oSelectionPlugin.attachEventOnce("selectionChange", function(oEvent) {
				assert.ok(fnGetContexts.calledWithExactly(5, 5, 0, undefined, true), "getContexts was called with the correct parameters");
				assert.ok(fnGetContexts.calledOnce, "getContexts was called once");
			...
			return new Promise(function(resolve) {
				oSelectionPlugin.attachEventOnce("selectionChange", function(oEvent) {
					assert.ok(fnGetContexts.calledWithExactly(4, 5, 0, undefined, true), "getContexts was called with the correct parameters");
					assert.ok(fnGetContexts.calledOnce, "getContexts was called once");
	...
	QUnit.test("Selection using addSelectionInterval: Number of items in range above limit", function(assert) {
		...
		return new Promise(function(resolve) {
			oSelectionPlugin.attachEventOnce("selectionChange", function(oEvent) {
				assert.ok(fnGetContexts.calledWithExactly(0, 1, 0, undefined, true), "getContexts was called with the correct parameters");
				assert.ok(fnGetContexts.calledOnce, "getContexts was called once");
			...
			oSelectionPlugin.attachEventOnce("selectionChange", function(oEvent) {
				...
				assert.ok(fnGetContexts.calledWithExactly(1, 6, 0, undefined, true), "getContexts was called with the correct parameters");
				assert.ok(fnGetContexts.calledOnce, "getContexts was called once");
			});
			fnGetContexts.reset();
			oSelectionChangeSpy.reset();
			...
			oSelectionPlugin.attachEventOnce("selectionChange", function(oEvent) {
				...
				assert.ok(oEvent.getParameters().limitReached, "limitReached parameter is correct");
				assert.ok(fnGetContexts.calledWithExactly(6, 6, 0, undefined, true), "getContexts was called with the correct parameters");
				assert.ok(fnGetContexts.calledOnce, "getContexts was called once");
			});
			fnGetContexts.reset();
			oSelectionChangeSpy.reset();
	...
	QUnit.test("Selection using setSelectionInterval", function(assert) {
		...
		return oSelectionPlugin.setSelectionInterval(-1, 10).then(function() {
			assert.ok(fnGetContexts.calledWithExactly(0, 6, 0, undefined, true), "getContexts was called with the correct parameters");
			assert.ok(fnGetContexts.calledOnce, "getContexts was called once");
			...
			return oSelectionPlugin.setSelectionInterval(5, 15).then(function() {
				assert.ok(fnGetContexts.calledWithExactly(5, 6, 0, undefined, true), "getContexts was called with the correct parameters");
				assert.ok(fnGetContexts.calledOnce, "getContexts was called once");
	...
	QUnit.test("Selection using setSelectedIndex", function(assert) {
		...
		return oSelectionPlugin.setSelectedIndex(3).then(function() {
			assert.ok(fnGetContexts.calledWithExactly(3, 1, 0, undefined, true), "getContexts was called with the correct parameters");
			assert.ok(fnGetContexts.calledOnce, "getContexts was called once");
	...
	QUnit.test("Select All", function(assert) {
		...
		return oSelectionPlugin.selectAll().then(function() {
			assert.ok(fnGetContexts.calledWithExactly(0, iHighestSelectableIndex + 1, 0, undefined, true), "getContexts was called with the correct parameters");
			assert.ok(fnGetContexts.calledOnce, "getContexts was called once");
	...
	QUnit.test("Selection (selectionMode = Single)", function(assert) {
		...
		oSelectionPlugin.attachEventOnce("selectionChange", function() {
			assert.ok(fnGetContexts.calledWithExactly(9, 1, 0, undefined, true), "getContexts was called with the correct parameters");
			assert.ok(fnGetContexts.calledOnce, "getContexts was called once");
			assert.deepEqual(oSelectionPlugin.getSelectedIndices(), [9], "Only one item is selected (iIndexTo)");

			oSelectionPlugin.attachEventOnce("selectionChange", function() {
				assert.ok(fnGetContexts.calledWithExactly(4, 1, 0, undefined, true), "getContexts was called with the correct parameters");
				assert.ok(fnGetContexts.calledOnce, "getContexts was called once");
