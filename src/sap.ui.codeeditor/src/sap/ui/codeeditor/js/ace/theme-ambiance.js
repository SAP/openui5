...
background-image: url(" + sap.ui.require.toUrl("sap/ui/codeeditor/js/ace/assets/theme_ambience_text_layer.png") + ");\
}\
.ace-ambiance .ace_indent-guide {\
background: url(" + sap.ui.require.toUrl("sap/ui/codeeditor/js/ace/assets/theme_ambience_indent_guide.png") + ") right repeat-y;\
}\
";
// #### END MODIFIED BY SAP
