sap.ui.define([
	...
	"sap/ui/core/library"
], function(App, Button, Label, MessageToast, Page, Select, ToggleButton, Item, VerticalLayout, ColorPicker, ColorPickerDisplayMode, ColorPickerPopover, unifiedLibrary, jQuery, coreLibrary) {
	"use strict";
