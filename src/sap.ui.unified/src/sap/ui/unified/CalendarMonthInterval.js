...
//		};
		...
		CalendarMonthInterval.prototype.onsaptabprevious = function(oEvent){
			...
			if (jQuery.sap.containsOrEquals(this.getDomRef("content"), oEvent.target)) {
				...
				case 0: // day picker
					...
					var oMonthDate = CalendarUtils._createUniversalUTCDate(oMonthsRow.getDate());
		...
		CalendarMonthInterval.prototype._getShowMonthsHeader = function(){
