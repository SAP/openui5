        ...
        if ("/resources/sap-ui-core.js".equals(path)) {
          ...
          if ("GET".equals(method)) {
            ...
            if (this.findResource("/resources/ui5loader.js") != null) {
              ...
              IOUtils.write(this.loadResource("/resources/ui5loader-bootconfig.js"), os, "UTF-8");
              IOUtils.write("require.sync(\"sap/ui/core/Core\"); sap.ui.getCore().boot && sap.ui.getCore().boot();", os, "UTF-8");
            } else {
