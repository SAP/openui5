...
sap.ui.define(['jquery.sap.global', './library', 'sap/ui/core/Control', 'sap/ui/core/Popup', 'sap/ui/core/ResizeHandler', 'sap/ui/core/delegate/ItemNavigation', 'jquery.sap.events', 'jquery.sap.keycodes'],
	...
	Splitter.prototype.splitterPart = function(domElement) {
		/** *************method variables********************** */
		var classDomElement;
		/** *************************************************** */
	 ...
	 */
	Splitter.prototype.setFocusNextSplitterElement = function(oEvent) {
	...
	Splitter.prototype.focusPrev = function(oElement) {
	 ...
	 * Note: in current spec splitter bar shouldn't be focused any more. This was changed in the code.
	 */
	Splitter.prototype.setFocusPreviousSplitterElement = function(oEvent) {
	 ...
	 */
	Splitter.prototype.onsapskipforward = function(oEvent) {
		// cancel the event
		oEvent.preventDefault();
		oEvent.stopPropagation();
	 ...
	 */
	Splitter.prototype.onsapskipback = function(oEvent) {
		// cancel the event
		oEvent.preventDefault();
		oEvent.stopPropagation();
