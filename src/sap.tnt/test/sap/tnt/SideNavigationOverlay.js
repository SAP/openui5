...
], function(Controller, Device, Fragment, SideNavigation, NavigationList, NavigationListItem, ResponsivePopover, NavigationListGroup, Dialog, Button, Text, InvisibleText) {
	"use strict";
