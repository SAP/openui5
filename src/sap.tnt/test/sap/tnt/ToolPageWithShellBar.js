sap.ui.define([
  ...
  "use strict";
  // Note: the HTML page 'ToolPageWithShellBar.html' loads this module via data-sap-ui-on-init
	  ...
	  menu: new Menu({
		  ...
		  items: [
			  new MenuItem({
				  ...
				  items: [
					  new MenuItem({ text: "accidental leave", icon: "sap-icon://accidental-leave" }),
					  new MenuItem({ text: "iphone", icon: "sap-icon://iphone" }),
					  new MenuItem({ text: "globe", icon: "sap-icon://globe" })
				  ]
			  })
		  ]
	  }),
