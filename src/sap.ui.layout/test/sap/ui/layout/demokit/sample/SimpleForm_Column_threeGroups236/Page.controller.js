sap.ui.define([
	...
	var PageController = Controller.extend("sap.ui.layout.sample.SimpleForm_Column_threeGroups236.Page", {
		...
		_getFormFragment: function (sFragmentName) {
			...
			if (!pFormFragment) {
				pFormFragment = Fragment.load({
					id: oView.getId(),
					name: "sap.ui.layout.sample.SimpleForm_Column_threeGroups236." + sFragmentName
				});
