sap.ui.define([
	...
	var PageController = Controller.extend("sap.ui.layout.sample.Form_Column_threeGroups346.Page", {
		...
		_getFormFragment: function (sFragmentName) {
			...
			if (!pFormFragment) {
				pFormFragment = Fragment.load({
					id: oView.getId(),
					name: "sap.ui.layout.sample.Form_Column_threeGroups346." + sFragmentName
				});
