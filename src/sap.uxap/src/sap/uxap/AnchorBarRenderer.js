...
sap.ui.define(["sap/m/ToolbarRenderer", "sap/ui/core/Lib", "sap/ui/core/Renderer", "sap/m/BarInPageEnabler", "./library"], function(ToolbarRenderer, Library, Renderer, BarInPageEnabler, library) {
	"use strict";
