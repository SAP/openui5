sap.ui.define([
	...
	return Controller.extend("sap.uxap.sample.ChildObjectPage.ChildObjectPage", {
		onAfterRendering: function () {
			var oJsonModel = new JSONModel("./test-resources/sap/uxap/demokit/sample/ChildObjectPage/employee.json");
			...
			var oModel = new JSONModel("./test-resources/sap/uxap/demokit/sample/ChildObjectPage/products.json");
