sap.ui.define([
	...
	return Controller.extend("sap.f.sample.IllustratedMessageSessionTimeout.controller.Main", {
		...
		onInit: function () {
			...
			var i18nModel = new ResourceModel({
				bundleName: "sap.f.sample.IllustratedMessageSessionTimeout.i18n.i18n"
			});
		...
		handleOpenDialog : function () {
			if (!this._oDialog) {
				Fragment.load({
					name: "sap.f.sample.IllustratedMessageSessionTimeout.view.fragments.Dialog",
					controller: this
