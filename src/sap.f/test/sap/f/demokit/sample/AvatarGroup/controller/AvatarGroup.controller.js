sap.ui.define([
	...
	return Controller.extend("sap.f.sample.AvatarGroup.controller.AvatarGroup", {
		...
		onInit: function () {
			...
			this.oModel.loadData(sap.ui.require.toUrl("sap/f/sample/AvatarGroup/model/avatargroup.json"));
			...
			this.oGroupModel.loadData(sap.ui.require.toUrl("sap/f/sample/AvatarGroup/model/avatargroup.json"));
