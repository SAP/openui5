sap.ui.define([
	...
	"use strict";
	return Controller.extend("sap.f.cardsVisualTests.controller.Manifest", {
		onInit: function () {
			this._createCardExample("card1", {
				xmlUsage: "<f:Card manifest='./cardsVisualTests/model/manifests/manifest_card1.json' width='500px' height='auto'/>"
			});
