...
sap.ui.define([
	...
	var oBindingParser = BindingParser.complexParser;

	var oConfig = new Configuration();

	// @deprecated since 1.24, enables simple bindings if specifically configured
	if ( oConfig.getBindingSyntax() === "simple" ) {
		oBindingParser = BindingParser.simpleParser;
	}

	if ( oConfig.getDesignMode() == true ) {
