...
sap.ui.define([
	 ...
	 * @param {sap.ui.model.Filter} oFilter the root filter of a filter tree
	 * @param {object} oEntityType the entity metadata object
	 * @return {string} the URL encoded filter parameters
	 * @private
	 */
	ODataUtils.createFilterParams = function(oFilter, oMetadata, oEntityType) {
		if (!oFilter) {
			return;
		}
	 ...
	 * @private
	 */
	ODataUtils._createFilterParams = function(oFilter, oMetadata, oEntityType) {
		var that = this;
