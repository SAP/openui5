...
sap.ui.define(['jquery.sap.global', 'sap/ui/base/Object', 'sap/ui/test/gherkin/dataTableUtils',
   ...
   * }
   *
   * @param {feature or string} vFeature - a feature object generated by sap.ui.test.gherkin.SimpleGherkinParser.
  ...
  return UI5Object.extend("sap.ui.test.gherkin.GherkinTestGenerator",
     ...
     *
     * @param {[[string]] or [string]} aExamples - scenario outline examples
