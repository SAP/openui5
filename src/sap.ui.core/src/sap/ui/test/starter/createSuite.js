...
(function() {
	...
	var setup = new Promise(function(resolve, reject) {
		...
		return {
			renderList: function() {
				return whenLoaded.then(renderList).catch(renderError);
			},
