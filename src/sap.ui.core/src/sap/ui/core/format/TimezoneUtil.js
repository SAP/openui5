...
sap.ui.define([], function() {
	 ...
	 * @private
 	 */
	TimezoneUtil.mCLDR2ABAPTimezones = {
	...
	TimezoneUtil.getLocalTimezone = function() {
		if (sLocalTimezone === "") { // timezone may be undefined, only value "" means empty cache
			...
			sLocalTimezone = TimezoneUtil.mCLDR2ABAPTimezones[sLocalTimezone] || sLocalTimezone;
		}
	 ...
	 * @private
	 */
	TimezoneUtil._clearLocalTimezoneCache = function () {
		sLocalTimezone = "";
	};
