...
sap.ui.define([
	...
	"sap/ui/core/library"
], function(Log, UIComponent, ComponentContainer, Placeholder, coreLib) {
	"use strict";

	var oAfterShowDelegate = {
		"onAfterShow": function() {
			this.getParent().hideGhost();
			this.removeEventDelegate(oAfterShowDelegate);
		}
	};
