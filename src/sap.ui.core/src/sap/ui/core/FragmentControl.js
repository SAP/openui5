...
sap.ui.define([
     ...
     * Setting invalidate to <code>true</code> or <code>"render"</code> for properties and aggregations sets the complete FragmentControl
     ...
     *          invalidate: true
     *       },
     *       value: { //changing this property will re-render the FragmentControl as it defines invalidate: "render"
     *          type: 'string',
     *          defaultValue: '',
     *          invalidate: 'render'
     *       },
     *       progress: { //changing this property will re-template the FragmentControl as it defines invalidate: "template"
     *          type: 'int',
     *          defaultValue: '',
     *          invalidate: 'template'
     *       }
