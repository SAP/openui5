...
(function() {
	...
	const sBaseUrl =
		...
		?? find("SCRIPT[src]", /^([^?#]*\/)?sap-ui-core-nojQuery\.js(?:[?#]|$)/); // or base dir of sap-ui-core-nojQuery.js (can be empty)
	...
	loadScripts([
		...
		loadScripts([
			...
			// cascade 3: bootstrap Core
			sap.ui.require(["sap/ui/core/Core"], function(_Core) {});
		});
	});
