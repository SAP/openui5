sap.ui.define([
	...
	return BaseController.extend("sap.ui.demo.nav.controller.employees.overview.EmployeesOverviewContent", {
		...
		onInit: function () {
			...
			oRouter.getRoute("employeesOverview").attachMatched(this._onRouteMatched, this);
		...
		onSortButtonPressed : function (oEvent) {
			...
			oRouter.navTo("employeesOverview",this._oRouterArgs);
		},
		...
		onSearchEmployeesTable : function (oEvent) {
			...
			oRouter.navTo("employeesOverview",this._oRouterArgs, true /*no history*/);
		},
		...
		_initViewSettingsDialog : function () {
			...
			this._oVSD = new sap.m.ViewSettingsDialog("vsd", {
				confirm: function (oEvent) {
					...
					oRouter.navTo("employeesOverview",this._oRouterArgs, true /*without history*/);
				}.bind(this),
