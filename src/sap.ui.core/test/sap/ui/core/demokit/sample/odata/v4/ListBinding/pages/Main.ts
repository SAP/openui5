    ...
    onTheMainPage: {
        ...
        assertions: {
            ...
            checkEmployeeEquipmentInRow: function (iRow, sEquipmentName) {
                Helper.checkInputValue(this, sViewName, /EQUIPMENT_2_PRODUCT:Name/, sEquipmentName, iRow);
            },
            ...
            checkProductImageInRow: function (iRow, sUrl) {
                this.waitFor({
                    ...
                    success: function (oEmployeeEquipments) {
                        var oRow = oEmployeeEquipments.getItems()[iRow], oImage = oRow.getCells()[1];
                        Opa5.assert.strictEqual(oImage.getSrc(), sUrl[0] === "/" ? sUrl : oImage.getBinding("src").getModel().sServiceUrl + sUrl, "URL of equipment image in row " + iRow + " as expected: " + sUrl);
                    },
                    viewName: sViewName
                });
            },
    ...
    onTheChangeManagerOfTeamDialog: {
        actions: {
            changeManager: function (sManager) {
                Helper.changeInputValue(this, sViewName, "ChangeManagerOfTeamDialog::Manager", sManager);
            },
        ...
        assertions: {
            checkManager: function (sManager) {
                Helper.checkInputValue(this, sViewName, "ChangeManagerOfTeamDialog::Manager", sManager);
            }
        }
    },
    onTheChangeTeamBudgetDialog: {
        actions: {
            changeBudget: function (sBudget) {
                Helper.changeInputValue(this, sViewName, "ChangeTeamBudgetDialog::Budget", sBudget);
            },
            pressChange: function () {
        ...
        assertions: {
            checkBudget: function (sBudget) {
                Helper.checkInputValue(this, sViewName, "ChangeTeamBudgetDialog::Budget", sBudget);
            },
            checkTeamID: function (sTeamID) {
                Helper.checkInputValue(this, sViewName, "ChangeTeamBudgetDialog::TeamID", sTeamID);
            }
        }
    }
});