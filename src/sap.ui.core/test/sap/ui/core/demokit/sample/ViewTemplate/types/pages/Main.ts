            ...
            changeBoolean: function () {
                this.waitFor({
                    ...
                    success: function (oControl) {
                        ...
                        Opa5.assert.ok(true, "Boolean value changed:" + oControl.getBinding("value").getValue());
                    },
                    viewName: sViewName
                });
            },
            enterDateTimePickerValue: function (sId, sValue, sControlType) {
                return this.waitFor({
                    ...
                    success: function (oControl) {
                        ...
                        Opa5.assert.strictEqual(oControl.getValue(), sValue, "Control: " + sId + " Value is: " + oControl.getValue());
                    },
                    viewName: sViewName
                });
            },
            ...
            checkDateTimePickerValueState: function (sId, sState, sControlType) {
                return this.waitFor({
                    ...
                    success: function (oInput) {
                        Opa5.assert.strictEqual(oInput.getValueState(), sState, "checkDateTimePickerValueState('" + sId + "', '" + sState + "')");
                    },
                    viewName: sViewName
                });
            },
