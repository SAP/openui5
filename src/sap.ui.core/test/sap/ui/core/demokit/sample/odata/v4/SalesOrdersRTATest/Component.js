...
sap.ui.define([
	...
	return UIComponent.extend("sap.ui.core.sample.odata.v4.SalesOrdersRTATest.Component", {
		metadata : {
			manifest : "json"
		},
		...
		createContent : function () {
			...
			oModel.getMetaModel().requestObject("/SalesOrderList/").then(function () {
				...
				jQuery.sap.log.debug("Last-Modified: " + oLastModified,
					...
					"sap.ui.core.sample.odata.v4.SalesOrdersRTATest.Component");

				oLayout.addItem(sap.ui.view({
					async : true,
					id : "sap.ui.core.sample.odata.v4.SalesOrdersRTATest.Main",
					...
					type : ViewType.XML,
					viewName : "sap.ui.core.sample.odata.v4.SalesOrdersRTATest.Main"
				}));
			});
			return oLayout;
		...
		exit : function () {
			TestUtils.retrieveData("sap.ui.core.sample.odata.v4.SalesOrdersRTATest.sandbox")
				.restore();
			...
			jQuery.sap.unloadResources(
				"sap/ui/core/sample/odata/v4/SalesOrdersRTATest/SalesOrdersSandbox.js",
