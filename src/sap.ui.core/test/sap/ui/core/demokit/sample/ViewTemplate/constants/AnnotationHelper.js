...
// Provides object sap.ui.core.sample.ViewTemplate.constants.AnnotationHelper
	...
	function(jQuery, BindingParser, Core, DateFormat, NumberFormat) {
		...
		function illegalValue(vRawValue) {
			jQuery.sap.log.warning("Illegal value for " + vRawValue["@odata.type"] + ": "
				+ vRawValue.value, null,
				"sap.ui.core.sample.ViewTemplate.constants.AnnotationHelper");
		 ...
		 *
		 * @alias sap.ui.core.sample.ViewTemplate.constants.AnnotationHelper
		 * @private
		 */
		return {
			/**
