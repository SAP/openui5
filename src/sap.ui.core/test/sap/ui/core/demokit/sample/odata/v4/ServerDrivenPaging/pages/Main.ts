        ...
        assertions: {
            checkGridTableTitle: function (sTitle) {
                this.waitFor({
                    ...
                    id: "businessPartnerTable",
                    success: function (oTable) {
                        Opa5.assert.strictEqual(oTable.getTitle().getText(), sTitle, "Grid table title: " + sTitle);
                    },
                    viewName: sViewName
                });
            },
            checkLastVisibleItemIndex: function (sValue) {
                this.waitFor({
                    ...
                    success: function (oTable) {
                        ...
                        Opa5.assert.strictEqual(oItem.getCells()[0].getText(), sValue, "Last table item index: " + sValue);
                    },
                    viewName: sViewName
                });
            },
            checkLastVisibleRowIndex: function (sValue) {
                this.waitFor({
                    ...
                    success: function (oTable) {
                        ...
                        Opa5.assert.strictEqual(oRow.getCells()[0].getText(), sValue, "Last table row index: " + sValue);
                    },
                    viewName: sViewName
                });
            },
            checkTableLength: function (iLength) {
                this.waitFor({
                    ...
                    id: "businessPartnerList",
                    success: function (oTable) {
                        Opa5.assert.strictEqual(oTable.getItems().length, iLength, "Table length: " + iLength);
                    },
                    viewName: sViewName
                });
            },
            checkTableTitle: function (sTitle) {
                this.waitFor({
                    ...
                    success: function (oTitle) {
                        Opa5.assert.strictEqual(oTitle.getText(), sTitle, "Table title: " + sTitle);
                    },
                    viewName: sViewName
                });
            }
