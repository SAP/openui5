...
sap.ui.define([
	...
	function setupMockServer() {
		...
		}, "sap/ui/core/sample/odata/v4/SalesOrdersRTATest/data",
			...
			var iQueryPos = mParameters.serviceUrl.indexOf("?"),
				...
				sUpdateGroupId = jQuery.sap.getUriParameters().get("updateGroupId")
					|| TestUtils.retrieveData(
						"sap.ui.core.sample.odata.v4.SalesOrdersRTATest.updateGroupId")
					|| undefined;
	...
	TestUtils.setData("sap.ui.core.sample.odata.v4.SalesOrdersRTATest.sandbox", oSandbox);
}, /* bExport= */false);