import library from "sap/f/library";
...
var LayoutType = library.LayoutType, sViewName = "sap.ui.core.sample.odata.v4.FlexibleColumnLayout.Main";
        ...
        assertions: {
            ...
            checkObjectPageNotVisible: function () {
                this.waitFor({
                    ...
                    success: function (oLayout) {
                        Opa5.assert.strictEqual(oLayout.getLayout(), LayoutType.OneColumn, "Object page not visible");
                    },
                    viewName: sViewName
                });
            },
            checkSubObjectPageNotVisible: function () {
                this.waitFor({
                    ...
                    id: "layout",
                    success: function (oLayout) {
                        Opa5.assert.strictEqual(oLayout.getLayout(), LayoutType.TwoColumnsMidExpanded, "Sub-object page not visible");
                    },
                    viewName: sViewName
                });
            }
    ...
    onTheListReport: {
        actions: {
            ...
            refresh: function () {
                this.waitFor({
                    success: function () {
                        TestUtils.setData("SalesOrderList_Refresh_with_GrossAmount_GT_1000.json", true);
                    }
                });
        ...
        assertions: {
            checkSalesOrder: function (iRow, sSalesOrderID, sNote) {
                Helper.waitForSortedByID(this, {
                    ...
                    success: function (aControls) {
                        Opa5.assert.strictEqual(aControls[0].getText(), sSalesOrderID, "Sales Order Id is " + sSalesOrderID);
                        Opa5.assert.strictEqual(aControls[1].getText(), sNote, "Note is " + sNote);
                    },
                    viewName: sViewName
                });
            },
            checkSalesOrderNotInTheList: function (sSalesOrderID) {
                this.waitFor({
                    ...
                    id: /salesOrderId/,
                    success: function (aControls) {
                        Opa5.assert.ok(aControls.every(function (oControl) {
            ...
            checkSalesOrdersCount: function (iCount) {
                Helper.waitForSortedByID(this, {
                    ...
                    success: function (aControls) {
                        ...
                        Opa5.assert.strictEqual(aControls[1].getText(), iCount + " New Sales Orders", "Count in title is " + iCount);
                    },
                    viewName: sViewName
                });
            }
    ...
    onTheObjectPage: {
        ...
        assertions: {
            checkGrossAmount: function (sGrossAmount) {
                Helper.checkInputValue(this, sViewName, "SalesOrder::grossAmount", sGrossAmount);
            },
            ...
            checkSalesOrderItem: function (iRow, sItemPosition, sQuantity) {
                Helper.waitForSortedByID(this, {
                    ...
                    success: function (aControls) {
                        Opa5.assert.strictEqual(aControls[0].getText(), sItemPosition, "Item position is " + sItemPosition);
                        Opa5.assert.strictEqual(aControls[1].getText(), sQuantity, "Quantity is " + sQuantity);
                    },
                    viewName: sViewName
                });
            },
            ...
            checkSalesOrderItemsCount: function (iCount) {
                Helper.waitForSortedByID(this, {
                    ...
                    success: function (aControls) {
                        Helper.checkMoreButtonCount(aControls[0], "[5/" + iCount + "]");
                        Opa5.assert.strictEqual(aControls[1].getText(), iCount + " Sales Order Line Items", "Count in title is " + iCount);
                    },
                    viewName: sViewName
                });
            }
    ...
    onTheSubObjectPage: {
        ...
        assertions: {
            checkItemPosition: function (sItemPosition) {
                Helper.checkInputValue(this, sViewName, "SO_2_ITEM::itemPosition", sItemPosition);
            },
