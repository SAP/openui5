...
(function () {
	...
	*/
	...
	jQuery.sap.require("sap.ui.core.sample.ViewTemplate.constants.AnnotationHelper");
	jQuery.sap.require("sap.ui.core.format.NumberFormat");

	var AnnotationHelper = sap.ui.core.sample.ViewTemplate.constants.AnnotationHelper,
		oCIRCULAR = {},
	...
	function formatAndParse(vValue, oCurrentBinding) {
		...
		sResult = AnnotationHelper.format.call(oThis, vValue);
		...
		jQuery.each(aValues, function (i, vValue) {
			test(sTitle + " (invalid: " + vValue + ")", sinon.test(function () {
				...
				oLogMock.expects("warning").once().withExactArgs(
					...
					null, "sap.ui.core.sample.ViewTemplate.constants.AnnotationHelper");
	...
	//*********************************************************************************************
	module("sap.ui.core.sample.ViewTemplate.constants.AnnotationHelper", {
		setup: function () {
