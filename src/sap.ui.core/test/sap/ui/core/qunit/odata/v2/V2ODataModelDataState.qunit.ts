...
QUnit.test("test DataState batch deferred", function (assert) {
    ...
    var oNameBinding = oModel.bindProperty("/ProductSet('AD-1000')/Name"), oFloatBinding = oModel.bindProperty("/ProductSet('AD-1000')/TaxTarifCode");
    ...
    oModel.read("/ProductSet('AD-1000')", {
        success: function () {
            testDataState(assert, oNameBinding, function () {
                ...
                laundering: false
            }, "Setting a string to a string type binding").then(function () {
                return testDataState(assert, oNameBinding, function () {
                    ...
                    success: function () {
                        ...
                        pOthersDone.then(function () {
                            testDataState(assert, oNameBinding, function () {
                                ...
                                invalidValue: undefined,
                                laundering: false
                            }, "Setting a string to a string type binding after submit", done);
                        });
                    }
                });
                oModel.attachBatchRequestSent(function () {
                    pOthersDone = testDataState(assert, oNameBinding, function () {
                        ...
                        invalidValue: undefined,
                        laundering: true
                    }, "Setting a string to a string type binding after submit").then(function () {
                        return testDataState(assert, oNameBinding, function () {
                        }, {
                            originalValue: "blabla2",
                            value: "blabla3",
        ...
        success: function () {
            ...
            testDataState(assert, oNameBinding, function () {
                ...
                oModel.attachRequestSent(function (oInfo) {
                    ...
                    pOthers = testDataState(assert, oNameBinding, function () {
                        oModel.setProperty("/ProductSet('AD-1000')/Name", "blabla3");
                    }, {
                        originalValue: "Flyer",
                        value: "blabla3",
                    ...
                    if (sRequestId && oInfo.mParameters["ID"] == sRequestId) {
                        ...
                        pOthers.then(function () {
                            testDataState(assert, oNameBinding, function () {
                                ...
                                invalidValue: undefined,
                                laundering: false
                            }, "Setting a string to a string type binding after submit", function () {
                                done();
                            });
                        });
                    }
...
QUnit.test("test DataState multiple submits", function (assert) {
    ...
    oModel.addBinding(oNameBinding);
    checkDataStatesInOrder(assert, oNameBinding, [{
    ...
    timeoutPromise(promiseRead(oModel, "/ProductSet('AD-1000')")).then(function () {
        ...
        oModel.submitChanges({
            success: function () {
                ...
                testDataState(assert, oNameBinding, function () {
                    ...
                    invalidValue: undefined,
                    laundering: false
                }, "Setting a 'blabla3' to a string type binding").then(done);
            }
        });
    };
});
QUnit.test("test DataState multiple submits with complext type", function (assert) {
    ...
    checkDataStatesInOrder(assert, oCityBinding, [{
            comment: "Change after initial read finishes",
...
QUnit.test("test DataState Composite Binding", function (assert) {
    ...
    oModel.read("/ProductSet('AD-1000')", {
        success: function () {
            ...
            Promise.resolve().then(function () {
                return testDataState(assert, oComositeBinding, function () {
                    oModel.setProperty("/ProductSet('AD-1000')/Name", "blabla2");
                }, {
...
QUnit.test("test DataState and Messages", function (assert) {
    ...
    oModel.read("/ProductSet('AD-1000')", {
        success: function () {
            ...
            testDataState(assert, oFloatInput.getBinding("value"), function () {
                oFloatInput.setValue("StringToFloatType");
            }, {
                originalValue: 1,
                value: 1,
                ...
                laundering: false,
                messages: 1
            }, "Forcing Validation error on float input", function () {
                testDataState(assert, oFloatInput.getBinding("value"), function () {
                    oFloatInput.setValue(1);
                }, {
                    originalValue: 1,
                    value: 1,
                    invalidValue: undefined,
                    ...
                    testDataState(assert, oNameInput.getBinding("value"), function () {
                        oNameInput.setValue("Test1");
                        ...
                        laundering: false,
                        messages: [oMessage1]
                    }, "Added warning and Error on Name input", function () {
                        ...
                        testDataState(assert, oNameInput.getBinding("value"), function () {
                            ...
                            testDataState(assert, oNameInput.getBinding("value"), function () {
                                ...
                                laundering: false,
                                messages: [oMessage2]
                            }, "Remove warning and Error on Name input", function () {
...
QUnit.test("test DataState and Messages on Composite Binding", function (assert) {
    ...
    var oFloatInput = new Input({ value: { path: "TaxTarifCode", type: "sap.ui.model.type.Float" } });
    var oNameInput = new Input({ value: { path: "Name" } });
    var oCompositeInput = new Input({ value: {
            parts: [{ path: "Name" }, { path: "TaxTarifCode", type: "sap.ui.model.type.Float" }]
        } });
    sap.ui.getCore().getMessageManager().registerObject(oVerticalLayout, true);
    oVerticalLayout.addContent(oFloatInput);
    ...
    oModel.read("/ProductSet('AD-1000')", {
        success: function () {
            ...
            testDataState(assert, oCompositeInput.getBinding("value"), function () {
                ...
                laundering: false,
                messages: 1
            }, "Added Messages to Composite input", function () {
...
QUnit.test("test DataState and Messages on Composite Binding 2", function (assert) {
    ...
    oModel.attachBatchRequestCompleted(function () {
        ...
        testDataState(assert, oBinding, function () { }, {
            originalValue: ["Flyer", 1],
            value: ["Flyer", 1],
            invalidValue: undefined,
            laundering: false,
            messages: 0
        }, "Initial status of Composite input after read").then(function () {
            oMessageManager.addMessages(oMessage1);
            return testDataState(assert, oBinding, function () { }, {
                originalValue: ["Flyer", 1],
                value: ["Flyer", 1],
                invalidValue: undefined,
                laundering: false,
