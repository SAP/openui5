...
import BooleanType from "sap/ui/model/odata/type/Boolean";
...
QUnit.test("format", function (assert) {
    ...
    try {
        ...
        assert.strictEqual(e.message, "Don't know how to format sap.ui.model.odata.type.Boolean to int");
    }
...
QUnit.test("format: Integration test getPrimitiveType", function (assert) {
    var oModel = new JSONModel({ value: true }), TestControl = ManagedObject.extend("test.sap.ui.model.odata.type.Boolean", {
        metadata: {
            properties: {
    ...
    oControl.bindProperty("labelFor", { path: "/value", type: "sap.ui.model.odata.type.Boolean" });
...
QUnit.test("parse", function (assert) {
    ...
    try {
        ...
        assert.strictEqual(e.message, "Don't know how to parse sap.ui.model.odata.type.Boolean from int");
    }
    this.mock(oType).expects("getPrimitiveType").withExactArgs("sap.ui.core.CSSSize").returns("string");
...
QUnit.test("setConstraints", function (assert) {
    var oType;
    this.oLogMock.expects("warning").withExactArgs("Illegal nullable: foo", null, "sap.ui.model.odata.type.Boolean");
    oType = new BooleanType({}, { nullable: false });
