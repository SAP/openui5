...
import asV2Requestor0 from "sap/ui/model/odata/v4/lib/_V2Requestor";
...
[{
    ...
    QUnit.test("doConvertResponse, " + i, function (assert) {
        var oRequestor = { fetchEntityContainer: function () { } }, oRequestorMock = this.mock(oRequestor);
        asV2Requestor(oRequestor);
        oRequestorMock.expects("convertNonPrimitive").withExactArgs(sinon.match.same(oFixture.oResponsePayload.d)).returns(oFixture.bIsCollection ? oFixture.oResponsePayload.d.results : oFixture.oResponsePayload.d);
        assert.deepEqual(oRequestor.doConvertResponse(oFixture.oResponsePayload), oFixture.oExpectedResult);
    });
});
QUnit.test("doConvertResponse, 2.2.7.2.3 RetrieveComplexType Request", function (assert) {
    var oPayload = {}, oRequestor = {}, oResponsePayload = {
        "d": {
            "flightDetails": {
                "__metadata": {
    ...
    asV2Requestor(oRequestor);
    this.mock(oRequestor).expects("convertNonPrimitive").withExactArgs(sinon.match.same(oResponsePayload.d.flightDetails)).returns(oPayload);
...
[{
    ...
    QUnit.test("doConvertResponse, not 2.2.7.2.3 RetrieveComplexType: " + i, function (assert) {
        var oPayload = {}, oRequestor = {};
        asV2Requestor(oRequestor);
        this.mock(oRequestor).expects("convertNonPrimitive").withExactArgs(sinon.match.same(oResponsePayload.d)).returns(oPayload);
        assert.strictEqual(oRequestor.doConvertResponse(oResponsePayload), oPayload);
    });
});
QUnit.test("doConvertResponse, 2.2.7.2.4 RetrievePrimitiveProperty Req.", function (assert) {
    var sMetaPath = "/FlightCollection/fldate", sOutput = "2017-08-10T00:00:00Z", oProperty = {}, oRequestor = {
    ...
    asV2Requestor(oRequestor);
    this.mock(oRequestor.oModelInterface).expects("fetchMetadata").withExactArgs(sMetaPath).returns(SyncPromise.resolve(oProperty));
    this.mock(oRequestor).expects("convertPrimitive").withExactArgs(oResponsePayload.d.fldate, sinon.match.same(oProperty), sMetaPath, "fldate").returns(sOutput);
    assert.deepEqual(oRequestor.doConvertResponse(oResponsePayload, sMetaPath), { value: sOutput });
});
QUnit.test("doConvertResponse, 2.2.7.2.3 & 2.2.7.2.4: null", function (assert) {
    var sMetaPath = "/FlightCollection/fldate", oRequestor = {}, oResponsePayload = {
        "d": {
            "fldate": null
        }
    };
    ...
    assert.deepEqual(oRequestor.doConvertResponse(oResponsePayload, sMetaPath), { value: null });
});
QUnit.test("doConvertResponse, 2.2.7.5 collection of primitives", function (assert) {
    var sMetaPath = "/__FAKE__GetAllFlightDates/@$ui5.overload/0/$ReturnType", sOutput0 = "2017-08-10T00:00:00Z", sOutput1 = "2017-08-10T00:00:01Z", oProperty = {}, oRequestor = {
        oModelInterface: { fetchMetadata: function () { } }
    }, oRequestorMock = this.mock(oRequestor), oResponsePayload = {
        "d": {
            "results": [
                "/Date(1502323200000)/",
                "/Date(1502323201000)/"
    ...
    oRequestorMock.expects("convertPrimitive").withExactArgs(oResponsePayload.d.results[0], sinon.match.same(oProperty), sMetaPath, "").returns(sOutput0);
    oRequestorMock.expects("convertPrimitive").withExactArgs(oResponsePayload.d.results[1], sinon.match.same(oProperty), sMetaPath, "").returns(sOutput1);
    assert.deepEqual(oRequestor.doConvertResponse(oResponsePayload, sMetaPath), { value: [sOutput0, sOutput1] });
});
QUnit.test("doConvertResponse, 2.2.7.5 empty collection", function (assert) {
    var sMetaPath = "/__FAKE__GetAllFlightDates/@$ui5.overload/0/$ReturnType", oRequestor = {}, oRequestorMock = this.mock(oRequestor), oResponsePayload = {
        "d": {
            "results": []
        }
    };
    ...
    assert.deepEqual(oRequestor.doConvertResponse(oResponsePayload, sMetaPath), { value: [] });
});
QUnit.test("convertNonPrimitive, complex value", function (assert) {
    ...
    }, oRequestor = {}, oRequestorMock = this.mock(oRequestor), oType = { property: { $Type: "Edm.Double" } };
    asV2Requestor(oRequestor);
    oRequestorMock.expects("getTypeForName").twice().withExactArgs("TypeQName").returns(oType);
    oRequestorMock.expects("convertPrimitive").withExactArgs("42", { $Type: "Edm.Double" }, "TypeQName", "property").returns(42);
...
QUnit.test("convertNonPrimitive, collection of complex values", function (assert) {
    ...
    oRequestorMock.expects("convertPrimitive").withExactArgs("42", { $Type: "Edm.Double" }, "TypeQName", "property").returns(42);
    oRequestorMock.expects("convertPrimitive").withExactArgs("77", { $Type: "Edm.Double" }, "TypeQName", "property").returns(77);
    oConvertedObject = oRequestor.convertNonPrimitive(oObject);
...
QUnit.test("convertNonPrimitive, __deferred (& 'for' loop & recursion)", function (assert) {
    var fnConvertNonPrimitive, oObject = {
        __metadata: { type: "TypeQName" },
        complex: {},
        missing: null,
        Products: {
        ...
        property: "42"
    }, oRequestor = {}, oType = { property: { $Type: "Edm.Double" } };
    asV2Requestor(oRequestor);
    ...
    this.mock(oRequestor).expects("convertNonPrimitive").withExactArgs(sinon.match.same(oObject.complex)).returns(oObject.complex);
    this.mock(oRequestor).expects("convertPrimitive").withExactArgs(oObject.property, { $Type: "Edm.Double" }, "TypeQName", "property").returns(42);
...
[{}, undefined].forEach(function (oInlineMetadata, i) {
    QUnit.test("convertNonPrimitive, __metadata.type missing, " + i, function (assert) {
        ...
        assert.throws(function () {
            oRequestor.convertNonPrimitive(oObject);
        }, new Error("Cannot convert structured value without type information in " + "__metadata.type: " + JSON.stringify(oObject)));
    });
});
[
    ...
    QUnit.test("convertPrimitive, " + oFixture.sType, function (assert) {
        var oRequestor = {}, vV2Value = {}, vV4Value = {};
        asV2Requestor(oRequestor);
        if (oFixture.sConvertMethod) {
            if (oFixture.sType === "Edm.DateTimeOffset") {
                this.mock(oRequestor).expects(oFixture.sConvertMethod).withExactArgs(sinon.match.same(vV2Value), { $Type: oFixture.sType }).returns(vV4Value);
            }
            else {
                this.mock(oRequestor).expects(oFixture.sConvertMethod).withExactArgs(sinon.match.same(vV2Value)).returns(vV4Value);
            }
        }
        else {
            vV4Value = vV2Value;
        }
        assert.strictEqual(oRequestor.convertPrimitive(vV2Value, { $Type: oFixture.sType }, "property", "Type"), vV4Value);
    });
});
QUnit.test("convertPrimitive, unknown and undefined type", function (assert) {
    ...
    }, new Error("Type 'Unknown' of property 'Property' in type 'Type' is unknown; " + "cannot convert value: foo"));
    assert.throws(function () {
        oRequestor.convertPrimitive("foo", undefined, "Type", "Property");
    }, new Error("Type 'undefined' of property 'Property' in type 'Type' is unknown; " + "cannot convert value: foo"));
});
[{
        input: "A+A+",
        output: "A-A-"
...
[{
        ...
        expectedError: "Cannot convert Edm.DateTime value '/Date(1395705600001)/' to Edm.Date" + " because it contains a time of day"
    }, {
...
[{
        ...
        input: "/Date(1395752399000)/",
        output: "2014-03-25T12:59:59Z"
    }, {
        input: "/Date(-327628800000)/",
    ...
    QUnit.test("convertDateTimeOffset, success " + i, function (assert) {
        ...
        sap.ui.getCore().getConfiguration().setCalendarType(CalendarType.Japanese);
        asV2Requestor0._setDateTimeFormatter();
        assert.strictEqual(oRequestor.convertDateTimeOffset(oFixture.input, { $Precision: oFixture.precision }), oFixture.output);
    });
});
[{
...
QUnit.test("convertDateTimeOffset, DateTimeInstance map callCount", function () {
    var oDateFormatMock = this.mock(DateFormat), oRequestor = {};
    asV2Requestor(oRequestor);
...
[{
    ...
    QUnit.test("convertDoubleSingle, " + i, function (assert) {
        var oRequestor = {};
        asV2Requestor(oRequestor);
        assert.strictEqual(oRequestor.convertDoubleSingle(oFixture.input), oFixture.output);
    });
});
[{
        input: "PT11H33M55S",
...
[{
    ...
    var sTitle = "doConvertSystemQueryOptions (V2): " + i + ", mQueryOptions" + JSON.stringify(oFixture.queryOptions);
    function executeTest(sCurrentTitle, aExpectedResultHandlerCalls, bSorted) {
        QUnit.test(sCurrentTitle, function (assert) {
            var fnResultHandlerSpy = this.spy(), oRequestor = {};
            asV2Requestor(oRequestor);
            oRequestor.doConvertSystemQueryOptions("/Foo", oFixture.queryOptions, fnResultHandlerSpy, oFixture.dropSystemQueryOptions, bSorted);
            assert.strictEqual(fnResultHandlerSpy.callCount, aExpectedResultHandlerCalls.length);
            aExpectedResultHandlerCalls.forEach(function (oResult, i) {
                var sCurrentKey = fnResultHandlerSpy.args[i][0], sCurrentValue = fnResultHandlerSpy.args[i][1];
                assert.strictEqual(sCurrentKey + "=" + sCurrentValue, oResult.key + "=" + oResult.value);
            });
        });
    }
...
[{
    ...
    var sTitle = "doConvertSystemQueryOptions (V2): unsupported system query options : " + JSON.stringify(oFixture.queryOptions);
    QUnit.test(sTitle, function (assert) {
        var oRequestor = {};
        asV2Requestor(oRequestor);
        assert.throws(function () {
            oRequestor.doConvertSystemQueryOptions("/Foo", oFixture.queryOptions, function () { });
        }, new Error(oFixture.error));
    });
});
QUnit.test("doConvertSystemQueryOptions: $filter", function () {
    var sFilter = "foo eq 'bar'", oRequestor = {}, fnResultHandlerSpy = this.spy();
    asV2Requestor(oRequestor);
    this.mock(oRequestor).expects("convertFilter").withExactArgs(sFilter, "/Foo").returns("~");
    oRequestor.doConvertSystemQueryOptions("/Foo", { $filter: sFilter }, fnResultHandlerSpy);
...
[
    ...
    QUnit.test("formatPropertyAsLiteral: " + sType, function (assert) {
        var sKeyPredicate = "(~)", oProperty = {
            "$kind": "Property",
            "$Type": sType
        }, oRequestor = {}, sResult, vValue = {};
        asV2Requestor(oRequestor);
        this.mock(ODataUtils).expects("formatValue").withExactArgs(sinon.match.same(vValue), sType).returns(sKeyPredicate);
...
QUnit.test("formatPropertyAsLiteral: Edm.Date", function (assert) {
    var oExpectation, oFormatOptions, sKeyPredicate = "(~)", oProperty = {
        "$kind": "Property",
        "$Type": "Edm.Date",
        "$v2Type": "Edm.DateTime"
    }, oRequestor = {}, sResult, vV2Value = {}, vV4Value = {};
    asV2Requestor(oRequestor);
    oExpectation = this.mock(DateFormat.prototype).expects("parse").withExactArgs(sinon.match.same(vV4Value)).returns(vV2Value);
    this.mock(ODataUtils).expects("formatValue").withExactArgs(sinon.match.same(vV2Value), "Edm.DateTime").returns(sKeyPredicate);
...
[undefined, "Edm.DateTime"].forEach(function (sV2Type) {
    ...
    QUnit.test(sTitle, function (assert) {
        ...
        asV2Requestor(oRequestor);
        oExpectation = this.mock(DateFormat.prototype).expects("parse").withExactArgs(sinon.match.same(vV4Value)).returns(vV2Value);
        this.mock(ODataUtils).expects("formatValue").withExactArgs(sinon.match.same(vV2Value), sV2Type || "Edm.DateTimeOffset").returns(sKeyPredicate);
        sResult = oRequestor.formatPropertyAsLiteral(vV4Value, oProperty);
        assert.strictEqual(sResult, sKeyPredicate);
        oFormatOptions = oExpectation.firstCall.thisValue.oFormatOptions;
...
QUnit.test("formatPropertyAsLiteral: Edm.TimeOfDay", function (assert) {
    var oDate = {
        getTime: function () { }
    }, oExpectation, oFormatOptions, sKeyPredicate = "(~)", oProperty = {
        "$kind": "Property",
        "$Type": "Edm.TimeOfDay",
        "$v2Type": "Edm.Time"
    }, oRequestor = {}, sResult, iTicks = 42, vV4Value = {};
    asV2Requestor(oRequestor);
    oExpectation = this.mock(DateFormat.prototype).expects("parse").withExactArgs(sinon.match.same(vV4Value)).returns(oDate);
    this.mock(oDate).expects("getTime").withExactArgs().returns(iTicks);
    this.mock(ODataUtils).expects("formatValue").withExactArgs({ __edmType: "Edm.Time", ms: iTicks }, "Edm.Time").returns(sKeyPredicate);
    sResult = oRequestor.formatPropertyAsLiteral(vV4Value, oProperty);
    assert.strictEqual(sResult, sKeyPredicate);
    oFormatOptions = oExpectation.firstCall.thisValue.oFormatOptions;
...
QUnit.test("formatPropertyAsLiteral: examples", function (assert) {
    ...
    [
        ...
        { value: "2015-05-23", type: "Edm.Date", v2type: "Edm.DateTime", result: "datetime'2015-05-23T00:00:00'" },
        { value: "2015-05-23T13:47:26Z", type: "Edm.DateTimeOffset", result: "datetimeoffset'2015-05-23T13:47:26Z'" },
        { value: "2015-05-23T18:47:26+0500", type: "Edm.DateTimeOffset", result: "datetimeoffset'2015-05-23T13:47:26Z'" },
        { value: "2015-05-23T13:47:26Z", type: "Edm.DateTimeOffset", v2type: "Edm.DateTime", result: "datetime'2015-05-23T13:47:26'" },
        { value: "13:47:26", type: "Edm.TimeOfDay", v2type: "Edm.Time", result: "time'PT13H47M26S'" }
    ].forEach(function (oFixture) {
        sap.ui.getCore().getConfiguration().setCalendarType(CalendarType.Japanese);
        asV2Requestor0._setDateTimeFormatter();
        ...
        }), oFixture.result, (oFixture.v2type || oFixture.type) + " " + oFixture.value);
    });
});
...
QUnit.test("formatPropertyAsLiteral: unsupported types", function (assert) {
    var oProperty = {}, oRequestor = {}, vValue = {};
    asV2Requestor(oRequestor);
...
[
    ...
    { literal: "2017-05-25", type: "Edm.Date", v2type: "Edm.DateTime", result: "foo/bar eq datetime'2017-05-25T00:00:00'" },
    { literal: "null", type: "Edm.Date", v2type: "Edm.DateTime", result: "foo/bar eq null" },
    { literal: "2017-05-25T17:42:43Z", type: "Edm.DateTimeOffset", result: "foo/bar eq datetimeoffset'2017-05-25T17:42:43Z'" },
    ...
    { literal: "936DA01F-9ABD-4D9D-80C7-02AF85C822A8", type: "Edm.Guid", result: "foo/bar eq guid'936DA01F-9ABD-4D9D-80C7-02AF85C822A8'" },
    ...
    { literal: "18:59:59", type: "Edm.TimeOfDay", v2type: "Edm.Time", result: "foo/bar eq time'PT18H59M59S'" },
    { literal: "null", type: "Edm.TimeOfDay", v2type: "Edm.Time", result: "foo/bar eq null" }
].forEach(function (oFixture) {
    QUnit.test("convertFilter: " + oFixture.type, function (assert) {
        var sFilter = "foo/bar eq " + oFixture.literal, sMetaPath = "/MyEntitySet", oProperty = { $Type: oFixture.type, $v2Type: oFixture.v2type }, oRequestor = {
            oModelInterface: { fetchMetadata: function () { } }
        };
        asV2Requestor(oRequestor);
        this.mock(oRequestor.oModelInterface).expects("fetchMetadata").withExactArgs(sMetaPath + "/foo/bar").returns(SyncPromise.resolve(oProperty));
        assert.strictEqual(oRequestor.convertFilter(sFilter, sMetaPath), oFixture.result || sFilter);
    });
});
[{
        v4: "3.14 eq foo",
    ...
    QUnit.test("convertFilter: " + oFixture.v4, function (assert) {
        var oProperty = { $Type: "Edm.Double" }, oRequestor = {
            oModelInterface: { fetchMetadata: function () { } }
        }, sResourcePath = "MyEntitySet";
        asV2Requestor(oRequestor);
        this.mock(oRequestor.oModelInterface).expects("fetchMetadata").atLeast(0).returns(SyncPromise.resolve(oProperty));
        if (oFixture.error) {
            assert.throws(function () {
                oRequestor.convertFilter(oFixture.v4, sResourcePath);
            }, new Error("Cannot convert filter to V2, " + oFixture.error + ": " + oFixture.v4));
        }
        else {
            assert.strictEqual(oRequestor.convertFilter(oFixture.v4, sResourcePath), oFixture.v2);
        }
    });
});
[{
    ...
    QUnit.test("convertFilter: " + oFixture.error, function (assert) {
        var sMetaPath = "/MyEntitySet", oRequestor = {
            oModelInterface: { fetchMetadata: function () { } }
        };
        asV2Requestor(oRequestor);
        this.mock(oRequestor.oModelInterface).expects("fetchMetadata").withExactArgs(sMetaPath + "/foo/bar").returns(SyncPromise.resolve(oFixture.property));
        assert.throws(function () {
...
QUnit.test("ready()", function (assert) {
    ...
    asV2Requestor(oRequestor);
    this.mock(oRequestor.oModelInterface).expects("fetchEntityContainer").returns(SyncPromise.resolve(Promise.resolve({})));
...
QUnit.test("getTypeForName", function (assert) {
    ...
    asV2Requestor(oRequestor);
    this.mock(oRequestor.oModelInterface).expects("fetchMetadata").withExactArgs("/my.Type").returns(SyncPromise.resolve(oType));
...
[{
    ...
    QUnit.test("doCheckVersionHeader, success cases - " + i, function (assert) {
        var oRequestor = _Requestor.create("/", {}, undefined, undefined, "2.0"), fnGetHeader = this.spy(function (sHeaderKey) {
            return oFixture.mHeaders[sHeaderKey];
        });
        oRequestor.doCheckVersionHeader(fnGetHeader, "Foo('42')/Bar", oFixture.bVersionOptional);
...
[{
    ...
    QUnit.test("doCheckVersionHeader, error cases - " + i, function (assert) {
        ...
        }, new Error("Expected 'DataServiceVersion' header with value '1.0' or '2.0' but " + "received " + oFixture.sError));
        assert.strictEqual(fnGetHeader.calledWithExactly("DataServiceVersion"), true);
        if (oFixture.iCallCount === 2) {
            assert.strictEqual(fnGetHeader.calledWithExactly("OData-Version"), true);
        }
...
QUnit.test("getPathAndAddQueryOptions: OperationImport", function (assert) {
    ...
    }, mParameters = { "ID": "1", "Foo": 42, "n/a": NaN }, mQueryOptions = {}, oRequestor = _Requestor.create("/", oModelInterface, undefined, undefined, "2.0"), oRequestorMock = this.mock(oRequestor);
    oRequestorMock.expects("formatPropertyAsLiteral").withExactArgs(42, oOperationMetadata.$Parameter[0]).returns("42");
    oRequestorMock.expects("formatPropertyAsLiteral").withExactArgs("1", oOperationMetadata.$Parameter[1]).returns("'1'");
    assert.strictEqual(oRequestor.getPathAndAddQueryOptions("/OperationImport(...)", oOperationMetadata, mParameters, mQueryOptions), "OperationImport");
...
[false, true].forEach(function (bAction) {
    ...
    QUnit.test(sTitle, function (assert) {
        var oEntity = { "Foo": 42, "ID": "1" }, oModelInterface = { fetchMetadata: function () { } }, oOperationMetadata = {
            "$IsBound": true,
            "$Parameter": [{
        ...
        }, mParameters = { "Bar": true }, mQueryOptions = {}, oRequestor = _Requestor.create("/", oModelInterface, undefined, undefined, "2.0"), oRequestorMock = this.mock(oRequestor), oTypeMetadata = {
            "$Key": ["ID", "Foo"],
            "Foo": {
                "$kind": "Property",
                "$Type": "Edm.Int16"
        ...
        this.mock(oModelInterface).expects("fetchMetadata").withExactArgs("/com.sap.ui5.OData.EdmTypes").returns(SyncPromise.resolve(oTypeMetadata));
        oRequestorMock.expects("formatPropertyAsLiteral").withExactArgs("1", oTypeMetadata.ID).returns("'1'");
        oRequestorMock.expects("formatPropertyAsLiteral").withExactArgs(42, oTypeMetadata.Foo).returns("42");
        oRequestorMock.expects("formatPropertyAsLiteral").withExactArgs(true, oOperationMetadata.$Parameter[1]).returns("true");
        assert.strictEqual(oRequestor.getPathAndAddQueryOptions("/EdmTypesCollection('1')/com.sap.ui5.OData.ResetEdmTypes(...)", oOperationMetadata, mParameters, mQueryOptions, bAction ? oEntity : function () { return oEntity; }), "ResetEdmTypes");
...
QUnit.test("getPathAndAddQueryOptions: Operation w/o parameters", function (assert) {
    var oOperationMetadata = {}, mParameters = { foo: "bar" }, oRequestor = _Requestor.create("/", {}, undefined, undefined, "2.0");
    this.mock(oRequestor).expects("formatPropertyAsLiteral").never();
    assert.strictEqual(oRequestor.getPathAndAddQueryOptions("/some.Operation(...)", oOperationMetadata, mParameters), "some.Operation");
    assert.deepEqual(mParameters, {});
});
QUnit.test("getPathAndAddQueryOptions: $v2HttpMethod", function (assert) {
    var oOperationMetadata = { $v2HttpMethod: "PUT" }, mParameters = { foo: "bar" }, oRequestor = _Requestor.create("/", {}, undefined, undefined, "2.0");
    assert.strictEqual(oRequestor.getPathAndAddQueryOptions("/some.Operation(...)", oOperationMetadata, mParameters), "some.Operation");
...
QUnit.test("getPathAndAddQueryOptions: collection parameter", function (assert) {
    var oOperationMetadata = { $Parameter: [{ $Name: "foo", $isCollection: true }] }, oRequestor = _Requestor.create("/", {}, undefined, undefined, "2.0");
    assert.throws(function () {
        oRequestor.getPathAndAddQueryOptions("/ActionImport(...)", oOperationMetadata, { "foo": [42] });
...
QUnit.test("convertKeyPredicate: simple string predicate", function (assert) {
    ...
    this.mock(_Helper).expects("getMetaPath").withExactArgs("/my/path('foo')").returns("/my/path");
    this.mock(oRequestor).expects("fetchTypeForPath").withExactArgs("/my/path").returns(SyncPromise.resolve(oEntityType));
    this.mock(_Parser).expects("parseKeyPredicate").withExactArgs("('foo')").returns({ "": "'foo'" });
...
QUnit.test("convertKeyPredicate: simple non-string predicate", function (assert) {
    ...
    this.mock(_Helper).expects("getMetaPath").withExactArgs("/my/path(42)").returns("/my/path");
    this.mock(oRequestor).expects("fetchTypeForPath").withExactArgs("/my/path").returns(SyncPromise.resolve(oEntityType));
    this.mock(_Parser).expects("parseKeyPredicate").withExactArgs("(42)").returns({ "": "42" });
    this.mock(_Helper).expects("parseLiteral").withExactArgs("42", "Edm.Foo", "/my/path(42)").returns(42);
    this.mock(oRequestor).expects("formatPropertyAsLiteral").withExactArgs(42, sinon.match.same(oEntityType.KeyProperty)).returns("~42~");
...
QUnit.test("convertKeyPredicate: named non-string predicate, encoded", function (assert) {
    ...
    this.mock(_Helper).expects("getMetaPath").withExactArgs("/my/path(f%C3%B8%C3%B8=42)").returns("/my/path");
    this.mock(oRequestor).expects("fetchTypeForPath").withExactArgs("/my/path").returns(SyncPromise.resolve(oEntityType));
    this.mock(_Parser).expects("parseKeyPredicate").withExactArgs("(f\u00F8\u00F8=42)").returns({ "f\u00F8\u00F8": "42" });
    this.mock(_Helper).expects("parseLiteral").withExactArgs("42", "Edm.Foo", "/my/path(f%C3%B8%C3%B8=42)").returns(42);
    this.mock(oRequestor).expects("formatPropertyAsLiteral").withExactArgs(42, sinon.match.same(oEntityType["f\u00F8\u00F8"])).returns("~b\u00E3r~");
    assert.strictEqual(oRequestor.convertKeyPredicate("(f%C3%B8%C3%B8=42)", "/my/path(f%C3%B8%C3%B8=42)"), "(f%C3%B8%C3%B8=~b%C3%A3r~)");
});
QUnit.test("convertKeyPredicate: compound predicate", function (assert) {
    var oEntityType = {
        ...
        p2: { $Type: "Edm.String" },
        p3: { $Type: "Edm.Double" }
    }, oHelperMock = this.mock(_Helper), oParserMock = this.mock(_Parser), oRequestor = _Requestor.create("/", {}, undefined, undefined, "2.0"), oRequestorMock = this.mock(oRequestor);
    this.mock(_Helper).expects("getMetaPath").withExactArgs("/my/path(p1=1,p2='2',p3=3)").returns("/my/path");
    oRequestorMock.expects("fetchTypeForPath").withExactArgs("/my/path").returns(SyncPromise.resolve(oEntityType));
    oParserMock.expects("parseKeyPredicate").withExactArgs("(p1=1,p2='2',p3=3)").returns({ "p1": "1", "p2": "'2'", "p3": "3" });
    oHelperMock.expects("parseLiteral").withExactArgs("1", "Edm.Double", "/my/path(p1=1,p2='2',p3=3)").returns(1);
    oRequestorMock.expects("formatPropertyAsLiteral").withExactArgs(1, sinon.match.same(oEntityType.p1)).returns("1d");
    oHelperMock.expects("parseLiteral").withExactArgs("3", "Edm.Double", "/my/path(p1=1,p2='2',p3=3)").returns(3);
    oRequestorMock.expects("formatPropertyAsLiteral").withExactArgs(3, sinon.match.same(oEntityType.p3)).returns("3d");
    assert.strictEqual(oRequestor.convertKeyPredicate("(p1=1,p2='2',p3=3)", "/my/path(p1=1,p2='2',p3=3)"), "(p1=1d,p2='2',p3=3d)");
});
["", "?$select=*"].forEach(function (sQuery) {
    QUnit.test("convertResourcePath: query=" + sQuery, function (assert) {
        var oRequestor = _Requestor.create("/", {}, undefined, undefined, "2.0"), oRequestorMock = this.mock(oRequestor);
        oRequestorMock.expects("convertKeyPredicate").withExactArgs("(42)", "/Foo/Bar(42)").returns("(~42~)");
        oRequestorMock.expects("convertKeyPredicate").withExactArgs("(23)", "/Foo/Bar(42)/Baz/Qux(23)").returns("(~23~)");
        assert.strictEqual(oRequestor.convertResourcePath("Foo/Bar(42)/Baz/Qux(23)" + sQuery), "Foo/Bar(~42~)/Baz/Qux(~23~)" + sQuery);
    });
});
QUnit.test("reportTransitionMessages does not call model", function (assert) {
    var fnreportTransitionMessages = this.spy(), oModelInterface = { reportTransitionMessages: fnreportTransitionMessages }, oRequestor = _Requestor.create("/", oModelInterface, undefined, undefined, "2.0");
...
QUnit.test("reportStateMessages does not call model", function (assert) {
    var fnreportStateMessages = this.spy(), oModelInterface = { reportStateMessages: fnreportStateMessages }, oRequestor = _Requestor.create("/", oModelInterface, undefined, undefined, "2.0");
    oRequestor.getModelInterface().reportStateMessages("Teams('42')", {});
...
QUnit.test("checkHeaderNames", function (assert) {
    ...
    oRequestor.checkHeaderNames({ "OData-Version": "123" });
    ["Accept", "Content-ID", "Content-Transfer-Encoding", "Content-Type", "DataServiceVersion", "If-Match", "If-None-Match", "MaxDataServiceVersion", "SAP-ContextId", "X-HTTP-Method"].forEach(function (sHeaderName) {
        var mHeaders = {};
