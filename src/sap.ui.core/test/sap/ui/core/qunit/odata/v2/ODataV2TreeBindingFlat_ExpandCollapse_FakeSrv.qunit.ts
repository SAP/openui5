...
QUnit.test("_loadSubTree: Request correct server index sections", function (assert) {
    ...
    oBinding._aNodes[1] = true;
    oBinding._aNodes[5] = true;
    oBinding._aNodes[6] = true;
    oBinding._aNodes[7] = true;
    oBinding._aNodes[10] = true;
    oBinding._aNodes[11] = true;
    oBinding._aNodes[13] = true;
    var oFakeParentNode = {
        serverIndex: 1,
        magnitude: 13
    };
...
QUnit.test("Expand root node (initial expansion level 0) to level 4 (ENtL01)", function (assert) {
    ...
    function handler2() {
        ...
        assert.deepEqual(oBinding.findNode(6).key, "ZTJ_G4_C_GLHIERResults('V2.36.34.32_1.2.4.0.1.2.3.0.1.2.1.1%3A0.16.0.0.X.0_IEQCACNIEQ00100000%3ACACNY0000000000_06Q88TZJOAW65DRWR6OHRU9QAX2H39PM')", "Correct node at index 6 (level 2)");
        assert.ok(!!oBinding.findNode(16), "Found a node at index 16");
        assert.deepEqual(oBinding.findNode(16).key, "ZTJ_G4_C_GLHIERResults('V2.36.34.32_1.2.4.0.1.2.3.0.1.2.1.1%3A0.16.0.0.X.0_IEQCACNIEQ00100000%3ACACN%200000000010_06Q88TZJOAW65DRWR6OHRU9QAX2H39PM')", "Correct node at index 16 (level 4)");
        done();
    }
...
QUnit.test("Expand root node (initial expansion level 2) to level 4 (ENtL02)", function (assert) {
    ...
    function handler2() {
        ...
        assert.deepEqual(oBinding.findNode(5).key, "ZTJ_G4_C_GLHIERResults('V2.36.29.32_1.2.4.0.1.2.3.0.1.2.1.1%3A0.11.0.0.X.0_IEQCACNIEQ0010000052372%3A001%202_0SUTU1Z8RLLDHJYDDY9JI1C15PXF8WA1')", "Correct node at index 5 (level 2)");
        assert.ok(!!oBinding.findNode(16), "Found a node at index 16");
        assert.deepEqual(oBinding.findNode(16).key, "ZTJ_G4_C_GLHIERResults('V2.36.34.32_1.2.4.0.1.2.3.0.1.2.1.1%3A0.16.0.0.X.0_IEQCACNIEQ00100000%3ACACN%200000000010_06Q88TZJOAW65DRWR6OHRU9QAX2H39PM')", "Correct node at index 16 (level 4)");
        done();
    }
...
QUnit.test("Expand deep node to level 4 (ENtL04)", function (assert) {
    ...
    function handler3() {
        ...
        assert.deepEqual(oBinding.findNode(10).key, "ZTJ_G4_C_GLHIERResults('V2.36.34.32_1.2.4.0.1.2.3.0.1.2.1.1%3A0.16.0.0.X.0_IEQCACNIEQ00100000%3ACACN%200000000010_0JF3PI8EYUQWUJJDOOYJV5DO616YD7AY')", "Correct node at index 10 (level 4)");
        done();
    }
    oBinding.attachChange(handler1);
    requestData(oBinding, 0, 20, 100);
...
QUnit.test("Expand root node (initial expansion level 0 + child and childrens childs manually expanded, some loaded only partially (paged)) to level 4 (ENtL05)", function (assert) {
    ...
    function handler6() {
        oBinding._bReadOnly = false;
        oBinding.getContexts(10, 30, 100);
        assert.ok(!!oBinding.findNode(16), "Found a node at index 16");
        assert.deepEqual(oBinding.findNode(16).key, "ZTJ_G4_C_GLHIERResults('V2.36.34.32_1.2.4.0.1.2.3.0.1.2.1.1%3A0.16.0.0.X.0_IEQCACNIEQ00100000%3ACACN%200000000010_0PVDB7PKY37IR1DZDNSLRY7R0GI6OIBV')", "Correct node at index 16 (level 4)");
        assert.ok(!!oBinding.findNode(32), "Found a node at index 32");
        assert.deepEqual(oBinding.findNode(32).key, "ZTJ_G4_C_GLHIERResults('V2.36.34.32_1.2.4.0.1.2.3.0.1.2.1.1%3A0.16.0.0.X.0_IEQCACNIEQ00100000%3ACACN%200000000082_0PVDB7PKY37IR1DZDNSLRY7R0GI6OIBV')", "Correct node at index 32 (level 4)");
        done();
    }
    oBinding.attachChange(handler1);
    requestData(oBinding, 0, 20, 100);
...
QUnit.test("Manual expand root node, expand root node (initial expansion level 0) to level 4, manual collapse some nodes (ENtL06)", function (assert) {
    ...
    function handler5() {
        ...
        assert.deepEqual(oBinding.findNode(14).key, "ZTJ_G4_C_GLHIERResults('V2.36.29.32_1.2.4.0.1.2.3.0.1.2.1.1%3A0.11.0.0.X.0_IEQCACNIEQ0010000052372%3A001%207_0OJCITXAIZ2D0WHVA468ROFWBKT4YWA6')", "Correct node at index 14 (level 2)");
        assert.ok(!!oBinding.findNode(15), "Found a node at index 15");
        assert.deepEqual(oBinding.findNode(15).key, "ZTJ_G4_C_GLHIERResults('V2.36.35.32_1.2.4.0.1.2.3.0.1.2.1.1%3A0.17.0.0.X.0_IEQCACNIEQ001000002000000502%3AREST_H_0FJGH0WOQW9T6CER4KYVCNV8EKS4JOWL')", "Correct node at index 15 (level 1)");
        done();
    }
    oBinding.attachChange(handler1);
    requestData(oBinding, 0, 20, 100);
...
QUnit.test("Expand root node (initial expansion level 2) to level 4 after it has been manually collapsed (ENtL09)", function (assert) {
    ...
    function handler3() {
        ...
        assert.ok(!!oBinding.findNode(6), "Found a node at index 6");
        assert.deepEqual(oBinding.findNode(6).key, "ZTJ_G4_C_GLHIERResults('V2.36.34.32_1.2.4.0.1.2.3.0.1.2.1.1%3A0.16.0.0.X.0_IEQCACNIEQ00100000%3ACACNY0000000000_0SUTU1Z8RLLDHJYDDY9JI1C15PXF8WA1')", "Correct node at index 6 (level 2)");
        assert.ok(!!oBinding.findNode(16), "Found a node at index 16");
        assert.deepEqual(oBinding.findNode(16).key, "ZTJ_G4_C_GLHIERResults('V2.36.34.32_1.2.4.0.1.2.3.0.1.2.1.1%3A0.16.0.0.X.0_IEQCACNIEQ00100000%3ACACN%200000000010_06Q88TZJOAW65DRWR6OHRU9QAX2H39PM')", "Correct node at index 16 (level 4)");
        done();
    }
...
QUnit.test("Expand deep node to level 4 after it has been manually expanded (ENtL10)", function (assert) {
    ...
    function handler4() {
        oBinding.getContexts(30, 20, 100);
        assert.ok(!!oBinding.findNode(47), "Found a node at index 47");
        assert.deepEqual(oBinding.findNode(47).key, "ZTJ_G4_C_GLHIERResults('V2.36.34.32_1.2.4.0.1.2.3.0.1.2.1.1%3A0.16.0.0.X.0_IEQCACNIEQ00100000%3ACACNY0000000000_0JF3PI8EYUQWUJJDOOYJV5DO616YD7AY')", "Correct node at index 47 (level 3)");
        assert.ok(!!oBinding.findNode(48), "Found a node at index 48");
        assert.deepEqual(oBinding.findNode(48).key, "ZTJ_G4_C_GLHIERResults('V2.36.29.32_1.2.4.0.1.2.3.0.1.2.1.1%3A0.11.0.0.X.0_IEQCACNIEQ0010000052372%3A001%207_0OJCITXAIZ2D0WHVA468ROFWBKT4YWA6')", "Correct node at index 48 (level 1)");
        done();
    }
    oBinding.attachChange(handler1);
    requestData(oBinding, 0, 20, 100);
...
QUnit.test("Expand level two node (initial expansion level 2) to level 4, expand root ndoe to level 4 (ENtL11)", function (assert) {
    ...
    function handler3() {
        ...
        assert.deepEqual(oBinding.findNode(59).parent.key, "ZTJ_G4_C_GLHIERResults('V2.36.30.32_1.2.4.0.1.2.3.0.1.2.1.1%3A0.12.0.0.X.0_IEQCACNIEQ0010000052372%3A001%20A5_06Q88TZJOAW65DRWR6OHRU9QAX2H39PM')", "Correct node at index 59 (level 4)");
        assert.ok(!!oBinding.findNode(62), "Found a node at index 62");
        assert.deepEqual(oBinding.findNode(62).key, "ZTJ_G4_C_GLHIERResults('V2.36.35.32_1.2.4.0.1.2.3.0.1.2.1.1%3A0.17.0.0.X.0_IEQCACNIEQ001000002000000502%3AREST_H_0SUTU1Z8RLLDHJYDDY9JI1C15PXF8WA1')", "Correct node at index 62 (level 0)");
        done();
    }
    oBinding.attachChange(handler1);
    requestData(oBinding, 0, 20, 100);
...
QUnit.test("Expand root node (initial expansion level 0) to level 4, collapse deep node and expand deep node to level 4 (ENtL12)", function (assert) {
    ...
    function handler4() {
        oBinding.getContexts(0, 20, 100);
        assert.ok(!!oBinding.findNode(16), "Found a node at index 16");
        assert.deepEqual(oBinding.findNode(16).key, "ZTJ_G4_C_GLHIERResults('V2.36.34.32_1.2.4.0.1.2.3.0.1.2.1.1%3A0.16.0.0.X.0_IEQCACNIEQ00100000%3ACACN%200000000010_06Q88TZJOAW65DRWR6OHRU9QAX2H39PM')", "Correct node at index 16 on level 4");
        done();
    }
    oBinding.attachChange(handler1);
    requestData(oBinding, 0, 20, 100);
