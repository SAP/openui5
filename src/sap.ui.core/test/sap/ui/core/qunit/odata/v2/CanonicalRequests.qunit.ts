...
var getLastRequest = function (test) {
    ...
    var oRelevantRequest = oLastRequest["data"]["__batchRequests"][0]["__changeRequests"] && oLastRequest["data"]["__batchRequests"][0]["__changeRequests"][0] || oLastRequest["data"]["__batchRequests"][0];
...
aVariants.forEach(function (oVariant) {
    ...
    QUnit.test("ODataModel.read " + "(Model:" + oVariant.Model + ", APICallParameter:" + oVariant.APICallParameter + ")", function (assert) {
        ...
        that.oModel.metadataLoaded().then(testODataAPI("/SalesOrderSet('0500000000')/ToLineItems", "SalesOrderSet('0500000000')/ToLineItems", assert, that, "read")).then(testODataAPI("/SalesOrderSet('0500000000')/ToLineItems(SalesOrderID='0500000000',ItemPosition='0000000010')", "SalesOrderLineItemSet(SalesOrderID='0500000000',ItemPosition='0000000010')", assert, that, "read")).then(testODataAPI("/SalesOrderSet('0500000000')/ToLineItems(SalesOrderID='0500000000',ItemPosition='0000000010')/ToProduct", "SalesOrderLineItemSet(SalesOrderID='0500000000',ItemPosition='0000000010')/ToProduct", assert, that, "read")).then(testODataAPI("/SalesOrderSet('0500000000')/ToLineItems(SalesOrderID='0500000000',ItemPosition='0000000010')/ToProduct/ProductId", "SalesOrderLineItemSet(SalesOrderID='0500000000',ItemPosition='0000000010')/ToProduct/ProductId", assert, that, "read")).then(function () {
    ...
    QUnit.test("ODataModel.update " + "(Model:" + oVariant.Model + ", APICallParameter:" + oVariant.APICallParameter + ")", function (assert) {
        ...
        var that = this;
        this.oModel.bCanonicalRequests = oVariant.Model;
        that.oModel.metadataLoaded().then(testODataAPI("/SalesOrderSet('0500000000')/ToLineItems", "SalesOrderSet('0500000000')/ToLineItems", assert, that, "update")).then(testODataAPI("/SalesOrderSet('0500000000')/ToLineItems(SalesOrderID='0500000000',ItemPosition='0000000010')", "SalesOrderLineItemSet(SalesOrderID='0500000000',ItemPosition='0000000010')", assert, that, "update")).then(testODataAPI("/SalesOrderSet('0500000000')/ToLineItems(SalesOrderID='0500000000',ItemPosition='0000000010')/ToProduct", "SalesOrderLineItemSet(SalesOrderID='0500000000',ItemPosition='0000000010')/ToProduct", assert, that, "read")).then(testODataAPI("/SalesOrderSet('0500000000')/ToLineItems(SalesOrderID='0500000000',ItemPosition='0000000010')/ToProduct/ProductId", "ProductSet('HT-1000')/ProductId", assert, that, "update")).then(function () {
            assert.equal(that.iInvalidationCounter, 0, "Check number of cache invalidations necessary.");
            return checkIfCacheEntriesAreValid(that.oModel, assert);
        }).then(done);
    });
    QUnit.test("ODataModel.remove " + "(Model:" + oVariant.Model + ", APICallParameter:" + oVariant.APICallParameter + ")", function (assert) {
        ...
        var that = this;
        this.oModel.bCanonicalRequests = oVariant.Model;
        that.oModel.metadataLoaded().then(testODataAPI("/SalesOrderSet('0500000005')/ToLineItems", "SalesOrderSet('0500000005')/ToLineItems", assert, that, "remove")).then(testODataAPI("/SalesOrderSet('0500000002')/ToLineItems(SalesOrderID='0500000002',ItemPosition='0000000010')", "SalesOrderLineItemSet(SalesOrderID='0500000002',ItemPosition='0000000010')", assert, that, "remove")).then(testODataAPI("/SalesOrderSet('0500000001')/ToLineItems(SalesOrderID='0500000001',ItemPosition='0000000010')/ToProduct", "SalesOrderLineItemSet(SalesOrderID='0500000001',ItemPosition='0000000010')/ToProduct", assert, that, "read")).then(testODataAPI("/SalesOrderSet('0500000001')/ToLineItems(SalesOrderID='0500000001',ItemPosition='0000000010')/ToProduct/ProductId", "ProductSet('HT-1030')/ProductId", assert, that, "remove")).then(function () {
            assert.equal(that.iInvalidationCounter, 0, "Check number of cache invalidations necessary.");
            return checkIfCacheEntriesAreValid(that.oModel, assert);
        }).then(done);
    });
    QUnit.test("ODataModel.create " + "(Model:" + oVariant.Model + ", APICallParameter:" + oVariant.APICallParameter + ")", function (assert) {
        ...
        var that = this;
        this.oModel.bCanonicalRequests = oVariant.Model;
        that.oModel.metadataLoaded().then(testODataAPI("/SalesOrderSet('0500000005')/ToLineItems", "SalesOrderSet('0500000005')/ToLineItems", assert, that, "create")).then(testODataAPI("/SalesOrderSet('0500000002')/ToLineItems(SalesOrderID='0500000002',ItemPosition='0000000010')", "SalesOrderLineItemSet(SalesOrderID='0500000002',ItemPosition='0000000010')", assert, that, "create")).then(testODataAPI("/SalesOrderSet('0500000001')/ToLineItems(SalesOrderID='0500000001',ItemPosition='0000000010')/ToProduct", "SalesOrderLineItemSet(SalesOrderID='0500000001',ItemPosition='0000000010')/ToProduct", assert, that, "read")).then(testODataAPI("/SalesOrderSet('0500000001')/ToLineItems(SalesOrderID='0500000001',ItemPosition='0000000010')/ToProduct/ProductId", "ProductSet('HT-1030')/ProductId", assert, that, "create")).then(function () {
            assert.equal(that.iInvalidationCounter, 0, "Check number of cache invalidations necessary.");
            return checkIfCacheEntriesAreValid(that.oModel, assert);
        }).then(done);
    });
    QUnit.test("ODataModel.createEntry " + "(Model:" + oVariant.Model + ", APICallParameter:" + oVariant.APICallParameter + ")", function (assert) {
        ...
        var that = this;
        this.oModel.bCanonicalRequests = oVariant.Model;
        that.oModel.metadataLoaded().then(testODataAPI("/SalesOrderSet('0500000005')/ToLineItems", "SalesOrderSet('0500000005')/ToLineItems", assert, that, "read")).then(testODataAPI("/SalesOrderSet('0500000001')/ToLineItems(SalesOrderID='0500000001',ItemPosition='0000000010')/ToProduct", "SalesOrderLineItemSet(SalesOrderID='0500000001',ItemPosition='0000000010')/ToProduct", assert, that, "read")).then(testODataAPI("/SalesOrderSet('0500000001')/ToLineItems(SalesOrderID='0500000001',ItemPosition='0000000010')/ToProduct", "ProductSet('HT-1030')", assert, that, "createEntry", oCreateEntryProduct)).then(function () {
    ...
    QUnit.test("ODataModel.submitChanges " + "(Model:" + oVariant.Model + ", APICallParameter:" + oVariant.APICallParameter + ")", function (assert) {
        var done = assert.async();
        var that = this;
        that.oModel.metadataLoaded().then(testODataAPI("/SalesOrderSet('0500000005')", "SalesOrderSet('0500000005')", assert, that, "read", { urlParameters: { "$expand": "ToLineItems" } })).then(function () {
...
QUnit.test("ODataModel.resolve", function (assert) {
    ...
    this.oModel.metadataLoaded().then(function () {
        ...
        var fnRequestCompleted = function (oEvent) {
            ...
            assert.equal(that.oModel.resolve("/SalesOrderSet('0500000000')/ToLineItems(SalesOrderID='0500000000',ItemPosition='0000000010')/ToProduct", undefined, true), "/ProductSet('HT-1000')", "Already loaded");
            var oSalesOrderSetContext = that.oModel.createBindingContext("/SalesOrderSet('0500000000')");
            assert.equal(that.oModel.resolve("ToLineItems(SalesOrderID='0500000000',ItemPosition='0000000010')/ToProduct", oSalesOrderSetContext, true), "/ProductSet('HT-1000')", "Already loaded");
            assert.equal(that.oModel.resolve("/SalesOrderSet('0500000001')/ToLineItems(SalesOrderID='0500000001',ItemPosition='0000000010')", undefined, true), "/SalesOrderLineItemSet(SalesOrderID='0500000001',ItemPosition='0000000010')", "Not loaded yet");
            assert.equal(that.oModel.resolve("/SalesOrderSet('0500000001')/ToLineItems(SalesOrderID='0500000001',ItemPosition='0000000010')/ToProduct", undefined, true), "/SalesOrderLineItemSet(SalesOrderID='0500000001',ItemPosition='0000000010')/ToProduct", "Not loaded yet");
            assert.equal(that.oModel.resolve("/SalesOrderSet('0500000000')/ToLineItems(SalesOrderID='0500000000',ItemPosition='0000000020')/ToProduct", undefined, true), "/SalesOrderLineItemSet(SalesOrderID='0500000000',ItemPosition='0000000020')/ToProduct", "Not loaded yet");
            assert.equal(that.oModel.resolve("ToLineItems(SalesOrderID='0500000000',ItemPosition='0000000020')/ToProduct", oSalesOrderSetContext, true), "/SalesOrderLineItemSet(SalesOrderID='0500000000',ItemPosition='0000000020')/ToProduct", "Not loaded yet");
            ...
            assert.equal(that.oModel.resolve("/SalesOrderSet('0500000000')/ToLineItems(SalesOrderID='0500000000',ItemPosition='0000000010')/ToProduct/ToSupplier", undefined, true), "/ProductSet('HT-1000')/ToSupplier", "Path was resolved correctly.");
            assert.equal(that.oModel.resolve("ToLineItems(SalesOrderID='0500000000',ItemPosition='0000000010')/ToProduct/ToSupplier", oSalesOrderSetContext, true), "/ProductSet('HT-1000')/ToSupplier", "Path was resolved correctly.");
            assert.equal(that.oModel.resolve("ToProduct/ToSupplier", oSalesOrderLineItemSetContext, true), "/ProductSet('HT-1000')/ToSupplier", "Path was resolved correctly.");
            that.oModel.read("/SalesOrderSet('0500000000')/ToLineItems(SalesOrderID='0500000000',ItemPosition='0000000010')/ToProduct/ToSupplier", {
                success: function () {
                    assert.equal(that.oModel.resolve("/SalesOrderSet('0500000000')/ToLineItems(SalesOrderID='0500000000',ItemPosition='0000000010')/ToProduct/ToSupplier", undefined, true), "/BusinessPartnerSet('0100000000')", "Path was resolved correctly.");
                    assert.equal(that.oModel.resolve("ToLineItems(SalesOrderID='0500000000',ItemPosition='0000000010')/ToProduct/ToSupplier", oSalesOrderSetContext, true), "/BusinessPartnerSet('0100000000')", "Path was resolved correctly.");
                    assert.equal(that.oModel.resolve("ToProduct/ToSupplier", oSalesOrderLineItemSetContext, true), "/BusinessPartnerSet('0100000000')", "Path was resolved correctly.");
    ...
    this.oModel.metadataLoaded().then(function () {
        ...
        var fnRequestCompleted = function (oEvent) {
            ...
            var fnBatchCompleted1 = function () {
                ...
                assert.equal(that.oModel.resolve("/SalesOrderSet('0500000000')", undefined, true), "/SalesOrderSet('0500000000')", "Path was resolved correctly.");
                assert.equal(that.oModel.resolve("/SalesOrderSet('0500000000')/ToLineItems(SalesOrderID='0500000000',ItemPosition='0000000010')", undefined, true), "/SalesOrderLineItemSet(SalesOrderID='0500000000',ItemPosition='0000000010')", "Path was resolved correctly.");
                assert.equal(that.oModel.resolve("/SalesOrderLineItemSet(SalesOrderID='0500000000',ItemPosition='0000000010')/ToProduct", undefined, true), "/ProductSet('HT-1004')", "Path was resolved correctly.");
                assert.equal(that.oModel.resolve("/SalesOrderSet('0500000000')/ToLineItems(SalesOrderID='0500000000',ItemPosition='0000000010')/ToProduct/ToSupplier", undefined, true), "/ProductSet('HT-1004')/ToSupplier", "Path was resolved correctly.");
                assert.equal(that.oModel.resolve("ToLineItems(SalesOrderID='0500000000',ItemPosition='0000000010')/ToProduct/ToSupplier", oSalesOrderSetContext, true), "/ProductSet('HT-1004')/ToSupplier", "Path was resolved correctly.");
                assert.equal(that.oModel.resolve("ToProduct/ToSupplier", oSalesOrderLineItemSetContext, true), "/ProductSet('HT-1004')/ToSupplier", "Path was resolved correctly.");
                var fnBatchCompleted2 = function () {
                    that.oModel.detachBatchRequestCompleted(fnBatchCompleted2);
                    assert.equal(that.oModel.resolve("/ProductSet('HT-1004')/ToSupplier", undefined, true), "/BusinessPartnerSet('0100000099')", "Path was resolved correctly.");
                    assert.equal(that.oModel.resolve("/SalesOrderSet('0500000000')/ToLineItems(SalesOrderID='0500000000',ItemPosition='0000000010')/ToProduct/ToSupplier", undefined, true), "/BusinessPartnerSet('0100000099')", "Path was resolved correctly.");
                    assert.equal(that.oModel.resolve("ToLineItems(SalesOrderID='0500000000',ItemPosition='0000000010')/ToProduct/ToSupplier", oSalesOrderSetContext, true), "/BusinessPartnerSet('0100000099')", "Path was resolved correctly.");
                    assert.equal(that.oModel.resolve("ToProduct/ToSupplier", oSalesOrderLineItemSetContext, true), "/BusinessPartnerSet('0100000099')", "Path was resolved correctly.");
    ...
    this.oModel.metadataLoaded().then(function () {
        ...
        var fnRequestCompleted = function () {
            ...
            oODataListBinding.attachDataReceived(function () {
                ...
                assert.equal(that.oModel.resolveDeep("ToProduct", aContexts[0]), "/SalesOrderSet('0500000000')/ToLineItems(SalesOrderID='0500000000',ItemPosition='0000000010')/ToProduct/ToSalesOrderLineItems(SalesOrderID='0500000007',ItemPosition='0000000070')/ToProduct", "Context is enriched with parent context information.");
                done();
            });
...
QUnit.test("Message Scope supported by service - scope: BusinessObject", function (assert) {
    ...
    this.oModel.metadataLoaded().then(function () {
        ...
        var fnRequestCompleted = function (oEvent) {
            ...
            that.oModel.messageScopeSupported().then(function (bSupported) {
...
QUnit.test("scope: BusinessObject", function (assert) {
    ...
    this.oModel.metadataLoaded().then(function () {
        ...
        var fnRequestCompleted = function (oEvent) {
            that.oModel.detachRequestCompleted(fnRequestCompleted);
            var mHeaders = oEvent.getParameter("headers");
            assert.notOk(mHeaders["sap-message-scope"], "Message scope 'BusinessObject' not set");
            that.oModel.messageScopeSupported().then(function (bSupported) {
                assert.ok(!bSupported);
                done();
            });
