...
import fakeService from "sap/ui/core/qunit/odata/data/ODataAnnotationsFakeService";
...
var mTest, sTestName, sServiceURI, mModelOptions, bServiceValid, bAnnotationsValid, sAnnotationsValid, bSharedMetadata, sTestType, fnTest, mService, oAnnotations, i;
...
for (i = 0; i < aServices.length; ++i) {
    ...
    sTestType = sTestName + " (" + (bServiceValid ? "Valid Service" : "Broken Service") + "/" + (bAnnotationsValid ? "Valid Annotations (" + sAnnotationsValid + ")" : "Broken Annotations") + (bSharedMetadata ? "/Shared Metadata" : "") + ")";
...
fnTest = function (sServiceURI, mModelOptions, bServiceValid, sAnnotationsValid, bSharedMetadata) {
    return function (assert) {
        ...
        var fnResolveMetadata, fnRejectMetadata, fnResolveAnnotations, fnRejectAnnotations, oAnnotationsPromise = new Promise(function (resolve, reject) {
...
for (i = 0; i < aServices.length; ++i) {
    ...
    QUnit.test("Asynchronous loading - " + sTestType, fnTest(sServiceURI, mModelOptions, bServiceValid, sAnnotationsValid));
}
...
fnTest = function (sServiceURI, mModelOptions, bServiceValid, sAnnotationsValid, bSharedMetadata) {
    return function (assert) {
        ...
        var fnResolveMetadata, fnRejectMetadata, fnResolveInternalMetadata, oInternalMetadataPromise = new Promise(function (resolve) {
...
for (i = 0; i < aServices.length; ++i) {
    ...
    mModelOptions.skipMetadataAnnotationParsing = true;
    sTestType = sTestName + " (" + (bServiceValid ? "Valid Service" : "Broken Service") + "/" + (bAnnotationsValid ? "Valid Annotations (" + sAnnotationsValid + ")" : "Broken Annotations") + (bSharedMetadata ? "/Shared Metadata" : "") + ")";
    QUnit.test("Asynchronous loading (joined events) - " + sTestType, fnTest(sServiceURI, mModelOptions, bServiceValid, sAnnotationsValid));
}
...
for (i = 0; i < aServices.length; ++i) {
    ...
    bAnnotationsValid = sAnnotationsValid === "all" || sAnnotationsValid === "some";
    sTestName = aServices[i].name ? aServices[i].name : "";
    sTestType = sTestName + " (" + (bAnnotationsValid ? "Valid Annotations (" + sAnnotationsValid + ")" : "Broken Annotations") + (bSharedMetadata ? "/Shared Metadata" : "") + ")";
    mModelOptions.loadAnnotationsJoined = false;
    mModelOptions.loadMetadataAsync = false;
    mModelOptions.skipMetadataAnnotationParsing = true;
...
QUnit.test("Asynchronous loading", function (assert) {
    ...
    assert.expect(12);
    cleanOdataCache();
    var oModel1 = new V1ODataModel("fakeService://testdata/odata/northwind-annotated/", {
        annotationURI: [
            "fakeService://testdata/odata/northwind-annotated/$metadata",
            "fakeService://testdata/odata/northwind-annotations-normal.xml"
        ],
    ...
    cleanOdataCache();
    var oModel2 = new V1ODataModel("fakeService://testdata/odata/northwind-annotated/", {
        annotationURI: [
            "fakeService://testdata/odata/northwind-annotations-normal.xml",
            "fakeService://testdata/odata/northwind-annotated/$metadata"
        ],
    ...
    cleanOdataCache();
    var oModel3 = new V1ODataModel("fakeService://testdata/odata/northwind-annotated/", {
        annotationURI: [
            "fakeService://testdata/odata/northwind-annotations-normal.xml",
            "fakeService://testdata/odata/northwind-annotated/$metadata"
        ],
    ...
    function startTest4() {
        cleanOdataCache();
        var oModel4 = new V1ODataModel("fakeService://testdata/odata/northwind-annotated/", {
            annotationURI: [
                "fakeService://testdata/odata/northwind-annotated/$metadata",
                "fakeService://testdata/odata/northwind-annotations-normal.xml"
            ],
...
QUnit.test("Asynchronous loading", function (assert) {
    var done = assert.async();
    assert.expect(6);
    var asyncStartsExpected = 2;
    var oModel3 = new V2ODataModel("fakeService://testdata/odata/northwind-annotated/", {
        annotationURI: [
            "fakeService://testdata/odata/northwind-annotations-normal.xml",
            "fakeService://testdata/odata/northwind-annotated/$metadata"
        ],
    ...
    var oModel4 = new V2ODataModel("fakeService://testdata/odata/northwind-annotated/", {
        annotationURI: [
            "fakeService://testdata/odata/northwind-annotated/$metadata",
            "fakeService://testdata/odata/northwind-annotations-normal.xml"
        ],
...
QUnit.test("Apply Function", function (assert) {
    ...
    assert.ok(!!oMetadata, "Metadata is available.");
    assert.ok(!!oAnnotations, "Annotations are available.");
    assert.ok(!!oAnnotations["Test.2014-12-08"], "Test Annotations are available");
    assert.ok(!!oAnnotations["Test.2014-12-08"]["com.sap.vocabularies.UI.v1.Identification"], "Namespace exists");
    assert.ok(!!oAnnotations["Test.2014-12-08"]["com.sap.vocabularies.UI.v1.Identification"][0], "Namespace has content");
    var mNamespace = oAnnotations["Test.2014-12-08"]["com.sap.vocabularies.UI.v1.Identification"][0];
    assert.ok(!!mNamespace["com.sap.vocabularies.UI.v1.Importance"], "Sub-namespace exists");
    assert.ok(!!mNamespace["com.sap.vocabularies.UI.v1.Importance"]["EnumMember"], "EnumMember exists");
    assert.equal(mNamespace["com.sap.vocabularies.UI.v1.Importance"]["EnumMember"], "com.sap.vocabularies.UI.v1.Priority/High", "EnumMember has correct value");
    assert.ok(!!mNamespace["RecordType"], "RecordType exists");
    assert.equal(mNamespace["RecordType"], "com.sap.vocabularies.UI.v1.DataField", "RecordType has correct value");
...
QUnit.test("Multiple Property Annotations", function (assert) {
    ...
    assert.ok(!!oAnnotations["propertyAnnotations"]["MultiplePropertyAnnotations.Product"], "Target namespace inside PropertyAnnotations exists");
    assert.ok(!!oAnnotations["propertyAnnotations"]["MultiplePropertyAnnotations.Product"]["Price/Amount"], "Target values exist");
    assert.ok(!!oAnnotations["propertyAnnotations"]["MultiplePropertyAnnotations.Product"]["Price/Amount"]["CQP.ISOCurrency"], "Target value 1 exists");
    assert.ok(!!oAnnotations["propertyAnnotations"]["MultiplePropertyAnnotations.Product"]["Price/Amount"]["Common.Label"], "Target value 2 exists");
    assert.ok(!!oAnnotations["propertyAnnotations"]["MultiplePropertyAnnotations.Product"]["Price/Amount"]["CQP.ISOCurrency"]["Path"], "Target value 1 property exists");
    assert.ok(!!oAnnotations["propertyAnnotations"]["MultiplePropertyAnnotations.Product"]["Price/Amount"]["Common.Label"]["String"], "Target value 2 property exists");
    assert.equal(oAnnotations["propertyAnnotations"]["MultiplePropertyAnnotations.Product"]["Price/Amount"]["CQP.ISOCurrency"]["Path"], "Price/CurrencyCode", "Target value 1 property exists");
    assert.equal(oAnnotations["propertyAnnotations"]["MultiplePropertyAnnotations.Product"]["Price/Amount"]["Common.Label"]["String"], "Price", "Target value 2 property exists");
    oModel.destroy();
});
...
QUnit.test("Qualifiers in Property Annotations", function (assert) {
    ...
    assert.ok(!!oAnnotations, "Annotations are available.");
    assert.ok(!!oAnnotations["propertyAnnotations"], "PropertyAnnotations namespace exists");
    assert.ok(!!oAnnotations["propertyAnnotations"]["PropertyAnnotationQualifiers.Product"], "Target namespace inside PropertyAnnotations exists");
    assert.ok(!!oAnnotations["propertyAnnotations"]["PropertyAnnotationQualifiers.Product"]["Price/Amount"], "Target value exists");
    assert.ok(!!oAnnotations["propertyAnnotations"]["PropertyAnnotationQualifiers.Product"]["Price/Amount"]["CQP.ISOCurrency#Amount1"], "Target value with Qualifier exists");
    assert.ok(!!oAnnotations["propertyAnnotations"]["PropertyAnnotationQualifiers.Product"]["Price/Amount"]["CQP.ISOCurrency#Amount1"]["Path"], "Target value with Qualifier value exists");
    assert.equal(oAnnotations["propertyAnnotations"]["PropertyAnnotationQualifiers.Product"]["Price/Amount"]["CQP.ISOCurrency#Amount1"]["Path"], "Price/CurrencyCode", "Target value with Qualifier value has correct content");
    oModel.destroy();
});
...
QUnit.test("Other Property Values", function (assert) {
    ...
    assert.ok(!!oAnnotations, "Annotations are available.");
    assert.ok(!!oAnnotations["propertyAnnotations"], "PropertyAnnotations namespace exists");
    assert.ok(!!oAnnotations["propertyAnnotations"]["OtherPropertyValues.Product"], "Target namespace inside PropertyAnnotations exists");
    assert.ok(!!oAnnotations["propertyAnnotations"]["OtherPropertyValues.Product"]["Price/Amount"], "Target value exists");
    assert.ok(!!oAnnotations["propertyAnnotations"]["OtherPropertyValues.Product"]["Price/Amount"]["CQP.ISOCurrency#Amount2"], "Target value with Qualifier exists");
    assert.ok(!!oAnnotations["propertyAnnotations"]["OtherPropertyValues.Product"]["Price/Amount"]["CQP.ISOCurrency#Amount2"]["String"], "Target value with Qualifier value exists");
    assert.equal(oAnnotations["propertyAnnotations"]["OtherPropertyValues.Product"]["Price/Amount"]["CQP.ISOCurrency#Amount2"]["String"], "EUR", "Target value with Qualifier value has correct content");
});
...
QUnit.test("Aliases in Namespaces", function (assert) {
    ...
    assert.ok(!!oAnnotations, "Annotations are available.");
    assert.ok(!!oAnnotations["propertyAnnotations"], "PropertyAnnotations namespace exists");
    assert.ok(!!oAnnotations["propertyAnnotations"]["NamespaceAliases.PurchaseOrder"], "Target namespace inside PropertyAnnotations exists");
    assert.ok(!!oAnnotations["propertyAnnotations"]["NamespaceAliases.PurchaseOrder"]["GrossAmount"], "Target value exists");
    assert.ok(!!oAnnotations["propertyAnnotations"]["NamespaceAliases.PurchaseOrder"]["GrossAmount"]["com.sap.vocabularies.Common.v1.Label"], "Target value with correct alias replacement (none!) exists");
    assert.ok(!!oAnnotations["propertyAnnotations"]["NamespaceAliases.PurchaseOrder"]["GrossAmount"]["com.sap.vocabularies.Common.v1.Label"]["String"], "Target value with String value exists");
    assert.equal(oAnnotations["propertyAnnotations"]["NamespaceAliases.PurchaseOrder"]["GrossAmount"]["com.sap.vocabularies.Common.v1.Label"]["String"], "Gross Amount", "Target value String value has correct content");
    oModel.destroy();
});
...
QUnit.test("Namespaces in Other Property Values", function (assert) {
    ...
    assert.ok(!!oAnnotations, "Annotations are available.");
    assert.ok(!!oAnnotations["propertyAnnotations"], "PropertyAnnotations namespace exists");
    assert.ok(!!oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"], "Target value exists");
    assert.ok(!!oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"]["com.sap.vocabularies.UI.v1.Name"], "Target value's namespace has been correctly replaced");
    assert.ok(!!oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"]["com.sap.vocabularies.UI.v1.Name"]["EnumMember"], "Target value's child exists");
    assert.equal(oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"]["com.sap.vocabularies.UI.v1.Name"]["EnumMember"], "com.sap.vocabularies.UI.v1.Value", "Target value's namespace has been correctly replaced");
    assert.ok(!!oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"]["com.sap.vocabularies.Communication.v1.Name"], "Target value's namespace has been correctly replaced");
    assert.ok(!!oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"]["com.sap.vocabularies.Communication.v1.Name"]["EnumMember"], "Target value's child exists");
    assert.equal(oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"]["com.sap.vocabularies.Communication.v1.Name"]["EnumMember"], "com.sap.vocabularies.Communication.v1.Value", "Target value's namespace has been correctly replaced");
    assert.ok(!!oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"]["Org.OData.Measures.V1.Name"], "Target value's namespace has been correctly replaced");
    assert.ok(!!oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"]["Org.OData.Measures.V1.Name"]["EnumMember"], "Target value's child exists");
    assert.equal(oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"]["Org.OData.Measures.V1.Name"]["EnumMember"], "Org.OData.Measures.V1.Value", "Target value's namespace has been correctly replaced");
    assert.ok(!!oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"]["Org.OData.Measures.V1.Name"], "Target value's namespace has been correctly replaced");
    assert.ok(!!oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"]["Org.OData.Measures.V1.Name"]["EnumMember"], "Target value's child exists");
    assert.equal(oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"]["Org.OData.Measures.V1.Name"]["EnumMember"], "Org.OData.Measures.V1.Value", "Target value's namespace has been correctly replaced");
    assert.ok(!!oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"]["com.sap.vocabularies.Common.v1.Name"], "Target value's namespace has been correctly replaced");
    assert.ok(!!oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"]["com.sap.vocabularies.Common.v1.Name"]["EnumMember"], "Target value's child exists");
    assert.equal(oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"]["com.sap.vocabularies.Common.v1.Name"]["EnumMember"], "com.sap.vocabularies.Common.v1.Value", "Target value's namespace has been correctly replaced");
    assert.ok(!!oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"]["FTGEN_HB_TE.Name"], "Target value's namespace has been correctly replaced");
    assert.ok(!!oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"]["FTGEN_HB_TE.Name"]["EnumMember"], "Target value's child exists");
    assert.equal(oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"]["FTGEN_HB_TE.Name"]["EnumMember"], "FTGEN_HB_TE.Value", "Target value's namespace has been correctly replaced");
    oModel.destroy();
});
...
QUnit.test("Text Properties", function (assert) {
    ...
    assert.ok(!!oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"], "PropertyAnnotation definition exists");
    assert.ok(!!oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"], "PropertyAnnotation definition value exists");
    assert.ok(!!oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"]["com.sap.vocabularies.UI.v1.Name1"], "Name1 with replaced alias exists");
    assert.ok(!!oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"]["com.sap.vocabularies.UI.v1.Name2"], "Name2 with replaced alias exists");
    assert.ok(!!oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"]["com.sap.vocabularies.UI.v1.Name3"], "Name3 with replaced alias exists");
    assert.ok(!!oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"]["com.sap.vocabularies.UI.v1.Name1"]["EnumMember"], "Name1 with replaced alias exists and has EnumMember child node");
    assert.ok(!!oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"]["com.sap.vocabularies.UI.v1.Name2"]["String"], "Name2 with replaced alias exists and has String child node");
    assert.ok(!!oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"]["com.sap.vocabularies.UI.v1.Name3"]["Invalid"], "Name3 with replaced alias exists and has Invalid child node");
    assert.equal(oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"]["com.sap.vocabularies.UI.v1.Name1"]["EnumMember"], "com.sap.vocabularies.UI.v1.Value", "Name1 with replaced alias exists and has EnumMember child node that contains alias replaced tet with trimmed white-spaces");
    assert.equal(oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"]["com.sap.vocabularies.UI.v1.Name2"]["String"], "   test test   ", "Name2 with replaced alias exists and has String child node that contains the exact text inclunding white-spaces");
    assert.deepEqual(oAnnotations["propertyAnnotations"]["OtherPropertyValueAliases.Test"]["Value"]["com.sap.vocabularies.UI.v1.Name3"]["Invalid"], {}, "Name3 with replaced alias exists and has Invalid child node that only contains an empy object");
    oModel.destroy();
});
...
QUnit.test("Entity Containers", function (assert) {
    ...
    assert.ok(!!oAnnotations["EntityContainer"]["AIVS_NEW_BO_SRV.AIVS_NEW_BO_SRV_Entities"]["SalesOrder"], "Entity in container exists");
    assert.ok(!!oAnnotations["EntityContainer"]["AIVS_NEW_BO_SRV.AIVS_NEW_BO_SRV_Entities"]["SalesOrder"]["com.sap.vocabularies.Common.v1.DraftRoot"], "Sub Entity in container exists");
    assert.ok(!!oAnnotations["EntityContainer"]["AIVS_NEW_BO_SRV.AIVS_NEW_BO_SRV_Entities"]["SalesOrder"]["com.sap.vocabularies.Common.v1.DraftRoot"]["ActivationAction"], "Sub Entity value in container exists");
    assert.ok(!!oAnnotations["EntityContainer"]["AIVS_NEW_BO_SRV.AIVS_NEW_BO_SRV_Entities"]["SalesOrder"]["com.sap.vocabularies.Common.v1.DraftRoot"]["ActivationAction"]["String"], "Sub Entity value in container exists");
    assert.equal(oAnnotations["EntityContainer"]["AIVS_NEW_BO_SRV.AIVS_NEW_BO_SRV_Entities"]["SalesOrder"]["com.sap.vocabularies.Common.v1.DraftRoot"]["ActivationAction"]["String"], "AIVS_NEW_BO_SRV.AIVS_NEW_BO_SRV_Entities/Activate", "Sub Entity value in container exists");
    assert.ok(!!oAnnotations["EntityContainer"]["AIVS_NEW_BO_SRV.AIVS_NEW_BO_SRV_Entities"]["SalesOrder"]["com.sap.vocabularies.Common.v1.DraftRoot"]["EditAction"], "Sub Entity value in container exists");
    assert.ok(!!oAnnotations["EntityContainer"]["AIVS_NEW_BO_SRV.AIVS_NEW_BO_SRV_Entities"]["SalesOrder"]["com.sap.vocabularies.Common.v1.DraftRoot"]["EditAction"]["String"], "Sub Entity value in container exists");
    assert.equal(oAnnotations["EntityContainer"]["AIVS_NEW_BO_SRV.AIVS_NEW_BO_SRV_Entities"]["SalesOrder"]["com.sap.vocabularies.Common.v1.DraftRoot"]["EditAction"]["String"], "AIVS_NEW_BO_SRV.AIVS_NEW_BO_SRV_Entities/Edit", "Sub Entity value in container exists");
    assert.ok(!!oAnnotations["EntityContainer"]["AIVS_NEW_BO_SRV.AIVS_NEW_BO_SRV_Entities"]["SalesOrder"]["com.sap.vocabularies.Common.v1.DraftRoot"]["ValidationFunction"], "Sub Entity value in container exists");
    assert.ok(!!oAnnotations["EntityContainer"]["AIVS_NEW_BO_SRV.AIVS_NEW_BO_SRV_Entities"]["SalesOrder"]["com.sap.vocabularies.Common.v1.DraftRoot"]["ValidationFunction"]["String"], "Sub Entity value in container exists");
    assert.equal(oAnnotations["EntityContainer"]["AIVS_NEW_BO_SRV.AIVS_NEW_BO_SRV_Entities"]["SalesOrder"]["com.sap.vocabularies.Common.v1.DraftRoot"]["ValidationFunction"]["String"], "AIVS_NEW_BO_SRV.AIVS_NEW_BO_SRV_Entities/Validate", "Sub Entity value in container exists");
    assert.ok(!!oAnnotations["EntityContainer"]["AIVS_NEW_BO_SRV.AIVS_NEW_BO_SRV_Entities"]["SalesOrder"]["com.sap.vocabularies.Common.v1.DraftRoot"]["PreparationAction"], "Sub Entity value in container exists");
    assert.ok(!!oAnnotations["EntityContainer"]["AIVS_NEW_BO_SRV.AIVS_NEW_BO_SRV_Entities"]["SalesOrder"]["com.sap.vocabularies.Common.v1.DraftRoot"]["PreparationAction"]["String"], "Sub Entity value in container exists");
    assert.equal(oAnnotations["EntityContainer"]["AIVS_NEW_BO_SRV.AIVS_NEW_BO_SRV_Entities"]["SalesOrder"]["com.sap.vocabularies.Common.v1.DraftRoot"]["PreparationAction"]["String"], "AIVS_NEW_BO_SRV.AIVS_NEW_BO_SRV_Entities/Prepare", "Sub Entity value in container exists");
    assert.ok(!!oAnnotations["AIVS_NEW_BO_SRV.SalesOrderType"], "Entity in namespace exists");
    assert.ok(!!oAnnotations["AIVS_NEW_BO_SRV.SalesOrderType"]["com.sap.vocabularies.Common.v1.SemanticKey"], "Entity in namespace exists");
    assert.ok(!!oAnnotations["AIVS_NEW_BO_SRV.SalesOrderType"]["com.sap.vocabularies.Common.v1.SemanticKey"][0], "Entity entries in namespace exists");
    assert.ok(!!oAnnotations["AIVS_NEW_BO_SRV.SalesOrderType"]["com.sap.vocabularies.Common.v1.SemanticKey"][0]["PropertyPath"], "Property exists");
    assert.equal(oAnnotations["AIVS_NEW_BO_SRV.SalesOrderType"]["com.sap.vocabularies.Common.v1.SemanticKey"][0]["PropertyPath"], "SalesOrderID", "Entity in namespace exists");
    assert.ok(!!oAnnotations["AIVS_NEW_BO_SRV.SalesOrderItemType"], "Entity in namespace exists");
    assert.ok(!!oAnnotations["AIVS_NEW_BO_SRV.SalesOrderItemType"]["com.sap.vocabularies.Common.v1.SemanticKey"], "Entity in namespace exists");
    assert.ok(!!oAnnotations["AIVS_NEW_BO_SRV.SalesOrderItemType"]["com.sap.vocabularies.Common.v1.SemanticKey"][0], "Entity entries in namespace exists");
    assert.ok(!!oAnnotations["AIVS_NEW_BO_SRV.SalesOrderItemType"]["com.sap.vocabularies.Common.v1.SemanticKey"][0]["PropertyPath"], "Property exists");
    assert.ok(!!oAnnotations["AIVS_NEW_BO_SRV.SalesOrderItemType"]["com.sap.vocabularies.Common.v1.SemanticKey"][1]["PropertyPath"], "Property exists");
    assert.equal(oAnnotations["AIVS_NEW_BO_SRV.SalesOrderItemType"]["com.sap.vocabularies.Common.v1.SemanticKey"][0]["PropertyPath"], "SalesOrderID", "Entity in namespace exists");
    assert.equal(oAnnotations["AIVS_NEW_BO_SRV.SalesOrderItemType"]["com.sap.vocabularies.Common.v1.SemanticKey"][1]["PropertyPath"], "SalesOrderItemID", "Entity in namespace exists");
    oModel.destroy();
});
...
QUnit.test("Simple Values", function (assert) {
    ...
    assert.ok(!!oMetadata, "Metadata is available.");
    assert.ok(!!oAnnotations, "Annotations are available.");
    assert.deepEqual(oAnnotations["SimpleValues.Test"]["com.sap.vocabularies.UI.v1.Name1"], oAnnotations["SimpleValues.Test"]["com.sap.vocabularies.UI.v1.Name2"], "Simple value attributes have the meaning as child elements");
    oModel.destroy();
});
...
QUnit.test("Collection with Namespace", function (assert) {
    ...
    assert.deepEqual(oAnnotations["propertyAnnotations"]["CollectionWithNamespace.Test"]["Value"]["UI.TestNS"], oAnnotations["propertyAnnotations"]["CollectionWithNamespace.Test"]["Value"]["UI.TestNoNS"], "Collection with and without namespace have the same values");
    oModel.destroy();
});
...
QUnit.test("UrlRef", function (assert) {
    ...
    deepContains(assert, oAnnotations["UrlTest"], {
...
QUnit.test("Alias Replacement", function (assert) {
    ...
    assert.equal(oAnnotations["Test.AliasReplacement"]["TestAnnotation"]["NotReplaced"][1]["AnnotationPath"], "@internal.ui5.test.Value1");
    assert.equal(oAnnotations["Test.AliasReplacement"]["TestAnnotation"]["NotReplaced"][2]["AnnotationPath"], "@internal.ui5.test.Value2");
...
QUnit.test("Multiple Simple Values", function (assert) {
    ...
    assert.ok(!!oMetadata, "Metadata is available.");
    assert.ok(!!oAnnotations, "Annotations are available.");
    deepContains(assert, oAnnotations["SimpleValues"], {
...
QUnit.test("If in Apply", function (assert) {
    ...
    oModel.attachAnnotationsLoaded(function () {
        ...
        assert.ok(!!oMetadata, "Metadata is available.");
        assert.ok(!!oAnnotations, "Annotations are available.");
        deepContains(assert, oAnnotations["IfInApply"], {
            "com.sap.vocabularies.Test.v1.Data": {
                "Value": {
                    "Apply": {
                        "Parameters": [{
...
QUnit.test("Other Elements in LabeledElement", function (assert) {
    ...
    oModel.attachAnnotationsLoaded(function () {
        ...
        assert.ok(!!oMetadata, "Metadata is available.");
        assert.ok(!!oAnnotations, "Annotations are available.");
        deepContains(assert, oAnnotations["LabeledElement"], {
            "com.sap.vocabularies.Test.v1.Data": {
                "Url": {
                    "UrlRef": {
                        "Apply": {
...
QUnit.test("V2 only: Annotated Metadata - Automated Parsing", function (assert) {
    ...
    Promise.all([oModel.getMetaModel().loaded(), oModel2.getMetaModel().loaded(), oModel3.getMetaModel().loaded(), oModel4.getMetaModel().loaded()]).then(function () {
        fnTestMetaModel(oModel, true, "Metadata");
        fnTestMetaModel(oModel2, true, "Annotations");
        fnTestMetaModel(oModel3, false);
        fnTestMetaModel(oModel4, true, "Annotations");
...
QUnit.test("Apply in If", function (assert) {
    ...
    oModel.attachAnnotationsLoaded(function () {
        ...
        assert.ok(!!oMetadata, "Metadata is available.");
        assert.ok(!!oAnnotations, "Annotations are available.");
        deepContains(assert, oAnnotations["ApplyInIf"], {
            "ui5.test.1": {
                "Value": {
                    "If": [{
                            "Ne": [{
...
var fnTestEmptyCollection = function (iModelVersion, assert) {
    ...
    oModel.attachAnnotationsLoaded(function () {
        ...
        assert.ok(!!oMetadata, "Metadata is available.");
        assert.ok(!!oAnnotations, "Annotations are available.");
        deepContains(assert, oAnnotations["ui5.test.Annotation"], {
...
var fnTestOverwritingOnTermLevel = function (iModelVersion, assert) {
    ...
    oModel.attachAnnotationsLoaded(function () {
        var oAnnotations = oModel.getServiceAnnotations();
        assert.deepEqual(oAnnotations["ui5.test.Annotation"], {
            "ui5.test.SimpleAnnotation": {
                "String": "From Metadata"
            },
        ...
        assert.deepEqual(oAnnotations.propertyAnnotations.Test.NorthwindEntities, {
            "ui5.test.OverwriteMe": {
                "From": {
                    "String": "2"
                }
        ...
        assert.deepEqual(oAnnotations.EntityContainer["ui5.test.NorthwindEntities"].X, {
            "ui5.test.OverwriteMe": {
                "From": {
                    "String": "2"
                }
...
function checkNestedAnnotations(assert, oAnnotations, oExpectedProductAnnotations) {
    assert.deepEqual(oAnnotations["NorthwindModel.Product"]["com.sap.vocabularies.UI.v1.LineItem"]["com.sap.vocabularies.UI.v1.Criticality"], { "Path": "Criticality" });
    assert.deepEqual(oAnnotations["NorthwindModel.Product"]["com.sap.vocabularies.UI.v1.LineItem#foo"]["com.sap.vocabularies.UI.v1.Criticality"], { "Path": "Criticality" });
    assert.deepEqual(oAnnotations["NorthwindModel.Product"]["com.sap.vocabularies.UI.v1.LineItem#foo"]["com.sap.vocabularies.UI.v1.Criticality#bar"], { "Path": "Criticality/bar" });
    assert.deepEqual(oAnnotations["NorthwindModel.Product"]["com.sap.vocabularies.UI.v1.Facets"][0].Facets["com.sap.vocabularies.Common.v1.Label"], { "String": "Supplier Identification" });
    assert.deepEqual(oAnnotations["NorthwindModel.Product"]["unittest.ui5.parentAnnotation"]["unittest.ui5.dynamicExpression3"].If["com.sap.vocabularies.Common.v1.Label"], { "String": "Who am I?" });
    assert.deepEqual(oAnnotations["NorthwindModel.Product"]["unittest.ui5.parentAnnotation"]["unittest.ui5.dynamicExpression6"].Apply.Parameters[0].Value["com.sap.vocabularies.Common.v1.Label"], { "String": "Who am I?" });
    assert.deepEqual(oAnnotations.annotationsAtArrays, [
        ["NorthwindModel.Product", "com.sap.vocabularies.UI.v1.LineItem", "com.sap.vocabularies.UI.v1.Criticality"],
        ["NorthwindModel.Product", "com.sap.vocabularies.UI.v1.LineItem#foo", "com.sap.vocabularies.UI.v1.Criticality"],
        ["NorthwindModel.Product", "com.sap.vocabularies.UI.v1.LineItem#foo", "com.sap.vocabularies.UI.v1.Criticality#bar"],
        ["NorthwindModel.Product", "com.sap.vocabularies.UI.v1.Facets", 0, "Facets", "com.sap.vocabularies.Common.v1.Label"],
        ["NorthwindModel.Product", "unittest.ui5.parentAnnotation", "unittest.ui5.dynamicExpression3", "If", "com.sap.vocabularies.Common.v1.Label"],
        ["NorthwindModel.Product", "unittest.ui5.parentAnnotation", "unittest.ui5.dynamicExpression6", "Apply", "Parameters", 0, "Value", "com.sap.vocabularies.Common.v1.Label"],
        ["NorthwindModel.Product", "com.sap.vocabularies.UI.v1.LineItem#inherited", "com.sap.vocabularies.UI.v1.Criticality"]
    ]);
...
var fnTestNestedAnnotations = function (iModelVersion, assert) {
    ...
    oModel.attachMetadataLoaded(function () {
        ...
        assert.equal(oAnnotations["NorthwindModel.Supplier"], undefined, "Annotations not loaded from service metadata");
        oModel.addAnnotationUrl(mTest.annotations[0]).then(function () {
            var AnnotationParser = sap.ui.require("sap/ui/model/odata/AnnotationParser"), oAnnotations = oModel.getServiceAnnotations(), oExpectedProductAnnotations = {
                "com.sap.vocabularies.UI.v1.LineItem": [{
                        "Label": {
...
var sNestedAnnotations = "<?xml version=\"1.0\" encoding=\"utf-8\"?><edm:Edm xmlns:edm=\"http://docs.oasis-open.org/odata/ns/edm\" xmlns:edmx=\"http://docs.oasis-open.org/odata/ns/edmx\" Version=\"4.0\">\t<edmx:Reference Uri=\"/coco/vocabularies/UI.xml\">\t\t<edmx:Include Namespace=\"com.sap.vocabularies.UI.v1\" Alias=\"UI\" />\t</edmx:Reference>\t<edmx:Reference Uri=\"http://services.odata.org/Northwind/Northwind.svc/$metadata\" >\t\t<edmx:Include Namespace=\"NorthwindModel\" Alias=\"self\" />\t</edmx:Reference>\t\t<edm:DataServices>\t\t<Schema xmlns=\"http://docs.oasis-open.org/odata/ns/edm\">\t\t\t<Annotations Target=\"self.Product\">\t\t\t\t<Annotation Term=\"UI.LineItem\">\t\t\t\t\t<Collection>\t\t\t\t\t\t<Record Type=\"UI.DataField\">\t\t\t\t\t\t\t<PropertyValue Property=\"Label\" String=\"Business Partner\"/>\t\t\t\t\t\t\t<PropertyValue Property=\"Value\" Path=\"BusinessPartnerID\"/>\t\t\t\t\t\t\t<Annotation Term=\"UI.Importance\"\t\t\t\t\t\t\t\tEnumMember=\"UI.ImportanceType/High\"/>\t\t\t\t\t\t</Record>\t\t\t\t\t</Collection>\t\t\t\t\t<Annotation Term=\"UI.Criticality\" Path=\"Criticality\"/>\t\t\t\t</Annotation>\t\t\t\t<Annotation Term=\"UI.LineItem\" Qualifier=\"foo\">\t\t\t\t\t<Collection>\t\t\t\t\t\t<Record Type=\"UI.DataField\">\t\t\t\t\t\t\t<PropertyValue Property=\"Label\" String=\"Business Partner\"/>\t\t\t\t\t\t\t<PropertyValue Property=\"Value\" Path=\"BusinessPartnerID\"/>\t\t\t\t\t\t\t<Annotation Term=\"UI.Importance\"\t\t\t\t\t\t\t\tEnumMember=\"UI.ImportanceType/Medium\"/>\t\t\t\t\t\t</Record>\t\t\t\t\t</Collection>\t\t\t\t\t<Annotation Term=\"UI.Criticality\" Qualifier=\"bar\" Path=\"Criticality\"/>\t\t\t\t</Annotation>\t\t\t\t<Annotation Term=\"UI.Facets\">\t\t\t\t\t<Collection>\t\t\t\t\t\t<Record Type=\"UI.CollectionFacet\">\t\t\t\t\t\t\t<PropertyValue Property=\"Facets\">\t\t\t\t\t\t\t\t<Collection>\t\t\t\t\t\t\t\t\t<Record Type=\"UI.ReferenceFacet\">\t\t\t\t\t\t\t\t\t\t<PropertyValue Property=\"Target\" AnnotationPath=\"Supplier/@UI.Identification\" />\t\t\t\t\t\t\t\t\t</Record>\t\t\t\t\t\t\t\t</Collection>\t\t\t\t\t\t\t\t<Annotation Term=\"com.sap.vocabularies.Common.v1.Label\" String=\"Supplier Identification\"/>\t\t\t\t\t\t\t</PropertyValue>\t\t\t\t\t\t</Record>\t\t\t\t\t</Collection>\t\t\t\t</Annotation>\t\t\t\t<Annotation Term=\"unittest.ui5.parentAnnotation\">\t\t\t\t\t<Annotation Term=\"unittest.ui5.dynamicExpression3\">\t\t\t\t\t\t<If>\t\t\t\t\t\t\t<Path>IsFemale</Path>\t\t\t\t\t\t\t<String>Iron Man</String>\t\t\t\t\t\t\t<String>Someone else</String>\t\t\t\t\t\t\t<Annotation Term=\"com.sap.vocabularies.Common.v1.Label\" String=\"Who am I?\"/>\t\t\t\t\t\t</If>\t\t\t\t\t</Annotation>\t\t\t\t\t<Annotation Term=\"unittest.ui5.dynamicExpression6\">\t\t\t\t\t\t<Apply Function=\"odata.concat\">\t\t\t\t\t\t\t<If>\t\t\t\t\t\t\t\t<Path>IsFemale</Path>\t\t\t\t\t\t\t\t<String>Iron Man</String>\t\t\t\t\t\t\t\t<String>Someone else</String>\t\t\t\t\t\t\t\t<Annotation Term=\"com.sap.vocabularies.Common.v1.Label\" String=\"Who am I?\"/>\t\t\t\t\t\t\t</If>\t\t\t\t\t\t</Apply>\t\t\t\t\t</Annotation>\t\t\t\t</Annotation>\t\t\t\t<Annotation Term=\"UI.HeaderInfo\">\t\t\t\t\t<Record>\t\t\t\t\t\t<PropertyValue Property=\"TypeName\" String=\"Product\" />\t\t\t\t\t\t<PropertyValue Property=\"TypeNamePlural\" String=\"Products\" />\t\t\t\t\t\t<PropertyValue Property=\"Title\">\t\t\t\t\t\t\t<Record>\t\t\t\t\t\t\t\t<PropertyValue Property=\"Label\" String=\"Product\" />\t\t\t\t\t\t\t\t<PropertyValue Property=\"Value\" Path=\"ProductName\" />\t\t\t\t\t\t\t\t<Annotation Term=\"com.sap.vocabularies.Common.v1.Label\" String=\"hello, world!\"/>\t\t\t\t\t\t\t</Record>\t\t\t\t\t\t</PropertyValue>\t\t\t\t\t</Record>\t\t\t\t</Annotation>\t\t\t</Annotations>\t\t\t<Annotations Target=\"self.Supplier\" Qualifier=\"foo\">\t\t\t\t<Annotation Term=\"UI.LineItem\">\t\t\t\t\t<Collection>\t\t\t\t\t\t<Record Type=\"UI.DataField\">\t\t\t\t\t\t\t<PropertyValue Property=\"Label\" String=\"Business Partner\"/>\t\t\t\t\t\t\t<PropertyValue Property=\"Value\" Path=\"BusinessPartnerID\"/>\t\t\t\t\t\t\t<Annotation Term=\"UI.Importance\"\t\t\t\t\t\t\t\tEnumMember=\"UI.ImportanceType/High\"/>\t\t\t\t\t\t</Record>\t\t\t\t\t</Collection>\t\t\t\t\t<Annotation Term=\"UI.Criticality\" Path=\"Criticality\" Qualifier=\"bar\"/>\t\t\t\t</Annotation>\t\t\t</Annotations>\t\t</Schema>\t</edm:DataServices></edm:Edm>";
function xml(assert, sContent) {
    var oDocument;
    oDocument = XMLHelper.parse(sContent.replace(/>\s+</g, "><"));
...
QUnit.module("Annotations@Arrays", {
    beforeEach: function (assert) {
        ...
        this.oProductElement = this.oDocumentElement.childNodes[2].childNodes[0].childNodes[0];
        this.oLineItemElement = this.oProductElement.childNodes[0].childNodes[1];
        this.oLineItemFooElement = this.oProductElement.childNodes[1].childNodes[1];
        this.oFacetElement = this.oProductElement.childNodes[2].childNodes[0].childNodes[0].childNodes[0].childNodes[1];
        this.oIfElement = this.oProductElement.childNodes[3].childNodes[0].childNodes[0].childNodes[3];
        this.oIfInApplyElement = this.oProductElement.childNodes[3].childNodes[1].childNodes[0].childNodes[0].childNodes[3];
        this.oHeaderInfoElement = this.oProductElement.childNodes[4].childNodes[0].childNodes[2].childNodes[0].childNodes[2];
        this.oSupplierElement = this.oDocumentElement.childNodes[2].childNodes[0].childNodes[1];
        this.oSupplierLineItemElement = this.oSupplierElement.childNodes[0].childNodes[1];
    }
});
QUnit.test("AnnotationParser.backupAnnotationAtArray: returns a path", function (assert) {
    var AnnotationParser = sap.ui.require("sap/ui/model/odata/AnnotationParser"), aSegments;
    ...
    assert.deepEqual(aSegments, ["NorthwindModel.Product", "com.sap.vocabularies.UI.v1.LineItem", "com.sap.vocabularies.UI.v1.Criticality"]);
    aSegments = AnnotationParser.backupAnnotationAtArray(this.oLineItemFooElement);
    assert.deepEqual(aSegments, ["NorthwindModel.Product", "com.sap.vocabularies.UI.v1.LineItem#foo", "com.sap.vocabularies.UI.v1.Criticality#bar"]);
    aSegments = AnnotationParser.backupAnnotationAtArray(this.oFacetElement);
    assert.deepEqual(aSegments, ["NorthwindModel.Product", "com.sap.vocabularies.UI.v1.Facets", 0, "Facets", "com.sap.vocabularies.Common.v1.Label"]);
    aSegments = AnnotationParser.backupAnnotationAtArray(this.oIfElement);
    assert.deepEqual(aSegments, ["NorthwindModel.Product", "unittest.ui5.parentAnnotation", "unittest.ui5.dynamicExpression3", "If", "com.sap.vocabularies.Common.v1.Label"]);
    aSegments = AnnotationParser.backupAnnotationAtArray(this.oIfInApplyElement);
    assert.deepEqual(aSegments, ["NorthwindModel.Product", "unittest.ui5.parentAnnotation", "unittest.ui5.dynamicExpression6", "Apply", "Parameters", 0, "Value", "com.sap.vocabularies.Common.v1.Label"]);
    aSegments = AnnotationParser.backupAnnotationAtArray(this.oHeaderInfoElement);
    assert.deepEqual(aSegments, ["NorthwindModel.Product", "com.sap.vocabularies.UI.v1.HeaderInfo", "Title", "com.sap.vocabularies.Common.v1.Label"]);
    aSegments = AnnotationParser.backupAnnotationAtArray(this.oSupplierLineItemElement);
    assert.deepEqual(aSegments, ["NorthwindModel.Supplier", "com.sap.vocabularies.UI.v1.LineItem#foo", "com.sap.vocabularies.UI.v1.Criticality#bar"]);
});
QUnit.test("AnnotationParser.backupAnnotationAtArray: adds a sibling", function (assert) {
    var AnnotationParser = sap.ui.require("sap/ui/model/odata/AnnotationParser"), oCriticality = { "Path": "Criticality" }, aFacets = [{
            "Target": {
                "AnnotationPath": "Supplier/@com.sap.vocabularies.UI.v1.Identification"
            },
            "RecordType": "com.sap.vocabularies.UI.v1.ReferenceFacet"
        ...
        "Facets": aFacets,
        "RecordType": "com.sap.vocabularies.UI.v1.CollectionFacet"
    }, oLabel = { "String": "Supplier Identification" }, aLineItems = [{
            "Label": {
                "String": "Business Partner"
            },
            "Value": {
    ...
    assert.strictEqual(mProduct["com.sap.vocabularies.UI.v1.LineItem@com.sap.vocabularies.UI.v1.Criticality"], oCriticality);
    AnnotationParser.backupAnnotationAtArray(this.oFacetElement, oAnnotations);
    assert.strictEqual(oCollectionFacet["Facets@com.sap.vocabularies.Common.v1.Label"], oLabel);
    sinon.assert.alwaysCalledWith(AnnotationParser.syncAnnotationsAtArrays, sinon.match.object, sinon.match.array, true);
});
QUnit.test("AnnotationParser.restoreAnnotationsAtArrays", function (assert) {
    var AnnotationParser = sap.ui.require("sap/ui/model/odata/AnnotationParser"), oAnnotations = {
        ...
        annotationsAtArrays: [
            ["NorthwindModel.Product", "com.sap.vocabularies.UI.v1.LineItem", "com.sap.vocabularies.UI.v1.Criticality"],
            ["NorthwindModel.Product", "com.sap.vocabularies.UI.v1.Facets", 3, "Facets", "com.sap.vocabularies.Common.v1.Label"],
            ["NorthwindModel.Product", "com.sap.vocabularies.UI.v1.Facets", 0, "Facets", "com.sap.vocabularies.Common.v1.Label"],
            ["NorthwindModel.Product", "com.sap.vocabularies.UI.v1.LineItem", 0, "Label", "com.sap.vocabularies.UI.v1.Criticality"],
            ["NorthwindModel.Product", "n/a", 0, "Facets", "com.sap.vocabularies.Common.v1.Label"],
            ["NorthwindModel.Product", "com.sap.vocabularies.UI.v1.Facets", 0, "n/a", "com.sap.vocabularies.Common.v1.Label"],
            ["NorthwindModel.Product", "com.sap.vocabularies.UI.v1.LineItem", 0, "Label", "String", "com.sap.vocabularies.UI.v1.Criticality"]
        ]
    }, aAnnotationsAtArrays = JSON.parse(JSON.stringify(oAnnotations.annotationsAtArrays));
    this.spy(AnnotationParser, "syncAnnotationsAtArrays");
    AnnotationParser.restoreAnnotationsAtArrays(oAnnotations);
    assert.strictEqual(oAnnotations["NorthwindModel.Product"]["com.sap.vocabularies.UI.v1.LineItem"]["com.sap.vocabularies.UI.v1.Criticality"], oAnnotations["NorthwindModel.Product"]["com.sap.vocabularies.UI.v1.LineItem@com.sap.vocabularies.UI.v1.Criticality"]);
    assert.strictEqual(oAnnotations["NorthwindModel.Product"]["com.sap.vocabularies.UI.v1.Facets"][0].Facets["com.sap.vocabularies.Common.v1.Label"], oAnnotations["NorthwindModel.Product"]["com.sap.vocabularies.UI.v1.Facets"][0]["Facets@com.sap.vocabularies.Common.v1.Label"]);
    assert.deepEqual(oAnnotations.annotationsAtArrays, aAnnotationsAtArrays, "annotationsAtArrays is unchanged");
    assert.notOk("Label@com.sap.vocabularies.UI.v1.Criticality" in oAnnotations["NorthwindModel.Product"]["com.sap.vocabularies.UI.v1.LineItem"][0], "do not modify non-arrays");
    assert.notOk("com.sap.vocabularies.UI.v1.Criticality" in oAnnotations["NorthwindModel.Product"]["com.sap.vocabularies.UI.v1.LineItem"][0].Label, "do not modify non-arrays");
    AnnotationParser.restoreAnnotationsAtArrays({});
    sinon.assert.alwaysCalledWith(AnnotationParser.syncAnnotationsAtArrays, sinon.match.object, sinon.match.array);
});
QUnit.test("AnnotationParser.merge", function (assert) {
    var AnnotationParser = sap.ui.require("sap/ui/model/odata/AnnotationParser"), mSourceAnnotations1 = {
...
QUnit.test("AnnotationParser.syncAnnotationsAtArrays", function (assert) {
    var AnnotationParser = sap.ui.require("sap/ui/model/odata/AnnotationParser"), mAnnotations = {
        "NorthwindModel.Product": {}
    }, aSegments = ["NorthwindModel.Product", "com.sap.vocabularies.UI.v1.LineItem", "com.sap.vocabularies.UI.v1.Criticality"], Log = sap.ui.require("sap/base/Log");
    assert.ok(Log, "Log module should be loaded");
    this.mock(Log).expects("warning").withExactArgs("Wrong path to annotation at array", sinon.match.same(aSegments), "sap.ui.model.odata.AnnotationParser");
