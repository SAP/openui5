...
QUnit.test("query initial parameter data", function (assert) {
    var query = "ApfTestQuery(P_SAPClient='9999',P_FromDate='01012014',P_ToDate='01062014'," + "P_DisplayCurrency='eu',P_ExchangeRateType='eu',P_ExchangeRateDate='01012014'," + "P_AgingGridMeasureInDays=10,P_NetDueGridMeasureInDays=10,P_NetDueArrearsGridMsrInDays=10)";
...
QUnit.test("navigate from initial param to initial data", function (assert) {
    var query = "ApfTestQuery(P_SAPClient='9999',P_FromDate='01012014',P_ToDate='01062014'," + "P_DisplayCurrency='eu',P_ExchangeRateType='eu',P_ExchangeRateDate='01012014'," + "P_AgingGridMeasureInDays=10,P_NetDueGridMeasureInDays=10,P_NetDueArrearsGridMsrInDays=10)" + "/Results";
    var response = jQuery.sap.sjax({ url: this.rootUri + query });
    assert.equal(response.statusCode, "200");
});
...
QUnit.test("POST table GET results on parameter set #111", function (assert) {
    ...
    this.postTable(aTable, this.resultTemplate, this.dataEntitySet);
    var query111 = "ApfTestQuery(P_SAPClient='777',P_FromDate='01012014',P_ToDate='01062014'," + "P_DisplayCurrency='us',P_ExchangeRateType='us',P_ExchangeRateDate='01012014'," + "P_AgingGridMeasureInDays=10,P_NetDueGridMeasureInDays=10,P_NetDueArrearsGridMsrInDays=10)";
    var response111 = jQuery.sap.sjax({ url: this.rootUri + query111 });
    assert.equal(response111.statusCode, "200");
    var query = "ApfTestQuery(P_SAPClient='777',P_FromDate='01012014',P_ToDate='01062014'," + "P_DisplayCurrency='us',P_ExchangeRateType='us',P_ExchangeRateDate='01012014'," + "P_AgingGridMeasureInDays=10,P_NetDueGridMeasureInDays=10,P_NetDueArrearsGridMsrInDays=10)" + "/Results";
    var response = jQuery.sap.sjax({ url: this.rootUri + query });
    assert.equal(response.statusCode, "200");
