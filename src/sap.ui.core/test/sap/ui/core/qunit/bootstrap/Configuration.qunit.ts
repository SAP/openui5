...
QUnit.test("LegacyDateCalendarCustomizing", function (assert) {
    var oCfg = new Configuration(), oFormatSettings = oCfg.getFormatSettings();
    var aData = [{
            "dateFormat": "A",
...
QUnit.test("applySettings", function (assert) {
    ...
    assert.deepEqual(Object.keys(this.changes[0]).sort(), [
        ...
        "timeFormats-medium",
        "timeFormats-short"
    ], "event should have reported the expected settings as changed");
    this.oConfig.applySettings({
        language: "en",
        formatSettings: {
...
QUnit.test("Format Locale", function (assert) {
    var oConfig;
    window["sap-ui-config"].formatlocale = "fr-CH";
...
QUnit.test("Invalid animation mode", function (assert) {
    ...
    assert.throws(function () { new Configuration(); }, new Error("Unsupported Enumeration value for animationMode, valid values are: full, basic, minimal, none"), "Unsupported value for animation mode should throw an error.");
});
...
QUnit.test("Invalid animation mode", function (assert) {
    var oConfiguration = this.getConfiguration();
    assert.throws(function () { oConfiguration.setAnimationMode("someUnsupportedStringValue"); }, new Error("Unsupported Enumeration value for animationMode, valid values are: full, basic, minimal, none"), "Unsupported value for animation mode should throw an error.");
...
QUnit.test("securityTokenHandlers", function (assert) {
    var oCfg, fnSecurityTokenHandler1 = function () { }, fnSecurityTokenHandler2 = function () { }, aSecurityTokenHandlers = [fnSecurityTokenHandler1];
    ...
    window["sap-ui-config"].securitytokenhandlers = [fnSecurityTokenHandler1, fnSecurityTokenHandler2];
    oCfg = new Configuration();
