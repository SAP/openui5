...
QUnit.test("Theme Modulepath should be registered accordingly", function (assert) {
    ...
    assert.equal(sap.ui.require.toUrl("sap/ui/core/themes/" + sTheme), "foo/bar/sap/ui/core/themes/" + sTheme, "Modulepath of 'sap/ui/core/themes/" + sTheme + "' should be set to themeroot.");
    assert.equal(sap.ui.require.toUrl("sap/ui/testlib/themes/" + sTheme), "foo/bar/sap/ui/testlib/themes/" + sTheme, "Modulepath of 'sap/ui/testlib/themes/" + sTheme + "' should be set to themeroot.");
});