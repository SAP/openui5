...
(function() {
	...
	sap.ui.require(['sap/ui/core/Configuration', 'sap/ui/core/Core', 'sap/ui/core/library', 'sap/ui/core/Locale', 'sap/base/Log'],
		...
		QUnit.test("Read 'sap-ui-legacy-number-format' from URL", function(assert) {
			...
			[
				...
				oSpySetLegacyNumberFormat.reset();
		...
		QUnit.test("Animation is off, valid but not possible mode is set and sanitized", function(assert) {
			window['sap-ui-config']['animaton'] = false;
		...
		QUnit.module("Animation runtime", {
			beforeEach: function() {
				...
				this.getHtmlAttribute = function(sAttribute) {
					var $html = jQuery("html");
					return $html.attr(sAttribute);
				};
			},
			afterEach: function() {
		...
		QUnit.test("Set animation mode to a valid value", function(assert) {
			...
			assert.equal(this.getHtmlAttribute("data-sap-ui-animation-mode"), AnimationMode.full);

			oConfiguration.setAnimationMode(AnimationMode.basic);
			assert.equal(oConfiguration.getAnimationMode(), AnimationMode.basic, "Animation mode should switch to " + AnimationMode.basic + ".");
			assert.equal(this.getHtmlAttribute("data-sap-ui-animation-mode"), AnimationMode.basic);
		});
		...
		QUnit.test("Set animation mode to " + AnimationMode.none + " to turn animation off", function(assert) {
			...
			assert.equal(oConfiguration.getAnimationMode(), AnimationMode.full, "Default animation mode is " + AnimationMode.full + ".");
			assert.equal(this.getHtmlAttribute("data-sap-ui-animation-mode"), AnimationMode.full, "Default animation mode should be injected as attribute.");
			assert.equal(this.getHtmlAttribute("data-sap-ui-animation"), "on", "Default animation should be injected as attribute.");
			...
			assert.equal(this.getHtmlAttribute("data-sap-ui-animation-mode"), AnimationMode.none, "Animation mode should be injected as attribute.");
			assert.equal(this.getHtmlAttribute("data-sap-ui-animation"), "off", "Animation should be turned off.");
		});
