...
import MatrixLayout from "sap/ui/commons/layout/MatrixLayout";
import CheckBox from "sap/ui/commons/CheckBox";
import DatePicker from "sap/ui/commons/DatePicker";
...
oMatrixLayout.createRow(new Label({ text: "Field 0 of group0", labelFor: "field00" }), new TextField({ id: "field100", width: "200px", fieldGroupIds: "group0" }));
oMatrixLayout.createRow(new Label({ text: "Field 1 of group1", labelFor: "field11" }), new TextField({ id: "field11", width: "200px", fieldGroupIds: "group1" }));
oMatrixLayout.createRow(new Label({ text: "Field 2 of group1", labelFor: "field12" }), new TextField({ id: "field12", width: "200px", fieldGroupIds: ["group1"] }));
oMatrixLayout.createRow(new Label({ text: "Field 3 of group1", labelFor: "field13" }), new TextField({ id: "field13", width: "200px", fieldGroupIds: ["group1"] }));
oMatrixLayout.createRow(new Label({ text: "Field 1 of group2", labelFor: "field21" }), new CheckBox({ id: "field21", width: "200px", fieldGroupIds: ["group2"] }));
oVerticalLayout.addContent(oMatrixLayout);
oMatrixLayout = new MatrixLayout({ width: "500px" });
oMatrixLayout.setLayoutFixed(false);
oMatrixLayout.createRow(new Label({ text: "Field 2 of group2", labelFor: "field22" }), new TextField({ id: "field22", width: "200px", fieldGroupIds: ["group2"] }));
oMatrixLayout.createRow(new Label({ text: "Field 1 with no group", labelFor: "field1" }), new TextField({ id: "field1", width: "200px" }));
oMatrixLayout.createRow(new Label({ text: "Field 3 of group2", labelFor: "field23" }), new TextField({ id: "field23", width: "200px", fieldGroupIds: ["group2"] }));
oMatrixLayout.createRow(new Label({ text: "Field 1 of group3", labelFor: "field31" }), new TextField({ id: "field31", width: "200px", fieldGroupIds: ["group3"] }));
oMatrixLayout.createRow(new Label({ text: "Field 2 of group3", labelFor: "field32" }), new CheckBox({ id: "field32", width: "200px", fieldGroupIds: ["group3"] }));
oMatrixLayout.createRow(new Label({ text: "Field 3 of group3", labelFor: "field33" }), new CheckBox({ id: "field33", width: "200px", fieldGroupIds: ["group3"] }));
oMatrixLayout.createRow(new Label({ text: "Field 4 with group3", labelFor: "field34" }), new DatePicker({ id: "field34", width: "200px", fieldGroupIds: ["group3"] }));
oMatrixLayout.createRow(new Label({ text: "Field 2 with no group", labelFor: "field2" }), new TextField({ id: "field2", width: "200px" }));
oMatrixLayout.createRow(new Label({ text: "Field 3 with no group", labelFor: "field3" }), new TextField({ id: "field3", width: "200px" }));
oMatrixLayout.createRow(new Label({ text: "Field 1 of group4", labelFor: "field41" }), new TextField({ id: "field41", width: "200px", fieldGroupIds: ["group4"] }));
oMatrixLayout.createRow(new Label({ text: "Field 2 of group4", labelFor: "field42" }), new CheckBox({ id: "field42", width: "200px", fieldGroupIds: ["group4"] }));
oMatrixLayout.createRow(new Label({ text: "Field 3 of group4 Field 1 of group5", labelFor: "field43-51" }), new CheckBox({ id: "field43-51", width: "200px", fieldGroupIds: ["group4", "group5"] }));
oMatrixLayout.createRow(new Label({ text: "Field 4 of group4 Field 2 of group5 Field 1 of group6", labelFor: "field44-52-61" }), new CheckBox({ id: "field44-52-61", width: "200px", fieldGroupIds: ["group5", "group4", "group6"] }));
oMatrixLayout.createRow(new Label({ text: "Field 3 of group5", labelFor: "field54" }), new CheckBox({ id: "field53", width: "200px", fieldGroupIds: ["group5"] }));
oMatrixLayout.createRow(new Label({ text: "Field 4 of group5", labelFor: "field54" }), new CheckBox({ id: "field54", width: "200px", fieldGroupIds: ["group5"] }));
oMatrixLayout.createRow(new Label({ text: "Field 5 of group5", labelFor: "field55" }), new CheckBox({ id: "field55", width: "200px", fieldGroupIds: ["group5"] }));
oMatrixLayout.createRow(new Label({ text: "Field 2 of group6", labelFor: "field62" }), new CheckBox({ id: "field62", width: "200px", fieldGroupIds: ["group6"] }));
oMatrixLayout.createRow(new Label({ text: "Field 3 of group6", labelFor: "field63" }), new CheckBox({ id: "field63", width: "200px", fieldGroupIds: ["group6"] }));
oMatrixLayout.createRow(new Label({ text: "Field 5 of group6 Field 5 of group4", labelFor: "field32" }), new CheckBox({ id: "field45-65", width: "200px", fieldGroupIds: ["group4", "group6"] }));
oVerticalLayout.addContent(oMatrixLayout);
...
var oEnterControl = null, sNewGroup = "", sCurrentGroup = "";
...
QUnit.test("focus field of group 3 and validate", function (assert) {
    ...
    moveFocus("field31", [], "group3", function () {
        qutils.triggerKeyEvent("keyup", sap.ui.core.UIArea._oFieldGroupControl.getDomRef(), UIArea._oFieldGroupValidationKey.keyCode, UIArea._oFieldGroupValidationKey.shiftKey, UIArea._oFieldGroupValidationKey.altKey, UIArea._oFieldGroupValidationKey.ctrlKey);
