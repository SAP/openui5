...
sap.ui.define([
	...
	QUnit.test("getLibraryResourceBundle() - Simple", function(assert) {
		return Core.loadLibrary("testlibs.terminologies.simple", {
			...
			var oLibRB = Lib.getResourceBundleFor("testlibs.terminologies.simple");
	...
	QUnit.test("getLibraryResourceBundle() - Absolute bundleUrl shouldn't be resolved", function(assert) {
		return Core.loadLibrary("testlibs.terminologies.absoluteBundleUrl", {
			...
			var oLibRB = Lib.getResourceBundleFor("testlibs.terminologies.absoluteBundleUrl");
	...
	QUnit.test("getLibraryResourceBundle() - (de) language parameter", function(assert) {
		...
		return Core.loadLibrary("testlibs.terminologies.simple", {
			...
			return Lib.getResourceBundleFor("testlibs.terminologies.simple", "de")/* LFUI5: For asynchronous loading, load the lib asynchronously and on promise resolution get the resource bundle. */
	...
	QUnit.test("getLibraryResourceBundle()", function (assert) {
		...
		return Lib.getResourceBundleFor("testlibs.terminologies.notLoadedYet")/* LFUI5: For asynchronous loading, load the lib asynchronously and on promise resolution get the resource bundle. */.then(function (oLibRB) {
		...
		.then(function () {
			return Core.loadLibrary("testlibs.terminologies.notLoadedYet", {
				...
				return Lib.getResourceBundleFor("testlibs.terminologies.notLoadedYet")/* LFUI5: For asynchronous loading, load the lib asynchronously and on promise resolution get the resource bundle. */
					.then(function (oLibRB) {
