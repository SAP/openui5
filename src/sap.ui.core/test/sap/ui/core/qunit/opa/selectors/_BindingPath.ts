...
QUnit.test("Should generate selector for bound property", function (assert) {
    ...
    Promise.all(aData.map(function (mData) {
        return _ControlSelectorGenerator._generate({ control: mData.control }).then(function (mSelector) {
...
QUnit.test("Should generate selector for composite property", function (assert) {
    ...
    Promise.all(aData.map(function (mData) {
        return _ControlSelectorGenerator._generate({ control: mData.control, includeAll: true }).then(function (aSelectors) {
...
QUnit.test("Should not generate selector when there is no binding for the property", function (assert) {
    ...
    _ControlSelectorGenerator._generate({ control: this.oCompositePropertyText, shallow: true }).catch(function (oError) {
...
QUnit.test("Should generate selector for static binding", function (assert) {
    ...
    Promise.all(aData.map(function (mData) {
        return _ControlSelectorGenerator._generate({ control: mData.control, multiple: true }).then(function (mSelector) {
...
QUnit.test("Should generate selector for bound property", function (assert) {
    var fnDone = assert.async();
    _ControlSelectorGenerator._generate({ control: this.oPropertyText }).then(function (mSelector) {
...
QUnit.test("Should generate selector for control with bound object", function (assert) {
    var fnDone = assert.async();
    _ControlSelectorGenerator._generate({ control: this.oInput, includeAll: true }).then(function (aSelectors) {
...
QUnit.test("Should generate selector for control with parent object binding", function (assert) {
    var fnDone = assert.async();
    _ControlSelectorGenerator._generate({ control: this.oTexts[0], includeAll: true }).then(function (aSelectors) {
...
QUnit.test("Should generate selector for control with aggregation", function (assert) {
    var fnDone = assert.async();
    _ControlSelectorGenerator._generate({ control: this.aLists[0] }).then(function (mSelector) {
