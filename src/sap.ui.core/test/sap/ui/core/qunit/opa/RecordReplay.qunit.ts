...
QUnit.module("RecordReplay - control selector", {
    beforeEach: function () {
        ...
        this.oView = sap.ui.view("myView", {
            viewContent: "<mvc:View xmlns:core=\"sap.ui.core\" xmlns:mvc=\"sap.ui.core.mvc\" xmlns=\"sap.m\" controllerName=\"myController\" viewName=\"myView\">" + "<App id=\"myApp\"><Page id=\"page1\">" + "<SearchField id=\"mySearch\" placeholder=\"Test\"></SearchField>" + "<SearchField placeholder=\"Placeholder\"></SearchField>" + "</Page></App>" + "</mvc:View>",
            type: ViewType.XML
        });
