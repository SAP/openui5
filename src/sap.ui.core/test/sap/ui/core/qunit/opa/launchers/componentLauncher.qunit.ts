...
QUnit.test("Should throw an exception after the start was called twice", function (assert) {
    ...
    assert.throws(function () {
        ...
        return oError instanceof Error && oError.message === "sap.ui.test.launchers.componentLauncher: " + "Start was called twice without teardown. Only one component can be started at a time.";
...
QUnit.test("Should throw an exception after the teardown was called without the start before", function (assert) {
    assert.throws(function () {
        ...
        return oError instanceof Error && oError.message === "sap.ui.test.launchers.componentLauncher: " + "Teardown was called before start. No component was started.";
    }, "Exception was thrown");
});