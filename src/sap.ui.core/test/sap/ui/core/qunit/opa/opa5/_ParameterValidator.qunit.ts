import Validator from "sap/ui/test/_ParameterValidator";
...
QUnit.test("Should throw an exception if the func param is not a function", function (assert) {
    ...
    }.bind(this), new Error("Parameter validator - the 'funcParam' parameter needs to be a function but '[object Object]' was passed"), "The expected exception was thrown");
});
...
QUnit.test("Should throw an exception if the array param is not an array", function (assert) {
    ...
    }.bind(this), new Error("Parameter validator - the 'arrayParam' parameter needs to be an array but '[object Object]' was passed"), "The expected exception was thrown");
});
...
QUnit.test("Should throw an exception if the numeric param is not a number", function (assert) {
    ...
    }.bind(this), new Error("Parameter validator - the 'numericParam' parameter needs to be numeric but 'NaN' was passed"), "The expected exception was thrown");
});
...
QUnit.test("Should throw an exception if the string param is not a number", function (assert) {
    ...
    }.bind(this), new Error("Parameter validator - the 'stringParam' parameter needs to be a string but 'NaN' was passed"), "The expected exception was thrown");
});
...
QUnit.test("Should throw an exception if no input is given", function (assert) {
    ...
    }.bind(this), new Error("Parameter validator - No 'inputToValidate' given but it is a mandatory parameter"), "The expected exception was thrown");
});
QUnit.test("Should throw if no object is passed as input", function (assert) {
    ...
    }.bind(this), new Error("Parameter validator - the 'inputToValidate' parameter needs to be an object but 'invalid' was passed"), "The expected exception was thrown");
});
QUnit.test("Should throw an exception if no validation info is given", function (assert) {
    ...
    }.bind(this), new Error("Parameter validator - No 'validationInfo' given but it is a mandatory parameter"), "The expected exception was thrown");
});
QUnit.test("Should throw an exception if allowUnknownProperties is not a boolean", function (assert) {
    ...
    }.bind(this), new Error("Parameter validator - the 'allowUnknownProperties' parameter" + " needs to be a boolean value but '[object Object]' was passed"), "The expected exception was thrown");
});
QUnit.test("Should throw an exception if we have an unknown property", function (assert) {
    ...
    }.bind(this), new Error("Parameter validator - the property 'foo' is not defined in the API"), "The expected exception was thrown");
});
...
QUnit.test("Should throw an exception if we have multiple unknown properties", function (assert) {
    ...
    }.bind(this), new Error("Multiple errors where thrown Parameter validator\n" + "the property 'foo' is not defined in the API\n" + "the property 'biz' is not defined in the API"), "The expected exception was thrown");
});
...
QUnit.test("Should validate recursively", function (assert) {
    ...
    }.bind(this), new Error("Multiple errors where thrown Parameter validator\n" + "the 'outerObject.innerFuncParam' parameter needs to be a function but 'foo' was passed\n" + "the 'outerObject.innerObject.innerFuncParam' parameter needs to be a function but 'bar' was passed"), "The expected exception was thrown");
});
