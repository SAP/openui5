...
var testdata = {
    teamMembers: [
        { firstName: "Andreas", lastName: "Klark", items: [{ name: "Snippix" }, { name: "Chili Plants" }] },
        { firstName: "Peter", lastName: "Miller", items: [{ name: "Android" }] },
        { firstName: "Gina", lastName: "Rush", items: [] },
        { firstName: "Steave", lastName: "Ander", items: [{ name: "Game1" }, { name: "Game2" }, { name: "Iron Maiden" }] },
        { firstName: "Michael", lastName: "Spring", items: [{ name: "QueenLP" }, { name: "QueenDoll" }] },
        { firstName: "Marc", lastName: "Green", items: [{ name: "Rioja Wine" }, { name: "Ribera del Duero Wine" }] },
        { firstName: "Frank", lastName: "Wallace", items: [{ name: "Hair Gel" }, { name: "Shampoo" }] },
        { firstName: "Malte", lastName: "Wedel", items: [{ name: "Ricola" }, { name: "flu shot" }] }
    ],
    buddies: [
...
var testdataXML = "<root><teamMembers>" + "<member firstName=\"Andreas\" lastName=\"Klark\" gender=\"male\">" + "<items><item name=\"Snippix\"></item><item name=\"Chili Plants\"></item></items></member>" + "<member firstName=\"Peter\" lastName=\"Miller\" gender=\"male\">" + "<items><item name=\"Android\"></item></items></member>" + "<member firstName=\"Gina\" lastName=\"Rush\" gender=\"female\">" + "<items></items></member>" + "<member firstName=\"Steave\" lastName=\"Ander\" gender=\"male\">" + "<items><item name=\"Game1\"></item><item name=\"Game2\"></item><item name=\"Iron Maiden\"></item></items></member>" + "<member firstName=\"Michael\" lastName=\"Spring\" gender=\"male\"></member>" + "<member firstName=\"Marc\" lastName=\"Green\" gender=\"male\"></member>" + "<member firstName=\"Frank\" lastName=\"Wallace\" gender=\"male\"></member>" + "</teamMembers> </root>";
