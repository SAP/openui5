...
QUnit.test("Succeeding _loadData() calls for same section only trigger one request", function(){
...
QUnit.test("Succeeding _loadData() calls for partially equal sections trigger delta requests", function(){
...
QUnit.test("Succeeding _loadData() calls for partially equal threshold-sections trigger threshold requests", function(){
...
QUnit.test("Succeeding _loadData() calls within threshold of each other trigger exactly one request", function(){
...
QUnit.test("Succeeding _loadChildren() calls for same section only trigger one request", function(){
...
QUnit.test("Succeeding _loadChildren() calls for partially equal sections trigger delta requests", function(){
...
QUnit.test("Succeeding _loadChildren() calls for separate parents trigger separate requests", function(){
