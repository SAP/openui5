...
var aLanguages = ["ar", "ar_EG", "ar_SA", "bg", "ca", "cy", "cs", "da", "de", "de_AT", "de_CH", "el", "el_CY", "en", "en_AU", "en_GB", "en_HK", "en_IE", "en_IN", "en_NZ", "en_PG", "en_SG", "en_ZA", "es", "es_AR", "es_BO", "es_CL", "es_CO", "es_MX", "es_PE", "es_UY", "es_VE", "et", "fa", "fi", "fr", "fr_BE", "fr_CA", "fr_CH", "fr_LU", "he", "hi", "hr", "hu", "id", "it", "it_CH", "ja", "kk", "ko", "lt", "lv", "ms", "nb", "nl", "nl_BE", "pl", "pt", "pt_PT", "ro", "ru", "ru_UA", "sk", "sl", "sr", "sr_Latn", "sh", "sv", "th", "tr", "uk", "vi", "zh_CN", "zh_HK", "zh_SG", "zh_TW"];
...
QUnit.test("getCurrentLanguageName specific sh", function (assert) {
    var oLocale = new Locale("sh"), oLocaleData = new LocaleData(oLocale);
    var oLanguagesObject = oLocaleData.getLanguages();
...
QUnit.test("getCurrentLanguageName specific sr-Latn", function (assert) {
    var oLocale = new Locale("sr-Latn"), oLocaleData = new LocaleData(oLocale);
    var oLanguagesObject = oLocaleData.getLanguages();
...
QUnit.test("getCurrentLanguageName specific sr", function (assert) {
    var oLocale = new Locale("sr"), oLocaleData = new LocaleData(oLocale);
    var oLanguagesObject = oLocaleData.getLanguages();
...
QUnit.test("getCurrentLanguageName specific iw", function (assert) {
    var oLocale = new Locale("iw"), oLocaleData = new LocaleData(oLocale);
    var oLanguagesObject = oLocaleData.getLanguages();
...
QUnit.test("getCurrentLanguageName specific he", function (assert) {
    var oLocale = new Locale("he"), oLocaleData = new LocaleData(oLocale);
    var oLanguagesObject = oLocaleData.getLanguages();
...
QUnit.test("getCurrentLanguageName specific iw-x-sapufmt", function (assert) {
    var oLocale = new Locale("iw-x-sapufmt"), oLocaleData = new LocaleData(oLocale);
    var oLanguagesObject = oLocaleData.getLanguages();
...
QUnit.test("getCurrentLanguageName specific he-x-sapufmt", function (assert) {
    var oLocale = new Locale("he-x-sapufmt"), oLocaleData = new LocaleData(oLocale);
    var oLanguagesObject = oLocaleData.getLanguages();
...
QUnit.test("getCurrentLanguageName specific ji", function (assert) {
    var oLocale = new Locale("ji"), oLocaleData = new LocaleData(oLocale);
    var oLanguagesObject = oLocaleData.getLanguages();
...
QUnit.test("getCurrentLanguageName specific yi", function (assert) {
    var oLocale = new Locale("yi"), oLocaleData = new LocaleData(oLocale);
    var oLanguagesObject = oLocaleData.getLanguages();
...
QUnit.test("getCurrentLanguageName specific de-x-sapufmt", function (assert) {
    var oLocale = new Locale("de-x-sapufmt"), oLocaleData = new LocaleData(oLocale);
    var oLanguagesObject = oLocaleData.getLanguages();
...
QUnit.test("getCurrentLanguageName specific en-GB-x-sapufmt", function (assert) {
    var oLocale = new Locale("en-GB-x-sapufmt"), oLocaleData = new LocaleData(oLocale);
    var oLanguagesObject = oLocaleData.getLanguages();
...
QUnit.test("getCurrentLanguageName specific zh-Hant-x-sapufmt", function (assert) {
    var oLocale = new Locale("zh-Hant-x-sapufmt"), oLocaleData = new LocaleData(oLocale);
    var oLanguagesObject = oLocaleData.getLanguages();
...
QUnit.test("getCurrentLanguageName specific sr-Latn-x-sapufmt", function (assert) {
    var oLocale = new Locale("sr-Latn-x-sapufmt"), oLocaleData = new LocaleData(oLocale);
    var oLanguagesObject = oLocaleData.getLanguages();
...
QUnit.test("getCurrentLanguageName specific sr-Cyrl-x-sapufmt", function (assert) {
    var oLocale = new Locale("sr-Cyrl-x-sapufmt"), oLocaleData = new LocaleData(oLocale);
    var oLanguagesObject = oLocaleData.getLanguages();
...
QUnit.test("Deprecated locales support", function (assert) {
    aDeprecatedLocales.forEach(function (sLocale) {
        var oLocale = new Locale(sLocale), oLocaleData = new LocaleData(oLocale);
