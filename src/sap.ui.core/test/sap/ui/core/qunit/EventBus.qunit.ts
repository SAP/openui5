...
QUnit.test("Suspend the EventBus", function (assert) {
    assert.expect(7);
    var sExpectedEventId = "Test_Suspend", sExpectedChannelId = "Test_Suspend_Resume", sExpectedData = "DataSuspend", sExpectedDataEvent1 = sExpectedData + "Event1", sExpectedDataEvent2 = sExpectedData + "Event2", fnHandler = function (sChannelId, sEventId, oData) {
...
QUnit.test("Suspend and Resume the EventBus", function (assert) {
    assert.expect(12);
    var sExpectedEventId = "Test_Suspend_Resume", sExpectedChannelId = "Test_Suspend_Resume", sExpectedData = "DataSuspendResume", sExpectedDataEvent1 = sExpectedData + "Event1", sExpectedDataEvent2 = sExpectedData + "Event2", sExpectedDataEvent3 = sExpectedData + "Event3", fnHandler = function (sChannelId, sEventId, oData) {
        assert.step("Event was published successfully with data: " + oData.data);
        checkHandler(assert, false, sChannelId, sEventId, oData, this, sExpectedChannelId, sExpectedEventId);
    };
    oBus.subscribe(sExpectedChannelId, sExpectedEventId, fnHandler);
...
QUnit.test("Subscribe to a suspended EventBus", function (assert) {
    assert.expect(8);
    var sExpectedEventId = "Test_Subscribe_After_Suspending", sExpectedChannelId = "Test_Suspend_After_Suspending", sExpectedData = "TestSuspendAfterSuspending", sExpectedDataEvent1 = sExpectedData + "Event1", fnHandler = function (sChannelId, sEventId, oData) {
        assert.step("Event was published successfully with data: " + oData.data);
        checkHandler(assert, false, sChannelId, sEventId, oData, this, sExpectedChannelId, sExpectedEventId);
    };
