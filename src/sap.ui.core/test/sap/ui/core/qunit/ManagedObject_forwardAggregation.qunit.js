				...
				init: function() {
					...
					var oSimpleElementObserver = new ManagedObjectObserver(function(oEvent) {
						if (oEvent.mutation === "insert") {
							...
							assert.ok(oSimpleElement.bIsDestroyed, "SimpleElement destroyed during aggregation forwarding");
							assert.ok(oElement.bIsDestroyed, "Aggregated Element destroyed during aggregation forwarding");
						}
					});
