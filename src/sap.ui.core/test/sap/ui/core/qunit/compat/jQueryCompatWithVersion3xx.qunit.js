...
(function() {
	...
	QUnit.test("no jQuery compat applied", function(assert) {
		...
		assert.ok(window.aWarnMessages.some(function(sMessage) {
			return sMessage === "The current jQuery version 3.6.0 is different than the version 3.5.1 that is used for testing jquery-compat.js. jquery-compat.js is applied but it may not work properly.";
