import jQuery from "jquery.sap.encoder";
...
QUnit.test("encode HTML", function (assert) {
    ...
    assert.equal(jQuery.sap.encodeHTML("\0\u0001\u0002"), "&#xfffd;&#xfffd;&#xfffd;", "0x00 0x01 0x02");
    assert.equal(jQuery.sap.encodeHTML(">&<\"'\\/"), "&gt;&amp;&lt;&quot;&#x27;&#x5c;&#x2f;", ">&<\"'\\/");
});
...
QUnit.test("characters above (>) 255 (0xff) should not be encoded, except for 0x2028 and 0x2029", function (assert) {
    ...
    assert.equal(jQuery.sap.encodeHTML(String.fromCharCode(8232)), "&#x2028;", "(0x2028)");
    assert.equal(jQuery.sap.encodeHTML(String.fromCharCode(8233)), "&#x2029;", "(0x2029)");
});
...
QUnit.test("encode JS", function (assert) {
    ...
    assert.equal(jQuery.sap.encodeJS("\0\u0001\u0002"), "\\x00\\x01\\x02", "0x00 0x01 0x02");
...
QUnit.test("characters above (>) 255 (0xff) should not be encoded, except for 0x2028 and 0x2029", function (assert) {
    ...
    assert.equal(jQuery.sap.encodeJS(String.fromCharCode(8232)), "\\u2028", "(0x2028)");
    assert.equal(jQuery.sap.encodeJS(String.fromCharCode(8233)), "\\u2029", "(0x2029)");
});
...
QUnit.test("encode URL", function (assert) {
    ...
    assert.equal(jQuery.sap.encodeURL("\0\u0001\u0002"), "%00%01%02", "0x00 0x01 0x02");
...
QUnit.test("encode CSS", function (assert) {
    ...
    assert.equal(jQuery.sap.encodeCSS("\0\u0001\u0002"), "\\0\\1\\2", "0x00 0x01 0x02");
...
QUnit.test("characters above (>) 255 (0xff) should not be encoded, except for 0x2028 and 0x2029", function (assert) {
    ...
    assert.equal(jQuery.sap.encodeCSS(String.fromCharCode(8232)), "\\2028", "(0x2028)");
    assert.equal(jQuery.sap.encodeCSS(String.fromCharCode(8233)), "\\2029", "(0x2029)");
});
