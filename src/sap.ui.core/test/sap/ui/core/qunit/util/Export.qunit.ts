...
var getJSONModelData = function () {
    return [
        ...
        { lastName: "Town", name: "Mo", checked: true, linkText: "www.spiegel.de", href: "http://www.spiegel.de", src: "images/Person.png", gender: "male", rating: 3, money: 678.9, birthday: "1968-01-01" },
...
QUnit.test("Default", function (assert) {
    ...
    }).generate().done(function (sContent) {
        var sExpected = "\"First; name\";Last name;Foo bar\r\n" + "Al;Dente;Yes\r\n" + "Andy;Friese;Yes\r\n" + "Anita;Mann;No\r\n" + "Doris;Schutt;Yes\r\n" + "Doris;Open;Yes\r\n" + "Kenya;Dewit;No\r\n" + "Lou;Zara;Yes\r\n" + "Tim;Burr;Yes\r\n" + "Tish;Hughes;Yes\r\n" + "Mo;Town;Yes\r\n" + "Justin;Case;No\r\n" + "Justin;Time;Yes\r\n" + "Sandy;Barr;Yes\r\n" + "Gene;Poole;Yes\r\n" + "Corey;Ander;No\r\n" + "Brighton;Early;Yes\r\n" + "Constance;Noring;Yes\r\n" + "Jack;O'Lantern;Yes\r\n" + "Matt;Tress;Yes\r\n" + "Peter;\"Mul\r\nti\r\nLi\r\nne\";Yes\r\n" + "\"\"\"\";\"Double \"\" Quote\";Yes\r\n" + "'=FOO();Formula;Yes";
