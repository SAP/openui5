...
import TechnicalInfo from "sap/ui/core/support/techinfo/TechnicalInfo";
...
QUnit.test("URL Validation", function (assert) {
    ...
    aInvalidValues.forEach(function (sValue) {
        ...
        }, ValidateException, "URL '" + sValue + "' is not a valid custom bootstrap URL");
    });
});
QUnit.test("Mode Validation", function (assert) {
    ...
    aInvalidValues.forEach(function (sValue) {
        ...
        }, ValidateException, "Mode '" + sValue + "' is not a valid custom debug mode");
    });
});
...
QUnit.test("Custom", function (assert) {
    ...
    var oRadioBtnStandard = sap.ui.getCore().byId("technicalInfoDialogAssistantPopover--standard"), oRadioBtnCustom = sap.ui.getCore().byId("technicalInfoDialogAssistantPopover--custom"), oCustom = sap.ui.getCore().byId("technicalInfoDialogAssistantPopover--customBootstrapURL"), oStandard = sap.ui.getCore().byId("technicalInfoDialogAssistantPopover--standardBootstrapURL");
