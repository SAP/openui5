import jQuery from "jquery.sap.history";
...
var sSuffix = "_skip", rSkipRegex = new RegExp(sSuffix + "[0-9]*$"), sHistoryPath = "pages%| _skip -id-0909-fsa-{jdsa}", sDifferentPath = "ajkf@djafs", sNewHistoryPath = "tabs", data1 = { id: 1 }, data2 = { id: 2 }, data3 = {
    id: 3,
    array: ["123", 1, { a: 1 }],
    object: {
        c: "afdsa"
