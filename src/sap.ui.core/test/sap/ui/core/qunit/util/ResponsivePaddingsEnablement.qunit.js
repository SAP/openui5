...
sap.ui.define([
    ...
    QUnit.test("The enabler should be correctly applied over Control's prototype", function(assert) {
        ...
        bIsFirstElementResponsive = $firstElement.hasClass("sapM-Std-PaddingS");
        bIsSecondElementResponsive = $secondElement.hasClass("sapM-Std-PaddingS");

        //Assert
        assert.ok(bIsFirstElementResponsive, "The sapM-Std-PaddingS class is applied to the first element");
        assert.ok(bIsSecondElementResponsive, "The sapM-Std-PaddingS class is applied to the second element");
        ...
        bIsFirstElementResponsive = $firstElement.hasClass("sapM-Std-PaddingM");
        bIsSecondElementResponsive = $secondElement.hasClass("sapM-Std-PaddingM");

        //Assert
        assert.ok(bIsFirstElementResponsive, "The sapM-Std-PaddingM class is applied to the first element");
        assert.ok(bIsSecondElementResponsive, "The sapM-Std-PaddingM class is applied to the second element");
        ...
        bIsFirstElementResponsive = $firstElement.hasClass("sapM-Std-PaddingL");
        bIsSecondElementResponsive = $secondElement.hasClass("sapM-Std-PaddingL");

        //Assert
        assert.ok(bIsFirstElementResponsive, "The sapM-Std-PaddingL class is applied to the first element");
        assert.ok(bIsSecondElementResponsive, "The sapM-Std-PaddingL class is applied to the second element");
        ...
        bIsFirstElementResponsive = $firstElement.hasClass("sapM-Std-PaddingXL");
        bIsSecondElementResponsive = $secondElement.hasClass("sapM-Std-PaddingXL");

        //Assert
        assert.ok(bIsFirstElementResponsive, "The sapM-Std-PaddingXL class is applied to the first element");
        assert.ok(bIsSecondElementResponsive, "The sapM-Std-PaddingXL class is applied to the second element");
