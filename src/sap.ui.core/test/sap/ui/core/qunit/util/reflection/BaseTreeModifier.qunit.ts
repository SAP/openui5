import BaseTreeModifier from "sap/ui/core/util/reflection/BaseTreeModifier";
import JsControlTreeModifier from "sap/ui/core/util/reflection/JsControlTreeModifier";
import XmlTreeModifier from "sap/ui/core/util/reflection/XmlTreeModifier";
import Control from "sap/ui/core/Control";
import UIComponent from "sap/ui/core/UIComponent";
import ManagedObject from "sap/ui/base/ManagedObject";
import sinon from "sap/ui/thirdparty/sinon-4";
var sandbox = sinon.sandbox.create();
var XML_VIEW = "<mvc:View id=\"testComponent---myView\" xmlns:mvc=\"sap.ui.core.mvc\" xmlns=\"sap.m\" xmlns:form=\"sap.ui.layout.form\">" + "<form:SimpleForm id=\"testComponent---myView--myForm\">" + "<Title id=\"testComponent---myView--myGroup\" />" + "<Input id=\"testComponent---myView--myGroupElement\" />" + "</form:SimpleForm>" + "</mvc:View>";
var XML_VIEW2 = "<mvc:View id=\"testComponent---myView\" xmlns:mvc=\"sap.ui.core.mvc\"  xmlns:core=\"sap.ui.core\" xmlns=\"sap.m\">" + "<HBox id=\"hbox1\">" + "<items>" + "<Button id=\"button1\" text=\"Button1\" />" + "<Button id=\"button2\" text=\"Button2\" />" + "<Button id=\"button3\" text=\"Button3\" />" + "<core:ExtensionPoint name=\"ExtensionPoint1\" />" + "<Label id=\"label1\" text=\"TestLabel1\" />" + "</items>" + "</HBox>" + "<Panel id=\"panel\">" + "<core:ExtensionPoint name=\"ExtensionPoint2\" />" + "<Label id=\"label2\" text=\"TestLabel2\" />" + "<core:ExtensionPoint name=\"ExtensionPoint3\" />" + "</Panel>" + "<HBox id=\"hbox2\">" + "<Button id=\"button4\" text=\"Button4\" />" + "<Button id=\"button5\" text=\"Button5\" />" + "<core:ExtensionPoint name=\"ExtensionPoint3\" />" + "<Label id=\"label3\" text=\"TestLabel3\" />" + "</HBox>" + "</mvc:View>";
...
QUnit.module("While handling xml views the BaseTreeModifier", {
    ...
    QUnit.test("can determine a targeted control for extension point changes with local IDs", function (assert) {
        ...
        return XmlTreeModifier.bySelectorTypeIndependent(oSelector, this.oComponent, this.oXmlView2).then(function (oControl) {
            assert.ok(oControl);
        });
    });
    ...
    QUnit.test("when getSelector is called with a non-stable node id", function (assert) {
        ...
        }, new Error("Generated ID attribute found - to offer flexibility a stable control ID is needed to assign the changes to, but for this control the ID was generated by SAPUI5 " + oFormNode.getAttribute("id")), "then the correct error was thrown");
...
QUnit.module("While handling js views the BaseTreeModifier", {
    ...
    QUnit.test("when called with a control containing a non-stable id", function (assert) {
        ...
        }, new Error("Generated ID attribute found - to offer flexibility a stable control ID is needed to assign the changes to, but for this control the ID was generated by SAPUI5 " + oManagedObject.getId()), "then the correct error was thrown");
        oManagedObject.destroy();
    });
});
QUnit.module("While handling js views (with extension points) the BaseTreeModifier", {
    ...
    QUnit.test("can determine a targeted control for changes with extension point selector", function (assert) {
        ...
        return JsControlTreeModifier.bySelectorTypeIndependent(oSelector, this.oComponent).then(function (oControl) {
...
QUnit.module("Given a BaseTreeModifier...", {
    ...
    QUnit.test("when checkAndPrefixIdsInFragment is called with various fragments", function (assert) {
        ...
        var oXML1 = jQuery.sap.parseXML("<core:FragmentDefinition xmlns=\"sap.m\" xmlns:core=\"sap.ui.core\">" + "<Input />" + "<HBox xmlns=\"sap.m\" id=\"hbox6\">" + "<items>" + "<Button id=\"button456\" text=\"Hello World\" press=\"onButtonPress\"></Button>" + "</items>" + "</HBox>" + "</core:FragmentDefinition>");
        var oXML2 = jQuery.sap.parseXML("<core:FragmentDefinition xmlns=\"sap.m\" xmlns:core=\"sap.ui.core\">" + "<Label id=\"label123\" text=\"These controls are within one multi-root Fragment:\" />" + "<Input />" + "<Button id=\"button123\" text=\"Still in the same Fragment\" />" + "<HBox xmlns=\"sap.m\" id=\"hbox6\">" + "<Button id=\"button456\" text=\"Hello World\" press=\"onButtonPress\"></Button>" + "</HBox>" + "</core:FragmentDefinition>");
        var oXML3 = jQuery.sap.parseXML("<core:FragmentDefinition xmlns=\"sap.m\" xmlns:core=\"sap.ui.core\">" + "<Label id=\"label123\" text=\"These controls are within one multi-root Fragment:\" />" + "<Input id=\"input123\" />" + "<Button id=\"button123\" text=\"Still in the same Fragment\" />" + "<HBox xmlns=\"sap.m\" id=\"hbox6\">" + "<items>" + "<Button id=\"button456\" text=\"Hello World\" press=\"onButtonPress\"></Button>" + "</items>" + "</HBox>" + "</core:FragmentDefinition>");
        var oXML4 = jQuery.sap.parseXML("<core:FragmentDefinition xmlns=\"sap.m\" xmlns:core=\"sap.ui.core\">" + "<Label id=\"label123\" text=\"These controls are within one multi-root Fragment:\" />" + "<Input id=\"input123\" />" + "<Button id=\"button123\" text=\"Still in the same Fragment\" />" + "<HBox xmlns=\"sap.m\" id=\"hbox6\">" + "<Button id=\"button456\" text=\"Hello World\" press=\"onButtonPress\"></Button>" + "</HBox>" + "</core:FragmentDefinition>");
        var oXML5 = jQuery.sap.parseXML("<core:FragmentDefinition xmlns:m=\"sap.m\" xmlns:mvc=\"sap.ui.core.mvc\" xmlns:layout=\"sap.ui.layout\" xmlns=\"sap.uxap\" xmlns:core=\"sap.ui.core\">" + "<ObjectPageLayout id=\"ProductDetailLayout\" subSectionLayout=\"{ConfigModel>/subSectionLayout}\" flexEnabled=\"true\">" + "<headerTitle>" + "<ObjectPageHeader id=\"DetailHeader\" objectTitle=\"DetailHeader\" objectSubtitle=\"DetailHeader\" >" + "</ObjectPageHeader>" + "</headerTitle>" + "<headerContent>" + "<layout:VerticalLayout id=\"DetailHeaderContent\" >" + "<m:FlexBox id=\"headerLine\" fitContainer=\"true\" renderType=\"Bare\" wrap=\"Wrap\">" + "<m:items>" + "<layout:VerticalLayout id=\"headerCategoryBlock\" class=\"sapUiSmallMarginEnd sapUiSmallMarginBottom\">" + "<layout:layoutData>" + "<m:FlexItemData id=\"flexItemData\" growFactor=\"10\" minWidth=\"250px\"/>" + "</layout:layoutData>" + "<m:ObjectStatus id=\"headerMainCategory\" title=\"headerMainCategory\" text=\"headerMainCategory\"/>" + "<m:ObjectStatus id=\"headerProductCategory\" title=\"headerProductCategory\" text=\"headerProductCategory\"/>" + "<m:ObjectStatus id=\"headerSupplierName\" title=\"headerSupplierName\" text=\"headerSupplierName\"/>" + "</layout:VerticalLayout>" + "</m:items>" + "</m:FlexBox>" + "</layout:VerticalLayout>" + "</headerContent>" + "<sections>" + "<ObjectPageSection id=\"ObjectSectionGeneral\" title=\"ObjectSectionGeneral\">" + "<subSections>" + "<ObjectPageSubSection id=\"SubSectionGeneral\" title=\"SubSectionGeneral\" mode=\"Expanded\">" + "<blocks>" + "<m:HBox id=\"hbox6\">" + "<m:items>" + "<m:Button id=\"button456\" text=\"Hello World\" press=\"onButtonPress\" />" + "</m:items>" + "</m:HBox>" + "</blocks>" + "</ObjectPageSubSection>" + "</subSections>" + "</ObjectPageSection>" + "<ObjectPageSection id=\"ObjectSectionTechnical\" title=\"{i18n>xtit.techData}\" visible=\"false\">" + "<subSections>" + "<ObjectPageSubSection id=\"SubSectionTechnical\" title=\"{i18n>xtit.techData}\" mode=\"Expanded\">" + "<blocks>" + "<m:HBox id=\"hbox7\">" + "<m:items>" + "<m:Button id=\"button789\" text=\"Hello World\" press=\"onButtonPress\" />" + "</m:items>" + "</m:HBox>" + "</blocks>" + "</ObjectPageSubSection>" + "</subSections>" + "</ObjectPageSection>" + "</sections>" + "</ObjectPageLayout>" + "</core:FragmentDefinition>");
        ...
        BaseTreeModifier._checkAndPrefixIdsInFragment(oXML1, "foo").catch(function (vError) {
            assert.strictEqual(vError.message, "At least one control does not have a stable ID", "missing stable ID error cought");
            fnDone();
        });
    ...
    QUnit.test("when getPropertyBindingOrProperty is called", function (assert) {
        sandbox.stub(BaseTreeModifier, "getPropertyBinding").onCall(0).returns(undefined).onCall(1).returns("propertyBinding").onCall(2).returns("propertyBinding");
        sandbox.stub(BaseTreeModifier, "getProperty").onCall(0).resolves("property").onCall(1).resolves(undefined).onCall(2).resolves("property");
        return BaseTreeModifier.getPropertyBindingOrProperty().then(function (oPropertyOrBinding) {
