...
QUnit.module("Using the JsControlTreeModifier...", {
    beforeEach: function () {
        ...
        var oXmlString = "<mvc:View id=\"testComponent---myView\" xmlns:mvc=\"sap.ui.core.mvc\"  xmlns:core=\"sap.ui.core\" xmlns=\"sap.m\">" + "<HBox id=\"hbox1\">" + "<items>" + "<Button id=\"button1\" text=\"Button1\" />" + "<Button id=\"button2\" text=\"Button2\" />" + "<Button id=\"button3\" text=\"Button3\" />" + "<core:ExtensionPoint name=\"ExtensionPoint1\">" + "<Label id=\"default-label1\" text=\"Extension point label1 - default content\" />" + "</core:ExtensionPoint>" + "<Label id=\"label1\" text=\"TestLabel1\" />" + "</items>" + "</HBox>" + "<Panel id=\"panel\">" + "<core:ExtensionPoint name=\"ExtensionPoint2\" />" + "<Label id=\"label2\" text=\"TestLabel2\" />" + "<core:ExtensionPoint name=\"ExtensionPoint3\" />" + "</Panel>" + "<HBox id=\"hbox2\">" + "<Button id=\"button4\" text=\"Button4\" />" + "<Button id=\"button5\" text=\"Button5\" />" + "<core:ExtensionPoint name=\"ExtensionPoint3\" />" + "<Label id=\"label3\" text=\"TestLabel3\" />" + "</HBox>" + "</mvc:View>";
    ...
    QUnit.test("the constructor processes parameters", function (assert) {
        ...
        return JsControlTreeModifier.createControl("sap.m.Button", this.oComponent, undefined, "myButton", { "text": sButtonText }).then(function (oControl) {
    ...
    QUnit.test("the createControl is called asynchronously", function (assert) {
        var sButtonText = "ButtonText";
        return JsControlTreeModifier.createControl("sap.m.Button", this.oComponent, undefined, "myButton", { "text": sButtonText }, true).then(function (oButton) {
    ...
    QUnit.test("the createControl is called asynchronously, expecting an error after loading", function (assert) {
        ...
        return JsControlTreeModifier.createControl("sap.m.Button", this.oComponent, undefined, "myButton", { "text": sButtonText }, true).then(function () {
            assert.notOk(true, "then the promise shouldn't be resolved");
        }).catch(function (oError) {
            assert.equal(oError.message, "Required control 'sap.m.Button' couldn't be created asynchronously", "then the promise is rejected with the expected message");
        });
    });
    QUnit.test("the modifier finds the index of the control in its parent aggregation correctly, case 1 - no overwritten methods in parent control", function (assert) {
        var aButtons = [];
        return JsControlTreeModifier.createControl("sap.m.Page", this.oComponent, undefined, "myPage").then(function (oControl) {
            this.oControl = oControl;
            var aPromises = [];
            [1, 2, 3].forEach(function (iIndex) {
                aPromises.push(JsControlTreeModifier.createControl("sap.m.Button", this.oComponent, undefined, "myButton" + iIndex, { "text": "ButtonText" + iIndex }).then(function (oButton) {
        ...
        }.bind(this)).then(function (iIndex) {
    ...
    QUnit.test("the modifier finds the index of the control in its parent aggregation correctly, case 2 - with overwritten methods in parent control", function (assert) {
        ...
        return Promise.all([
            ...
            var aPromises = [1, 2, 3].map(function (iIndex) {
                return JsControlTreeModifier.createControl("sap.m.Button", this.oComponent, undefined, "myButton" + iIndex, { "text": "ButtonText" + iIndex }).then(function (oButton) {
                    aButtons.push(oButton);
            ...
            return JsControlTreeModifier.findIndexInParentAggregation(aButtons[2]);
        }.bind(this)).then(function (iIndexInParentAggregation) {
    ...
    QUnit.test("createAndAddCustomData adds Custom Data properly", function (assert) {
        ...
        return JsControlTreeModifier.createAndAddCustomData(this.oControl, "myKey", "myValue", this.oComponent).then(function (oCustomData) {
    ...
    QUnit.test("when getExtensionPointInfo is called", function (assert) {
        return JsControlTreeModifier.getExtensionPointInfo("ExtensionPoint1", this.oXmlView).then(function (oExtensionPointInfo1) {
        ...
        }.bind(this)).then(function (oExtensionPointInfo1) {
        ...
        }.bind(this)).then(function (oExtensionPointInfo2) {
    ...
    QUnit.test("when getExtensionPointInfo is called with an extension point which is not on the view", function (assert) {
        return JsControlTreeModifier.getExtensionPointInfo("notAvailableExtensionPoint", this.oXmlView).then(function (oExtensionPointInfo) {
    ...
    QUnit.test("when getExtensionPointInfo is called with an extension point which exists multiple times on the view", function (assert) {
        return JsControlTreeModifier.getExtensionPointInfo("ExtensionPoint3", this.oXmlView).then(function (oExtensionPointInfo) {
            assert.notOk(oExtensionPointInfo, "then nothing is returned");
        });
    });
});
QUnit.module("Given the JsControlTreeModifier...", {
    ...
    QUnit.test("when the modifier retrieves the change handler module for a control with instance-specific change handler module", function (assert) {
        ...
        return JsControlTreeModifier.createControl("sap.m.Button", this.oComponent, undefined, "myButton", { "text": "ButtonInHeading", "customData": mCustomData }).then(function (oControl) {
            this.oControl = oControl;
    ...
    QUnit.test("when the modifier tries to retrieve the change handler module for a control without instance-specific change handler module", function (assert) {
        return JsControlTreeModifier.createControl("sap.m.Button", this.oComponent, undefined, "myButton", { "text": "ButtonInHeading" }).then(function (oControl) {
            this.oControl = oControl;
            var sChangeHandlerModulePath = JsControlTreeModifier.getChangeHandlerModulePath(this.oControl);
    ...
    QUnit.test("when getFlexDelegate() is called to retrieve the delegate info for a control with delegate info", function (assert) {
        ...
        return _getDelegate.call(this, mCustomData).then(function (mDelegateInfo) {
    ...
    QUnit.test("when getFlexDelegate() is called to retrieve the delegate info for a control, with no custom data", function (assert) {
        return _getDelegate.call(this, undefined).then(function (mDelegateInfo) {
            assert.deepEqual(mDelegateInfo, undefined, "then an undefined value is returned");
        });
    });
    ...
    QUnit.test("applySettings", function (assert) {
        this.oControl = new Button();
        return JsControlTreeModifier.applySettings(this.oControl, { text: "Test", enabled: false }).then(function () {
            return JsControlTreeModifier.getProperty(this.oControl, "enabled");
        }.bind(this)).then(function (oProperty) {
    ...
    QUnit.test("when getStashed is called for non-stash control", function (assert) {
        ...
        return JsControlTreeModifier.getStashed(this.oControl).catch(function (vError) {
    ...
    QUnit.test("when getStashed is called for a stashed control", function (assert) {
        ...
        return JsControlTreeModifier.getStashed(this.oControl).then(function (bIsStashed) {
    ...
    QUnit.test("when setStashed is called for stash control", function (assert) {
        var oXmlString = "<mvc:View id=\"testComponent---myView\" xmlns:mvc=\"sap.ui.core.mvc\" xmlns=\"sap.m\">" + "<Panel id=\"panel\">" + "<Button id=\"button1\" text=\"button\" stashed=\"true\"></Button>" + "</Panel>" + "</mvc:View>";
        return XMLView.create({ id: "testapp---view", definition: oXmlString }).then(function (oXmlView) {
            this.oXmlView = oXmlView;
    ...
    QUnit.test("when getProperty is called for a property of type object", function (assert) {
        ...
        this.oControl.addDependent(oSomeObject);
        var mData = { key: "value" };
        ...
        }, /TypeError/, "then passing non JSON data will throw a message");
    });
    ...
    QUnit.test("when templating a fragment", function (assert) {
        ...
        return JsControlTreeModifier.templateControlFragment("sap.ui.test.other.fragment-withTemplating", mPreprocessorSettings, undefined).then(function (aControls) {
...
QUnit.module("Events", {
    ...
    QUnit.test("attachEvent() \u2014 basic case", function (assert) {
        return JsControlTreeModifier.attachEvent(this.oButton, "press", "$sap__qunit_presshandler1", ["param0", "param1", { foo: "bar" }]).then(function () {
    ...
    QUnit.test("attachEvent() \u2014 attempt to attach non-existent function", function (assert) {
        return JsControlTreeModifier.attachEvent(this.oButton, "press", "$sap__qunit_non_existent_handler").catch(function (vError) {
    ...
    QUnit.test("detachEvent() \u2014 basic case", function (assert) {
        return JsControlTreeModifier.attachEvent(this.oButton, "press", "$sap__qunit_presshandler1").then(function () {
    ...
    QUnit.test("detachEvent() \u2014 attempt to detach non-existent function", function (assert) {
        return JsControlTreeModifier.detachEvent(this.oButton, "press", "$sap__qunit_non_existent_handler").catch(function (vError) {
