...
QUnit.module("Using the XmlTreeModifier...", {
    beforeEach: function () {
        ...
        this.oXmlString = "<mvc:View id=\"testComponent---myView\" " + "xmlns:mvc=\"sap.ui.core.mvc\" " + "xmlns=\"sap.m\" " + "xmlns:f=\"sap.f\" " + "xmlns:app=\"http://schemas.sap.com/sapui5/extension/sap.ui.core.CustomData/1\" " + "xmlns:fl=\"sap.ui.fl\">" + "<VBox>\n" + "<tooltip>\n</tooltip>" + "<Label visible=\"true\"></Label>" + "<Label visible=\"false\" design=\"Bold\"></Label>" + "</VBox>" + "<HBox id=\"" + HBOX_ID + "\">" + "<tooltip>" + "<TooltipBase xmlns=\"sap.ui.core\"></TooltipBase>" + "</tooltip>" + "<items>\n" + "<Text id=\"" + TEXT_ID + "\"></Text>" + "</items>" + "</HBox>" + "<Bar tooltip=\"barTooltip\">" + "</Bar>\n" + "<VBox id=\"foo." + HBOX_ID + "\">" + "<Button text=\"Button1\" id=\"button1\"></Button>" + "<Button text=\"Button2\"></Button>\n" + "<Button text=\"Button3\"></Button>" + "</VBox>" + "<f:DynamicPageTitle id=\"title1\">\n" + "<f:actions>\n" + "<Button text=\"Action1\"></Button>\n" + "<Button text=\"Action2\"></Button>\n" + "<Button text=\"Action3\"></Button>" + "</f:actions>" + "</f:DynamicPageTitle>" + "<VBox id=\"vbox2\">" + "<tooltip>\n</tooltip>" + "<Button text=\"Button1\"></Button>" + "<Button text=\"Button2\"></Button>" + "<Button text=\"Button3\"></Button>" + "</VBox>" + "<f:DynamicPageTitle id=\"" + ID_OF_CONTROL_WITH_CUSTOM_DATA + "\" fl:flexibility=\"" + CHANGE_HANDLER_PATH + "\" app:someInlineAppCustomData=\"inlineValue\" >" + "<f:actions>" + "<Button text=\"Action1\"></Button>" + "<Button text=\"Action2\"></Button>" + "<Button text=\"Action3\"></Button>" + "</f:actions>" + "<f:snappedContent>" + "<Text text=\"text1\"></Text>" + "<Text text=\"text2\"></Text>" + "<Text text=\"text3\"></Text>" + "</f:snappedContent>" + "<f:customData>" + "<CustomData xmlns=\"sap.ui.core\" key=\"fullCustomData\" value=\"full\"></CustomData>" + "</f:customData>" + "</f:DynamicPageTitle>" + "<VBox id=\"stashedExperiments\">" + "<Label text=\"visibleLabel\" stashed=\"false\"></Label>" + "<Label text=\"stashedInvisibleLabel\" visible=\"false\" stashed=\"true\"></Label>" + "</VBox>" + "<QuickViewPage id=\"" + ID_OF_CONTROL_WITH_PROP_TYPE_OBJECT + "\" crossAppNavCallback=\"\\{&quot;key&quot;:&quot;value&quot;\\}\" />" + "<QuickViewPage id=\"" + ID_OF_CONTROL_WITH_PROP_TYPE_OBJECT_2 + "\" crossAppNavCallback=\"{&quot;key&quot;:&quot;value&quot;}\" />" + "<QuickViewPage id=\"" + ID_OF_CONTROL_WITH_PROP_TYPE_OBJECT_3 + "\" crossAppNavCallback=\"{'key': 'value'}\" />" + "<QuickViewPage id=\"" + ID_OF_CONTROL_WITH_PROP_BINDING + "\" crossAppNavCallback=\"{/foo}\" />" + "<QuickViewPage id=\"" + ID_OF_CONTROL_WITH_PROP_TYPE_ARRAY + "\" crossAppNavCallback=\"[\\{&quot;key&quot;:&quot;value&quot;\\}]\" />" + "<f:DynamicPageTitle id=\"" + ID_OF_CONTROL_WITH_INLINE_CUSTOM_DATA + "\" app:someInlineAppCustomData=\"inlineValue\" />" + "</mvc:View>";
        this.oXmlView = XMLHelper.parse(this.oXmlString, "application/xml").documentElement;
        this.oXmlString2 = "<mvc:View id=\"testComponent---myView\" xmlns:mvc=\"sap.ui.core.mvc\" xmlns:fl=\"sap.ui.fl\" xmlns:core=\"sap.ui.core\" xmlns=\"sap.m\" >" + "<HBox id=\"hbox1\">" + "<items>" + "<Button id=\"button1\" text=\"Button1\" />" + "<Button id=\"button2\" text=\"Button2\" />" + "<Button id=\"button3\" text=\"Button3\" />" + "<core:ExtensionPoint name=\"ExtensionPoint1\">" + "<Label id=\"default-label1\" text=\"Extension point label1 - default content\" />" + "</core:ExtensionPoint>" + "<Label id=\"label1\" text=\"TestLabel1\" />" + "</items>" + "</HBox>" + "<Panel id=\"panel\">" + "<core:ExtensionPoint name=\"ExtensionPoint2\" />" + "<Label id=\"label2\" text=\"TestLabel2\" />" + "<core:ExtensionPoint name=\"ExtensionPoint3\" />" + "</Panel>" + "<HBox id=\"hbox2\">" + "<Button id=\"button4\" text=\"Button4\" />" + "<Button id=\"button5\" text=\"Button5\" />" + "<core:ExtensionPoint name=\"ExtensionPoint3\">" + "<Label id=\"ep3-label1\" text=\"EP label1 - default content\" />" + "<Label id=\"ep3-label2\" text=\"EP label2 - default content\" />" + "<Label id=\"ep3-label3\" text=\"EP label3 - default content\" />" + "<Label id=\"ep3-label4\" text=\"EP label4 - default content\" />" + "</core:ExtensionPoint>" + "<Label id=\"label3\" text=\"TestLabel3\" />" + "</HBox>" + "</mvc:View>";
    ...
    QUnit.test("the createControl is processing parameters and is working with default namespaces", function (assert) {
        ...
        return XmlTreeModifier.createControl("sap.m.Button", this.oComponent, this.oXmlView, "testComponent---myView--MyButton", { "text": sButtonText }).then(function (oButtonElement) {
    ...
    QUnit.test(" the createControl is adding missing namespaces ", function (assert) {
        return XmlTreeModifier.createControl("sap.ui.core.CustomData", this.oComponent, this.oXmlView, "", { "key": "someKey", "value": "someValue" }).then(function (oCustomDataElement) {
    ...
    QUnit.test(" the createControl is using existing namespaces ", function (assert) {
        return XmlTreeModifier.createControl("sap.ui.layout.VerticalLayout", this.oComponent, this.oXmlView).then(function (oVerticalLayout) {
    ...
    QUnit.test(" the createControl is called for async return value", function (assert) {
        ...
        return oPromise.then(function (oVerticalLayout) {
    ...
    QUnit.test(" the createControl is called for sync return value and control is already created", function (assert) {
        ...
        return XmlTreeModifier.createControl("sap.ui.layout.VerticalLayout", this.oComponent, this.oXmlView).catch(function (vError) {
    ...
    QUnit.test("the default aggregation is returned if aggregation node is not available", function (assert) {
        ...
        return XmlTreeModifier.getAggregation(oVBox, "items").then(function (aDefaultAggregationElements) {
    ...
    QUnit.test("the default aggregation is returned if aggregation node is available", function (assert) {
        ...
        return XmlTreeModifier.getAggregation(oHBox, "items").then(function (aDefaultAggregationElements) {
    ...
    QUnit.test("the empty non default aggregation is returned ", function (assert) {
        var oVBox = XmlTreeModifier._children(this.oXmlView)[0];
        return XmlTreeModifier.getAggregation(oVBox, "customData").then(function (aNonDefaultAggregationElements) {
    ...
    QUnit.test("the empty non default aggregation is returned when no default aggregation exists", function (assert) {
        ...
        return XmlTreeModifier.getAggregation(oBar, "contentRight").then(function (aNonDefaultAggregationElements) {
            assert.equal(aNonDefaultAggregationElements.length, 0);
        });
    });
    QUnit.test("the empty single aggregation is returning nothing", function (assert) {
        var oVBox = XmlTreeModifier._children(this.oXmlView)[0];
        return XmlTreeModifier.getAggregation(oVBox, "tooltip").then(function (vAggregationElements) {
    ...
    QUnit.test("the not in xml view available single aggregation is returning nothing", function (assert) {
        ...
        return XmlTreeModifier.getAggregation(oLabel, "tooltip").then(function (vAggregationElements) {
            assert.ok(!vAggregationElements);
        });
    });
    QUnit.test("the single aggregation is returning the control node directly", function (assert) {
        var oHBox = XmlTreeModifier._children(this.oXmlView)[1];
        return XmlTreeModifier.getAggregation(oHBox, "tooltip").then(function (oAggregationElements) {
    ...
    QUnit.test("the altType aggregation returns the property value", function (assert) {
        var oBar = XmlTreeModifier._children(this.oXmlView)[2];
        return XmlTreeModifier.getAggregation(oBar, "tooltip").then(function (vAggregationElements) {
    ...
    QUnit.test("attribute specified inline is returned in custom data aggregation", function (assert) {
        ...
        return XmlTreeModifier.getAggregation(oControl, "customData").then(function (aCustomData) {
    ...
    QUnit.test("createAndAddCustomData adds the custom data properly, and getAggregation returns them", function (assert) {
        ...
        var oControl = XmlTreeModifier._byId(ID_OF_CONTROL_WITH_CUSTOM_DATA, this.oXmlView);
        return XmlTreeModifier.createAndAddCustomData(oControl, "myKey", "myValue").then(XmlTreeModifier.getAggregation.bind(XmlTreeModifier, oControl, "customData")).then(function (aCustomData) {
    ...
    QUnit.test("the first non default aggregation childNode is added under a newly created aggregation node ", function (assert) {
        var oVBox = XmlTreeModifier._children(this.oXmlView)[0];
        return XmlTreeModifier.createControl("sap.ui.core.CustomData", this.oComponent, this.oXmlView, "someId", { "key": "someKey", "value": "someValue" }).then(function (oCustomDataElement) {
    ...
    QUnit.test("a child is added to the default aggregation ", function (assert) {
        var oVBox = XmlTreeModifier._children(this.oXmlView)[0];
        return XmlTreeModifier.createControl("sap.m.Text", this.oComponent, this.oXmlView).then(function (oCustomDataElement) {
    ...
    QUnit.test("a child is removed from the default aggregation ", function (assert) {
        var oVBox = XmlTreeModifier._children(this.oXmlView)[0];
        var oLabel = XmlTreeModifier._children(this.oXmlView)[0].childNodes[2];
        return XmlTreeModifier.removeAggregation(oVBox, "items", oLabel).then(function () {
            var aChildNodes = XmlTreeModifier._children(oVBox);
    ...
    QUnit.test("removeAll from the default aggregation ", function (assert) {
        var oVBox = XmlTreeModifier._children(this.oXmlView)[0];
        return XmlTreeModifier.removeAllAggregation(oVBox, "items").then(function () {
            var aChildNodes = XmlTreeModifier._children(oVBox);
            assert.equal(aChildNodes.length, 1);
            assert.equal(aChildNodes[0].localName, "tooltip");
            assert.equal(aChildNodes[0].namespaceURI, "sap.m");
    ...
    QUnit.test("removeAll from the default aggregation ", function (assert) {
        var oHBox = XmlTreeModifier._children(this.oXmlView)[1];
        return XmlTreeModifier.removeAllAggregation(oHBox, "items").then(function () {
    ...
    QUnit.test("getProperty for properties of type object (double escaped case)", function (assert) {
        ...
        return XmlTreeModifier.getProperty(oControl, "crossAppNavCallback").then(function (mData) {
    ...
    QUnit.test("applySettings", function (assert) {
        ...
        return XmlTreeModifier.applySettings(oVisibleLabel, {
            design: "Bold",
            required: true,
            labelFor: ID_OF_CONTROL_WITH_PROP_TYPE_OBJECT
        }).then(function () {
            return Promise.all([
                XmlTreeModifier.getProperty(oVisibleLabel, "design"),
    ...
    QUnit.test("applySetting with property of type object", function (assert) {
        var oControl = XmlTreeModifier._byId(ID_OF_CONTROL_WITH_PROP_TYPE_OBJECT, this.oXmlView);
        var mData = { key2: 2 };
        return XmlTreeModifier.applySettings(oControl, { crossAppNavCallback: mData }).then(XmlTreeModifier.getProperty.bind(XmlTreeModifier, oControl, "crossAppNavCallback")).then(function (oProperty) {
    ...
    QUnit.test("findIndexInParentAggregation returns the correct value: case 1 - control in aggregation 0..1 passed as parameter", function (assert) {
        ...
        return XmlTreeModifier.findIndexInParentAggregation(oTooltip).then(function (iIndexInParentAggregation) {
    ...
    QUnit.test("findIndexInParentAggregation returns the correct value: case 2 - default aggregation only in xml tree", function (assert) {
        ...
        return XmlTreeModifier.findIndexInParentAggregation(oButton).then(function (iIndexInParentAggregation) {
    ...
    QUnit.test("the modifier finds the index of the control in its parent aggregation correctly, case 7 - when stashed controls exist", function (assert) {
        ...
        return XmlTreeModifier.findIndexInParentAggregation(oLastButton).then(function (iIndexInParentAggregation) {
    ...
    QUnit.test("getParentAggregationName returns the correct name: ", function (assert) {
        var oVBox = XmlTreeModifier._children(this.oXmlView)[0], oLabel = XmlTreeModifier._children(oVBox)[1];
        var oHBox = XmlTreeModifier._children(this.oXmlView)[1], oTooltip = oHBox.childNodes[0].childNodes[0], oText = oHBox.childNodes[1].childNodes[0];
        var oDynamicPageTitle = XmlTreeModifier._children(this.oXmlView)[6], oButton = oDynamicPageTitle.childNodes[0].childNodes[0], oText2 = oDynamicPageTitle.childNodes[1].childNodes[0];
        return Promise.all([
    ...
    QUnit.test("when getBingingTemplate is called for an aggregation without nodes", function (assert) {
        var oVBox = XmlTreeModifier._children(this.oXmlView)[5];
        return XmlTreeModifier.getBindingTemplate(oVBox, "tooltip").then(function (oBindingTemplate) {
    ...
    QUnit.test("when getBingingTemplate is called for an aggregation with multiple nodes", function (assert) {
        var oVBox = XmlTreeModifier._children(this.oXmlView)[0];
        return XmlTreeModifier.getBindingTemplate(oVBox, "content").then(function (oBindingTemplate) {
            assert.notOk(oBindingTemplate, "then nothing is returned");
        });
    });
    QUnit.test("when getBingingTemplate is called for an aggregation that has a single real control, but text nodes", function (assert) {
        var oHBox = XmlTreeModifier._children(this.oXmlView)[1];
        return XmlTreeModifier.getBindingTemplate(oHBox, "items").then(function (oBindingTemplate) {
    ...
    QUnit.test("when instantiateFragment is called with a duplicate ID", function (assert) {
        var sFragment = "<core:FragmentDefinition xmlns=\"sap.m\" xmlns:core=\"sap.ui.core\">" + "<Button id=\"" + HBOX_ID + "\" text=\"Button1\"></Button>" + "</core:FragmentDefinition>";
        return XmlTreeModifier.instantiateFragment(sFragment, "foo", this.oXmlView).catch(function (vError) {
            assert.strictEqual(vError.message, "The following ID is already in the view: foo." + HBOX_ID, "then the right exception is thrown");
        });
    });
    QUnit.test("when instantiateFragment is called with a FragmentDefinition", function (assert) {
        var sFragment = "<core:FragmentDefinition xmlns=\"sap.m\" xmlns:core=\"sap.ui.core\">" + "<Button id=\"button123\" text=\"Button1\"></Button>" + "<Button id=\"button1234\" text=\"Button2\"></Button>" + "</core:FragmentDefinition>";
        return XmlTreeModifier.instantiateFragment(sFragment, "foo", this.oXmlView).then(function (aControls) {
    ...
    QUnit.test("when instantiateFragment is called with a Control", function (assert) {
        var sFragment = "<sap.m.Button id=\"button123\" text=\"Button1\" />";
        return XmlTreeModifier.instantiateFragment(sFragment, "foo", this.oXmlView).then(function (aControls) {
    ...
    QUnit.test("when templating a fragment", function (assert) {
        ...
        return XmlTreeModifier.templateControlFragment("sap.ui.test.other.fragment-withTemplating", mPreprocessorSettings, undefined).then(function (aControls) {
    ...
    QUnit.test("when insertAggregation is called without bSkipAdjustIndex for an aggregation containing an extension point", function (assert) {
        ...
        return XmlTreeModifier.createControl("sap.m.Text", this.oComponent, this.oXmlView2, oSelector).then(function (oText) {
    ...
    QUnit.test("when insertAggregation is called without bSkipAdjustIndex for an aggregation without an extension point", function (assert) {
        ...
        return XmlTreeModifier.createControl("sap.m.Text", this.oComponent, this.oXmlView, oSelector).then(function (oText) {
    ...
    QUnit.test("when getExtensionPointInfo is called", function (assert) {
        return XmlTreeModifier.getExtensionPointInfo("ExtensionPoint1", this.oXmlView2).then(function (oExtensionPointInfo1) {
    ...
    QUnit.test("when getExtensionPointInfo is called with an extension point which is not on the view", function (assert) {
        return XmlTreeModifier.getExtensionPointInfo("notAvailableExtensionPoint", this.oXmlView2).then(function (oExtensionPointInfo) {
    ...
    QUnit.test("when getExtensionPointInfo is called with an extension point which exists multiple times on the view", function (assert) {
        return XmlTreeModifier.getExtensionPointInfo("ExtensionPoint3", this.oXmlView2).then(function (oExtensionPointInfo) {
            assert.notOk(oExtensionPointInfo, "then nothing is returned");
        });
    });
...
QUnit.module("Events", {
    ...
    beforeEach: function () {
        ...
        this.oXmlString = ("<mvc:View " + "id=\"testComponent---myView\" " + "xmlns:mvc=\"sap.ui.core.mvc\" " + "xmlns=\"sap.m\"" + ">" + "<Button text=\"Button1\" id=\"button1\"></Button>" + "</mvc:View>");
        this.oXmlView = XMLHelper.parse(this.oXmlString, "application/xml").documentElement;
    ...
    QUnit.test("attachEvent() \u2014 basic case", function (assert) {
        return XmlTreeModifier.attachEvent(this.oButton, "press", "$sap__qunit_presshandler1").then(function () {
    ...
    QUnit.test("attachEvent() \u2014 basic case with parameters", function (assert) {
        return XmlTreeModifier.attachEvent(this.oButton, "press", "$sap__qunit_presshandler1", ["param0", "param1", { foo: "bar" }]).then(function () {
            this.oView = this.createView(this.oXmlView);
            this.oView.byId("button1").firePress();
            assert.strictEqual(this.oSpy1.callCount, 1);
    ...
    QUnit.test("attachEvent() \u2014 two different event handlers with different set of parameters for the same event name", function (assert) {
        return XmlTreeModifier.attachEvent(this.oButton, "press", "$sap__qunit_presshandler1", ["param0", "param1"]).then(XmlTreeModifier.attachEvent.bind(XmlTreeModifier, this.oButton, "press", "$sap__qunit_presshandler2", ["param2", "param3"])).then(function () {
            this.oView = this.createView(this.oXmlView);
            this.oView.byId("button1").firePress();
            assert.strictEqual(this.oSpy1.callCount, 1);
    ...
    QUnit.test("attachEvent() \u2014 attempt to attach non-existent function", function (assert) {
        return XmlTreeModifier.attachEvent(this.oButton, "press", "$sap__qunit_non_existent_handler").catch(function (vError) {
    ...
    QUnit.test("attachEvent() \u2014 two equal event handlers with a different set of parameters", function (assert) {
        return XmlTreeModifier.attachEvent(this.oButton, "press", "$sap__qunit_presshandler1", ["param0", "param1"]).then(XmlTreeModifier.attachEvent.bind(XmlTreeModifier, this.oButton, "press", "$sap__qunit_presshandler1", ["param2", "param3"])).then(function () {
            this.oView = this.createView(this.oXmlView);
            this.oView.byId("button1").firePress();
    ...
    QUnit.test("detachEvent() \u2014 basic case", function (assert) {
        ...
        return XmlTreeModifier.attachEvent(this.oButton, "press", "$sap__qunit_presshandler1").then(XmlTreeModifier.detachEvent.bind(XmlTreeModifier, this.oButton, "press", "$sap__qunit_presshandler1")).then(function () {
            assert.notOk(this.oButton.hasAttribute("press"));
            this.oView = this.createView(this.oXmlView);
            this.oView.byId("button1").firePress();
    ...
    QUnit.test("detachEvent() \u2014 three event handlers, two of them are with a different set of parameters", function (assert) {
        return XmlTreeModifier.attachEvent(this.oButton, "press", "$sap__qunit_presshandler1").then(XmlTreeModifier.attachEvent.bind(XmlTreeModifier, this.oButton, "press", "$sap__qunit_presshandler2", ["param0", "param1"])).then(XmlTreeModifier.attachEvent.bind(XmlTreeModifier, this.oButton, "press", "$sap__qunit_presshandler2", ["param2", "param3"])).then(XmlTreeModifier.detachEvent.bind(XmlTreeModifier, this.oButton, "press", "$sap__qunit_presshandler2")).then(function () {
            this.oView = this.createView(this.oXmlView);
            this.oView.byId("button1").firePress();
            assert.strictEqual(this.oSpy1.callCount, 1);
            assert.strictEqual(this.oSpy2.callCount, 1);
    ...
    QUnit.test("detachEvent() \u2014 attempt to detach non-existent function", function (assert) {
        return XmlTreeModifier.detachEvent(this.oButton, "press", "$sap__qunit_non_existent_handler").catch(function (vError) {
            assert.ok(vError.message.indexOf("function is not found") > -1);
        });
    });
});
QUnit.module("Aggregation binding", {
    ...
    QUnit.test("bindAggregation - complex binding via binding string", function (assert) {
        return XmlTreeModifier.createControl("sap.ui.core.CustomData", this.oComponent, this.oXmlView, {
            ...
            return XmlTreeModifier.bindAggregation(this.oButton, "customData", {
    ...
    QUnit.test("unbindAggregation", function (assert) {
        ...
        }.bind(this)).then(XmlTreeModifier.unbindAggregation.bind(XmlTreeModifier, this.oButton, "customData")).then(function () {
            this.oView = this.createView(this.oXmlView);
            this.oView.setModel(this.oModel, this.sModelName);
            this.oButtonInstance = this.oView.byId("button1");
