...
QUnit.test("Range", function (assert) {
    var start = [3, 5], end = [4, 2], rangeCheck = ["v<min", "v=min", "min<v<max", "v=max", "v>max"], checkVersion = [new jQuery.sap.Version(2), new jQuery.sap.Version(3, 5), new jQuery.sap.Version(3, 9), new jQuery.sap.Version(4, 2), new jQuery.sap.Version(5)], args, isOk, res;
