...
import TypedView from "my/TypedView";
...
var oXmlView, oXmlFragmentInXmlView, oXmlFragmentWithIdInXmlView, oHtmlFragmentInXmlView, oHtmlFragmentWithIdInXmlView, oJsFragmentInXmlView, oJsFragmentWithIdInXmlView;
...
QUnit.test("XML Fragment as Dialog", function (assert) {
    ...
    window.setTimeout(function () {
        ...
        triggerClickEvent("xmlDialogBtn");
        window.setTimeout(function () {
            assert.ok(!oDialog.isOpen(), "Dialog should be closed now");
            oDialog.destroy();
            done();
...
QUnit.test("HTML Fragment as Dialog", function (assert) {
    ...
    window.setTimeout(function () {
        ...
        triggerClickEvent("htmlDialogBtn");
        window.setTimeout(function () {
            assert.ok(!oDialog.isOpen(), "Dialog should be closed now");
            oDialog.destroy();
            done();
