...
import TypeInteger from "sap/ui/model/type/Integer";
...
QUnit.test("Message parsing: Not filtering duplicates with messages in response header", function (assert) {
    var aMessages, oOdataMessageParser = new ODataMessageParser("fakeService", oFakeMsgProcessor), oResponse = {
        headers: {
            "sap-message": "{" + "\"code\": \"ABC\"," + "\"message\": \"This is a duplicate message.\"," + "\"target\": \"\"," + "\"details\": [{" + "\"code\": \"ABC\"," + "\"message\": \"This is non duplicate message.\"" + "}, {" + "\"code\": \"ABC\"," + "\"message\": \"This is a duplicate message.\"" + "}]" + "}"
        }
    };
    oOdataMessageParser.setProcessor({ resolve: function () { } });
    aMessages = oOdataMessageParser._parseHeader(oResponse, { url: "myurl", request: { headers: {} }, response: oResponse });
...
QUnit.test("Message parsing: Filter out duplicates with messages in response body", function (assert) {
    var aMessages, oOdataMessageParser = new ODataMessageParser("fakeService", oFakeMsgProcessor), oResponse = {
        body: "<?xml version=\"1.0\" encoding=\"utf-8\"?><error xmlns=\"http://schemas.microsoft.com/ado/2007/08/dataservices/metadata\">\t<code>ABC</code>\t<message xml:lang=\"en\">I am a duplicate.</message>\t<innererror>\t\t<transactionid>55025622675C2E69E10000000A4450F0</transactionid>\t\t<timestamp>20150318080838.2106030</timestamp>\t\t<errordetails>\t\t\t<errordetail>\t\t\t\t<code>ABC2</code>\t\t\t\t<message>I am not a duplicate.</message>\t\t\t</errordetail>\t\t\t<errordetail>\t\t\t\t<code>ABC</code>\t\t\t\t<message>I am a duplicate.</message>\t\t\t</errordetail>\t\t</errordetails>\t</innererror></error>",
        headers: {
            "content-type": "text/xml"
        }
    };
    oOdataMessageParser.setProcessor({ resolve: function () { } });
    aMessages = oOdataMessageParser._parseBody(oResponse, { url: "myurl", request: { headers: {} }, response: oResponse });
