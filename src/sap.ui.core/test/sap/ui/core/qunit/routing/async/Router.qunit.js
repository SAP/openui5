...
sap.ui.define([
	...
	"sap/m/VBox"
], function (Log, deepExtend, UIComponent, Controller, JSView, View, HashChanger, RouterHashChanger, Router, Views, JSONModel, App, Button, NavContainer, Panel, SplitContainer, ModuleHook, EventProvider, Device, Component, ComponentContainer, VBox) {
	"use strict";
	...
	QUnit.test("Should create a view", function (assert) {
		// Act
		var oExpectedView = this.oRouter.getView("foo", "XML", "baz");
		...
		assert.strictEqual(oCallArguments.type, "XML", "Did pass the type");
		...
		beforeEach: function() {
			...
			this.createComponent = function(sComponentName) {
				return Component.create({
					...
					return this.oRootView.loaded().then(function() {
