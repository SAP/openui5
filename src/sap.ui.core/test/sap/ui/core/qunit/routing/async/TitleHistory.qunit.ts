...
QUnit.test("avoid title history redundancy", function (assert) {
    var that = this, oParameters, sHomeTitle = "HOME", sProductTitle = "PRODUCT", sProductDetailTitle = "PRODUCT_DETAIL", fnEventSpy = this.spy(function (oEvent) {
        oParameters = oEvent.getParameters();
    });
    this.oRouterConfig = {
        home: {
...
QUnit.test("Home Route declaration with dynamic parts", function (assert) {
    var sHomeTitle = "HOME", sProductTitle = "PRODUCT", oParameters, fnEventSpy = this.spy(function (oEvent) {
        oParameters = oEvent.getParameters();
    });
    this.oRouterConfig = {
        home: {
