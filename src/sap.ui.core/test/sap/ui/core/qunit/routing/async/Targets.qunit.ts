...
QUnit.test("Further call of setting router is ignored", function (assert) {
    var oRouter = new Router({}, { async: true }, null, {}), oRouter1 = new Router({}, { async: true }, null, {});
    this.oTargets._setRouter(oRouter);
...
QUnit.test("Display a component target", function (assert) {
    var oTarget = this.oTargets.getTarget("myTarget"), oTargetDisplaySpy = this.sandbox.spy(oTarget, "_display"), oInitializeSpy = this.sandbox.spy(Router.prototype, "initialize");
    return this.oTargets.display("myTarget").then(function () {
...
QUnit.test("Display a component target which has a parent set with another component target", function (assert) {
    var oTarget = this.oTargets.getTarget("myTarget"), oParentTarget = this.oTargets.getTarget("myParent"), oTargetDisplaySpy = this.sandbox.spy(oTarget, "_display"), oParentTargetDisplaySpy = this.sandbox.spy(oParentTarget, "_display");
...
QUnit.test("Should destroy all dependencies", function (assert) {
    var oViews = new Views({ async: true }), oFirstTarget, oSecondTarget;
