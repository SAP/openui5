...
QUnit.test("Placeholder - show / hide", function (assert) {
    ...
    var oButton, oButtonDelegate, oPlaceholder;
    oButton = new Button({
        id: "myButton"
    ...
    oButtonDelegate = {
        "onAfterRendering": function () {
            ...
            oPlaceholder.show(oButton).then(function () {
                assert.ok(document.getElementById("myButton").contains(document.getElementById("myPlaceholder")), "Placeholder should be available.");
                oPlaceholder.hide();
                assert.notOk(document.getElementById("myButton").contains(document.getElementById("myPlaceholder")), "Placeholder shouldn't be available anymore after hide().");
                oButton.destroy();
...
QUnit.test("NavContainer - needPlaceholder", function (assert) {
    var oNavContainer = new NavContainer(), oPage1 = new Page(), oPage2 = new Page();
...
QUnit.test("sap/m/TargetHandler - showPlaceholder (sync)", function (assert) {
    var oTargetHandler = new MTargetHandler(), oNavContainer = new NavContainer(), oPage1 = new Page(), oPage2 = new Page();
...
QUnit.test("NavContainer", function (assert) {
    ...
    var oNavConShowPlaceholderSpy = sinon.spy(NavContainer.prototype, "showPlaceholder"), oNavConHidePlaceholderSpy = sinon.spy(NavContainer.prototype, "hidePlaceholder");
    var oRouter;
...
QUnit.test("SplitContainer", function (assert) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        assert.equal(oSplitAppShowPlaceholderSpy.getCall(0).args[0].aggregation, "detailPages", "SplitApp.showPlaceholder should be called only on 'detailPages' aggregation - 'masterPages' didn't change");
        ...
        assert.ok(oDetailPageNavContainer.getDomRef().contains(document.getElementById("myPlaceholder")), "DetailPage NavContainer should contain the placeholder");
        oDetailPageNavContainer.hidePlaceholder();
        assert.notOk(oDetailPageNavContainer.getDomRef().contains(document.getElementById("myPlaceholder")), "DetailPage NavContainer shouldn't contain the placeholder anymore");
        oComponentContainer.destroy();
...
QUnit.test("FlexibleColumnLayout", function (assert) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        assert.equal(oFlexLayoutShowPlaceholderSpy.getCall(2).args[0].aggregation, "endColumnPages", "FlexibleColumnLayout.showPlaceholder should be called on 'endColumnPages' aggregation");
        ...
        assert.equal(oFlexLayoutShowPlaceholderSpy.getCall(0).args[0].aggregation, "midColumnPages", "FlexibleColumnLayout.showPlaceholder should be called on 'midColumnPages' aggregation - 'beginColumnPages' didn't change");
        assert.equal(oFlexLayoutShowPlaceholderSpy.getCall(1).args[0].aggregation, "endColumnPages", "FlexibleColumnLayout.showPlaceholder should be called on 'endColumnPages' aggregation - 'beginColumnPages' didn't change");
        ...
        assert.equal(oFlexLayoutHidePlaceholderSpy.getCall(0).args[0].aggregation, "midColumnPages", "FlexibleColumnLayout.hidePlaceholder should be called on 'midColumnPages' aggregation");
        assert.ok(oFlexColumnLayout._getBeginColumn().getDomRef().contains(document.getElementById("myPlaceholder")), "beginColumn should still contain the placeholder (autoClose: false)");
        assert.ok(oFlexColumnLayout._getEndColumn().getDomRef().contains(document.getElementById("myPlaceholder1")), "endColumn should still contain the placeholder (autoClose: false)");
        oFlexColumnLayout.hidePlaceholder({ aggregation: "beginColumPages" });
        assert.notOk(oFlexColumnLayout._getEndColumn().getDomRef().contains(document.getElementById("myPlaceholder")), "beginColumn shouldn't contain the placeholder anymore");
        oFlexColumnLayout.hidePlaceholder({ aggregation: "endColumnPages" });
        assert.notOk(oFlexColumnLayout._getEndColumn().getDomRef().contains(document.getElementById("myPlaceholder1")), "endColumn shouldn't contain the placeholder anymore");
        oComponentContainer.destroy();
