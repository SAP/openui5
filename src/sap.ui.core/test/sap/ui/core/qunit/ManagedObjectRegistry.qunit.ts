import ManagedObjectRegistry from "sap/ui/base/ManagedObjectRegistry";
...
QUnit.test("Should ensure that extended function is subclass of ManagedObject", function (assert) {
    ...
    }, new TypeError("ManagedObjectRegistry mixin can only be applied to subclasses of sap.ui.base.ManagedObject"), "throws because function is not subclass of ManagedObject");
});
