    ...
    createContent: function (oController) {
        ...
        ext2 = new VerticalLayout({
            content: [
                ...
                sap.ui.extensionpoint(this, "extension42"),
        ...
        var fnCreateDefaultContent2 = function () {
            return [new TextView(that.createId("iShouldBeDestroyed1"), { text: "Extension point 44: Default Content" }), new TextView(that.createId("iShouldBeDestroyed2"), { text: "Extension point 44: Second Default Content" })];
        };
        ext4 = sap.ui.extensionpoint(this, "extension45", fnCreateDefaultContent2);
        var fnCreateDefaultContent3 = function () {
            return [new TextView(that.createId("defaultContentTextView2"), { text: "Extension point 667: Default Content" }), new TextView(that.createId("defaultContentTextView3"), { text: "Extension point 667: Second Default Content" })];
        };
