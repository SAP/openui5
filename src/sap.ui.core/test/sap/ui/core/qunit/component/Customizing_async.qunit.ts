...
QUnit.test("ExtensionPoint contains async View/Fragment", function (assert) {
    ...
    return Component.create({
    ...
    }.bind(this)).then(function (oExtensionView) {
        ...
        return oRootComponent.getRootControl().byId("myCustomerComponent---mainView--extPoint2Fragment--extPoint3View").loaded();
        ...
        assert.equal(aExtPoint3Content[0], oExtPoint3View.byId("extPoint4Fragment--buttonExtPoint4_1"), "Button1 inside ExtensionPoint View is at the correct position.");
        assert.equal(aExtPoint3Content[1], oExtPoint3View.byId("extPoint4Fragment--buttonExtPoint4_2"), "Button2 inside ExtensionPoint View is at the correct position.");
