	...
	return View.extend("testdata.customizing.sap.Sub4Typed", {
		...
		createContent : function(oController) {
			...
			var fnCreateDefaultContent = function(){
				var aDefaultContent = [new Text(that.createId("defaultContentTextView"), {text: "Extension point 1: Default Content"})];
			...
			var fnCreateDefaultContent2 = function(){
				return [ new Text(that.createId("iShouldBeDestroyed1"), {text: "Extension point 44: Default Content"}),
			...
			var fnCreateDefaultContent3 = function(){
				return [ new Text(that.createId("defaultContentTextView2"), {text: "Extension point 667: Default Content"}),
