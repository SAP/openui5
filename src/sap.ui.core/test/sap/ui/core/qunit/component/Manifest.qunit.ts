...
QUnit.test("Manifest.load ASYNC", function (assert) {
    ...
    Manifest.load({
        ...
        that.oManifest = oManifest;
        assert.strictEqual(that.oManifest.getEntry("sap.ui5").someValue, "someValue456", "Manifest data was loaded ASYNC");
        assert.strictEqual(that.oManifest._resolveUri(new URI("test-resources/sap/ui/core/qunit/component/testdata/manifestload"), "manifest").toString(), "test-resources/sap/ui/core/qunit/component/testdata/manifestload/test-resources/sap/ui/core/qunit/component/testdata/manifestload", "URL should resolve relative to the Manifest");
        assert.strictEqual(that.oManifest.resolveUri("test-resources/sap/ui/core/qunit/component/testdata/manifestload", "manifest"), "test-resources/sap/ui/core/qunit/component/testdata/manifestload/test-resources/sap/ui/core/qunit/component/testdata/manifestload", "URL should resolve relative to the Manifest");
        done();
    });
});
QUnit.test("Manifest.load SYNC", function (assert) {
    ...
    assert.strictEqual(this.oManifest.resolveUri("test-resources/sap/ui/core/qunit/component/testdata/manifestload", "manifest").toString(), "test-resources/sap/ui/core/qunit/component/testdata/manifestload/test-resources/sap/ui/core/qunit/component/testdata/manifestload", "URL should resolve relative to the Manifest");
});
QUnit.test("Manifest from Object", function (assert) {
    ...
    assert.strictEqual(this.oManifest._resolveUri(new URI("test-resources/sap/ui/core/qunit/component/testdata/manifestload"), "manifest").toString(), "test-resources/sap/ui/core/qunit/component/testdata/manifestload/test-resources/sap/ui/core/qunit/component/testdata/manifestload", "URL should resolve relative to the Manifest");
    assert.strictEqual(this.oManifest.resolveUri("test-resources/sap/ui/core/qunit/component/testdata/manifestload", "manifest"), "test-resources/sap/ui/core/qunit/component/testdata/manifestload/test-resources/sap/ui/core/qunit/component/testdata/manifestload", "URL should resolve relative to the Manifest");
});
