...
import Handlebars from "sap/ui/thirdparty/handlebars";
...
QUnit.test("Binding Path in Template", function (assert) {
    ...
    var html = "" + "<template data-controller-name=\"test.myController\">" + "<div id=\"myTemplate\" data-type=\"text/x-handlebars-template\">" + "<div>Binding in Template:</div>" + "<span id=\"templateContent\">{{text path=\"navigation>/title\"}}</span>" + "</div>" + "</template>";
