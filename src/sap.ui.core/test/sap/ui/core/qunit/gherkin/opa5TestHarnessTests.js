...
sap.ui.require([
  ...
  // TEST /////////////////////////////////////////////////////////////////////////////////////////////////
  // //////////////////////////////////////////////////////////////////////////////////////////////////////
  QUnit.test("fnAlternateTestStepGenerator: simple function call", function() {
  ...
  // TEST /////////////////////////////////////////////////////////////////////////////////////////////////
  // //////////////////////////////////////////////////////////////////////////////////////////////////////
  QUnit.test("fnAlternateTestStepGenerator: page object", function() {
  ...
  // TEST /////////////////////////////////////////////////////////////////////////////////////////////////
  // //////////////////////////////////////////////////////////////////////////////////////////////////////
  QUnit.test("Smoke test Page Object logging when some steps are generated + test step generation", function() {
    var sText = [
  ...
  // TEST /////////////////////////////////////////////////////////////////////////////////////////////////
  // //////////////////////////////////////////////////////////////////////////////////////////////////////
  QUnit.test("Given generate missing test steps + steps file, when function DNE build fails immediately", function() {
  ...
  // TEST /////////////////////////////////////////////////////////////////////////////////////////////////
  // //////////////////////////////////////////////////////////////////////////////////////////////////////
  QUnit.test("Given generate missing test steps + NO steps file, when function exists build passes", function() {
  ...
  // TEST /////////////////////////////////////////////////////////////////////////////////////////////////
  // //////////////////////////////////////////////////////////////////////////////////////////////////////
  QUnit.test("Given generate missing test steps + NO steps file, when function DNE build fails immediately", function() {
