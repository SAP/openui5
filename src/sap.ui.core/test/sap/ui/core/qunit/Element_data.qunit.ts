...
QUnit.test("Negative Test: invalid arguments", function (assert) {
    ...
    assert.throws(function () { element.data(undefined); }, "Getting data with a key of type undefined should raise an error");
});
...
QUnit.test("Usage in XML View declaration with binding", function (assert) {
    var xml = "<mvc:View xmlns:mvc=\"sap.ui.core.mvc\" xmlns=\"sap.m\" " + "xmlns:app=\"http://schemas.sap.com/sapui5/extension/sap.ui.core.CustomData/1\">" + "<Button id=\"myBtn\" text=\"test\" app:coords=\"{/data}\"></Button></mvc:View>";
    return View.create({
        type: ViewType.XML,
        definition: xml
