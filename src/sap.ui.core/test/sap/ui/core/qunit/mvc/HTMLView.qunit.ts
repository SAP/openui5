...
testsuite(oConfig, "HTMLView creation via HTML string", function () {
    var sHtml = "<template data-controller-name=\"example.mvc.test\">" + "<div class=\"test test2 test3\" data-sap-ui-type=\"sap.m.Panel\" id=\"myPanel\">" + "\t<div class=\"test test2 test3\" data-sap-ui-type=\"sap.m.Button\" id=\"Button1\" data-text=\"Hello World\" data-press=\"doIt\"></div>" + "\t<div data-sap-ui-type=\"sap.m.Button\" id=\"Button2\" data-text=\"Hello\"></div>" + "\t<div data-sap-ui-type=\"sap.m.Button\" id=\"ButtonX\" data-text=\"Another Hello\" data-press=\".sap.doIt\"></div>" + "\t<div data-sap-ui-type=\"sap.ui.core.mvc.HTMLView\" id=\"MyHTMLView\" data-view-name=\"example.mvc.test2\"></div>\"" + "\t<div data-sap-ui-type=\"sap.ui.core.mvc.JSView\" id=\"MyJSView\" data-view-name=\"example.mvc.test2\"></div>" + "\t<div data-sap-ui-type=\"sap.ui.core.mvc.JSONView\" id=\"MyJSONView\" data-view-name=\"example.mvc.test2\"></div>" + "\t<div data-sap-ui-type=\"sap.ui.core.mvc.XMLView\" id=\"MyXMLView\" data-view-name=\"example.mvc.test2\"></div>" + "</div>" + "</template>";
