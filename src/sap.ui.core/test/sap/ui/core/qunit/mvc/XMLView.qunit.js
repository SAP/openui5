...
], function(future, Log, Localization, ResourceBundle, OwnStatics, Element, Controller, View, ViewType, XMLView, RenderManager, JSONModel, ResourceModel, XMLHelper, testsuite, jQuery, nextUIUpdate) {
	"use strict";
