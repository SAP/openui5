sap.ui.require.preload({
	"fixture/async-sync-conflict/library-using-require-declare/library.js": function() {
		"use strict";
	...
	"fixture/async-sync-conflict/library-using-require-declare/manifest.json": JSON.stringify({
		"sap.ui5": {
			"dependencies": {
				"libs": {
					"sap.ui.core": {
