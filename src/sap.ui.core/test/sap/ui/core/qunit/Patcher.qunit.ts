...
import Patcher from "sap/ui/core/Patcher";
...
QUnit.test("No DOM patching needed - Normal tag", function (assert) {
    ...
    this.html("<div id='d' title='t'>" + "<div class='x'></div><div class='x'></div>" + "<div id='n'><div></div></div>" + "0<span>1<img id='s'>2</span>3 4" + "<b>b<i>bi<u>biu</u></i></b>" + "<h1>" + encodeXML("<h1> & <hr>") + "</h1><hr>" + "</div>", function (oElement) {
        document.getElementById("n").style.width = "10px";
    }).patch(function () {
        oPatcher.openStart("div", "d").attr("title", "t").openEnd().openStart("div").class("x").openEnd().close("div").openStart("div").class("x").openEnd().close("div").openStart("div", "n").style("width", "10px").openEnd().openStart("div").openEnd().close("div").close("div").text(0).openStart("span").openEnd().text(1).voidStart("img", "s").voidEnd().text(2).close("span").text("3 4").openStart("b").openEnd().text("b").openStart("i").openEnd().text("bi").openStart("u").openEnd().text("biu").close("u").close("i").close("b").openStart("h1").openEnd().text("<h1> & <hr>").close("h1").voidStart("hr").voidEnd().close("div");
    }, function (aMutations) {
...
QUnit.test("No DOM patching needed - SVG", function (assert) {
    this.html("<svg id='x' viewBox='-5 -5 10 10' xmlns='http://www.w3.org/2000/svg'>" + "<linearGradient gradientTransform='rotate(90)'>" + "<stop offset='5%' stop-color='gold'/>" + "<stop offset='95%' stop-color='red'></stop>" + "</linearGradient>" + "<rect x='0' y='0' width='100%' />" + "</svg>", function (oElement) {
        oElement.lastChild.style.height = "100%";
    }).patch(function () {
        oPatcher.openStart("svg", "x").attr("viewBox", "-5 -5 10 10").attr("xmlns", "http://www.w3.org/2000/svg").openEnd().openStart("linearGradient").attr("gradientTransform", "rotate(90)").openEnd().openStart("stop").attr("offset", "5%").attr("stop-color", "gold").openEnd().close("stop").openStart("stop").attr("offset", "95%").attr("stop-color", "red").openEnd().close("stop").close("linearGradient").openStart("rect").attr("x", 0).attr("y", 0).attr("width", "100%").style("height", "100%").openEnd().close("rect").close("svg");
    }, function (aMutations) {
...
QUnit.test("Attribute/property/text changes", function (assert) {
    ...
    this.html("<select>" + "<option></option>" + "<option selected='selected'></option>" + "</select>").patch(function (oElement) {
        oElement.lastChild.selected = false;
        oPatcher.openStart("select").openEnd().openStart("option").openEnd().close("option").openStart("option").attr("selected", "selected").openEnd().close("option").close("select");
    }, function (aMutations, oElement) {
        assert.equal(aMutations.length, 0, "No change");
    ...
    this.html("<div value='value'></div>").patch(function (oElement) {
        oPatcher.openStart("div").attr("value", "newvalue").attr("checked", "checked").attr("selected", "selected").openEnd().close("div");
    }, function (aMutations, oElement) {
...
QUnit.test("NodeName changes", function (assert) {
    ...
    this.html("<span>Text</span>").patch(function () {
        oPatcher.openStart("span").openEnd().openStart("div").openEnd().close("div").close("span");
    }, function (aMutations, oElement) {
    ...
    this.html("<span>Text<img></span>").patch(function () {
        oPatcher.openStart("span").openEnd().voidStart("img").voidEnd().text("Text").close("span");
    }, function (aMutations, oElement) {
        assert.equal(aMutations.length, 2, "Two changes");
...
QUnit.test("Patching - Keys", function (assert) {
    ...
    this.html("<ul>" + "<li id='x'></li>" + "</ul>").patch(function () {
        oPatcher.openStart("ul").openEnd().openStart("li", "y").openEnd().close("li").openStart("li", "x").openEnd().close("li").close("ul");
    }, function (aMutations, oElement) {
    ...
    this.html("<ul>" + "<li id='x'>X</li>" + "<li id='y'>Y</li>" + "</ul>").patch(function () {
        oPatcher.openStart("ul").openEnd().openStart("li", "x").openEnd().text("X").close("li").close("ul");
    }, function (aMutations, oElement) {
    ...
    this.html("<ul>" + "<li id='x'>X</li>" + "<li id='y'>Y</li>" + "</ul>").patch(function () {
        oPatcher.openStart("ul").openEnd().openStart("li", "y").openEnd().text("Y").close("li").openStart("li", "x").openEnd().text("X").close("li").close("ul");
    }, function (aMutations, oElement) {
    ...
    this.html("<ul>" + "<li id='x'>X</li>" + "<li id='y'>Y</li>" + "</ul>").patch(function () {
        oPatcher.openStart("ul").openEnd().openStart("li", "x").openEnd().text("X").close("li").openStart("li", "z").openEnd().text("Z").close("li").openStart("li", "y").openEnd().text("Y").close("li").close("ul");
    }, function (aMutations, oElement) {
    ...
    this.html("<ul>" + "<li id='x'></li>" + "<li id='prefix-y'></li>" + "</ul>").patch(function () {
        oPatcher.openStart("ul").openEnd().openStart("li", "y").openEnd().close("li").close("ul");
    }, function (aMutations, oElement) {
        assert.equal(oElement.firstChild.id, "y", "id is updated");
    ...
    this.html("<ul></ul>").patch(function () {
        oPatcher.openStart("ul").openEnd().openStart("li", "a").attr("title", "a").openEnd().text("a").close("li").openStart("li", "b").attr("title", "b").openEnd().text("b").close("li").openStart("li", "c").attr("data-title", "c").class("c").style("color", "red").openEnd().openStart("div").openEnd().text("c").close("div").close("li").openStart("span").openEnd().text("d").close("span").openStart("li").openEnd().close("li").close("ul");
    }, function (aMutations, oElement) {
...
QUnit.test("Patching Nested", function (assert) {
    this.html("<ul>" + "<li id='x'>1</li>" + "<li id='y'>2</li>" + "</ul>").patch(function () {
    ...
    this.html("<ul>" + "<li></li>" + "<li id='x'><input><b>Test</b></li>" + "</ul>").patch(function () {
    ...
    this.html("<ul></ul>").patch(function () {
        oPatcher.openStart("ul").openEnd().openStart("li").attr("title", "x").openEnd().openStart("b").openEnd().text(1).close("b").close("li").openStart("li").attr("title", "y").openEnd().openStart("u").openEnd().text(2).close("u").close("li").close("ul");
    }, function (aMutations, oElement) {
...
QUnit.test("Patching unsafeHtml", function (assert) {
    this.html("<div>Here can be any content from outside</div>").patch(function () {
        oPatcher.openStart("div").openEnd().unsafeHtml("Plain text actually not supported with unsafeHtml").close("div");
    }, function (aMutations, oElement) {
    ...
    this.html("<ul></ul>").patch(function () {
        oPatcher.openStart("ul").openEnd().unsafeHtml("<li id='x'><input><b>Test</b></li>").unsafeHtml("<li id='y'><input><b>Test</b></li>").close("ul");
    }, function (aMutations, oElement) {
        assert.equal(aMutations.length, 2, "Two changes");
        assert.equal(aMutations[0].addedNodes.length + aMutations[1].addedNodes.length, 2, "Two children are added");
    });
    ...
    this.html("<ul>" + "<li id='x'>X</li>" + "<li id='y'><b id='t'>text</b></li>" + "<li id='z'>Z</li>" + "</ul>").patch(function () {
        oPatcher.openStart("ul").openEnd().unsafeHtml("<li id='a'>A</li>").openStart("li", "y").openEnd().unsafeHtml("text").close("li").unsafeHtml("<li id='b'>B</li>").close("ul");
    }, function (aMutations, oElement) {
    ...
    this.html("<ul>" + "<li id='a'>X</li>" + "<li id='b'>Y</li>" + "<li id='c'>Z</li>" + "<li id='q'>Q</li>" + "</ul>").patch(function () {
        oPatcher.openStart("ul").openEnd().unsafeHtml("<li id='a'>A</li><li id='d'>D</li>", "a", function (aDomNodes) {
        ...
        }).unsafeHtml("<li id='b'>B</li>", "b").unsafeHtml("<li id='c'>C</li>", "c").close("ul");
    }, function (aMutations, oElement) {
    ...
    this.html("<ul><li>1</li><li>2</li><li>3</li><li>4</li></ul>").patch(function () {
        oPatcher.openStart("ul").openEnd().unsafeHtml("<li id='x'>5</li>").close("ul");
    }, function (aMutations, oElement) {
    ...
    this.html("<div>A<i id='i'>B</i>C</div>").patch(function () {
        oPatcher.openStart("div").openEnd().text("A").unsafeHtml("<i id='i'>D</i>", "i").text("C").close("div");
    }, function (aMutations, oElement) {
    ...
    this.html("<div>ABC</div>").patch(function () {
        oPatcher.openStart("div").openEnd().text("A").unsafeHtml("DC").close("div");
    }, function (aMutations, oElement) {
...
QUnit.test("Patching - SVG Partial", function (assert) {
    this.html("<svg viewBox='0 0 220 100' xmlns='http://www.w3.org/2000/svg'>" + "<rect width='100' height='100' />" + "</svg>").patch(function () {
        oPatcher.openStart("svg").class("c").attr("viewBox", "0 0 220 100").attr("xmlns", "http://www.w3.org/2000/svg").openEnd().openStart("rect").attr("width", "100").attr("height", "100").openEnd().close("rect").openStart("rect").attr("x", 120).attr("width", "100").attr("height", "100").openEnd().close("rect").close("svg");
    ...
    this.html("<svg viewBox='0 0 220 100' xmlns='http://www.w3.org/2000/svg'>" + "<rect width='100' height='100' />" + "</svg>").patch(function () {
        oPatcher.openStart("svg").attr("viewBox", "0 0 220 100").attr("xmlns", "http://www.w3.org/2000/svg").openEnd().openStart("rect").attr("width", "100").attr("height", "100").openEnd().close("rect").openStart("foreignObject").attr("x", "20").attr("y", "20").openEnd().openStart("p").openEnd().text("Text").close("p").close("foreignObject").close("svg");
    }, function (aMutations, oSVG) {
...
QUnit.test("no existing elements", function (assert) {
    this.render(function () {
        oPatcher.openStart("div", "d").attr("title", "t").openEnd().openStart("div").class("x").openEnd().close("div").openStart("p").attr("data-x", "~!@#$%^&*()_+{}:<>?'\"").openEnd().close("p").openStart("div").style("width", "10px").openEnd().openStart("div").style("width", "20px").openEnd().close("div").close("div").text(0).openStart("span").openEnd().text(1).voidStart("img", "s").voidEnd().text(2).close("span").text("3 4").openStart("b").openEnd().text("b").openStart("i").openEnd().text("bi").openStart("u").openEnd().text("biu").close("u").close("i").close("b").openStart("h1").openEnd().text("<h1> & <hr>").close("h1").voidStart("hr").voidEnd().close("div");
    }, function (oElement, aMutations) {
        assert.equal(aMutations.length, 0, "No mutations during the Patcher execution");
        assert.equal(oElement.outerHTML, "<div id=\"d\" title=\"t\">" + "<div class=\"x\"></div>" + "<p data-x=\"~!@#$%^&amp;*()_+{}:<>?'&quot;\"></p>" + "<div style=\"width: 10px;\"><div style=\"width: 20px;\"></div></div>" + "0" + "<span>1<img id=\"s\">2</span>" + "3 4" + "<b>b<i>bi<u>biu</u></i></b>" + "<h1>&lt;h1&gt; &amp; &lt;hr&gt;</h1><hr>" + "</div>", "Complex structure is rendered");
    });
    this.render(function () {
        oPatcher.openStart("svg", "x").attr("viewBox", "-5 -5 10 10").attr("xmlns", "http://www.w3.org/2000/svg").openEnd().openStart("linearGradient").attr("gradientTransform", "rotate(90)").openEnd().openStart("stop").attr("offset", "5%").attr("stop-color", "gold").openEnd().close("stop").openStart("stop").attr("offset", "95%").attr("stop-color", "red").openEnd().close("stop").close("linearGradient").close("svg");
    }, function (oElement, aMutations) {
        assert.equal(aMutations.length, 0, "No mutations during the Patcher execution");
        assert.equal(oElement.outerHTML, "<svg id=\"x\" viewBox=\"-5 -5 10 10\" xmlns=\"http://www.w3.org/2000/svg\">" + "<linearGradient gradientTransform=\"rotate(90)\">" + "<stop offset=\"5%\" stop-color=\"gold\"></stop>" + "<stop offset=\"95%\" stop-color=\"red\"></stop>" + "</linearGradient>" + "</svg>", "SVG structure is rendered");
    });
    this.render(function () {
        oPatcher.openStart("div").openEnd().close("div").voidStart("img").voidEnd().openStart("p").openEnd().close("p");
    }, function (oElement, aMutations) {
        assert.equal(aMutations.length, 0, "No mutations during the Patcher execution");
...
QUnit.test("existing elements", function (assert) {
    ...
    this.render(function () {
        oPatcher.openStart("div", "outer").attr("draggable", "true").openEnd().openStart("i").attr("title", "t").openEnd().text("text").close("i").close("div");
    }, function (oElement, aMutations) {
        ...
        assert.equal(oElement.outerHTML, "<div id=\"outer\" draggable=\"true\">" + "<i title=\"t\">text</i>" + "</div>", "Output correct for the existing element");
        document.body.lastChild.remove();
    });
});
QUnit.test("unsafeHtml", function (assert) {
    this.render(function () {
        oPatcher.openStart("div").openEnd().unsafeHtml("<div></div><img><p></p><b>b<i>bi<u>biu</u></i></b><input>").close("div");
    }, function (oElement) {
        assert.equal(oElement.outerHTML, "<div>" + "<div></div><img><p></p><b>b<i>bi<u>biu</u></i></b><input>" + "</div>", "Output correct for the unsafeHtml");
    });
    this.render(function () {
        oPatcher.openStart("svg").attr("xmlns", "http://www.w3.org/2000/svg").attr("viewBox", "0 0 30 10").openEnd().unsafeHtml("<circle id=\"circle\" cx=\"5\" cy=\"5\" r=\"4\" stroke=\"blue\"></circle>", "circle", function (aElements) {
            assert.equal(aElements[0].namespaceURI, "http://www.w3.org/2000/svg", "Parsed SVG element NS is valid");
        }).close("svg");
    }, function (oElement) {
        assert.equal(oElement.outerHTML, "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 30 10\">" + "<circle id=\"circle\" cx=\"5\" cy=\"5\" r=\"4\" stroke=\"blue\"></circle>" + "</svg>", "Output correct for the SVG unsafeHtml");
