...
var testData = "<?xml version=\"1.0\" encoding=\"UTF-8\" ?>" + "<root><clients>" + "<member firstName=\"Donald\" lastName=\"Duck\"> </member>" + "<member firstName=\"Lucky\" lastName=\"Luke\"> </member>" + "<member firstName=\"Micky\" lastName=\"Mouse\"> </member>" + "<member firstName=\"Black\" lastName=\"Spider\"> </member>" + "<member firstName=\"Judge\" lastName=\"Dredd\"> </member>" + "<member firstName=\"Captain\" lastName=\"Comic\"> </member>" + "<member firstName=\"Flash\" lastName=\"Gordon\"> </member>" + "</clients> </root>";
...
QUnit.module("sap.ui.model.xml.XMLModel: BindingMode", {
    ...
    createPropertyBindingsUI: function (sName, property, sMode) {
        var aTextFields = this.aTextFields = [], i, oTextField;
        for (i = 0; i < 7; i++) {
