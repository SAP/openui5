...
var testdata = "<teamMembers xmlns=\"http://tempuri.org/x\" xmlns:a=\"http://tempuri.org/a\" xmlns:b=\"http://tempuri.org/b\">" + "<a:member firstName=\"Andreas\" lastName=\"Klark\"></a:member>" + "<a:member firstName=\"Peter\" lastName=\"Miller\"></a:member>" + "<a:member firstName=\"Gina\" lastName=\"Rush\"></a:member>" + "<b:member firstName=\"Steave\" lastName=\"Ander\"></b:member>" + "<b:member firstName=\"Michael\" lastName=\"Spring\"></b:member>" + "<b:member firstName=\"Marc\" lastName=\"Green\"></b:member>" + "<b:member firstName=\"Frank\" lastName=\"Wallace\"></b:member>" + "<test a:value=\"Namespace a\" b:value=\"Namespace b\" />" + "</teamMembers>";
