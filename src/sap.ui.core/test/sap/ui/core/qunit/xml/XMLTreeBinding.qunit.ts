...
import XMLTreeBinding from "sap/ui/model/xml/XMLTreeBinding";
import Filter from "sap/ui/model/Filter";
import FilterOperator from "sap/ui/model/FilterOperator";
import FilterType from "sap/ui/model/FilterType";
import Sorter from "sap/ui/model/Sorter";
var testData = "<root>" + "<orgStructure>" + "<level00 name=\"Peter Cliff\" gender=\"male\">" + "<level10 name=\"Inga Horst\" gender=\"female\">" + "<level20 name=\"John Wallace\" gender=\"male\"></level20>" + "<level21 name=\"Frank Wallace\" gender=\"male\"></level21>" + "<level22 name=\"Gina Rush\" gender=\"female\"></level22>" + "</level10>" + "<level11 name=\"Tom Bay\" gender=\"male\">" + "</level11>" + "<level12 name=\"Catherine Platte\" gender=\"female\">" + "</level12>" + "</level00>" + "</orgStructure>" + "<orgStructure2>" + "<level00 name=\"Inga Horst\" gender=\"female\">" + "<level10 name=\"John Wallace\" gender=\"male\"></level10>" + "<level11 name=\"Frank Wallace\" gender=\"male\"></level11>" + "<level12 name=\"Gina Rush\" gender=\"female\"></level12>" + "</level00>" + "<level00 name=\"Tom Bay\" gender=\"male\"></level00>" + "<level00 name=\"Catherine Platte\" gender=\"female\"></level00>" + "</orgStructure2>" + "<orgStructureAppControlFilter>" + "<level00 name=\"Peter Cliff\" gender=\"male\" tree=\"#1\">" + "<level10 name=\"Inga Horst\" gender=\"female\" tree=\"#1\">" + "<level20 name=\"John Doe\" gender=\"male\" tree=\"#1\"></level20>" + "<level21 name=\"Jennifer Wallace\" gender=\"female\" tree=\"#1\"></level21>" + "</level10>" + "<level11 name=\"Tom Bay\" gender=\"male\">" + "</level11>" + "<level12 name=\"Catherine Platte\" gender=\"female\">" + "</level12>" + "</level00>" + "</orgStructureAppControlFilter>" + "</root>";
...
QUnit.test("TreeBinding relative getRootContexts getNodeContexts", function (assert) {
    var treeBinding = this.createTreeBinding("orgStructure"), contexts, context;
...
QUnit.test("TreeBinding getRootContexts getNodeContexts", function (assert) {
    ...
    contexts = treeBinding.getRootContexts();
    assert.equal(contexts.length, 1, "TreeBinding rootContexts length");
    var newData = "<root>" + "<orgStructure>" + "<level00 name=\"root1\">" + "<level10 name=\"subnode1\">" + "<level20 name=\"subsubnode1\"></level20>" + "</level10>" + "</level00>" + "<level01 name=\"root2\">" + "<level10 name=\"subnode2\">" + "</level10>" + "</level01>" + "</orgStructure>" + "</root>";
...
QUnit.test("TreeBinding filters and setData again", function (assert) {
    ...
    var newData = "<root>" + "<orgStructure>" + "<level00 name=\"Peter Cliffs\" gender=\"male\">" + "<level11 name=\"Mason Storm\" gender=\"male\">" + "</level11>" + "<level12 name=\"Catherine Pallate\" gender=\"female\">" + "</level12>" + "</level00>" + "</orgStructure></root>";
    this.oModel.setXML(newData);
...
QUnit.test("TreeBinding - Application & Control filters - initial filters", function (assert) {
    var treeBinding = this.createTreeBinding("/orgStructureAppControlFilter", null, [new Filter("@tree", FilterOperator.Contains, "#1")]);
...
QUnit.test("TreeBinding - Application & Control filters - clear filters separately", function (assert) {
    var treeBinding = this.createTreeBinding("/orgStructureAppControlFilter"), filteredContext;
    treeBinding.filter(new Filter("@tree", FilterOperator.Contains, "#1"), "Application");
    treeBinding.filter(new Filter("@name", FilterOperator.Contains, "Jennifer"), FilterType.Control);
    filteredContext = treeBinding.getRootContexts();
    assert.equal(filteredContext.length, 1, "TreeBinding rootContexts length");
...
QUnit.test("Bind aggregation (not possible with XML behave normal)", function (assert) {
    var treeBinding = this.createTreeBinding("/orgStructure2"), contexts, context;
