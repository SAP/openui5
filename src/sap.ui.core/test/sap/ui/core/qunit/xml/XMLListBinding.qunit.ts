...
var testData = "<root>" + "<name>Peter</name>" + "<teamMembers>" + "<member firstName=\"Andreas\" lastName=\"Klark\" gender=\"male\">1</member>" + "<member firstName=\"Peter\" lastName=\"Miller\" gender=\"male\">2</member>" + "<member firstName=\"Gina\" lastName=\"Rush\" gender=\"female\">3</member>" + "<member firstName=\"Steave\" lastName=\"Ander\" gender=\"male\">4</member>" + "<member firstName=\"Michael\" lastName=\"Spring\" gender=\"male\">5</member>" + "<member firstName=\"Marc\" lastName=\"Green\" gender=\"male\">6</member>" + "<member firstName=\"Frank\" lastName=\"Wallace\" gender=\"male\">7</member>" + "</teamMembers>" + "<teamMembersNew>" + "<member firstName=\"Andreas\" lastName=\"Klark\" gender=\"male\">1</member>" + "<member firstName=\"Gina\" lastName=\"Rush\" gender=\"female\">2</member>" + "<member firstName=\"Steave\" lastName=\"Ander\" gender=\"male\">3</member>" + "<member firstName=\"Michael\" lastName=\"Grey\" gender=\"male\">4</member>" + "<member firstName=\"Michael\" lastName=\"Spring\" gender=\"male\">5</member>" + "<member firstName=\"Marc\" lastName=\"Green\" gender=\"male\">6</member>" + "<member firstName=\"Peter\" lastName=\"Franklin\" gender=\"male\">7</member>" + "</teamMembersNew>" + "<sortData>" + "<entry word=\"Fu\u00DF\">1</entry>" + "<entry word=\"F\u00FCssen\">1</entry>" + "<entry word=\"F\u00FC\u00DFe\">1</entry>" + "<entry word=\"Fu\u00DFball\">1</entry>" + "<entry word=\"Fussel\">1</entry>" + "<entry word=\"Funzel\">1</entry>" + "</sortData>" + "<root>" + "<nodes0 name=\"item1\">" + "<nodes1 name=\"subitem1\">" + "<nodes2 name=\"subsubitem1\">" + "<nodes3>subsubsubitem1</nodes3>" + "<nodes3>subsubsubitem2</nodes3>" + "</nodes2>" + "<nodes2 name=\"subsubitem2\" collapsed=\"true\">" + "<nodes3>subsubsubitem3</nodes3>" + "</nodes2>" + "</nodes1>" + "</nodes0>" + "<nodes0 name=\"item2\">" + "<nodes1>subitem3</nodes1>" + "</nodes0>" + "</root>" + "<changeTestProperty>SAPUI5</changeTestProperty>" + "<changingArray><entry>1</entry><entry>2</entry><entry>3</entry><entry>4</entry></changingArray>" + "</root>";
...
QUnit.test("ListBinding getCurrentContexts", function (assert) {
    var listBinding = this.createListBinding("/teamMembers/member"), currentContexts;
...
QUnit.test("ListBinding filter", function (assert) {
    var listBinding = this.createListBinding("/teamMembers/member"), oFilter, oFilter2, filtered;
...
QUnit.test("ListBinding filter (without array)", function (assert) {
    var listBinding = this.createListBinding("/teamMembers/member"), oFilter, filtered;
    oFilter = new Filter("@firstName", FilterOperator.EQ, "Peter");
    listBinding.filter(oFilter);
    filtered = listBinding.getContexts().map(function (context) {
        return context.getProperty("@firstName");
...
QUnit.test("ListBinding complex filters", function (assert) {
    var listBinding = this.createListBinding("/teamMembers/member"), oFilter1, oFilter2, oFilter3, oFilter4, filtered;
...
QUnit.test("ListBinding nested array structure", function (assert) {
    var binding0 = this.oModel.bindList("/root/nodes0", ""), binding1 = this.oModel.bindList("/root/nodes0/0/nodes1/0/nodes2", ""), binding2 = this.oModel.bindList("/root/nodes0/1/", ""), contexts;
...
QUnit.test("ListBinding getDistinctValues", function (assert) {
    var binding = this.createListBinding("/teamMembers/member"), distinctValues;
...
QUnit.test("ListBinding setSizeLimit", function (assert) {
    ...
    var oListBinding = oModel.bindList("/item"), aContexts;
