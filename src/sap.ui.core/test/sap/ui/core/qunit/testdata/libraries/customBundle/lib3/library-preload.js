...
sap.ui.predefine("testlibs/customBundle/lib3/library", ["sap/ui/core/Lib"],function(e,i){"use strict"; return e.init({name:"testlibs.customBundle.lib3",apiVersion:2,version:"1.0.0",dependencies:["sap.ui.core"],noLibraryCSS:true,controls:[]});});
