/* eslint-disable */
sap.ui.define(['exports', "sap/ui/thirdparty/jquery"], (function(exports, jQuery) { 'use strict';
  ...
  const l$j = class l{constructor(){this.list=[],this.lookup=new Set;}add(t){this.lookup.has(t)||(this.list.push(t),this.lookup.add(t));}remove(t){this.lookup.has(t)&&(this.list=this.list.filter(e=>e!==t),this.lookup.delete(t));}shift(){const t=this.list.shift();if(t)return this.lookup.delete(t),t}isEmpty(){return this.list.length===0}isAdded(t){return this.lookup.has(t)}process(t){let e;const s=new Map;for(e=this.shift();e;){const i=s.get(e)||0;if(i>10)throw new Error("Web component processed too many times this task, max allowed is: 10");t(e),s.set(e,i+1),e=this.shift();}}};
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/SAP/ui5-webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
  ...
  let t$9;const a$6 = class a{static getLegacyDateCalendarCustomizing(){return t$9===void 0&&(t$9=M$2()),t$9.legacyDateCalendarCustomizing||[]}};s$t("LegacyDateFormats",a$6);
  ...
  const r=new Map;let s$2;const u$2 = class u{constructor(e){this.packageName=e;}getText(e,...i){if(typeof e=="string"&&(e={key:e,defaultText:e}),!e||!e.key)return "";const t=A$1(this.packageName);t&&!t[e.key]&&console.warn(`Key ${e.key} not found in the i18n bundle, the default text will be used`);const l=t&&t[e.key]?t[e.key]:e.defaultText||e.key;return i$4(l,i)}};const a$3=n=>{if(r.has(n))return r.get(n);const e=new u$2(n);return r.set(n,e),e},f$4=async n=>s$2?s$2(n):(await w$1(n),a$3(n)),y$1=n=>{s$2=n;};
