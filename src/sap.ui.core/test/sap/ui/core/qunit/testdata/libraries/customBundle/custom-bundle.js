...
sap.ui.predefine("testlibs/customBundle/lib1/library", ["sap/ui/core/Core","testlibs/customBundle/lib2/library", "testlibs/customBundle/lib4/library"],function(e,i){"use strict"; return e.initLibrary({name:"testlibs.customBundle.lib1",version:"1.0.0",dependencies:["sap.ui.core","testlibs.customBundle.lib2", "testlibs.customBundle.lib4"],noLibraryCSS:true,controls:[]});});
...
sap.ui.predefine("testlibs/customBundle/lib4/library", ["sap/ui/core/Core","testlibs/customBundle/lib1/library"],function(e,i){"use strict"; return e.initLibrary({name:"testlibs.customBundle.lib4",version:"1.0.0",dependencies:["sap.ui.core","testlibs.customBundle.lib1"],noLibraryCSS:true,controls:[]});});
sap.ui.require.preload({
