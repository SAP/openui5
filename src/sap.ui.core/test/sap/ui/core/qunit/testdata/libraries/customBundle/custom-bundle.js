...
sap.ui.predefine("testlibs/customBundle/lib4/library", ["sap/ui/core/Lib","testlibs/customBundle/lib1/library"],function(e,i){"use strict"; return e.init({name:"testlibs.customBundle.lib4",apiVersion:2,version:"1.0.0",dependencies:["sap.ui.core","testlibs.customBundle.lib1"],noLibraryCSS:true,controls:[]});});
sap.ui.require.preload({
