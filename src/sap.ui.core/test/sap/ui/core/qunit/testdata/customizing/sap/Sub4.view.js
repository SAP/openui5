sap.ui.jsview("testdata.customizing.sap.Sub4", {
	...
	createContent : function(oController) {
		...
		var fnCreateDefaultContent = function(){
			var aDefaultContent = [new sap.ui.commons.TextView(that.createId("defaultContentTextView"), {text: "Extension point 1: Default Content"})];
		...
		var fnCreateDefaultContent2 = function(){
			return [ new sap.ui.commons.TextView(that.createId("iShouldBeDestroyed1"), {text: "Extension point 44: Default Content"}),
