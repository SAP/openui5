...
QUnit.test("JSON Button", function (assert) {
    var sText = "Hello", sTooltip = "abc", sWidth = "111px", sIcon = "../images/help.gif", sHelpId = "12345", sPressMessage = "Button Pressed Event!", bEnabled = false, bVisible = false, bIconFirst = false;
