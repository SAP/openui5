...
var EXPECTATIONS = {
    ...
    "both,testlibs.scenario7.lib2:json,testlibs.scenario8.lib2:json,testlibs.scenario7.lib3:js,testlibs.scenario8.lib3:js": [null, "json", "js", null, null],
    "js,testlibs.scenario7.lib2:json,testlibs.scenario8.lib2:json,testlibs.scenario7.lib3:none,testlibs.scenario8.lib3:none": [null, "json", "none", null, null],
    "json,testlibs.scenario7.lib2:none,testlibs.scenario8.lib2:none,testlibs.scenario7.lib3:js,testlibs.scenario8.lib3:js": [null, "none", "js", null, null],
    "both,testlibs.scenario7.lib4:none,testlibs.scenario8.lib4:none,testlibs.scenario7.lib5:none,testlibs.scenario8.lib5:none": [null, null, null, "none", "none"]
};
...
QUnit.test("async", function (assert) {
    ...
    var vResult = sap.ui.getCore().loadLibraries([
        "testlibs.scenario7.lib1",
        "testlibs.scenario7.lib2",
        "testlibs.scenario7.lib3",
        { name: "testlibs.scenario7.lib4", json: true },
        { name: "testlibs.scenario7.lib5", json: false }
    ]);
...
QUnit.test("sync", function (assert) {
    ...
    sap.ui.getCore().loadLibraries([
        "testlibs.scenario8.lib1",
        "testlibs.scenario8.lib2",
        "testlibs.scenario8.lib3",
        { name: "testlibs.scenario8.lib4", json: true },
        { name: "testlibs.scenario8.lib5", json: false }
    ], { async: false });
    EXPECTATIONS[cfgLibraryPreloadFiles].forEach(function (expected, idx) {
        if (expected == null) {
            return;
