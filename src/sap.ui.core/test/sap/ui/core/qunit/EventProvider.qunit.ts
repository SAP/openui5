...
QUnit.test("PreventDefault", function (assert) {
    var oObject = new EventProvider(), bExecDefault;
...
var oBubble1 = new EventProvider(), oBubble2 = new EventProvider(), oBubble3 = new EventProvider(), cancelHandler = function (event) {
    event.cancelBubble();
};
