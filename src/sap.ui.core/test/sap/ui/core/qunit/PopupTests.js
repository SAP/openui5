/* global sinon, QUnit */
sap.ui.require(["sap/ui/core/Popup","sap/m/Button", "sap/ui/events/isMouseEventDelayed", "sap/ui/Device", "sap/ui/thirdparty/jquery"],
function(Popup, Button, isMouseEventDelayed, Device, jQuery){
	"use strict";
