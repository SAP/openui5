...
QUnit.test("Currency format with sMeasure", function (assert) {
    ...
    assert.equal(oFormat.format(123456.789, "EUR").toString(), "123,456.79" + "\u00A0" + "EUR", "123456.789 EUR");
    assert.equal(oFormat.format([123456.789, "EUR"]).toString(), "123,456.79" + "\u00A0" + "EUR", "123456.789 EUR");
    assert.equal(oFormat.format(-123456.789, "EUR").toString(), "-123,456.79" + "\u00A0" + "EUR", "-123456.789 EUR");
    assert.equal(oFormat.format([-123456.789, "EUR"]).toString(), "-123,456.79" + "\u00A0" + "EUR", "-123456.789 EUR");
    assert.equal(oFormat.format(123456.789, "JPY").toString(), "123,457" + "\u00A0" + "JPY", "123456.789 JPY");
    assert.equal(oFormat.format([123456.789, "JPY"]).toString(), "123,457" + "\u00A0" + "JPY", "123456.789 JPY");
    assert.equal(oFormat.format(-123456.789, "JPY").toString(), "-123,457" + "\u00A0" + "JPY", "-123456.789 JPY");
    assert.equal(oFormat.format([-123456.789, "JPY"]).toString(), "-123,457" + "\u00A0" + "JPY", "-123456.789 JPY");
    assert.equal(oFormat.format([-123456.789, "ABC"]).toString(), "-123,456.79" + "\u00A0" + "ABC", "-123456.789 ABC");
    assert.equal(oFormat.format(123456.789, "\u00A3").toString(), "\u00A3123,456.79", "\u00A3123456.789 EUR - Not trailing because it's not a valid currency code.");
    assert.equal(oFormat.format([123456.789, "\u00A3"]).toString(), "\u00A3123,456.79", "\u00A3123456.789 EUR - Not trailing because it's not a valid currency code.");
    assert.equal(oFormat.format(-123456.789, "\u00A3").toString(), "\u00A3" + "\uFEFF" + "-123,456.79", "\u00A3-123456.789 EUR - Not trailing because it's not a valid currency code.");
    assert.equal(oFormat.format([-123456.789, "\u00A3"]).toString(), "\u00A3" + "\uFEFF" + "-123,456.79", "\u00A3-123456.789 EUR - Not trailing because it's not a valid currency code.");
});
QUnit.test("Currency format with sMeasure and style", function (assert) {
    ...
    assert.equal(oFormat.format(123456.789, "EUR").toString(), "123K" + "\u00A0" + "EUR", "123456.789 EUR");
    assert.equal(oFormat.format(123456.789, "\u00A3").toString(), "\u00A3123K", "\u00A3123456.789 - Not trailing because it's not a valid currency code.");
    oFormat = getCurrencyInstance({ style: "short" }, oLocale);
    assert.equal(oFormat.format(123456.789, "EUR").toString(), "123K" + "\u00A0" + "EUR", "123456.789 EUR");
    assert.equal(oFormat.format(123456.789, "\u00A3").toString(), "\u00A3123K", "\u00A3123456.789 - Not trailing because it's not a valid currency code.");
    oFormat = getCurrencyInstance({ style: "standard" }, oLocale);
    assert.equal(oFormat.format(123456.789, "EUR").toString(), "123,456.79" + "\u00A0" + "EUR", "123456.789 EUR");
    assert.equal(oFormat.format(123456.789, "\u00A3").toString(), "\u00A3123,456.79", "\u00A3123456.789 - Not trailing because it's not a valid currency code.");
...
QUnit.test("Currency format for locale DE", function (assert) {
    ...
    ["long", "short"].forEach(function (sStyle) {
        ...
        assert.equal(oFormat.format(123456.789, "EUR").toString(), "123.456,79" + "\u00A0" + "EUR");
        assert.equal(oFormat.format(-123456.789, "JPY").toString(), "-123.457" + "\u00A0" + "JPY");
        assert.equal(oFormat.format(47123456.789, "EUR").toString(), "47" + "\u00A0" + "Mio." + "\u00A0" + "EUR");
        assert.equal(oFormat.format(-47123456.789, "JPY").toString(), "-47" + "\u00A0" + "Mio." + "\u00A0" + "JPY");
    });
});
QUnit.test("Currency format with different parameters undefined", function (assert) {
    ...
    assert.equal(oFormat.format(1234.5728, "FOB"), "F" + "\u00A0" + "1,234.573", "formatted both");
});
QUnit.test("Currency format with sMeasure - unknown currency", function (assert) {
    var oFormat = getCurrencyInstance();
    assert.equal(oFormat.format(123456.789, "\u00A3").toString(), "\u00A3123,456.79", "\u00A3123456.789");
    assert.equal(oFormat.format([-123456.789, "\u00A3"]).toString(), "\u00A3\uFEFF-123,456.79", "\u00A3-123456.789");
    assert.equal(oFormat.format(123456.789, "ASDEF").toString(), "ASDEF" + "\u00A0" + "123,456.79", "ASDEF 123456.789");
    assert.equal(oFormat.format([-123456.789, "ASDEF"]).toString(), "ASDEF" + "\uFEFF" + "-123,456.79", "ASDEF -123456.789");
    assert.equal(oFormat.format(123456.789, undefined).toString(), "123,456.79", "123456.79 undefined");
    assert.equal(oFormat.format(-123456.789, undefined).toString(), "-123,456.79", "-123456.79 undefined");
    assert.equal(oFormat.format([123456.789, undefined]).toString(), "123,456.79", "123456.79 undefined");
...
QUnit.test("Currency Format with fraction as decimals", function (assert) {
    ...
    assert.equal(oFormat.format(2, "EUR"), "2.000000" + "\u00A0" + "EUR", "fractions should set the decimals if not specified");
});
...
QUnit.test("Currency format with custom number of decimals", function (assert) {
    ...
    assert.equal(oFormat.format(123456.789, "CZK"), "CZK\u00A0" + "123,456.79", "123456.789 CZK");
    assert.equal(oFormat.format(123456.789, "BTC"), "BTC\u00A0" + "123,456.79", "123456.79 BTC");
    ...
    assert.equal(oFormat.format(123456.789, "CZK"), "CZK\u00A0" + "123,456.789", "123456.789 CZK");
    assert.equal(oFormat.format(123456.789, "BTC"), "BTC\u00A0" + "123,456.78900", "123456.789 BTC");
    ...
    assert.equal(oFormat.format(123456.789, "EUR"), "\u20AC" + "123,456.8", "123456.789 EUR");
    assert.equal(oFormat.format(123456.789, "MON"), "MON\u00A0" + "123,456.789000", "123456.789 MON");
    sap.ui.getCore().getConfiguration().getFormatSettings().setCustomCurrencies();
    oFormat = getCurrencyInstance({
        currencyCode: false
    });
    ...
    assert.equal(oFormat.format(123456.789, "JPY"), "\u00A5" + "123,457", "123456.789 YEN");
    assert.equal(oFormat.format(123456.789, "CZK"), "CZK\u00A0" + "123,456.79", "123456.789 CZK");
    assert.equal(oFormat.format(123456.789, "BTC"), "BTC\u00A0" + "123,456.79", "123456.789 BTC");
});
...
QUnit.test("Format using currency instance", function (assert) {
    ...
    var sFormatted = oFormat.format(123456.789, "EUR");
    ...
    var sFormatted2 = oFormat2.format(123456.789, "EUR");
    ...
    assert.equal(oFormat3.format(123456.789, "\u0243").toString(), "", "Empty string formatted");
...
QUnit.test("Missing decimals information in defined custom currencies", function (assert) {
    ...
    assert.equal(sFormatted.toString(), "123,456.79" + "\u00A0" + "BTC", "Default decimals are 2");
});
QUnit.test("Custom Currencies defined via currency instance options", function (assert) {
    ...
    assert.equal(sFormatted, "123,456.789" + "\u00A0" + "BTC", "BTC 123,456.789");
    ...
    assert.equal(sFormatted2, "\u0243\u00A0123,456.789", "\u0243\u00A0123,456.789");
    ...
    assert.equal(sFormatted3, "123.456,789" + "\u00A0" + "BTC", "123.456,789 BTC");
    ...
    assert.equal(sFormatted4, "123.456,789" + "\u00A0" + "\u0243", "123.456,789 \u0243");
    ...
    assert.equal(sFormatted5, "123,456.789" + "\u00A0" + "\u0243", "123,456.789 \u0243");
    ...
    assert.equal(sFormatted6.toString(), "\u0243" + "\u00A0" + "123,456.789", "\u0243 123,456.789");
...
QUnit.test("'decimals' set on FormatOptions and custom currency", function (assert) {
    ...
    assert.equal(oFormatDE.format(1234.5728, "HOD"), "1.234,5728" + "\u00A0" + "H$", "formatted with 4 decimals - de");
});
QUnit.test("'decimals' only set on format-options", function (assert) {
    ...
    assert.equal(oFormatDE.format(1234.5728, "HUF"), "1.234,6" + "\u00A0" + "HUF", "formatted with default 2 decimals - de");
});
QUnit.test("no 'decimals' set at all", function (assert) {
    ...
    assert.equal(oFormatDE.format(1234.5728, "HUF"), "1.235" + "\u00A0" + "HUF", "formatted with default 2 decimals - de");
});
...
QUnit.test("Format with currency symbol w/o symbol mixed in", function (assert) {
    ...
    assert.equal(sFormatted, "\u0243" + "\u00A0" + "123,456.789", "'\u0243\u00A0123,456.789' is formatted");
...
QUnit.test("Format with currency symbol with isoCode lookup", function (assert) {
    ...
    assert.equal(oFormat.format(123456.789, "Bitcoin"), "\u0243" + "\u00A0" + "123,456.789", "\u0243\u00A0123,456.789 - symbol lookup in global configuration.");
    ...
    assert.equal(oFormat.format(123456.789, "DOLLAR"), "DOLLAR" + "\u00A0" + "123,456.7890", "DOLLAR 123,456.7890.");
...
QUnit.test("Format with currencies with symbol from global config", function (assert) {
    ...
    assert.equal(oFormat.format(123456.789, "BTC"), "\u0243" + "\u00A0" + "123,456.79", "\u0243\u00A0123,456.79 - symbol lookup in global configuration.");
    assert.deepEqual(oFormat.parse(oFormat.format(123456.789, "BTC")), [123456.79, "BTC"], "[123456.79, 'BTC']");
    assert.equal(oFormat.format(123456.789, "Bitcoin"), "Bitcoin" + "\u00A0" + "123,456.789", "Bitcoin\u00A0123,456.789 - No symbol found");
    assert.deepEqual(oFormat.parse(oFormat.format(123456.789, "Bitcoin")), [123456.789, "Bitcoin"], "[123456.789, 'Bitcoin']");
    assert.equal(oFormat.format(123456.789, "DOLLAR"), "DOLLAR" + "\u00A0" + "123,456.7890", "DOLLAR 123,456.7890.");
    assert.deepEqual(oFormat.parse(oFormat.format(123456.789, "DOLLAR")), [123456.789, "DOLLAR"], "[123456.789, 'DOLLAR']");
});
QUnit.test("Format with currencies from global config", function (assert) {
    ...
    assert.equal(oFormat.format(123456.789, "BTC").toString(), "123,456.79" + "\u00A0" + "BTC", "\u0243\u00A0123,456.79 - symbol lookup in global configuration.");
    assert.deepEqual(oFormat.parse(oFormat.format(123456.789, "BTC").toString()), [123456.79, "BTC"], "[123456.79, 'BTC']");
    assert.equal(oFormat.format(123456.789, "Bitcoin").toString(), "123,456.789" + "\u00A0" + "Bitcoin", "Bitcoin\u00A0123,456.789 - No symbol found");
    assert.deepEqual(oFormat.parse(oFormat.format(123456.789, "Bitcoin").toString()), [123456.789, "Bitcoin"], "[123456.789, 'Bitcoin']");
    assert.equal(oFormat.format(123456.789, "DOLLAR").toString(), "123,456.7890" + "\u00A0" + "DOLLAR", "DOLLAR 123,456.7890.");
    assert.deepEqual(oFormat.parse(oFormat.format(123456.789, "DOLLAR").toString()), [123456.789, "DOLLAR"], "[123456.789, 'DOLLAR']");
});
...
QUnit.test("Custom Currencies instance overwrites global configuration", function (assert) {
    ...
    assert.equal(oFormat1.format(12345.6789, "DOLLAR"), "12,345.679" + "\u00A0" + "DOLLAR", "DOLLAR 12,345.679");
...
QUnit.test("Currencies with numbers in their names", function (assert) {
    ...
    assert.equal(oFormatEN.format(1234.5678, "4DOL"), "1,234.57" + "\u00A0" + "4DOL", "format in English locale - number at the start");
    ...
    assert.equal(oFormatEN.format(1234.5678, "DO"), "1,234.5678" + "\u00A0" + "DO", "format in English locale - number at the start");
    ...
    assert.equal(oFormatEN.format(1234.5678, "D4OL"), "1,234.6" + "\u00A0" + "D4OL", "format in English locale - number in the middle");
    ...
    assert.equal(oFormatEN.format(1234.5678, "DOL4"), "1,234.568" + "\u00A0" + "DOL4", "format in English locale - number at the end");
    ...
    assert.equal(oFormatEN.format(-1234.56789, "DO"), "-1,234.5679" + "\u00A0" + "DO", "format in English locale - short match");
    ...
    assert.equal(oFormatDE.format(1234.5678, "4DOL"), "1.234,57" + "\u00A0" + "4DOL", "format in German locale - number at the start");
    ...
    assert.equal(oFormatDE.format(1234.5678, "DO"), "1.234,5678" + "\u00A0" + "DO", "format in German locale - short match");
    ...
    assert.equal(oFormatDE.format(1234.5678, "D4OL"), "1.234,6" + "\u00A0" + "D4OL", "format in German locale - number in the middle");
    ...
    assert.equal(oFormatDE.format(1234.5678, "DOL4"), "1.234,568" + "\u00A0" + "DOL4", "format in German locale - number at the end");
    ...
    assert.equal(oFormatDE.format(-1234.56789, "DO"), "-1.234,5679" + "\u00A0" + "DO", "format in German locale - short match");
...
QUnit.test("Currencies with numbers in their names - currencyCode: false", function (assert) {
    ...
    assert.equal(oFormatEN.format(1234.5678, "4DOL"), "!!\u00A01,234.57", "format in English locale - number at the start");
    ...
    assert.equal(oFormatEN.format(1234.5678, "D4OL"), "\u00A7\u00A01,234.6", "format in English locale - number in the middle");
    ...
    assert.equal(oFormatDE.format(1234.5678, "4DOL"), "1.234,57" + "\u00A0" + "!!", "format in German locale - number at the start");
    ...
    assert.equal(oFormatDE.format(1234.5678, "D4OL"), "1.234,6" + "\u00A0" + "\u00A7", "format in German locale - number in the middle");
    ...
    assert.equal(oFormatDE.format(1234.5678, "DOL4"), "1.234,568" + "\u00A0" + "$", "format in German locale - number at the end");
    ...
    assert.equal(oFormatDE.format(1234.5678, "DO"), "1.234,5678" + "\u00A0" + "My#", "format in German locale - short match");
...
QUnit.test("Currencies with numbers in their names - currencyContext: 'accounting'", function (assert) {
    ...
    assert.equal(oFormatEN.format(1234.5678, "4DOL"), "1,234.57\u00A04DOL", "format in English locale - number at the start");
    assert.equal(oFormatEN.format(-1234.5678, "4DOL"), "(1,234.57\u00A04DOL)", "format in English locale - number at the start");
    assert.equal(oFormatEN.format(1234.5678, "DO"), "1,234.5678\u00A0DO", "format in English locale - short match");
    assert.equal(oFormatEN.format(-1234.5678, "DO"), "(1,234.5678\u00A0DO)", "format in English locale - short match");
    assert.equal(oFormatEN.format(1234.5678, "D4OL"), "1,234.6\u00A0D4OL", "format in English locale - number in the middle");
    assert.equal(oFormatEN.format(-1234.5678, "D4OL"), "(1,234.6\u00A0D4OL)", "format in English locale - number in the middle");
    assert.equal(oFormatEN.format(1234.5678, "DOL4"), "1,234.568\u00A0DOL4", "format in English locale - number at the end");
...
QUnit.test("Currencies with numbers in their names - Log", function (assert) {
    ...
    assert.ok(oLogSpy.calledOnceWith("Symbol '$' is defined multiple times in custom currencies.", undefined, "NumberFormat"), "Correct error log is displayed.");
...
QUnit.test("Multiple custom currencies with same currency symbol", function (assert) {
    ...
    assert.equal(oFormat.format(12345.6789, "MON"), "12,345.68" + "\u00A0" + "MON", "MON 12,345.68");
    assert.equal(oFormat.format(12345.6789, "MONERO"), "12,345.67890" + "\u00A0" + "MONERO", "MONERO 12,345.6789");
...
QUnit.test("decimals = 0", function (assert) {
    ...
    assert.equal(oFormatDE.format(1234.5728, "HOD"), "1.235" + "\u00A0" + "H$", "formatted both - de");
});
...
QUnit.test("Parse simple number", function (assert) {
    ...
    assert.deepEqual(oFormat.parse("IOTA" + "\u00A0" + "123.45788888"), ["123.45788888", "IOTA"], "['123.4578888', 'IOTA']");
    assert.deepEqual(oFormat.parse("DOLLAR" + "\u00A0" + "123,456.789"), ["123456.789", "DOLLAR"], "['123456.789', 'DOLLAR']");
    assert.deepEqual(oFormat.parse("DOLLAR" + "\u00A0" + "9,007,199,254,740,991.000"), ["9007199254740991.000", "DOLLAR"], "['9007199254740991.000', 'DOLLAR']");
    assert.deepEqual(oFormat.parse("DOLLAR" + "\u00A0" + "9,007,199,254,740,991,678.000"), ["9007199254740991678.000", "DOLLAR"], "['9007199254740991678.000', 'DOLLAR']");
});
...
QUnit.test("Currency format with showMeasure true and currencyContext accounting", function (assert) {
    ...
    assert.equal(oFormat.format(123456.789, "EUR"), "123,456.79" + "\u00A0" + "EUR", "123456.789 EUR");
    assert.equal(oFormat.format([123456.789, "EUR"]), "123,456.79" + "\u00A0" + "EUR", "123456.789 EUR");
    assert.equal(oFormat.format(-123456.789, "EUR"), "(123,456.79" + "\u00A0" + "EUR)", "123456.789 EUR");
    assert.equal(oFormat.format([-123456.789, "EUR"]), "(123,456.79" + "\u00A0" + "EUR)", "123456.789 EUR");
});
...
QUnit.test("Currency format with sMeasure and set decimal option to overwrite the default number of decimal", function (assert) {
    ...
    assert.equal(oFormat.format(123456.789, "EUR"), "123,456.8" + "\u00A0" + "EUR", "123456.789 EUR");
    assert.equal(oFormat.format([123456.789, "EUR"]), "123,456.8" + "\u00A0" + "EUR", "123456.789 EUR");
    assert.equal(oFormat.format(-123456.789, "EUR"), "-123,456.8" + "\u00A0" + "EUR", "123456.789 EUR");
    assert.equal(oFormat.format([-123456.789, "EUR"]), "-123,456.8" + "\u00A0" + "EUR", "123456.789 EUR");
});
QUnit.test("Currency format with sMeasure and the precision option should be ignored", function (assert) {
    ...
    assert.equal(oFormat.format(123456, "EUR"), "123,456.00" + "\u00A0" + "EUR", "123456 EUR");
    assert.equal(oFormat.format([123456.7, "EUR"]), "123,456.70" + "\u00A0" + "EUR", "123456.7 EUR");
    assert.equal(oFormat.format(-123456.78, "EUR"), "-123,456.78" + "\u00A0" + "EUR", "-123456.78 EUR");
    assert.equal(oFormat.format([-123456.789, "EUR"]), "-123,456.79" + "\u00A0" + "EUR", "-123456.789 EUR");
});
QUnit.test("Currency format with sMeasure and style short. The default precision option shouldn't be ignored", function (assert) {
    ...
    assert.equal(oFormat.format(123456, "EUR"), "123K" + "\u00A0" + "EUR", "123456 EUR");
    assert.equal(oFormat.format([1234567.8, "EUR"]), "1.2M" + "\u00A0" + "EUR", "123456.7 EUR");
    assert.equal(oFormat.format(12345678.9, "EUR"), "12M" + "\u00A0" + "EUR", "-123456.78 EUR");
});
QUnit.test("check space between currency code and number in different scenarios", function (assert) {
    var oCurrencyCodeFormatter = getCurrencyInstance(), oCurrencySymbolFormatter = getCurrencyInstance({
        currencyCode: false
    });
    assert.equal(oCurrencyCodeFormatter.format(123456.789, "EUR"), "123,456.79" + "\u00A0" + "EUR", "123456.789 EUR");
    assert.equal(oCurrencyCodeFormatter.format(-123456.789, "EUR"), "-123,456.79" + "\u00A0" + "EUR", "-123456.789 EUR");
    ...
    assert.equal(oCurrencySymbolFormatter.format(123456.789, "EUR"), "123.456,79" + "\u00A0" + "\u20AC", "123456.789 EUR");
    assert.equal(oCurrencySymbolFormatter.format(-123456.789, "EUR"), "-123.456,79" + "\u00A0" + "\u20AC", "-123456.789 EUR");
    assert.equal(oCurrencySymbolFormatter.format(123456.789, "HKD"), "123.456,79" + "\u00A0" + "HK$", "123456.789 HKD");
    assert.equal(oCurrencySymbolFormatter.format(-123456.789, "HKD"), "-123.456,79" + "\u00A0" + "HK$", "-123456.789 HKD");
    ...
    assert.equal(oCurrencyCodeFormatter.format(123456.789, "UAH"), "123" + "\u00A0" + "456,79" + "\u00A0" + "UAH", "123456.789 UAH");
    assert.equal(oCurrencyCodeFormatter.format(-123456.789, "UAH"), "-123" + "\u00A0" + "456,79" + "\u00A0" + "UAH", "-123456.789 UAH");
    assert.equal(oCurrencySymbolFormatter.format(123456.789, "UAH"), "123" + "\u00A0" + "456,79" + "\u00A0\u20B4", "123456.789 UAH");
    assert.equal(oCurrencySymbolFormatter.format(-123456.789, "UAH"), "-123" + "\u00A0" + "456,79" + "\u00A0\u20B4", "-123456.789 UAH");
    assert.equal(oCurrencySymbolFormatter.format(123456.789, "UAK"), "123" + "\u00A0" + "456,79" + "\u00A0\u043A\u0440\u0431.", "123456.789 UAK");
    assert.equal(oCurrencySymbolFormatter.format(-123456.789, "UAK"), "-123" + "\u00A0" + "456,79" + "\u00A0\u043A\u0440\u0431.", "-123456.789 UAK");
});
...
QUnit.test("format/parse indian lakhs/crores", function (assert) {
    ...
    var oFormat = getCurrencyInstance({}, oLocale);
    assert.equal(oFormat.format(100000, "INR"), "1,00,000.00" + "\u00A0" + "INR", "INR is formatted with correct grouping");
    assert.equal(oFormat.format(10000000, "INR"), "1,00,00,000.00" + "\u00A0" + "INR", "INR is formatted with correct grouping");
    assert.equal(oFormat.format(10000000000, "INR"), "1,000,00,00,000.00" + "\u00A0" + "INR", "INR is formatted with correct grouping");
    assert.equal(oFormat.format(1000000000000, "INR"), "1,00,000,00,00,000.00" + "\u00A0" + "INR", "INR is formatted with correct grouping");
    assert.equal(oFormat.format(100000000000000, "INR"), "1,00,00,000,00,00,000.00" + "\u00A0" + "INR", "INR is formatted with correct grouping");
    oFormat = getCurrencyInstance({ style: "short" }, oLocale);
    assert.equal(oFormat.format(100000, "INR"), "1 Lk" + "\u00A0" + "INR", "INR is formatted as Lk/Cr");
    assert.equal(oFormat.format(10000000, "INR"), "1 Cr" + "\u00A0" + "INR", "INR is formatted as Lk/Cr");
    assert.equal(oFormat.format(10000000000, "INR"), "1,000 Cr" + "\u00A0" + "INR", "INR is formatted as Lk/Cr");
    assert.equal(oFormat.format(1000000000000, "INR"), "1 Lk Cr" + "\u00A0" + "INR", "INR is formatted as Lk/Cr");
    assert.equal(oFormat.format(100000000000000, "INR"), "1 Cr Cr" + "\u00A0" + "INR", "INR is formatted as Lk/Cr");
    assert.equal(oFormat.format(100000, "USD"), "100K" + "\u00A0" + "USD", "USD is formatted as M/B/T");
    assert.equal(oFormat.format(1000000, "USD"), "1M" + "\u00A0" + "USD", "USD is formatted as M/B/T");
    assert.equal(oFormat.format(1000000000, "USD"), "1B" + "\u00A0" + "USD", "USD is formatted as M/B/T");
