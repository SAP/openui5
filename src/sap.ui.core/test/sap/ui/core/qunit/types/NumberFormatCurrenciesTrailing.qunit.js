...
sap.ui.define(["sap/ui/core/format/NumberFormat", "sap/ui/core/Locale", "sap/ui/core/LocaleData", "sap/base/Log"], function (NumberFormat, Locale, LocaleData, Log) {
	...
	*/
	...
	QUnit.test("Format with currencies from global config", function (assert) {
		...
		assert.equal(oFormat.format(123456.789, "BTC").toString(), "123,456.79" + "\xa0" + "BTC", "Ƀ 123,456.79 - symbol lookup in global configuration.");
		assert.deepEqual(oFormat.parse(oFormat.format(123456.789, "BTC").toString()), [123456.79, "BTC"], "[123456.79, 'BTC']");
		assert.equal(oFormat.format(123456.789, "Bitcoin").toString(), "123,456.789" + "\xa0" + "Bitcoin", "Bitcoin 123,456.789 - No symbol found");
