...
function getHex(i, binary) {
    switch (i) {
        case 1: return binary ? "0x800" : "0x7d0";
        case 2: return binary ? "0x200000" : "0x1e8480";
        case 3: return binary ? "0x80000000" : "0x77359400";
        case 4: return binary ? "0x20000000000" : "0x1d1a94a2000";
        case 5: return binary ? "0x8000000000000" : "0x71afd498d0000";
        case 6: return binary ? "0x2000000000000000" : "0x1bc16d674ec80000";
        case 7: return binary ? "0x800000000000000000" : "0x6c6b935b8bbd400000";
        case 8: return binary ? "0x200000000000000000000" : "0x1a784379d99db40000000";
        default: return "0x0";
    }
}
