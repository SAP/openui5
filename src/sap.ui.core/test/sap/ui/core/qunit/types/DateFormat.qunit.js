sap.ui.define([
	...
	QUnit.module("DateFormat - format relative with timezone America/Los_Angeles", {
		beforeEach: function () {
	...
	QUnit.module("DateFormat - parse using pattern in UTC", {
		beforeEach: function () {
	...
	QUnit.module("DateFormat - format Asia/Tokyo", {
		beforeEach: function () {
	...
	QUnit.module("DateFormat - format with timezone Etc/UTC", {
		beforeEach: function () {
			Localization.setTimezone("Etc/UTC");
		},
		afterEach: function () {
	...
	QUnit.module("DateFormat - format with timezone Europe/Berlin", {
		beforeEach: function () {
			Localization.setTimezone("Europe/Berlin");
		},
		afterEach: function () {
	...
	QUnit.module("DateFormat - format with timezone Asia/Calcutta", {
		beforeEach: function () {
	...
	QUnit.module("DateFormat - format relative");
	...
	//*********************************************************************************************
	QUnit.module("DateFormat - relative to", {
		beforeEach: function () {
			Localization.setTimezone("Europe/Berlin");
		},
		afterEach: function () {
	...
	//*********************************************************************************************
	QUnit.module("DateFormat - 'now' for different time zones", {
		beforeEach: function () {
	...
	QUnit.module("DateFormat - German summer time 28.03.2021 (2h->3h) (offset: +2 -> +1)", {
		beforeEach: function () {
			Localization.setTimezone("Europe/Berlin");
	...
	QUnit.module("DateFormat - German winter time 31.10.2021 (3h->2h) (offset: +1 -> +2)", {
		beforeEach: function () {
			Localization.setTimezone("Europe/Berlin");
...
[
	...
	QUnit.module("DateFormat - Calendar Week precedence", {
		beforeEach: function () {
	...
	QUnit.module("DateFormat - Scaling: Relative Time Formatter", {
		beforeEach: function () {
	...
	QUnit.module("DateFormat - Islamic Date in locale en");
	...
	QUnit.module("DateFormat - Islamic Date in other locales", {
		beforeEach: function () {
...
["ar", "ar_EG", "ar_SA", "he"].forEach(function (sLocale, index) {
	...
	QUnit.module("DateFormat - Japanese Date");
	...
	QUnit.module("DateFormat - Japanese Date in locale en");
	...
	QUnit.module("DateFormat - Persian Date");
	...
	QUnit.module("DateFormat - Persian Date in locale en");
	...
	QUnit.module("DateFormat - Buddhist Date");
	...
	QUnit.module("DateFormat - Buddhist Date in locale en");
...
[
	...
	QUnit.module("DateFormat - interval options validation", {
		beforeEach: function (assert) {
	...
	QUnit.module("DateFormat - interval behavior");
	...
	QUnit.module("DateFormat - format & parse interval");
	...
	QUnit.module("DateFormat - Interval parse in addition");
	...
	QUnit.module("DateFormat - FallbackFormatOptions");
	...
	QUnit.module("DateFormat - Timezone pattern symbol VV", {
		beforeEach: function () {
			Localization.setTimezone("Europe/Berlin");
		},
		afterEach: function () {
	...
	QUnit.module("DateFormat - timezone Australia/Sydney", {
		beforeEach: function () {
	...
	QUnit.module("DateFormat - timezone Europe/Berlin", {
		beforeEach: function () {
			Localization.setTimezone("Europe/Berlin");
		},
		afterEach: function () {
	...
	QUnit.module("DateFormat - timezone America/Adak", {
		beforeEach: function () {
	...
	QUnit.module("DateFormat - timezone Pacific/Kiritimati", {
		beforeEach: function () {
	...
	QUnit.module("DateFormat - timezone America/New_York", {
		beforeEach: function () {
			Localization.setTimezone("America/New_York");
		},
		afterEach: function () {
	...
	//*****************************************************************************************************************
	QUnit.module("DateFormat - pattern symbols", {
		beforeEach: function () {
