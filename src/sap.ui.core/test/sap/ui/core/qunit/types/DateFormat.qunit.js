...
["getDateInstance", "getDateTimeInstance", "getTimeInstance"].forEach(function (sMethod) {
	...
	QUnit.test("DateFormat: alternative month abbreviations (integrative test)", function (assert) {
		...
		var oDateFormat = DateFormat.getDateInstance(),
			oDate = UI5Date.getInstance(2023, 8, 15);
	...
	QUnit.test("DateFormat#init", function (assert) {
		var oLocalData = {
				_getMonthsWithAlternatives: function () {},
				_getMonthsStandAloneWithAlternatives: function () {},
				getDayPeriods: function () {},
				getDays: function () {},
				getDaysStandAlone: function () {},
				getEras: function () {},
				getFlexibleDayPeriods: function () {},
				getFlexibleDayPeriodsStandAlone: function () {},
				getMonths: function () {},
				getMonthsStandAlone: function () {},
				getQuarters: function () {},
				getQuartersStandAlone: function () {}
			},
			oDateFormat = {
				oFormatOptions: {calendarType: "~calendarType", pattern: "~pattern"},
				oLocaleData: oLocalData,
				getAllowedCharacters: function () {},
				parseCldrDatePattern: function () {}
			},
			oLocalDataMock = this.mock(oLocalData);
	...
	QUnit.test("DateFormat#findEntry", function (assert) {
		var oParseHelperMock = this.mock(DateFormat._oParseHelper);
	...
	QUnit.test("oSymbols.M#format: abbreviations contains array", function (assert) {
		var oField = {digits: 3},
			oFormat = {aMonthsAbbrev: ["foo", "bar", ["baz", "qux"]]};
	...
	QUnit.test("oSymbols.L#format: abbreviations contains array", function (assert) {
		var oField = {digits: 3},
			oFormat = {aMonthsAbbrevSt: ["foo", "bar", ["baz", "qux"]]};
