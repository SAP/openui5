...
jQuery(function () {
    ...
    oRoot.append(container(true, null, "Visible", [nl(), popup(1, false, false, false, "NONE", []), popup(2, false, true, false, "DOCK", []), popup(3, false, true, false, "SCOPE", []), nl(), popup(4, true, false, false, "NONE", []), popup(5, true, false, false, "SCOPE", []), popup(6, true, false, false, "SCOPE", [popup(7, false, true, true, "DOCK", [])])], true, sStyle));
