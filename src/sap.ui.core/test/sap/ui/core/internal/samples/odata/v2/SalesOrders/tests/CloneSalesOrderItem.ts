...
opaTest("(XI) Clone a sales order item and expand product information", function (Given, When, Then) {
    ...
    Then.onMainPage.checkTableRowsEqualInColumns(0, 1, ["SalesOrderID", "ProductID", "Quantity", "Unit", "GrossAmount", "Currency"]);
