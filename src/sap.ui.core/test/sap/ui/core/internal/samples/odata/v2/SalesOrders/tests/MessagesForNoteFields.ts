...
Helper.qUnitModule("sap.ui.core.internal.samples.odata.v2.SalesOrders - Messages For Note Fields");
opaTest("Change note and check for messages", function (Given, When, Then) {
    ...
    [{
        ...
        Then.onMainPage.checkValueStateOfField(0, "Note", oFixture.valueState, oFixture.messageKey);
