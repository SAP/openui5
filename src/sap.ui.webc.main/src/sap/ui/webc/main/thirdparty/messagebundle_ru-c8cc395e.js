sap.ui.define(['exports'], function (exports) { 'use strict';
	...
	var messagebundle_ru = {
		...
		SEGMENTEDBUTTON_ARIA_DESCRIBEDBY: "Для выбора элемента нажмите пробел или Enter",
		...
		TABLE_ROW_POSITION: "{0} из {1}",
		TABLE_GROUP_ROW_ARIA_LABEL: "Строка заголовка группы",
