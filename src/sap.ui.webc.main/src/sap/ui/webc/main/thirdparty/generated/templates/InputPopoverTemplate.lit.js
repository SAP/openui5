sap.ui.define(["exports", "sap/ui/webc/common/thirdparty/base/renderer/LitRenderer"], function (_exports, _LitRenderer) {
  ...
  function block14(context, tags, suffix, item, index) {
    return suffix ? (0, _LitRenderer.html)`<${(0, _LitRenderer.scopeTag)("ui5-li-suggestion-item", tags, suffix)} image="${(0, _LitRenderer.ifDefined)(item.image)}" icon="${(0, _LitRenderer.ifDefined)(item.icon)}" additional-text="${(0, _LitRenderer.ifDefined)(item.additionalText)}" type="${(0, _LitRenderer.ifDefined)(item.type)}" additional-text-state="${(0, _LitRenderer.ifDefined)(item.additionalTextState)}" data-ui5-key="${(0, _LitRenderer.ifDefined)(item.key)}">${(0, _LitRenderer.unsafeHTML)(item.text)}${item.description ? block15.call(this, context, tags, suffix, item, index) : undefined}</${(0, _LitRenderer.scopeTag)("ui5-li-suggestion-item", tags, suffix)}>` : (0, _LitRenderer.html)`<ui5-li-suggestion-item image="${(0, _LitRenderer.ifDefined)(item.image)}" icon="${(0, _LitRenderer.ifDefined)(item.icon)}" additional-text="${(0, _LitRenderer.ifDefined)(item.additionalText)}" type="${(0, _LitRenderer.ifDefined)(item.type)}" additional-text-state="${(0, _LitRenderer.ifDefined)(item.additionalTextState)}" data-ui5-key="${(0, _LitRenderer.ifDefined)(item.key)}">${(0, _LitRenderer.unsafeHTML)(item.text)}${item.description ? block15.call(this, context, tags, suffix, item, index) : undefined}</ui5-li-suggestion-item>`;
  }
