sap.ui.define(['exports'], function (exports) { 'use strict';
	...
	var messagebundle_ja = {
		...
		COLOR_PALETTE_DIALOG_CANCEL_BUTTON: "中止",
		...
		MESSAGE_STRIP_CLOSE_BUTTON: "メッセージストリップ \"閉じる\"",
		...
		SWITCH_OFF: "オフ",
		LOAD_MORE_TEXT: "詳細",
		TABLE_HEADER_ROW_TEXT: "ヘッダ行",
		TABLE_ROW_POSITION: "{0} / {1}",
		TABLE_GROUP_ROW_ARIA_LABEL: "グループヘッダ行",
		ARIA_LABEL_ROW_SELECTION: "アイテム選択",
		ARIA_LABEL_SELECT_ALL_CHECKBOX: "全行を選択",
		TABCONTAINER_NEXT_ICON_ACC_NAME: "次",
		TABCONTAINER_PREVIOUS_ICON_ACC_NAME: "前",
		TABCONTAINER_OVERFLOW_MENU_TITLE: "オーバーフローメニュー",
		TEXTAREA_CHARACTERS_LEFT: "{0} 文字残っています",
		TEXTAREA_CHARACTERS_EXCEEDED: "上限を {0} 文字超過しました",
		TIMEPICKER_HOURS_LABEL: "時間",
		TIMEPICKER_MINUTES_LABEL: "分",
		TIMEPICKER_SECONDS_LABEL: "秒",
		TIMEPICKER_PERIODS_LABEL: "午前/午後",
		TIMEPICKER_SUBMIT_BUTTON: "OK",
		TIMEPICKER_CANCEL_BUTTON: "中止",
