sap.ui.define(['exports'], function (exports) { 'use strict';
	...
	var messagebundle_ru = {
		...
		CAROUSEL_OF_TEXT: "из",
		CAROUSEL_DOT_TEXT: "Отображается элемент {0} из {1}",
		...
		MESSAGE_STRIP_CLOSE_BUTTON: "Строка сообщения для статуса Закрыто",
		...
		SEGMENTEDBUTTON_ARIA_DESCRIPTION: "Кнопка сегментации",
		SLIDER_ARIA_DESCRIPTION: "Ползунок",
		SWITCH_ON: "Вкл.",
		SWITCH_OFF: "Выкл.",
		LOAD_MORE_TEXT: "Больше",
		TABLE_HEADER_ROW_TEXT: "Строка заголовка",
		ARIA_LABEL_ROW_SELECTION: "Выбор элемента",
		ARIA_LABEL_SELECT_ALL_CHECKBOX: "Выбрать все строки",
		...
		TREE_ITEM_ARIA_LABEL: "Позиция дерева",
