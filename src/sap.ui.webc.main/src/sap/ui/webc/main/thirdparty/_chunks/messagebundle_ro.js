sap.ui.define(['exports'], function (exports) { 'use strict';
	...
	var messagebundle_ro = {
		...
		SELECT_ROLE_DESCRIPTION: "Selectare casetă combinată",
		...
		MULTIINPUT_SHOW_MORE_TOKENS: "Încă {0}",
		...
		TABLE_HEADER_ROW_TEXT: "Linie antet",
		TABLE_ROW_POSITION: "{0} din {1}",
		TABLE_GROUP_ROW_ARIA_LABEL: "Linie antet de grup",
		ARIA_LABEL_ROW_SELECTION: "Selecție poziție",
		ARIA_LABEL_SELECT_ALL_CHECKBOX: "Selectare toate liniile",
