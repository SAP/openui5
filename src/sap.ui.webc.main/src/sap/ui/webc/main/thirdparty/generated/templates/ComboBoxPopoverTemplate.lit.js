sap.ui.define(["exports", "sap/ui/webc/common/thirdparty/base/renderer/LitRenderer"], function (_exports, _LitRenderer) {
  ...
  function block13(context, tags, suffix, item, index) {
    return suffix ? (0, _LitRenderer.html)`<${(0, _LitRenderer.scopeTag)("ui5-li", tags, suffix)} type="Active" additional-text=${(0, _LitRenderer.ifDefined)(item.additionalText)} group-name=${(0, _LitRenderer.ifDefined)(item.groupName)} ._tabIndex=${(0, _LitRenderer.ifDefined)(item.itemTabIndex)} .mappedItem=${(0, _LitRenderer.ifDefined)(item)} ?selected=${item.selected} ?focused=${item.focused}>${(0, _LitRenderer.ifDefined)(item.text)}</${(0, _LitRenderer.scopeTag)("ui5-li", tags, suffix)}>` : (0, _LitRenderer.html)`<ui5-li type="Active" additional-text=${(0, _LitRenderer.ifDefined)(item.additionalText)} group-name=${(0, _LitRenderer.ifDefined)(item.groupName)} ._tabIndex=${(0, _LitRenderer.ifDefined)(item.itemTabIndex)} .mappedItem=${(0, _LitRenderer.ifDefined)(item)} ?selected=${item.selected} ?focused=${item.focused}>${(0, _LitRenderer.ifDefined)(item.text)}</ui5-li>`;
  }
