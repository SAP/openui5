sap.ui.define(['exports'], function (exports) { 'use strict';
	...
	var messagebundle_ko = {
		...
		BREADCRUMBS_OVERFLOW_ARIA_LABEL: "기타",
		...
		SELECT_ROLE_DESCRIPTION: "콤보 박스 선택",
		...
		MULTIINPUT_SHOW_MORE_TOKENS: "{0} 항목 더",
		PANEL_ICON: "펼치기/접기",
		...
		SWITCH_OFF: "Off",
		LOAD_MORE_TEXT: "추가",
		TABLE_HEADER_ROW_TEXT: "헤더 행",
		TABLE_ROW_POSITION: "{0}/{1}",
		TABLE_GROUP_ROW_ARIA_LABEL: "그룹 헤더 행",
		ARIA_LABEL_ROW_SELECTION: "항목 선택",
		ARIA_LABEL_SELECT_ALL_CHECKBOX: "모든 행 선택",
		TABCONTAINER_NEXT_ICON_ACC_NAME: "다음",
		TABCONTAINER_PREVIOUS_ICON_ACC_NAME: "이전",
		TABCONTAINER_OVERFLOW_MENU_TITLE: "오버플로우 메뉴",
		TABCONTAINER_END_OVERFLOW: "자세히",
		...
		TIMEPICKER_PERIODS_LABEL: "오전/오후",
