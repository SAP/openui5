sap.ui.define(["exports", "sap/ui/webc/common/thirdparty/base/renderer/LitRenderer"], function (_exports, _LitRenderer) {
  ...
  function block14(context, tags, suffix, item, index) {
    return suffix ? (0, _LitRenderer.html)`<${(0, _LitRenderer.scopeTag)("ui5-li", tags, suffix)} type="${(0, _LitRenderer.ifDefined)(this._listItemsType)}" additional-text=${(0, _LitRenderer.ifDefined)(item.additionalText)} ?selected=${item.selected} data-ui5-token-id="${(0, _LitRenderer.ifDefined)(item._id)}" data-ui5-stable="${(0, _LitRenderer.ifDefined)(item.stableDomRef)}" @keydown="${this._onItemKeydown}">${(0, _LitRenderer.ifDefined)(item.text)}</${(0, _LitRenderer.scopeTag)("ui5-li", tags, suffix)}>` : (0, _LitRenderer.html)`<ui5-li type="${(0, _LitRenderer.ifDefined)(this._listItemsType)}" additional-text=${(0, _LitRenderer.ifDefined)(item.additionalText)} ?selected=${item.selected} data-ui5-token-id="${(0, _LitRenderer.ifDefined)(item._id)}" data-ui5-stable="${(0, _LitRenderer.ifDefined)(item.stableDomRef)}" @keydown="${this._onItemKeydown}">${(0, _LitRenderer.ifDefined)(item.text)}</ui5-li>`;
  }
