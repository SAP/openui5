sap.ui.define(["exports", "sap/ui/webc/common/thirdparty/base/renderer/LitRenderer"], function (_exports, _LitRenderer) {
  ...
  function block0(context, tags, suffix) {
    return (0, _LitRenderer.html)`<div class="ui5-progress-indicator-root ${(0, _LitRenderer.classMap)(this.classes.root)}" role="progressbar" aria-valuemin="0" aria-valuenow="${(0, _LitRenderer.ifDefined)(this.validatedValue)}" aria-valuemax="100" aria-valuetext="${(0, _LitRenderer.ifDefined)(this.valueStateText)}" aria-disabled="${(0, _LitRenderer.ifDefined)(this._ariaDisabled)}"><div class="ui5-progress-indicator-bar" style="${(0, _LitRenderer.styleMap)(this.styles.bar)}">${!this.showValueInRemainingBar ? block1.call(this, context, tags, suffix) : undefined}</div><div class="ui5-progress-indicator-remaining-bar">${this.showValueInRemainingBar ? block6.call(this, context, tags, suffix) : undefined}</div></div>`;
  }
