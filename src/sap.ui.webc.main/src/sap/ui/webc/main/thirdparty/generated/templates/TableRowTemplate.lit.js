sap.ui.define(["exports", "sap/ui/webc/common/thirdparty/base/renderer/LitRenderer"], function (_exports, _LitRenderer) {
  ...
  function block0(context, tags, suffix) {
    return (0, _LitRenderer.html)`<tr class="ui5-table-row-root" tabindex="${(0, _LitRenderer.ifDefined)(this._tabIndex)}" @focusin="${this._onfocusin}" @focusout="${this._onfocusout}" @click="${this._onrowclick}" @keydown="${this._onkeydown}" @keyup="${this._onkeyup}" @mouseup="${this._onmouseup}" @touchstart="${this._ontouchstart}" @touchend="${this._ontouchend}" aria-label="${(0, _LitRenderer.ifDefined)(this.ariaLabelText)}" aria-selected="${(0, _LitRenderer.ifDefined)(this.selected)}" aria-current="${(0, _LitRenderer.ifDefined)(this._ariaCurrent)}" data-sap-focus-ref part="row" data-ui5-dir="${(0, _LitRenderer.ifDefined)(this.effectiveDir)}">${this.isMultiSelect ? block1.call(this, context, tags, suffix) : undefined}${this.shouldPopin ? block2.call(this, context, tags, suffix) : block4.call(this, context, tags, suffix)}<td class="ui5-table-row-navigated" aria-hidden="true"><div class="ui5-table-div-navigated"></div></td></tr>${this.shouldPopin ? block6.call(this, context, tags, suffix) : undefined} `;
  }
