sap.ui.define(["exports", "sap/ui/webc/common/thirdparty/base/renderer/LitRenderer"], function (_exports, _LitRenderer) {
  ...
  function block2(context, tags, suffix) {
    return suffix ? (0, _LitRenderer.html)`<div class="ui5-responsive-popover-header"><div class="row"><span>${(0, _LitRenderer.ifDefined)(this._headerTitleText)}</span><${(0, _LitRenderer.scopeTag)("ui5-button", tags, suffix)} class="ui5-responsive-popover-close-btn" icon="decline" design="Transparent" @click="${this._toggleRespPopover}"></${(0, _LitRenderer.scopeTag)("ui5-button", tags, suffix)}></div>${this.hasValueStateText ? block3.call(this, context, tags, suffix) : undefined}</div>` : (0, _LitRenderer.html)`<div class="ui5-responsive-popover-header"><div class="row"><span>${(0, _LitRenderer.ifDefined)(this._headerTitleText)}</span><ui5-button class="ui5-responsive-popover-close-btn" icon="decline" design="Transparent" @click="${this._toggleRespPopover}"></ui5-button></div>${this.hasValueStateText ? block3.call(this, context, tags, suffix) : undefined}</div>`;
  }
