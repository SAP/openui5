sap.ui.define(['exports'], function (exports) { 'use strict';
	...
	var messagebundle_es_MX = {
		...
		MESSAGE_STRIP_CLOSE_BUTTON: "Cierre de franja de mensajes",
		...
		SWITCH_ON: "Activar",
		SWITCH_OFF: "Desactivar",
		LOAD_MORE_TEXT: "Más",
		TABLE_HEADER_ROW_TEXT: "Fila de encabezado",
		TABLE_ROW_POSITION: "{0} de {1}",
		TABLE_GROUP_ROW_ARIA_LABEL: "Fila de encabezado de grupo",
		ARIA_LABEL_ROW_SELECTION: "Selección de elemento",
