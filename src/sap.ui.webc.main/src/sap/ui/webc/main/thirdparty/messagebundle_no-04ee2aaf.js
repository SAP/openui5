sap.ui.define(['exports'], function (exports) { 'use strict';
	...
	var messagebundle_no = {
		...
		MESSAGE_STRIP_CLOSE_BUTTON: "Lukking av meldingslinje",
		...
		SEGMENTEDBUTTON_ARIA_DESCRIBEDBY: "Trykk på mellomroms- eller Enter-tasten for å velge et element",
		SEGMENTEDBUTTONITEM_ARIA_DESCRIPTION: "Segmentert knapp",
		SLIDER_ARIA_DESCRIPTION: "Handle for glidebryter",
		SWITCH_ON: "På",
		SWITCH_OFF: "Av",
		LOAD_MORE_TEXT: "Mer",
		TABLE_HEADER_ROW_TEXT: "Topprad",
		TABLE_ROW_POSITION: "{0} av {1}",
		TABLE_GROUP_ROW_ARIA_LABEL: "Gruppetopprad",
		ARIA_LABEL_ROW_SELECTION: "Elementutvalg",
		ARIA_LABEL_SELECT_ALL_CHECKBOX: "Velg alle rader",
		TABCONTAINER_NEXT_ICON_ACC_NAME: "Neste",
		TABCONTAINER_PREVIOUS_ICON_ACC_NAME: "Tilbake",
		...
		VALUE_STATE_INFORMATION: "Informative data",
