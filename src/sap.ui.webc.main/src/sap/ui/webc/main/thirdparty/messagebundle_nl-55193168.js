sap.ui.define(['exports'], function (exports) { 'use strict';
	...
	var messagebundle_nl = {
		...
		MESSAGE_STRIP_CLOSE_BUTTON: "Statusbalk voor sluiten",
		...
		SWITCH_OFF: "Uit",
		LOAD_MORE_TEXT: "Meer",
		TABLE_HEADER_ROW_TEXT: "Kopregel",
		TABLE_ROW_POSITION: "{0} van {1}",
		TABLE_GROUP_ROW_ARIA_LABEL: "Groepskopregel",
		ARIA_LABEL_ROW_SELECTION: "Elementselectie",
		ARIA_LABEL_SELECT_ALL_CHECKBOX: "Alle regels selecteren",
		...
		TIMEPICKER_PERIODS_LABEL: "A.m./p.m.",
