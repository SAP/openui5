...
sap.ui.define([
		...
		return BaseController.extend("sap.ui.documentation.controller.App", {
			onInit : function () {
			...
			aboutDialogOpen: function () {
				if (!this._oAboutDialog) {
					this._oAboutDialog = new sap.ui.xmlfragment("aboutDialogFragment", "sap.ui.documentation.view.AboutDialog", this);
			...
			onReleaseDialogOpen: function (oEvent) {
				...
				if (!this._oReleaseDialog) {
					this._oReleaseDialog = new sap.ui.xmlfragment("releaseDialogFragment", "sap.ui.documentation.view.ReleaseDialog", this);
					this._oView.addDependent(this._oReleaseDialog);
				}

				if (!this._oNotesView) {
					this._oNotesView = sap.ui.view({id:"notesView", viewName:"sap.ui.documentation.view.ReleaseNotesView", type:"Template"});
			...
			feedbackDialogOpen: function () {
				...
				if (!this._oFeedbackDialog) {
					this._oFeedbackDialog = new sap.ui.xmlfragment("feedbackDialogFragment", "sap.ui.documentation.view.FeedbackDialog", this);
