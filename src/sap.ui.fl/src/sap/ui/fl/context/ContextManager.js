...
sap.ui.define(["sap/ui/fl/LrepConnector", "sap/ui/fl/Utils", "sap/ui/fl/context/Context"], function(LrepConnector, Utils, Context) {
	...
	ContextManager = {
		 ...
		 * @param {Object[]} oPropertyBag.parameters - runtime context parameters required to match for the context being active
		 ...
		 * @param {String} oPropertyBad.validAppVersions.creation - application version when it was created
		 * @param {String} oPropertyBad.validAppVersions.from - minimum application version
		 */
