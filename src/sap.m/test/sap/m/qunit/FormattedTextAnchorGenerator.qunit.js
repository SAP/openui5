...
sap.ui.define([
	...
	function(AnchorGenerator, createAndAppendDiv, mobileLibrary) {
		...
		QUnit.test("it should convert potential links starting with starting with http", function (assert) {
			var sInputHtml = '<pre> http://openui5.hana.ondemand.com <h3>www.sap.com</h3></pre>';
			var sExpectedOutput = '<pre> <a href="http://openui5.hana.ondemand.com"' +
				' target="_blank">http://openui5.hana.ondemand.com</a> <h3>www.sap.com</h3></pre>';
		...
		QUnit.test("it should convert potential links starting with starting with https", function (assert) {
			var sInputHtml = '<pre> https://openui5.hana.ondemand.com <h3>www.sap.com</h3></pre>';
			var sExpectedOutput = '<pre> <a href="https://openui5.hana.ondemand.com"' +
				' target="_blank">https://openui5.hana.ondemand.com</a> <h3>www.sap.com</h3></pre>';
			assert.strictEqual(AnchorGenerator.generateAnchors(sInputHtml, this.sStrategy, this.sTarget), sExpectedOutput);
			assert.strictEqual(AnchorGenerator.generateAnchors(sInputHtml, this.sStrategy, this.sTarget)
				.indexOf(this.sTarget), 58);
		});

		QUnit.test("it should convert potential links starting with starting with ftp", function (assert) {
			var sInputHtml = '<pre> ftp://openui5.hana.ondemand.com <h3>www.sap.com</h3></pre>';
			var sExpectedOutput = '<pre> <a href="ftp://openui5.hana.ondemand.com" ' +
				'target="_blank">ftp://openui5.hana.ondemand.com</a> <h3>www.sap.com</h3></pre>';
			assert.strictEqual(AnchorGenerator.generateAnchors(sInputHtml, this.sStrategy, this.sTarget), sExpectedOutput);
			assert.strictEqual(AnchorGenerator.generateAnchors(sInputHtml, this.sStrategy, this.sTarget)
		...
		QUnit.test("it should convert potential links using the provided target when it changes at run time", function (assert) {
			var sInputHtml = '<pre> https://openui5.hana.ondemand.com <h3>www.sap.com</h3></pre>';
			var sExpectedOutput = '<pre> <a href="https://openui5.hana.ondemand.com" ' +
					'target="_self">https://openui5.hana.ondemand.com</a> <h3>www.sap.com</h3></pre>',
				sTarget = "_self";

			assert.strictEqual(AnchorGenerator.generateAnchors(sInputHtml, this.sStrategy, sTarget), sExpectedOutput);
			assert.strictEqual(AnchorGenerator.generateAnchors(sInputHtml, this.sStrategy, sTarget).indexOf(sTarget), 58);
		});

		QUnit.test("it shouldn't touching existing anchors", function (assert) {
			var sInputHtml = '<h1><a href="http://openui5.hana.ondemand.com" target="_blank">http://openui5.hana.ondemand.com</a></h1>';
			assert.strictEqual(AnchorGenerator.generateAnchors(sInputHtml, this.sStrategy, this.sTarget), sInputHtml);

			sInputHtml = '<h1><a href="ftp://openui5.hana.ondemand.com" target="_blank">ftp://openui5.hana.ondemand.com</a></h1>';
			assert.strictEqual(AnchorGenerator.generateAnchors(sInputHtml, this.sStrategy, this.sTarget), sInputHtml);

			sInputHtml = '<h1><a href="https://openui5.hana.ondemand.com" target="_blank">https://openui5.hana.ondemand.com</a></h1>';
			assert.strictEqual(AnchorGenerator.generateAnchors(sInputHtml, this.sStrategy, this.sTarget), sInputHtml);
		});

		QUnit.test("links starting protocol in html attribute shouldn't create anchor tags", function (assert) {
			var sInputHtml = '<pre class="http://openui5.hana.ondemand.com"></pre>';
			var sExpectedOutput = '<pre class="http://openui5.hana.ondemand.com"></pre>';
			assert.strictEqual(AnchorGenerator.generateAnchors(sInputHtml, this.sStrategy, this.sTarget), sExpectedOutput);
		});
		...
		QUnit.test("it should convert potential links starting with starting with www and links with protocols as well", function (assert) {
			var sInputHtml = '<pre> http://openui5.hana.ondemand.com <h3>www.sap.com</h3></pre>';
			var sExpectedOutput = '<pre> <a href="http://openui5.hana.ondemand.com" target="_self">http://openui5.hana.ondemand.com</a> ' +
				'<h3><a href="//www.sap.com" target="_self">www.sap.com</a></h3></pre>';

			assert.strictEqual(AnchorGenerator.generateAnchors(sInputHtml, this.sStrategy, this.sTarget), sExpectedOutput);
			assert.strictEqual(AnchorGenerator.generateAnchors(sInputHtml, this.sStrategy, this.sTarget).indexOf(this.sTarget), 57);
		});
		...
		QUnit.test("it should convert potential links starting with starting with www and links with leaving existing anchors untouched", function (assert) {
			var sInputHtml = '<pre> http://openui5.hana.ondemand.com <h3>www.sap.com</h3> <h4><a href="//www.sap.com" target="_self">www.sap.com</a></h4></pre>';
			var sExpectedOutput = '<pre> <a href="http://openui5.hana.ondemand.com" target="_self">http://openui5.hana.ondemand.com</a> <h3><a href="//www.sap.com"' +
		...
		QUnit.test("links starting with www in html attribute shouldn't create anchor tags", function (assert) {
			var sInputHtml = '<pre data-url="http://openui5.hana.ondemand.com">www.sap.com</pre>';
			var sExpectedOutput = '<pre data-url="http://openui5.hana.ondemand.com"><a href="//www.sap.com" target="_self">www.sap.com</a></pre>';
			assert.strictEqual(AnchorGenerator.generateAnchors(sInputHtml, this.sStrategy, this.sTarget), sExpectedOutput);
		});
		...
		QUnit.test("it should work with all of the stuff at once", function (assert) {
			var sInputHtml = '<www.my.tag.com> Imaginary tags that seemingly contain links while containing real links www.my-very-real-webside.info.biz' +
				...
				'script link</a>\n - <code>href=&lt;javascript:..&gt;</code> is not allowed.<ul><li class="https://openui5.hana.ondemand.com">' +
				...
				'<pre www.even.imaginary-attributes_will_not.trick.me.com.biz.info="www.sap.com">https://openui5.hana.ondemand.com ' +
				'<h3>www.sap.com</h3><h4 class="www.sap.com">Something else https://openui5.hana.ondemand.com</h4></pre>' +
				'<dl data="https://openui5.hana.ondemand.com"><dt>dl - dt - de:</dt><dd>Definition list <code>&lt;dl&gt;</code>' +
				' of terms <code>&lt;dt&gt;</code> and descriptions <code>&lt;dd&gt;</code></dd><br><cite>Cite: a reference to a source</cite>' +
				'<pre data-url="http://openui5.hana.ondemand.com"><a href="//www.sap.com" target="_self">www.sap.com</a></pre>';
			...
			var sExpectedOutput = '<www.my.tag.com> Imaginary tags that seemingly contain links while containing real links ' +
				...
				'<code>href=&lt;javascript:..&gt;</code> is not allowed.<ul><li class="https://openui5.hana.ondemand.com">&lt;ul&gt; - &lt;li&gt;</li>' +
				...
				'<a href="https://openui5.hana.ondemand.com" target="_self">https://openui5.hana.ondemand.com</a> ' +
				'<h3><a href="//www.sap.com" target="_self">www.sap.com</a></h3><h4 class="www.sap.com">Something else ' +
				'<a href="https://openui5.hana.ondemand.com" target="_self">https://openui5.hana.ondemand.com</a></h4>' +
				'</pre><dl data="https://openui5.hana.ondemand.com"><dt>dl - dt - de:</dt><dd>Definition list ' +
