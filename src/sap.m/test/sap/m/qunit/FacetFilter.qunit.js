	...
	QUnit.test("FacetFilter.type", function(assert) {
		...
		var fnTestLight = function(oFF) {
			var oSummaryBar = oFF.getAggregation("summaryBar"),
				...
				sSelectedText = oResourceBundle.getText("FACETFILTER_INFOBAR_NO_FILTERS");
			...
			assert.equal(oSummaryBar.$().attr("aria-label"), sSelectedText, "The aria-label of the summary bar is " + sSelectedText);
