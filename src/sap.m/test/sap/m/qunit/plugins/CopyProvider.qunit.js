...
], function(ClipboardUtils, Text, Table, Column, ColumnListItem, nextUIUpdate, GridTable, GridColumn, MultiSelectionPlugin, MDCTable, MDCColumn, PluginBase, CopyProvider, CellSelector, JSONModel, Filter, CustomData, coreLib, MessageToast, QUnitUtils, KeyCodes, MDCQUnitUtils, MDCTableQUnitUtils) {
