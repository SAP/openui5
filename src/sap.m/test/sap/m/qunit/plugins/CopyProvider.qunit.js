sap.ui.define([
...
], function(ClipboardUtils, Text, Table, Column, ColumnListItem, nextUIUpdate, GridTable, GridColumn, MultiSelectionPlugin, MDCTable, MDCColumn, PluginBase, CopyProvider, CellSelector, JSONModel, Filter, CustomData, coreLib, ShortcutHintsMixin, Device, MessageToast, QUnitUtils, KeyCodes, MDCQUnitUtils, MDCTableQUnitUtils) {
	...
	QUnit.test("CellSelector", async function(assert) {
		...
		var checkNotifyCalledWith = (iRows, iCells, sText) => {
