...
sap.ui.define([
	...
	"sap/ui/core/Control",
	"sap/m/ListItemBase"
], function(jQuery, EventExtension, createAndAppendDiv, qutils, JSONModel, Parameters, CustomData, coreLibrary, library, Device, App, Page, Button, Bar, List, DisplayListItem, StandardListItem, InputListItem, CustomListItem, ActionListItem, Input, KeyCodes, Control, ListItemBase) {
	"use strict";
	...
	*/
	...
	QUnit.test("ListItemBase - getAccessibilityDescription", function(assert) {
		...
		aState.splice(2, 0, oRb.getText("LIST_ITEM_NOT_SELECTED"));
