	...
	unifiedLibrary
		...
		QUnit.test("appointmentSelect: select a single appointment", function (assert) {
			var oAppointment = new CalendarAppointment(),
				...
				fnFireAppointmentSelectSpy = this.spy(oGrid, "fireEvent");
			...
			assert.ok(fnFireAppointmentSelectSpy.calledWithMatch("appointmentSelect", {
		...
		QUnit.test("appointmentSelect: deselect all appointments", function (assert) {
			...
			//assert
			assert.ok(fnFireAppointmentSelectSpy.calledTwice, "Event was fired"); // cellPress and appointmentSelect
			assert.ok(fnFireAppointmentSelectSpy.calledWithMatch("appointmentSelect", {
