...
(function() {
	...
	sap.ui.require([
		...
		"sap/m/InputListItem",
		"sap/m/Input"
	], function(MockServer, SinonQUnit, ODataModel, ODataModelV2, ListBase, StringUtil, Sjax, FilterOperator, JSONModel, Filter, Sorter, List, StandardListItem, InputListItem, Input) {
