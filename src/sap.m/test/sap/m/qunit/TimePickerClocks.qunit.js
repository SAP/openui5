...
sap.ui.define([
	...
	"sap/ui/core/Element"
], function(TimePickerClocks, TimePickerInternals, KeyCodes, jQuery, oCore, UI5Date, Element) {
	"use strict";
	...
	QUnit.test("Clicking on button changes the clock", function (assert) {
		...
		Element.registry.get(sId + "-btnH").focus();
		oCore.applyChanges();
		assert.ok(Element.registry.get(sId + "-clockH").hasStyleClass("sapMTPCActive"), "Hours clock is visible after clicking the Hours button");
		assert.notOk(Element.registry.get(sId + "-clockM").hasStyleClass("sapMTPCActive"), "Minutes clock is not visible after clicking the Hours button");
		assert.notOk(Element.registry.get(sId + "-clockS").hasStyleClass("sapMTPCActive"), "Seconds clock is not visible after clicking the Hours button");

		Element.registry.get(sId + "-btnM").focus();
		oCore.applyChanges();

		assert.notOk(Element.registry.get(sId + "-clockH").hasStyleClass("sapMTPCActive"), "Hours clock is not visible after clicking the Minutes button");
		assert.ok(Element.registry.get(sId + "-clockM").hasStyleClass("sapMTPCActive"), "Minutes clock is visible after clicking the Minutes button");
		assert.notOk(Element.registry.get(sId + "-clockS").hasStyleClass("sapMTPCActive"), "Seconds clock is not visible after clicking the Minutes button");

		Element.registry.get(sId + "-btnS").focus();
		oCore.applyChanges();
		assert.notOk(Element.registry.get(sId + "-clockH").hasStyleClass("sapMTPCActive"), "Hours clock is not visible after clicking the Seconds button");
		assert.notOk(Element.registry.get(sId + "-clockM").hasStyleClass("sapMTPCActive"), "Minutes clock is not visible after clicking the Seconds button");
		assert.ok(Element.registry.get(sId + "-clockS").hasStyleClass("sapMTPCActive"), "Seconds clock is visible after clicking the Seconds button");
	});
	...
	QUnit.test("Direct input of two-digit numbers", function (assert) {
		...
		assert.notOk(Element.registry.get(sId + "-clockH").hasStyleClass("sapMTPCActive"), "Hours clock is not visible after entering hours value");
		assert.ok(Element.registry.get(sId + "-clockM").hasStyleClass("sapMTPCActive"), "Minutes clock is visible after entering hours value");
		assert.notOk(Element.registry.get(sId + "-clockS").hasStyleClass("sapMTPCActive"), "Seconds clock is not visible after entering hours value");
		...
		assert.notOk(Element.registry.get(sId + "-clockH").hasStyleClass("sapMTPCActive"), "Hours clock is not visible after entering minutes value");
		assert.notOk(Element.registry.get(sId + "-clockM").hasStyleClass("sapMTPCActive"), "Minutes clock is not visible after entering minutes value");
		assert.ok(Element.registry.get(sId + "-clockS").hasStyleClass("sapMTPCActive"), "Seconds clock is visible after entering minutes value");
	...
	QUnit.test("Direct input of one-digit numbers w/o overflow", function (assert) {
		...
		assert.ok(Element.registry.get(sId + "-clockH").hasStyleClass("sapMTPCActive"), "Hours clock is still visible after entering hours value");
		assert.notOk(Element.registry.get(sId + "-clockM").hasStyleClass("sapMTPCActive"), "Minutes clock is not visible after entering hours value");
		assert.notOk(Element.registry.get(sId + "-clockS").hasStyleClass("sapMTPCActive"), "Seconds clock is not visible after entering hours value");
		...
		assert.notOk(Element.registry.get(sId + "-clockH").hasStyleClass("sapMTPCActive"), "Hours clock is not visible after entering minutes value");
		assert.ok(Element.registry.get(sId + "-clockM").hasStyleClass("sapMTPCActive"), "Minutes clock is stil visible after entering minutes value");
		assert.notOk(Element.registry.get(sId + "-clockS").hasStyleClass("sapMTPCActive"), "Seconds clock is not visible after entering minutes value");
	...
	QUnit.test("Direct input of 24 when support2400 is enabled", function (assert) {
		...
		assert.ok(Element.registry.get(sId + "-clockH").hasStyleClass("sapMTPCActive"), "Hours clock is visible after entering hours value");
