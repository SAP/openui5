...
sap.ui.define([
	...
	QUnit.test("MenuButton with tooltip in Split mode", function (assert) {
		...
		assert.ok(oArrowButton.getDomRef().hasAttribute("title"), "The inner '_arrowButton' button has DOM title property set to its Icon name");
...
QUnit.test("MenuButton IconOnly in Split mode with tooltip and icon that has tooltip", function (assert) {
		var sIconName = "add";
		this.sut.setIcon("sap-icon://" + sIconName);
