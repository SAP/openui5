...
sap.ui.define([
	...
	"sap/ui/core/Core"
], function(Theming, qutils, nextUIUpdate, jQuery, FeedListItem, FeedListItemAction, List, StandardListItem, JSONModel, Button, Popover, Bar, ActionSheet, App, Page, Device, FormattedText, IconPool, library, Log, KeyCodes, oCore) {
	"use strict";
