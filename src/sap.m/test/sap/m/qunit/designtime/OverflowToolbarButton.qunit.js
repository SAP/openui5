sap.ui.define([
	...
	controlEnablingCheck("Checking the remove action for OverflowToolbarButton", {
		xmlView:
	...
	controlEnablingCheck("Checking the reveal action for a OverflowToolbarButton", {
		xmlView:
			'<mvc:View xmlns:mvc="sap.ui.core.mvc" xmlns="sap.m">"' +
				'<OverflowToolbar>' +
