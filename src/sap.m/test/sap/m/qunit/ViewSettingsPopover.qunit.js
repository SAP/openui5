...
sap.ui.define([
	...
	"sap/m/Label",
	"jquery.sap.mobile"
], function(createAndAppendDiv, jQuery, qutils, Icon, ViewSettingsPopover, Device, JSONModel, ViewSettingsItem, ViewSettingsFilterItem, Button, library, TabStripItem, ViewSettingsCustomTab, Label) {
	"use strict";
