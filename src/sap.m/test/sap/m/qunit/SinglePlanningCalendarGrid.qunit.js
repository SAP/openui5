...
sap.ui.define([
	...
	QUnit.test("Formatters pattern is correct", function (assert) {
		...
		assert.strictEqual(oGrid._oFormatAriaApp.oFormatOptions.pattern.indexOf("EEEE dd/MM/yyyy"), 0, "Start End Aria info pattern is correct (contains 'yyyy' instead of 'YYYY'");
		...
		assert.strictEqual(oGrid._oFormatAriaCell.oFormatOptions.pattern.indexOf("EEEE dd/MM/yyyy"), 0, "Grid cell pattern is correct (contains 'yyyy' instead of 'YYYY'");
