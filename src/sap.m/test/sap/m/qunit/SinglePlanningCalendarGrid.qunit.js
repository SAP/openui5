...
sap.ui.define([
	...
	QUnit.test("CalendarAppointment's getDomRef() returns proper DOM element", function(assert) {
		...
		// assert
		assert.strictEqual(aAppointments[1].getDomRef().getAttribute("id"), "SPC-app-11", "The returned DOM reference of the appointment with index 1 is correct.");
		assert.strictEqual(aAppointments[3].getDomRef().getAttribute("id"), "SPC-app-1", "The returned DOM reference of the appointment with index 3 is correct.");
