...
sap.ui.define([
	...
	QUnit.test("check 'getArrayDeltaChanges (moving) - SNOW: CS20240007665800'", function(assert) {
		// arrange
		const oAdaptationControl = this.oSelectionController.getAdaptationControl();
		...
		const data = {
			...
			deltaAttributes: ["key", "name"],
			changeOperations: {add: "addFilter", remove: "removeFilter", move: "moveFilter"},
			existingState: [{"name":"A","key":"A"},{"name":"B","key":"B"},{"name":"C","key":"C"},{"name":"D","key":"D"},{"name":"E","key":"E"},{"name":"F","key":"F"},{"name":"g","key":"G"}],
			changedState: [{"name":"A","key":"A"},{"name":"C","key":"C"},{"name":"B","key":"B"},{"name":"D","key":"D"},{"name":"F","key":"F"},{"name":"E","key":"E"},{"name":"g","key":"G"}]
		};
		const aTarget = data.existingState;
