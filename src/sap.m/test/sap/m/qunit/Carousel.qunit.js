...
test("Arrow Right", function () {
	...
	oCarousel.$().focus();
	sap.ui.test.qunit.triggerKeydown(oCarousel.$(), jQuery.sap.KeyCodes.ARROW_RIGHT); // trigger Arrow Right on carousel should go to second page

	this.clock.tick(600);

	// Assert
	equal(oCarousel.getActivePage(), "keyTestPage2", "active page is keyTestPage2");

	// Cleanup
	oCarousel.destroy();
});

test("Arrow Right on the last page", function () {
	// Arrange
	var oCarousel = new sap.m.Carousel({
		pages: [
			new sap.m.Page("keyTestPage1"),
	...
	oCarousel.$().focus();
	sap.ui.test.qunit.triggerKeydown(oCarousel.$(), jQuery.sap.KeyCodes.ARROW_RIGHT); // trigger Arrow Right, shoud do nothing

	this.clock.tick(600);

	// Assert
	equal(oCarousel.getActivePage(), "keyTestPage2", "active page stays keyTestPage2");
...
test("Arrow Up", function () {
	...
	oCarousel.$().focus();
	sap.ui.test.qunit.triggerKeydown(oCarousel.$(), jQuery.sap.KeyCodes.ARROW_UP); // trigger Arrow Up on carousel should go to second page
...
test("Arrow Up last page", function () {
	// Arrange
	var oCarousel = new sap.m.Carousel({
		pages: [
			new sap.m.Page("keyTestPage1"),
	...
	oCarousel.$().focus();
	sap.ui.test.qunit.triggerKeydown(oCarousel.$(), jQuery.sap.KeyCodes.ARROW_UP); // trigger Arrow Up, shoud do nothing
...
test("Arrow Left", function () {
	...
	oCarousel.$().focus();
	sap.ui.test.qunit.triggerKeydown(oCarousel.$(), jQuery.sap.KeyCodes.ARROW_LEFT); // trigger Arrow Left on carousel should go on first page

	this.clock.tick(500);

	// Assert
	equal(oCarousel.getActivePage(), "keyTestPage1", "active page is keyTestPage1");

	// Cleanup
	oCarousel.destroy();
});

test("Arrow Left on first page", function () {
	// Arrange
	var oCarousel = new sap.m.Carousel({
		pages: [
			new sap.m.Page("keyTestPage1"),
	...
	oCarousel.$().focus();
	sap.ui.test.qunit.triggerKeydown(oCarousel.$(), jQuery.sap.KeyCodes.ARROW_LEFT); // trigger Arrow Left , shoud do nothing

	this.clock.tick(500);

	// Assert
	equal(oCarousel.getActivePage(), "keyTestPage1", "active page stays keyTestPage1");
...
test("Arrow Down", function () {
	...
	oCarousel.$().focus();
	sap.ui.test.qunit.triggerKeydown(oCarousel.$(), jQuery.sap.KeyCodes.ARROW_DOWN); // trigger Arrow Down on carousel should stay on first page
...
test("Arrow Down on first page", function () {
	// Arrange
	var oCarousel = new sap.m.Carousel({
		pages: [
			new sap.m.Page("keyTestPage1"),
	...
	oCarousel.$().focus();
	sap.ui.test.qunit.triggerKeydown(oCarousel.$(), jQuery.sap.KeyCodes.ARROW_DOWN); // trigger Arrow Down again, shoud do nothing
...
test("HOME", function () {
	...
	oCarousel.$().focus();
	sap.ui.test.qunit.triggerKeydown(oCarousel.$(), jQuery.sap.KeyCodes.HOME); // trigger Home on carousel, should go to first page
...
test("END", function () {
	...
	oCarousel.$().focus();
	sap.ui.test.qunit.triggerKeydown(oCarousel.$(), jQuery.sap.KeyCodes.END); // trigger End on carousel, should go to last page
...
test("ESCAPE", function () {
	...
	sap.ui.test.qunit.triggerKeydown(oCarousel.$(), jQuery.sap.KeyCodes.ESCAPE); // trigger Escape, should return to the default active page - 2
...
test("CTRL + ARROW_RIGHT", function () {
	// Arrange
	var oCarousel = new sap.m.Carousel({
		pages: [
			new sap.m.Page("keyTestPage1"),
	...
	sap.ui.test.qunit.triggerKeydown(oCarousel.$(), jQuery.sap.KeyCodes.ARROW_RIGHT, false, false, true); // trigger Right arrow key + Control key, should go to page 11

	this.clock.tick(500);

	// Assert
	equal(oCarousel.getActivePage(), "keyTestPage11", "active page is keyTestPage11");
...
test("CTRL + ARROW_RIGHT less than 10 go to last page", function () {
	// Arrange
	var oCarousel = new sap.m.Carousel({
		pages: [
			new sap.m.Page("keyTestPage1"),
	...
	sap.ui.test.qunit.triggerKeydown(oCarousel.$(), jQuery.sap.KeyCodes.ARROW_RIGHT, false, false, true); // trigger Right arrow key + Control key, should go to the last page - 12

	this.clock.tick(500);

	// Assert
	equal(oCarousel.getActivePage(), "keyTestPage12", "active page is keyTestPage12");

	// Cleanup
	oCarousel.destroy();
});

test("CTRL + ARROW_UP", function () {
	// Arrange
	var oCarousel = new sap.m.Carousel({
		pages: [
			new sap.m.Page("keyTestPage1"),
	...
	sap.ui.test.qunit.triggerKeydown(oCarousel.$(), jQuery.sap.KeyCodes.ARROW_UP, false, false, true); // trigger Up arrow key + Control key
...
test("CTRL + ARROW_UP less than 10 go to last page", function () {
	// Arrange
	var oCarousel = new sap.m.Carousel({
		pages: [
			new sap.m.Page("keyTestPage1"),
...
test("PAGE_UP", function () {
	...
	oCarousel.$().focus();
	sap.ui.test.qunit.triggerKeydown(oCarousel.$(), jQuery.sap.KeyCodes.PAGE_UP); // trigger PAGE_UP key and navigate 10 pages forward - page 11
...
test("PAGE_UP on less than 10 go to last page", function () {
	// Arrange
	var oCarousel = new sap.m.Carousel({
		pages: [
			new sap.m.Page("keyTestPage1"),
	...
	oCarousel.$().focus();
	sap.ui.test.qunit.triggerKeydown(oCarousel.$(), jQuery.sap.KeyCodes.PAGE_UP); // trigger PAGE_UP key
...
test("CTRL + ARROW_LEFT", function () {
	...
	oCarousel.$().focus();
	sap.ui.test.qunit.triggerKeydown(oCarousel.$(), jQuery.sap.KeyCodes.ARROW_LEFT, false, false, true); // trigger Left arrow key + Control key to go 10 pages backward
...
test("CTRL + ARROW_LEFT less than 10 goes to first page", function () {
	// Arrange
	var oCarousel = new sap.m.Carousel({
		pages: [
			new sap.m.Page("keyTestPage1"),
	...
	oCarousel.$().focus();
	sap.ui.test.qunit.triggerKeydown(oCarousel.$(), jQuery.sap.KeyCodes.ARROW_LEFT, false, false, true); // trigger Left arrow key + Control key
...
test("CTRL + ARROW_DOWN", function () {
	...
	oCarousel.$().focus();
	sap.ui.test.qunit.triggerKeydown(oCarousel.$(), jQuery.sap.KeyCodes.ARROW_DOWN, false, false, true); // trigger Down arrow key + Control key to go 10 pages backward
...
test("CTRL + ARROW_DOWN less than 10 goes to first page", function () {
	// Arrange
	var oCarousel = new sap.m.Carousel({
		pages: [
			new sap.m.Page("keyTestPage1"),
	...
	oCarousel.$().focus();
	sap.ui.test.qunit.triggerKeydown(oCarousel.$(), jQuery.sap.KeyCodes.ARROW_DOWN, false, false, true); // trigger Down arrow key + Control key
...
test("PAGE_DOWN", function () {
	...
	oCarousel.$().focus();
	sap.ui.test.qunit.triggerKeydown(oCarousel.$(), jQuery.sap.KeyCodes.PAGE_DOWN); // trigger PAGE_DOWN key
...
test("PAGE_DOWN less than 10 goes to first page", function () {
	// Arrange
	var oCarousel = new sap.m.Carousel({
		pages: [
			new sap.m.Page("keyTestPage1"),
