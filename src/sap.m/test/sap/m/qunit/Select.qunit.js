...
sap.ui.define([
	...
	function(
		...
		QUnit.test("it should show the text and additionalText, separated by '-'", function (assert) {
			...
			assert.strictEqual(oSelect.$().find(".sapMSelectListItemText").text(), sText + " \u2013 " + sAdditionalText,
				"The text and additionalText should be shown, separated by '–' when showSecondaryValues is set to true");
