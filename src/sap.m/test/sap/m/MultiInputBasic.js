sap.ui.define([
	...
	"sap/ui/table/Table",
	"sap/ui/table/Column"
], function (JSONModel, App, Button, Column, ColumnListItem, Label, List, MessageBox, MultiInput, Page, StandardListItem, Table, Text, Token, coreLibrary, GridTable, GridTableColumn){
	"use strict";
