sap.ui.define([
	...
	var oButton3 = new Button("btn3", {
		...
		press: function () {
			oPopover.setPlacement(mLibrary.PlacementType.Horizontal);
			oPopover.openBy(this);
		}
	...
	var oButton5 = new Button("btn5", {
		...
		press: function () {
			oPopover.setPlacement(mLibrary.PlacementType.HorizontalPreferredLeft);
			oPopover.openBy(this);
		}
	...
	var oButton7 = new Button("btn7", {
		...
		press: function () {
			oPopover.setPlacement(mLibrary.PlacementType.HorizontalPreferredRight);
			oPopover.openBy(this);
		}
	...
	var oButton11 = new Button("btn11", {
		...
		press: function () {
			oPopover.setPlacement(mLibrary.PlacementType.PreferredBottomOrFlip);
			oPopover.openBy(this);
		}
	...
	var oButton13 = new Button("btn13", {
		...
		press: function () {
			oPopover.setPlacement(mLibrary.PlacementType.PreferredLeftOrFlip);
			oPopover.openBy(this);
		}
	...
	var oButton17 = new Button("btn17", {
		...
		press: function () {
			oPopover.setPlacement(mLibrary.PlacementType.PreferredTopOrFlip);
			oPopover.openBy(this);
		}
	...
	var oButton22 = new Button("btn22", {
		...
		press: function () {
			oPopover.setPlacement(mLibrary.PlacementType.VerticalPreferredBottom);
			oPopover.openBy(this);
		}
	...
	var oButton24 = new Button("btn24", {
		...
		press: function () {
			oPopover.setPlacement(mLibrary.PlacementType.VerticalPreferredTop);
			oPopover.openBy(this);
		}
