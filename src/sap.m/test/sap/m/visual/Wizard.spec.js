...
describe("sap.m.Wizard", function() {
	...
	it("Should load test page with size S", function () {
		browser.executeScript(function() {
			sap.ui.getCore().byId("linear-wiz")/*Not inside AMD call*/.setWidth("580px");
		});
	...
	it("Should load test page with size M", function () {
		browser.executeScript(function() {
			sap.ui.getCore().byId("linear-wiz")/*Not inside AMD call*/.setWidth("1000px");
		});
	...
	it("Should load test page with size L", function () {
		browser.executeScript(function() {
			sap.ui.getCore().byId("linear-wiz")/*Not inside AMD call*/.setWidth("1430px");
		});
	...
	it("Should load test page with size XL", function () {
		browser.executeScript(function() {
			sap.ui.getCore().byId("linear-wiz")/*Not inside AMD call*/.setWidth("1500px");
		});
	...
	it("changing the StepTitle should be reflected in the ProgressNavigator", function () {
		element(by.id("fwd-wiz-sel")).click();
		browser.executeScript(function() {
			sap.ui.getCore().byId("linear-wiz-step1")/*Not inside AMD call*/.setTitle("Test");
		});
