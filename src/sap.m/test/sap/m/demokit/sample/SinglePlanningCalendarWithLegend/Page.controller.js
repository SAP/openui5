			...
			oModel.setData({
					...
					secondaryTypes: (function() {
						...
						specialDates: [
						{
							...
							end: UI5Date.getInstance("2018", "6", "9"),
							type: "Type14"
						},
						{
							start: UI5Date.getInstance("2018", "6", "2"),
							end: UI5Date.getInstance("2018", "6", "2", "23", "59"),
							type: "Type08"
						},
						{
							start: UI5Date.getInstance("2018", "6", "11"),
							end: UI5Date.getInstance("2018", "6", "11", "23", "59"),
							type: "Type11",
							color: "#ff69b4"
						},
						{
							start: UI5Date.getInstance("2018", "6", "12"),
							end: UI5Date.getInstance("2018", "6", "12", "23", "59"),
							type: "Type03",
							color: "#add8e6"
						},
						{
						...
						},
						{
							...
							end: UI5Date.getInstance("2018", "6", "18", "23", "59"),
							type: "Type07"
						}
					],
					appointments: [{
