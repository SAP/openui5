sap.ui.define(['sap/ui/core/UIComponent'],
	function(UIComponent) {
		...
		return UIComponent.extend("sap.m.sample.Worklist.Component", {
			...
			metadata : {
				...
				config : {
					sample : {
						iframe : "webapp/test/testOpenUI5Service.html",
						stretch : true,
						files : [
							"webapp/Component.js",
							...
							"webapp/localService/mockdata/Objects.json",
							...
							"webapp/test/testOpenUI5Service.html",
