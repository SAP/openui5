...
function(Controller, JSONModel, unifiedLibrary,
		...
		CustomThreeDaysView, CustomTenDaysView, UI5Date) {
	"use strict";
		...
		onInit: function() {
			...
			oModel.setData({
					...
					appointments: [{
						...
						text: "online",
						type: CalendarDayType.Type01,
						startDate: UI5Date.getInstance("2018", "6", "16", "8", "0"),
						endDate: UI5Date.getInstance("2018", "6", "16", "9", "0")
					}, {
						title:"Discussion of the plan",
						type: CalendarDayType.Type08,
						...
						title: "Working out of the building",
						type: CalendarDayType.Type07,
						startDate: UI5Date.getInstance("2018", "6", "17", "6", "0"),
						endDate: UI5Date.getInstance("2018", "6", "17", "9", "30")
					}, {
						title: "Team meeting",
						text: "room 5",
						type: CalendarDayType.Type01,
						startDate: UI5Date.getInstance("2018", "6", "18", "11", "0"),
						endDate: UI5Date.getInstance("2018", "6", "18", "14", "0")
					},{
						title:"Discussion with clients",
						text: "Online meeting",
						type: CalendarDayType.Type08,
