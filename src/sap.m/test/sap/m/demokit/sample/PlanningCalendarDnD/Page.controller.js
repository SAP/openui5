	...
	function (Controller, JSONModel, MessageToast, UI5Date) {
		...
		return Controller.extend("sap.m.sample.PlanningCalendarDnD.Page", {
			...
			onInit: function () {
				...
				oModel.setData({
					startDate: UI5Date.getInstance("2017", "10", "13", "8", "0"),
					people: [
						{
							...
							appointments: [
								{
									start: UI5Date.getInstance("2017", "10", "13", "08", "00"),
									end: UI5Date.getInstance("2017", "10", "13", "09", "00"),
									title: "Team sync",
									info: "Canteen",
									type: "Type07",
								...
								{
									start: UI5Date.getInstance("2017", "10", "13", "09", "0"),
									end: UI5Date.getInstance("2017", "10", "13", "11", "0"),
									title: "Morning Sync",
									info: "I call you",
									type: "Type01",
									pic: "sap-icon://call"
								...
								{
									start: UI5Date.getInstance("2017", "10", "13", "10", "00"),
									end: UI5Date.getInstance("2017", "10", "13", "12", "00"),
									title: "Sync Bill",
									info: "Online",
									type: "Type03"
								},
								{
									start: UI5Date.getInstance("2017", "10", "13", "10", "00"),
									end: UI5Date.getInstance("2017", "10", "13", "13", "00"),
									title: "Check Flights",
									info: "no room",
									type: "Type09",
									pic: "sap-icon://flight"
								...
								{
									start: UI5Date.getInstance("2017", "10", "13", "13", "00"),
									end: UI5Date.getInstance("2017", "10", "13", "14", "00"),
									title: "Lunch",
									info: "canteen",
									type: "Type05",
								...
								{
									start: UI5Date.getInstance("2017", "10", "13", "18", "00"),
									end: UI5Date.getInstance("2017", "10", "13", "20", "00"),
									title: "Discussion of the plan",
									info: "Online meeting",
									type: "Type04"
								},
								{
									start: UI5Date.getInstance("2017", "10", "14", "03", "00"),
									end: UI5Date.getInstance("2017", "10", "14", "23", "00"),
									title: "Deadline",
									type: "Type05"
								},
								{
									start: UI5Date.getInstance("2017", "10", "14", "09", "00"),
									end: UI5Date.getInstance("2017", "10", "14", "14", "00"),
									title: "Blocker",
									info: "room 6",
									type: "Type08"
								},
								{
									start: UI5Date.getInstance("2017", "10", "17", "09", "00"),
									end: UI5Date.getInstance("2017", "10", "17", "18", "00"),
									title: "Boss Birthday",
									type: "Type02"
								},
								{
									start: UI5Date.getInstance("2017", "10", "24", "09", "00"),
									end: UI5Date.getInstance("2017", "10", "24", "18", "00"),
									title: "Urgent Planning",
									type: "Type08"
								},
								{
									start: UI5Date.getInstance("2017", "10", "20", "01", "00"),
									end: UI5Date.getInstance("2017", "10", "20", "23", "00"),
									title: "Planning",
									type: "Type09"
								}
							]
						},
						{
							...
							appointments: [
								{
									start: UI5Date.getInstance("2017", "10", "13", "08", "00"),
									end: UI5Date.getInstance("2017", "10", "13", "09", "26"),
									title: "Team sync",
									info: "Canteen",
									type: "Type07",
									pic: "sap-icon://family-care"
								...
								{
									start: UI5Date.getInstance("2017", "10", "13", "11", "00"),
									end: UI5Date.getInstance("2017", "10", "13", "12", "00"),
								...
								{
									start: UI5Date.getInstance("2018", "2", "20", "01", "00"),
									end: UI5Date.getInstance("2018", "2", "20", "23", "00"),
									title: "Off",
									type: "Type08"
								}
							]
