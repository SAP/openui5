jQuery.sap.require("sap.m.sample.TableBreadcrumb.Formatter");

sap.ui.controller("sap.m.sample.TableBreadcrumb.Page", {
	...
	onInit: function (oEvent) {
		...
		this.getView().setModel(new sap.ui.model.json.JSONModel(this.mInitialOrderState), "Order");
	},
