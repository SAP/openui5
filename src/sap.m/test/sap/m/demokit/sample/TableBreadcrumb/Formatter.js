...
sap.m.sample.TableBreadcrumb.Formatter = {
	...
	isProductSelected : function (sProductId) {
		var aProductsSelected = sap.m.sample.TableBreadcrumb.Formatter.listProductsSelected(this);
	...
	isAnyProductSelected : function () {
		return sap.m.sample.TableBreadcrumb.Formatter.listProductsSelected(this).length > 0;
	},
