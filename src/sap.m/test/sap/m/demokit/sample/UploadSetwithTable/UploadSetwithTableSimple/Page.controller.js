sap.ui.define([
	...
	return Controller.extend("sap.m.sample.UploadSetwithTableSimple.Page", {
		onInit: function () {
			var sPath = sap.ui.require.toUrl("sap/m/sample/UploadSetwithTable/UploadSetwithTableSimple/test/items.json");
		...
		openAddOrEditDialog: function () {
			if (!this._addViaUrlFragment){
				Fragment.load({
					name: "sap.m.sample.UploadSetwithTable.UploadSetwithTableSimple.fragments.AddViaUrl",
					id: "addViaUrlDialog",
					controller: this
				})
