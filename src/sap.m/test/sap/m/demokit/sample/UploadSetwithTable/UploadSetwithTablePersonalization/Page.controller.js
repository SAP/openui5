sap.ui.define([
	...
	return Controller.extend("sap.m.sample.UploadSetwithTablePersonalization.Page", {
		onInit: function () {
			var sPath = sap.ui.require.toUrl("sap/m/sample/UploadSetwithTable/UploadSetwithTablePersonalization/test/items.json");
		...
		openAddOrEditDialog: function () {
			if (!this._addViaUrlFragment){
				Fragment.load({
					name: "sap.m.sample.UploadSetwithTable.UploadSetwithTablePersonalization.fragments.AddViaUrl",
					id: "addViaUrlDialog",
					controller: this
				})
