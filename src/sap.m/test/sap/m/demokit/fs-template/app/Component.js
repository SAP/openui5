sap.ui.define([
		...
		"sap/ui/demo/fstemplate/model/Device",
		"sap/ui/demo/fstemplate/model/AppModel",
		"sap/ui/demo/fstemplate/controller/BusyHandler",
		"sap/ui/demo/fstemplate/model/formatter"
	], function (UIComponent, ResourceModel, DeviceModel, AppModel, BusyHandler) {
	"use strict";

	return UIComponent.extend("sap.ui.demo.fstemplate.Component", {
		...
		metadata : {
			...
			rootView : "sap.ui.demo.fstemplate.view.App",

			config : {
				messageBundle : "sap.ui.demo.fstemplate.i18n.messageBundle",
				// always use absolute paths relative to our own component
				// (relative paths will fail if running in the Fiori Launchpad)
				rootPath: jQuery.sap.getModulePath("sap.ui.demo.fstemplate"),
			...
			routing : {
				config : {
					...
					viewType : "XML",
					viewPath : "sap.ui.demo.fstemplate.view",
