...
<html>
	...
	<body class="sapUiBody sapUiMediumMargin sapUiForceWidthAuto">
		...
		<ul>
			<li><a href="test/testService.html">test/testService.html</a> - start the app (with local mock data)</li>			<li><a href="test/testsuite.qunit.html">test/testsuite.qunit.html</a> - run all the tests</li>
