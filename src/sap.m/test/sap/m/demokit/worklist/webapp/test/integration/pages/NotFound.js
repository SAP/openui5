				...
				actions : {
					...
					iWaitUntilISeeObjectNotFoundPage : function () {
						return this.waitFor({
							...
							success : function (oPage) {
								QUnit.strictEqual(oPage.getTitle(), oPage.getModel("i18n").getProperty("objectTitle"), "the object text is shown as title");
					...
					iWaitUntilISeeResourceNotFoundPage : function () {
						return this.waitFor({
							...
							viewName : "NotFound",
							success : function (oPage) {
								QUnit.strictEqual(oPage.getTitle(), oPage.getModel("i18n").getProperty("notFoundTitle"), "the not found title is shown as title");
								QUnit.strictEqual(oPage.getText(), oPage.getModel("i18n").getProperty("notFoundText"), "the not found text is shown");
							},
							errorMessage : "Did not display the object not found text"
						});
					},
