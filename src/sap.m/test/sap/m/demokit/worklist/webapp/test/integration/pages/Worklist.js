				...
				assertions: jQuery.extend({
					...
					theTableShouldHaveAllEntries : function () {
						...
						return this.waitFor({
							...
							success : function (oTable) {
								QUnit.strictEqual(oTable.getItems().length, iExpectedNumberOfItems, "The growing Table has " + iExpectedNumberOfItems + " items");
							},
					...
					iShouldSeeTheNoDataTextForNoSearchResults : function () {
						return this.waitFor({
							...
							viewName : sViewName,
							success : function (oTable) {
								QUnit.strictEqual(oTable.getNoDataText(), oTable.getModel("i18n").getProperty("worklistNoDataWithSearchText"), "the table should show the no data text for search");
							},
