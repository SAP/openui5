sap.ui.define(['sap/ui/base/Object'], function (Object) {
	...
	return Object.extend("sap.ui.demo.worklist.controller.BusyHandler", {
		 ...
		 * @class
		 * @public
		 * @alias sap.ui.demo.worklist.controller.BusyHandler
		 */
		...
		/**
		 * This method removes or sets the busy indicator delay and sets or removes the root view's busy state.
