			...
			assertions: {
				...
				iShouldSeeTheNotFoundGeneralPage: function (sPageViewName) {
					return this.waitFor({
						...
						success: function () {
							Opa5.assert.ok(true, "Shows the illustrated message");
						},
				...
				theNotFoundPageShouldSayResourceNotFound: function () {
					return this.waitFor({
						...
						success: function (oPage) {
							...
							Opa5.assert.strictEqual(oPage.getDescription(), oPage.getModel("i18n").getProperty("notFoundText"), "The resource not found text is shown");
						},
				...
				theNotFoundPageShouldSayObjectNotFound: function () {
					return this.waitFor({
						...
						success: function (oPage) {
							...
							Opa5.assert.strictEqual(oPage.getDescription(), oPage.getModel("i18n").getProperty("noObjectFoundText"), "The object not found text is shown");
						},
