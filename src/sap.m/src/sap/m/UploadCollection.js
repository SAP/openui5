...
sap.ui.define(
    ...
    function(
         ...
         */
        var UploadCollection = Control.extend(
            "sap.m.UploadCollection",
            /** @lends sap.m.UploadCollection.prototype */ {
                constructor: function(sId, mSettings) {
                    ...
                    if (
                        mSettings &&
                        mSettings.mode === Library.ListMode.MultiSelect &&
                        bInstantUpload === false
                    ) {
                        ...
                        sId &&
                        sId.mode === Library.ListMode.MultiSelect &&
                        bInstantUpload === false
                    ) {
        ...
        UploadCollection.prototype.init = function() {
            UploadCollection.prototype._oRb = sap.ui
                .getCore()
            ...
            this.setAggregation(
                "_noDataIcon",
                new Icon(this.getId() + "-no-data-icon", {
            ...
            this.setAggregation(
                "_dragDropIcon",
                new Icon(this.getId() + "-drag-drop-icon", {
            ...
            this.setAggregation(
                "_dragDropText",
                new Text(this.getId() + "-drag-drop-text", {
                    text: this._oRb.getText(
        ...
        UploadCollection.prototype.setFileType = function(aFileTypes) {
            ...
            if (!this.getInstantUpload()) {
                Log.info(
                    "As property instantUpload is false it is not allowed to change fileType at runtime."
                );
            } else {
        ...
        UploadCollection.prototype.setMaximumFilenameLength = function(
            iMaximumFilenameLength
        ) {
            if (!this.getInstantUpload()) {
                Log.info(
                    "As property instantUpload is false it is not allowed to change maximumFilenameLength at runtime."
                );
            } else if (
                this.getMaximumFilenameLength() !== iMaximumFilenameLength
            ) {
                this.setProperty(
                    "maximumFilenameLength",
                    iMaximumFilenameLength,
                ...
                this._getFileUploader().setMaximumFilenameLength(
                    iMaximumFilenameLength
                );
            }
            return this;
        ...
        UploadCollection.prototype.setMaximumFileSize = function(
            iMaximumFileSize
        ) {
            if (!this.getInstantUpload()) {
                Log.info(
                    "As property instantUpload is false it is not allowed to change maximumFileSize at runtime."
                );
        ...
        UploadCollection.prototype.setMimeType = function(aMimeTypes) {
            if (!this.getInstantUpload()) {
                Log.info(
                    "As property instantUpload is false it is not allowed to change mimeType at runtime."
                );
        ...
        UploadCollection.prototype.setMultiple = function(bMultiple) {
            if (!this.getInstantUpload()) {
                Log.info(
                    "As property instantUpload is false it is not allowed to change multiple at runtime."
                );
        ...
        UploadCollection.prototype.setShowSeparators = function(
            bShowSeparators
        ) {
        ...
        UploadCollection.prototype.setUploadEnabled = function(bUploadEnabled) {
            if (!this.getInstantUpload()) {
                Log.info(
                    "As property instantUpload is false it is not allowed to change uploadEnabled at runtime."
                );
        ...
        UploadCollection.prototype.setUploadUrl = function(sUploadUrl) {
            if (!this.getInstantUpload()) {
                Log.info(
                    "As property instantUpload is false it is not allowed to change uploadUrl at runtime."
                );
        ...
        UploadCollection.prototype.setMode = function(mode) {
            if (mode === Library.ListMode.Delete) {
                ...
                Log.info(
                    "sap.m.ListMode.Delete is not supported by UploadCollection. Value has been resetted to 'None'"
                );
            } else if (
        ...
        UploadCollection.prototype.getNoDataText = function() {
            ...
            sNoDataText =
                sNoDataText ||
                this._oRb.getText("UPLOADCOLLECTION_NO_DATA_TEXT");
            return sNoDataText;
        };
        ...
        UploadCollection.prototype.getNoDataDescription = function() {
            ...
            sNoDataDescription =
                sNoDataDescription ||
                this._oRb.getText("UPLOADCOLLECTION_NO_DATA_DESCRIPTION");
            return sNoDataDescription;
        };

        UploadCollection.prototype.setUploadButtonInvisible = function(
            uploadButtonInvisible
        ) {
        ...
        UploadCollection.prototype.upload = function() {
            ...
            var iFileUploadersCounter = this._aFileUploadersForPendingUpload
                .length;
            ...
            if (this._aFilesFromDragAndDropForPendingUpload.length > 0) {
                // Copy the parameters and headerParameters from UploadCollection to FileUploader
                this._copyHeaderParametersToFileUploader();
        ...
        UploadCollection.prototype.getSelectedItems = function() {
            ...
            return this._getUploadCollectionItemsByListItems(
                aSelectedListItems
            );
        };
        ...
        UploadCollection.prototype.getSelectedItem = function() {
            ...
            if (oSelectedListItem) {
                return this._getUploadCollectionItemByListItem(
                    oSelectedListItem
                );
            }
            return null;
        ...
        UploadCollection.prototype.setSelectedItemById = function(id, select) {
            ...
            this._setSelectedForItems(
                [this._getUploadCollectionItemById(id)],
                select
            );
            return this;
        };
         ...
         * @public
         */
        UploadCollection.prototype.setSelectedItem = function(
            uploadCollectionItem,
            select
        ) {
            return this.setSelectedItemById(
                uploadCollectionItem.getId(),
                select
            );
        };
        ...
        UploadCollection.prototype.selectAll = function() {
            ...
            if (aSelectedList.getItems().length !== this.getItems().length) {
                Log.info(
                    "Internal 'List' and external 'UploadCollection' are not in sync."
                );
            }
         ...
         * @public
         */
        UploadCollection.prototype.downloadItem = function(
            uploadCollectionItem,
            askForLocation
        ) {
            if (!this.getInstantUpload()) {
            ...
            if (this._oFileUploader) {
                if (item) {
                    if (!this._oFileUploader.getMultiple()) {
                        ...
                        Log.warning(
                            "Version Upload cannot be used in multiple upload mode"
                        );
                    }
                } else {
                    this._oFileUploader
        ...
        UploadCollection.prototype.removeAggregation = function(
            sAggregationName,
            vObject,
            bSuppressInvalidate
        ) {
            ...
            if (
                ...
                if (oFileFromDragDrop) {
                    iIndexOfFile = this._aFilesFromDragAndDropForPendingUpload.indexOf(
                        oFileFromDragDrop
                    );
                    if (iIndexOfFile !== -1) {
                        this._aFilesFromDragAndDropForPendingUpload.splice(
                            iIndexOfFile,
                            1
                        );
                    }
        ...
        UploadCollection.prototype.removeAllAggregation = function(
            sAggregationName,
            bSuppressInvalidate
        ) {
            if (!this.getInstantUpload() && sAggregationName === "items") {
                if (this._aFileUploadersForPendingUpload) {
                    for (
                        var i = 0;
                        i < this._aFileUploadersForPendingUpload.length;
                        i++
                    ) {
            ...
            return Control.prototype.removeAllAggregation.apply(
                this,
                arguments
            );
        };
        ...
        UploadCollection.prototype.onBeforeRendering = function() {
            ...
            this._clearList();
            this._fillList(this.aItems);
            this._oList.setAggregation(
                "headerToolbar",
                this._oHeaderToolbar,
                true
            ); // note: suppress re-rendering

            // enable/disable FileUploader according to error state
            if (this.sErrorState !== "Error") {
                if (
                    this.getUploadEnabled() !== this._oFileUploader.getEnabled()
                ) {
                    ...
                    if (this.editModeItem) {
                        var $oEditBox = jQuery(
                            document.getElementById(
                                this.editModeItem + "-ta_editFileName-inner"
                            )
                        );
                        if ($oEditBox) {
        ...
        UploadCollection.prototype._bindDragEnterLeave = function() {
            ...
            if (!this._oDragDropHandler) {
                this._oDragDropHandler = {
                    ...
                    dragEnterUploadCollection: this._onDragEnterUploadCollection.bind(
                        this
                    ),
                    dragLeaveUploadCollection: this._onDragLeaveUploadCollection.bind(
                        this
                    ),
                    dragOverUploadCollection: this._onDragOverUploadCollection.bind(
                        this
                    ),
                    dropOnUploadCollection: this._onDropOnUploadCollection.bind(
                        this
                    )
                };
            }
         ...
         * @private
         */
        UploadCollection.prototype._onDragEnterUploadCollection = function(
            event
        ) {
            if (!this._checkForFiles(event)) {
                return;
            ...
            if (event.target === this._$DragDropArea[0]) {
                ...
                this._adjustDragDropIcon();
                this.getAggregation("_dragDropText").setText(
                    this._oRb.getText("UPLOADCOLLECTION_DROP_FILE_INDICATOR")
                );
            }
        };
         ...
         * @private
         */
        UploadCollection.prototype._onDragOverUploadCollection = function(
            event
        ) {
            event.preventDefault();
        };
         ...
         * @private
         */
        UploadCollection.prototype._onDragLeaveUploadCollection = function(
            event
        ) {
            if (event.target === this._$DragDropArea[0]) {
                this._$DragDropArea.removeClass("sapMUCDropIndicator");
                this.getAggregation("_dragDropText").setText(
                    this._oRb.getText("UPLOADCOLLECTION_DRAG_FILE_INDICATOR")
                );
            }
        };
        ...
        UploadCollection.prototype._onDropOnUploadCollection = function(event) {
            ...
            if (event.target === this._$DragDropArea[0]) {
                ...
                if (aFiles.length > 1 && !this.getMultiple()) {
                    var sMessage = this._oRb.getText(
                        "UPLOADCOLLECTION_MULTIPLE_FALSE"
                    );
                ...
                if (!this.getInstantUpload()) {
                    for (var i = 0; i < aFiles.length; i++) {
                        ...
                        this._aFilesFromDragAndDropForPendingUpload.push(
                            aFiles[i]
                        );
                    }
                } else {
        ...
        UploadCollection.prototype._adjustDragDropIcon = function() {
            ...
            if (this._$DragDropArea[0].offsetHeight < 160) {
                this.getAggregation("_dragDropIcon")
                    .$()
                    .hide();
            }
        };
            ...
            if (!this.getInstantUpload()) {
                ...
                if (this._aFileUploadersForPendingUpload.length) {
                    for (i = 0; i < iToolbarElements; i++) {
                        ...
                        if (
                            this._oHeaderToolbar.getContent()[i] instanceof
                            FileUploader
                        ) {
                            if (
                                i === this._iFileUploaderPH &&
        ...
        UploadCollection.prototype._truncateFileName = function(item) {
            ...
            if (item._status === "Edit") {
                ...
                this.$()
                    .find("#" + sItemId)
                    .find(".sapMUCObjectMarkerContainer")
                    .attr("style", "display: none"); // the markers are not displayed in edit mode
                return;
            }
            var iMarkersWidth = 0;
            ...
            for (var i = 0; i < aMarkers.length; i++) {
                iMarkersWidth =
                    iMarkersWidth +
                    aMarkers[i].$().width() +
                    UploadCollection._markerMargin;
            }
            if (iMarkersWidth > 0) {
                var $FileName = this.$().find(
                    "#" + item.getId() + "-ta_filenameHL"
                );
                if ($FileName) {
        ...
        UploadCollection.prototype._getListHeader = function(count) {
            ...
            if (!this._oHeaderToolbar) {
                ...
                if (!this._oHeaderToolbar) {
                    ...
                    this._iFileUploaderPH = this._getFileUploaderPlaceHolderPosition(
                        this._oHeaderToolbar
                    );
                    if (this._oHeaderToolbar && this._iFileUploaderPH > -1) {
                        ...
                        Log.info(
                            "A place holder of type 'sap.m.UploadCollectionPlaceholder' needs to be provided."
                        );
                    }
                }
                ...
                var iPendingUploadsNumber = this._aFileUploadersForPendingUpload
                    .length;
                for (i = iPendingUploadsNumber - 1; i >= 0; i--) {
                    if (
                        this._aFileUploadersForPendingUpload[i].getId() ===
                        this._oFileUploader.getId()
                    ) {
                        oFileUploader = this._getFileUploader();
         ...
         * @private
         */
        UploadCollection.prototype._getFileUploaderPlaceHolderPosition = function(
            toolbar
        ) {
            for (var i = 0; i < toolbar.getContent().length; i++) {
                if (
                    toolbar.getContent()[i] instanceof
                    UploadCollectionToolbarPlaceholder
                ) {
                    return i;
                }
         ...
         * @private
         */
        UploadCollection.prototype._setFileUploaderInToolbar = function(
            fileUploader
        ) {
            this._oHeaderToolbar
                .getContent()
                [this._iFileUploaderPH].setVisible(false);
            this._oHeaderToolbar.insertContent(
                fileUploader,
                this._iFileUploaderPH
            );
        };
        ...
        UploadCollection.prototype._mapItemToListItem = function(item) {
            ...
            if (
                !item ||
                (this._oItemToUpdate &&
                    item.getId() === this._oItemToUpdate.getId())
            ) {
                return null;
            }
            var sItemId,
            ...
            if (sStatus === UploadCollection._uploadingStatus) {
                oBusyIndicator = item._getBusyIndicator
                    ? item._getBusyIndicator()
                    : item
                          ._getControl(
                              "sap.m.BusyIndicator",
                              {
         ...
         * @private
         */
        UploadCollection.prototype._renderContent = function(
            item,
            containerId
        ) {
            var sItemId,
            ...
            if (sStatus === UploadCollection._uploadingStatus) {
                oRm.renderControl(
                    this._createProgressLabel(item, sPercentUploaded)
                );
            } else {
                if (iMarkersCounter > 0) {
                    ...
                    for (i = 0; i < iMarkersCounter; i++) {
                        oRm.renderControl(
                            aMarkers[i].addStyleClass("sapMUCObjectMarker")
                        );
                    }
                ...
                if (iAttrCounter > 0) {
                    ...
                    for (i = 0; i < iAttrCounter; i++) {
                        ...
                        if (i + 1 < iAttrCounter) {
                            oRm.write(
                                '<div class="sapMUCSeparator">&nbsp&#x00B7&#160</div>'
            ...
            this._sReziseHandlerId = ResizeHandler.register(
                this,
         ...
         * @private
         */
        UploadCollection.prototype._renderButtons = function(
            oRm,
            item,
            status,
            itemId
            ...
            if (iButtonCounter > 0) {
                ...
                for (var i = 0; i < iButtonCounter; i++) {
                    if (i + 1 < iButtonCounter) {
                        // if both buttons are displayed
        ...
        UploadCollection.prototype._getFileNameControl = function(item) {
            ...
            if (sStatus !== "Edit") {
                oFileName = item._getFileNameLink
                    ? item._getFileNameLink()
                    : item._getControl(
                          "sap.m.Link",
                          {
                ...
                if (item.errorState === "Error") {
                    ...
                    if (sFileName.length === 0) {
                        sValueStateText = this._oRb.getText(
                            "UPLOADCOLLECTION_TYPE_FILENAME"
                        );
                    } else {
                        sValueStateText = this._oRb.getText(
                            "UPLOADCOLLECTION_EXISTS"
                        );
                    }
                }

                oFileNameEditBox = item._getFileNameEditBox
                    ? item._getFileNameEditBox()
                    : item._getControl(
                          "sap.m.Input",
                          {
                ...
                oFileNameEditBox.setShowValueStateMessage(
                    bShowValueStateMessage
                );

                if (iMaxLength - oFile.extension.length > 0) {
                    oFileNameEditBox.setProperty(
                        "maxLength",
                        iMaxLength - oFile.extension.length,
                        true
                    );
                }
        ...
        UploadCollection.prototype._onItemPressed = function(event, item) {
            if (item.hasListeners("press")) {
                ...
                jQuery.trim(item.getProperty("url"))
            ) {
         ...
         * @private
         */
        UploadCollection.prototype._createProgressLabel = function(
            item,
            percentUploaded
        ) {
            var oProgressLabel,
            ...
            oProgressLabel = item._getProgressLabel
                ? item._getProgressLabel()
                : item
                      ._getControl(
                          "sap.m.Label",
                          {
            ...
            oProgressLabel.setText(
                this._oRb.getText("UPLOADCOLLECTION_UPLOADING", [
                    percentUploaded
                ])
            );
         ...
         * @private
         */
        UploadCollection.prototype._createIcon = function(
            item,
            itemId,
            longFileName
        ) {
            ...
            if (sThumbnailUrl) {
                oItemIcon = IconPool.createControlByURI(
                    ...
                    Image
                ).addStyleClass("sapMUCItemImage sapMUCItemIcon");
                ...
                if (sThumbnail === UploadCollection._placeholderCamera) {
                    if (
                        ...
                        sStyleClass =
                            sStyleClass + " sapMUCItemPlaceholderInactive";
                    }
                }
         ...
         * @private
         */
        UploadCollection.prototype._getButtons = function(
            item,
            status,
            itemId
        ) {
            ...
            aButtons = [];
            if (!this.getInstantUpload()) {
                // in case of pending upload we always have only "delete" button (no "edit" button)
            ...
            if (status === "Edit") {
                    ...
                    : item
                          ._getControl(
                              "sap.m.Button",
                              {
                                  id: itemId + "-okButton",
                                  text: this._oRb.getText(
                                      "UPLOADCOLLECTION_RENAMEBUTTON_TEXT"
                                  ),
                ...
                oCancelButton = item._getCancelButton
                    ? item._getCancelButton()
                    : item
                          ._getControl(
                              "sap.m.Button",
                              {
                                  ...
                                  text: this._oRb.getText(
                                      "UPLOADCOLLECTION_CANCELBUTTON_TEXT"
                                  ),
                                  type: Library.ButtonType.Transparent
                              },
                              "CancelButton"
                ...
                if (item.getVisibleEdit()) {
                    // if the Edit button is invisible we do not need to render it
                    oEditButton = item._getEditButton
                        ? item._getEditButton()
                        : item
                              ._getControl(
                                  "sap.m.Button",
                                  {
                                      ...
                                      tooltip: this._oRb.getText(
                                          "UPLOADCOLLECTION_EDITBUTTON_TEXT"
                                      ),
                ...
                sButton = "deleteButton";
                if (item.getVisibleDelete()) {
                    // if the Delete button is invisible we do not need to render it
                    oDeleteButton = this._createDeleteButton(
                        itemId,
                        sButton,
                        item,
         ...
         * @private
         */
        UploadCollection.prototype._createDeleteButton = function(
            itemId,
            buttonType,
            item,
            errorState
            ...
            if (buttonType === "deleteButton") {
                ...
                sTooltip = this._oRb.getText(
                    "UPLOADCOLLECTION_DELETEBUTTON_TEXT"
                );
        ...
        UploadCollection.prototype._fillList = function(items) {
            var that = this,
                ...
                bGroupCreated = false,
                sGroupKey,
                sModelName = this.getBindingInfo("items")
                    ? this.getBindingInfo("items").model
                    : undefined,
                fnGroupHeader = this.getBindingInfo("items")
                    ? this.getBindingInfo("items").groupHeaderFactory
                    : null;
            var fnGroup = function(oItem) {
                ...
                return oItem.getBindingContext(sModelName)
                    ? oItemsBinding.getGroup(
                          oItem.getBindingContext(sModelName)
                      )
                    : null;
            };
            ...
            jQuery.each(items, function(index, item) {
                ...
                if (oItemsBinding && oItemsBinding.isGrouped() && item) {
                    if (!bGroupCreated || sGroupKey !== fnGroupKey(item)) {
                        if (fnGroupHeader) {
                            that._oList.addItemGroup(
                                fnGroup(item),
                                fnGroupHeader(fnGroup(item)),
                                true
                            );
                ...
                if (!item._status) {
                    ...
                    that.getInstantUpload() &&
                    that._oItemForDelete &&
                    that._oItemForDelete._status ===
                        UploadCollection._toBeDeletedStatus &&
                    item.getDocumentId() === that._oItemForDelete.documentId
                ) {
                    return false;
                }
                if (
                    !item._percentUploaded &&
                    item._status === UploadCollection._uploadingStatus
                ) {
         ...
         * @private
         */
        UploadCollection.prototype._setNumberOfAttachmentsTitle = function(
            count
        ) {
            var nItems = count || 0;
            var sText;
         ...
         * @private
         */
        UploadCollection.prototype._setFileUploaderVisibility = function(
            uploadButtonInvisible
        ) {
        ...
        UploadCollection.prototype._handleDelete = function(event) {
            ...
            if (
                jQuery(document.getElementById(this.sId)).hasClass(
                    "sapUiSizeCompact"
                )
            ) {
            ...
            if (aItems[iIndex] && aItems[iIndex].getEnableDelete()) {
                ...
                if (!sFileName) {
                    sMessageText = this._oRb.getText(
                        "UPLOADCOLLECTION_DELETE_WITHOUT_FILENAME_TEXT"
                    );
                } else {
                    sMessageText = this._oRb.getText(
                        "UPLOADCOLLECTION_DELETE_TEXT",
                        sFileName
                    );
                }
        ...
        UploadCollection.prototype._onCloseMessageBoxDeleteItem = function(
            ...
            if (this.getInstantUpload()) {
                for (var i = 0; i < aItems.length; i++) {
                    if (
                        aItems[i].getDocumentId() ===
                        this._oItemForDelete.documentId
                    ) {
            ...
            if (action === MessageBox.Action.OK) {
                ...
                if (this.getInstantUpload()) {
                    ...
                    if (this.aItems.length === 1) {
                        ...
                        this._oItemForDelete._iLineNumber <
        ...
        UploadCollection.prototype._handleTerminate = function(event, item) {
            ...
            oDialog = new Dialog({
                ...
                content: [
                    new Text({
                        text: this._oRb.getText(
                            "UPLOADCOLLECTION_TERMINATE_TEXT"
                        )
                    }),
                    oFileList
                ],
                buttons: [
                    new Button({
                        text: this._oRb.getText(
                            "UPLOADCOLLECTION_OKBUTTON_TEXT"
                        ),
            ...
            function onPressOk() {
                ...
                for (var i = 0; i < this.aItems.length; i++) {
                    if (
                        ...
                        item.getFileName() === this.aItems[i].getFileName() &&
                        this.aItems[i]._status ===
                            UploadCollection._displayStatus
                    ) {
                        this.aItems[i]._status =
                            UploadCollection._toBeDeletedStatus;
                        this._oItemForDelete = this.aItems[i];
                ...
                if (bAbort) {
                    this._getFileUploader().abort(
                        this._headerParamConst.fileNameRequestIdName,
                        this._encodeToAscii(item.getFileName()) +
        ...
        UploadCollection.prototype._handleClick = function(event, itemId) {
            ...
            if (sId.lastIndexOf("editButton") === -1) {
                if (sId.lastIndexOf("cancelButton") !== -1) {
                    ...
                    event.target.id.lastIndexOf("ia_imageHL") < 0 &&
                    event.target.id.lastIndexOf("ia_iconHL") < 0 &&
                    event.target.id.lastIndexOf("deleteButton") < 0 &&
                    event.target.id.lastIndexOf("ta_editFileName-inner") < 0
                ) {
         ...
         * @private
         */
        UploadCollection.prototype._handleOk = function(
            event,
            itemId,
            invalidate
        ) {
            var oEditbox = document.getElementById(
                itemId + "-ta_editFileName-inner"
            );
            var sNewFileName;
            ...
            if (
                UploadCollection._checkDoubleFileName(
                    sNewFileName + oFile.extension,
                    this.aItems
                )
            ) {
         ...
         * @private
         */
        UploadCollection.prototype._setErrorStateOnItem = function(
            oContext,
            oSourceItem,
            sNewFileName,
            sChangedNameBefore,
            ...
            if (
                sErrorStateBefore !== "Error" ||
                sChangedNameBefore !== sNewFileName
            ) {
                oContext.invalidate();
            }
        };
         ...
         */
        UploadCollection.prototype._removeErrorStateFromItem = function(
            oContext,
            oItem
        ) {
        ...
        UploadCollection.prototype._onChange = function(event) {
            if (event) {
                ...
                var aHeaderParametersAfter = this.getAggregation(
                    "headerParameters"
                );
                if (!this.getInstantUpload()) {
                    this._aFileUploadersForPendingUpload.push(
                        this._oFileUploader
                    );
                }
                for (i = 0; i < iCountFiles; i++) {
                    ...
                    if (event.getParameter("fromDragDrop")) {
                        oItem._internalFileIdWithinDragDropArray = event.getParameter(
                            "files"
                        )[i];
                    }
                    ...
                    if (!this.getInstantUpload()) {
                        oItem.setAssociation(
                            "fileUploader",
                            this._oFileUploader,
                            true
                        );
                        sFileSizeFormatted = this._oFormatDecimal.format(
                            event.getParameter("files")[i].size
                        );
                        oAttr = new ObjectAttribute({
                            text: sFileSizeFormatted
                        });
                ...
                if (aHeaderParametersAfter) {
                    jQuery.each(
                        aHeaderParametersAfter,
                        function(iIndex, headerParameter) {
        ...
        UploadCollection.prototype._onUploadTerminated = function(event) {
            ...
            for (i = 0; i < cItems; i++) {
                if (
                    this.aItems[i] &&
                    this.aItems[i].getFileName() === sFileName &&
            ...
            this.fireUploadTerminated({
                fileName: sFileName,
                getHeaderParameter: this._getHeaderParameterWithinEvent.bind(
                    event
                )
            });
        };
        ...
        UploadCollection.prototype._onUploadComplete = function(event) {
            if (event) {
                ...
                aInProgressStates = [
                    UploadCollection._uploadingStatus,
                    UploadCollection._pendingUploadStatus
                ];
                for (i = 0; i < cItems; i++) {
                    if (
                        (!sRequestId ||
                            this.aItems[i]._requestIdName === sRequestId) &&
                        this.aItems[i].getProperty("fileName") ===
                            sUploadedFile &&
                ...
                this.fireUploadComplete({
                    ...
                    files: [
                        {
                            fileName:
                                event.getParameter("fileName") || sUploadedFile,
            ...
            function checkRequestStatus() {
                var sRequestStatus =
                    event.getParameter("status").toString() || "200";
        ...
        UploadCollection.prototype._onUploadProgress = function(event) {
            ...
            var sUploadedFile = event.getParameter("fileName"),
                sPercentUploaded,
                iPercentUploaded = Math.round(
                    (event.getParameter("loaded") /
            ...
            if (iPercentUploaded === 100) {
                sPercentUploaded = this._oRb.getText(
                    "UPLOADCOLLECTION_UPLOAD_COMPLETED"
                );
            } else {
                sPercentUploaded = this._oRb.getText(
                    "UPLOADCOLLECTION_UPLOADING",
                    [iPercentUploaded]
                );
            }
            ...
            for (var i = 0; i < iItems; i++) {
                oItem = this.aItems[i];
                if (
                    oItem.getProperty("fileName") === sUploadedFile &&
                    oItem._requestIdName === sRequestId &&
                    oItem._status === UploadCollection._uploadingStatus
                ) {
                    oProgressLabel = oItem._getProgressLabel
                        ? oItem._getProgressLabel()
                        : oItem._getControl(
                              "sap.m.Label",
                              {
                    ...
                    if (oProgressLabel) {
                        ...
                        $busyIndicator = jQuery(
                            document.getElementById(
                                oItem.getId() + "-ia_indicator"
                            )
                        );
                        if (iPercentUploaded === 100) {
        ...
        UploadCollection.prototype._getFileUploader = function() {
            ...
            if (!bUploadOnChange || !this._oFileUploader) {
                // In case of instantUpload = false always create a new FU instance. In case of instantUpload = true only create a new FU instance if no FU instance exists yet
                var sTooltip = this.getInstantUpload()
                    ? this._oRb.getText("UPLOADCOLLECTION_UPLOAD")
                ...
                this._oFileUploader = new FileUploader(
                    this.getId() + "-" + this._iFUCounter + "-uploader",
                    {
                        buttonOnly: true,
                        buttonText: sTooltip,
                        tooltip: sTooltip,
        ...
        UploadCollection.prototype._onUploadStart = function(event) {
            ...
            for (i = 0; i < iParamCounter; i++) {
                if (
                    event.getParameter("requestHeaders")[i].name ===
                    this._headerParamConst.requestIdName
                ) {
                    sRequestIdValue = event.getParameter("requestHeaders")[i]
                        .value;
                    break;
                }
            }
            ...
            for (i = 0; i < this._aDeletedItemForPendingUpload.length; i++) {
                if (
                    this._aDeletedItemForPendingUpload[i].getAssociation(
                        "fileUploader"
                    ) === event.oSource.sId &&
                    this._aDeletedItemForPendingUpload[i].getFileName() ===
                        sFileName &&
                    this._aDeletedItemForPendingUpload[i]
                        ._internalFileIndexWithinFileUploader ===
                        this._iUploadStartCallCounter
                ) {
                    event
                        .getSource()
                        .abort(
                            this._headerParamConst.fileNameRequestIdName,
                            this._encodeToAscii(sFileName) + sRequestIdValue
                        );
                    return;
                }
            }
            ...
            if (Array.isArray(oGetHeaderParameterResult)) {
                for (i = 0; i < oGetHeaderParameterResult.length; i++) {
                    if (
                        event.getParameter("requestHeaders")[i].name ===
                        oGetHeaderParameterResult[i].getName()
                    ) {
                        event.getParameter("requestHeaders")[
                            i
                        ].value = oGetHeaderParameterResult[i].getValue();
                    }
                }
            } else if (
                oGetHeaderParameterResult instanceof UploadCollectionParameter
            ) {
                for (
                    i = 0;
                    i < event.getParameter("requestHeaders").length;
                    i++
                ) {
                    if (
                        event.getParameter("requestHeaders")[i].name ===
                        oGetHeaderParameterResult.getName()
                    ) {
                        event.getParameter("requestHeaders")[
                            i
                        ].value = oGetHeaderParameterResult.getValue();
                        break;
                    }
                }
            }
            ...
            function getHeaderParameter(sHeaderParameterName) {
                oGetHeaderParameterResult = this._getHeaderParameterWithinEvent.bind(
                    event
                )(sHeaderParameterName);
        ...
        UploadCollection.prototype._getIconFromFilename = function(sFilename) {
            var sFileExtension = UploadCollection._splitFilename(sFilename)
                .extension;
         ...
         * @private
         */
        UploadCollection.prototype._getThumbnail = function(
            sThumbnailUrl,
            sFilename
        ) {
            if (sThumbnailUrl) {
        ...
        UploadCollection.prototype._triggerLink = function(event) {
            ...
            MobileLibrary.URLHelper.redirect(
                this.aItems[iLine].getProperty("url"),
                true
            );
        };
        ...
        UploadCollection.prototype._handleENTER = function(event) {
            ...
            switch (sTarget) {
                ...
                case "cli":
                    //Display mode
                    sLinkId =
                        event.target.id.split(sTarget)[0] + "ta_filenameHL";
        ...
        UploadCollection.prototype._handleESC = function(event) {
            if (this.editModeItem) {
                this.sFocusId = this.editModeItem + "-cli";
                this.aItems[this.editModeItem.split("-").pop()]._status =
                    UploadCollection._displayStatus;
                this._handleCancel(event, this.editModeItem);
            }
        };
         ...
         * @private
         */
        UploadCollection.prototype._getHeaderParameterWithinEvent = function(
            sHeaderParameterName
        ) {
            ...
            for (var i = 0; i < aListItems.length; i++) {
                ...
                setTimeout(
                    function() {
                        ...
                        if (
                            typeof fnMethod === "string" ||
                            fnMethod instanceof String
                        ) {
                            fnMethod = this[fnMethod];
                        }
                        fnMethod.apply(
                            this,
                            [oLastItem._oUploadCollectionItem] || []
                        );
                    }.bind(this),
                    UploadCollection._resizeTimeoutInterval
                );
         ...
         * @private
         */
        UploadCollection.prototype._getUploadCollectionItemByListItem = function(
            listItem
        ) {
         ...
         * @private
         */
        UploadCollection.prototype._getUploadCollectionItemById = function(
            uploadCollectionItemId
        ) {
            var aAllItems = this.getItems();
            for (var i = 0; i < aAllItems.length; i++) {
         ...
         * @private
         */
        UploadCollection.prototype._getUploadCollectionItemsByListItems = function(
            listItems
        ) {
            ...
            if (listItems) {
                for (var i = 0; i < listItems.length; i++) {
                    for (
                        var j = 0;
                        j < aLocalUploadCollectionItems.length;
                        j++
                    ) {
                        if (
                            listItems[i].getId().replace("-cli", "") ===
                            aLocalUploadCollectionItems[j].getId()
                        ) {
                            aUploadCollectionItems.push(
                                aLocalUploadCollectionItems[j]
                            );
                            break;
                        }
                    }
         ...
         * @private
         */
        UploadCollection.prototype._setSelectedForItems = function(
            uploadCollectionItemsToUpdate,
            selected
        ) {
        ...
        UploadCollection.prototype._handleSelectionChange = function(event) {
            ...
            var aUploadCollectionListItems = this._getUploadCollectionItemsByListItems(
                event.getParameter("listItems")
            );
            var oUploadCollectionItem = this._getUploadCollectionItemByListItem(
                oListItem
            );
            if (
                oUploadCollectionItem &&
                oListItem &&
                aUploadCollectionListItems
            ) {
        ...
        /**
         * Copies the parameters- and headerParameters-aggregation from the <code>sap.m.UploadCollection</code>
         * to the current FileUploaderInstance, because the onBeforeRender function triggers the creation of a new
         * FileUploader-instance without these parameters which were set.
         * @private
         */
        UploadCollection.prototype._copyHeaderParametersToFileUploader = function() {
            // Clears the parameters and headerParameters aggregation for the FileUploader
            ...
            this.getParameters().forEach(
                function(oParameter) {
                    this._oFileUploader.addParameter(
                        new FileUploaderParameter({
