...
sap.ui.define(["jquery.sap.global", "./MessageBox", "./Dialog", "./library", "sap/ui/core/Control", "sap/ui/core/Icon", "sap/ui/core/IconPool", "sap/m/Image", "sap/m/Text", "sap/m/List", "sap/ui/unified/FileUploaderParameter", "sap/ui/unified/FileUploader", "sap/ui/core/format/FileSizeFormat", "sap/m/Link", "sap/m/OverflowToolbar", "./ObjectAttribute", "./ObjectStatus", "./UploadCollectionItem", "sap/ui/core/HTML", "./BusyIndicator", "./CustomListItem", "sap/ui/core/ResizeHandler", "sap/ui/Device", "./CustomListItemRenderer", "sap/ui/core/HTMLRenderer", "./LinkRenderer", "./ObjectAttributeRenderer", "./ObjectStatusRenderer", "./ObjectMarkerRenderer", "./TextRenderer", "./DialogRenderer"],
	function(jQuery, MessageBox, Dialog, Library, Control, Icon, IconPool, Image, Text, List, FileUploaderParameter, FileUploader, FileSizeFormat, Link, OverflowToolbar, ObjectAttribute, ObjectStatus, UploadCollectionItem, HTML, BusyIndicator, CustomListItem, ResizeHandler, Device) {
		"use strict";
		...
		UploadCollection.prototype._mapItemToListItem = function(oItem) {
			...
			var sItemId, sStatus, sFileNameLong, oBusyIndicator, oListItem, sContainerId, $container, oContainer, oItemIcon;
			...
			if (sStatus === UploadCollection._uploadingStatus) {
				...
				oItemIcon = this._createIcon(oItem, sItemId, sFileNameLong);
			}
			...
			oContainer = new sap.ui.core.HTML({
				...
				afterRendering: this._renderContent.bind(this, oItem, sContainerId)
			});
		 ...
		 * @private
		 */
		UploadCollection.prototype._renderContent = function(oItem, sContainerId) {
			...
			oRm.write('" >');
			oRm.renderControl(this._getFileNameControl(oItem));
			...
			this._renderButtons(oRm, oItem, sStatus, sItemId, this);
		 ...
		 * @private
		 */
		UploadCollection.prototype._getFileNameControl = function(oItem) {
			var oFileName, oFile, sFileName, sFileNameLong, sItemId, sStatus, iMaxLength, sValueState, bShowValueStateMessage, oFileNameEditBox, sValueStateText;
			...
			if (sStatus !== "Edit") {
				oFileName = oItem._getFileNameLink ? oItem._getFileNameLink() : oItem._getControl("sap.m.Link", {
					...
					press: [oItem, this._onItemPressed, this]
				}, "FileNameLink");
				oFileName.setEnabled(this._getItemPressEnabled(oItem));
		...
		UploadCollection.prototype._createIcon = function(oItem, sItemId, sFileNameLong) {
			...
			if (this._getItemPressEnabled(oItem)) {
				oItemIcon.attachPress(oItem, this._onItemPressed, this);
			}
			return oItemIcon;
		};
