    ...
    function(
        ...
        UploadCollection.prototype.upload = function() {
            ...
            if (this._aFilesFromDragAndDropForPendingUpload.length > 0) {
                // Inject the parameters from the UploadCollection to the FileUploader (because they are empty at this point)
        ...
        UploadCollection.prototype.downloadItem = function(
            ...
            if (!this.getInstantUpload()) {
                jQuery.sap.log.info(
                    "Download is not possible on Pending Upload mode"
                );
                return false;
            } else {
        ...
        UploadCollection.prototype._fillList = function(items) {
            ...
            var fnGroup = function(oItem) {
                return oItem.getBindingContext()
                    ? oItemsBinding.getGroup(oItem.getBindingContext())
                    : null;
            };
        ...
        UploadCollection.prototype._onResize = function() {
            ...
            for (var i = 0; i < aListItems.length; i++) {
                jQuery.sap.delayedCall(
                    ...
                    [aListItems[i]._oUploadCollectionItem]
                );
            }
        };
