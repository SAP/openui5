...
sap.ui.define(['jquery.sap.global', './InputBase', 'sap/ui/model/type/Date', 'sap/ui/core/date/UniversalDate', './library'],
	 ...
	 * <b><i>Overview</i></b>
	 * <br><br>
	 * The {@link sap.m.DatePicker} control lets users select a localized date using
	 * touch, mouse, or keyboard input. It consists of two parts: the date input
	 ...
	 * <code>DatePicker</code> to a model using the
	 * <code>sap.ui.model.type.Date</code></li>
