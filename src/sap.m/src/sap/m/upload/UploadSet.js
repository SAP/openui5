...
sap.ui.define([
	...
	UploadSet.prototype._getListItemById = function(sID) {
		if (this.getList() && this.getList().getItems() && this.getList().getItems().length && sID) {
			return this.getList().getItems().find(function(oListItem){
				if (oListItem && oListItem.getId()) {
					return oListItem.getId() === sID;
				}
			});
		}
		return null;
