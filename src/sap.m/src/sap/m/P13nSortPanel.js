 ...
 *
 * @class
 * The SortPanel Control can be used to...
 ...
 */
var P13nSortPanel = P13nPanel.extend("sap.m.P13nSortPanel", /** @lends sap.m.P13nSortPanel.prototype */ { metadata : {
	...
	aggregations : {
		 ...
		 * tbd
		 */
		sortItems : {type : "sap.m.P13nSortItem", multiple : true, singularName : "sortItem", bindable : "bindable"}
	},
	events : {
		...
		addSortItem : {
			parameters : {
				 ...
				 * item added
				 */
				newItem : {type : "sap.m.P13nSortItem"}
			}
		}, 
...
/**
 * This method allows you to specify the KeyFields for the sort. You can set an array of object with Key and Label properties to define the keyfields.
 *
 * @name sap.m.P13nSortPanel#setKeyFields
 * @function
 * @type void
 * @public
...
/**
 * This method must be used to assign a list of conditions to the SortPanel.
 *
 * @name sap.m.P13nSortPanel#setConditions
 * @function
 ...
 */
	...
	P13nSortPanel.prototype.init = function() {
		...
		if (!this._aOperations) {
			this.setOperations([ sap.m.P13nConditionOperation.Ascending, sap.m.P13nConditionOperation.Descending ]);
		}
	...
	//sap.m.P13nSortPanel.prototype.removeSortItem = function(oSortItem) {
	//	this.removeAggregation("sortItems", oSortItem);
	//};
	//
	//sap.m.P13nSortPanel.prototype.removeAllSortItems = function() {
	//	this.removeAllAggregation("sortItems");
	//};
	...
	P13nSortPanel.prototype._handleDataChange = function() {
		...
		return function(oEvent) {
			...
			if (sOperation === "add") {
				...
				that.fireAddSortItem({ key: sKey, index: oEvent.getParameter("index"), newItem : oSortItem });
				that._bIgnoreAdd = false;
			}
			if (sOperation === "remove") {
				that.fireRemoveSortItem({ key : sKey });
			}
		};
	};
