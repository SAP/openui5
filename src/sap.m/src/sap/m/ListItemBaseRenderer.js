...
sap.ui.define(["sap/ui/core/ControlBehavior", "./library", "sap/ui/Device", "sap/ui/core/InvisibleText", "sap/ui/core/InvisibleRenderer", "sap/ui/core/Lib"],
	function(ControlBehavior, library, Device, InvisibleText, InvisibleRenderer, Library) {
	"use strict";
	...
	ListItemBaseRenderer.decorateMode = function(oModeControl, oLI) {
		...
		if (ControlBehavior.getAnimationMode() === undefined/*Configuration*/.AnimationMode.none || !oLI.getListProperty("modeAnimationOn")) {
			return;
		}
