...
sap.ui.define(['jquery.sap.global', 'sap/ui/base/Metadata', './OverflowToolbarButton', './ToggleButton', './Button', 'sap/m/library'],
	function(jQuery, Metadata, OverflowToolbarButton, ToggleButton, Button, library) {
		"use strict";
