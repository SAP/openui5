sap.ui.define(['exports'], function (exports) { 'use strict';
	...
	const isShow = event => {
		...
		return (event.keyCode === KeyCodes.F4 && !hasModifierKeys(event)) || (event.keyCode === KeyCodes.ARROW_DOWN && checkModifierKeys(event,  false,  true,  false));
	};
	const isF4 = event => {
	...
	exports.isCtrlV = isCtrlV;
	exports.isDelete = isDelete;
	exports.isDeleteShift = isDeleteShift;
	...
	exports.isInsertCtrl = isInsertCtrl;
	exports.isInsertShift = isInsertShift;
	...
	exports.isSpaceCtrl = isSpaceCtrl;
