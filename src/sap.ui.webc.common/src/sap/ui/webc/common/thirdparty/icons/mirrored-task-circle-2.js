sap.ui.define(["exports", "sap/ui/webc/common/thirdparty/base/config/Theme", "./v4/mirrored-task-circle-2", "./v5/mirrored-task-circle-2"], function (_exports, _Theme, _mirroredTaskCircle, _mirroredTaskCircle2) {
  "use strict";
