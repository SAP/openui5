sap.ui.define(["exports", "sap/ui/webc/common/thirdparty/base/config/Theme", "./v5/add-activity-2", "./v4/add-activity-2"], function (_exports, _Theme, _addActivity, _addActivity2) {
  "use strict";
