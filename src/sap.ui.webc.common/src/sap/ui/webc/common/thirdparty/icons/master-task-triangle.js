sap.ui.define(["exports", "sap/ui/webc/common/thirdparty/base/config/Theme", "./v4/master-task-triangle", "./v5/master-task-triangle"], function (_exports, _Theme, _masterTaskTriangle, _masterTaskTriangle2) {
  "use strict";
