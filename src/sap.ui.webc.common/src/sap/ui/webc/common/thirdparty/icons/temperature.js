sap.ui.define(["exports", "sap/ui/webc/common/thirdparty/base/config/Theme", "./v4/temperature", "./v5/temperature"], function (_exports, _Theme, _temperature, _temperature2) {
  "use strict";
