sap.ui.define(["exports", "sap/ui/webc/common/thirdparty/base/config/Theme", "./v4/project-definition-triangle", "./v5/project-definition-triangle"], function (_exports, _Theme, _projectDefinitionTriangle, _projectDefinitionTriangle2) {
  "use strict";
