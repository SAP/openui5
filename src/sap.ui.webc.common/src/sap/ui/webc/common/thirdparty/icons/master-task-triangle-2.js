sap.ui.define(["exports", "sap/ui/webc/common/thirdparty/base/config/Theme", "./v5/master-task-triangle-2", "./v4/master-task-triangle-2"], function (_exports, _Theme, _masterTaskTriangle, _masterTaskTriangle2) {
  "use strict";
