sap.ui.define(["exports", "sap/ui/webc/common/thirdparty/base/config/Theme", "./v5/program-triangles-2", "./v4/program-triangles-2"], function (_exports, _Theme, _programTriangles, _programTriangles2) {
  "use strict";
