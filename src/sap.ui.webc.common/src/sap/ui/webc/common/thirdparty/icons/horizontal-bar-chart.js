sap.ui.define(["exports", "sap/ui/webc/common/thirdparty/base/config/Theme", "./v4/horizontal-bar-chart", "./v5/horizontal-bar-chart"], function (_exports, _Theme, _horizontalBarChart, _horizontalBarChart2) {
  "use strict";
