sap.ui.define(["exports", "sap/ui/webc/common/thirdparty/base/config/Theme", "./v4/rhombus-milestone", "./v5/rhombus-milestone"], function (_exports, _Theme, _rhombusMilestone, _rhombusMilestone2) {
  "use strict";
