sap.ui.define(['exports', '../style-map-40b1b123', 'sap/ui/webc/common/thirdparty/lit-html/static', 'sap/ui/webc/common/thirdparty/lit-html/directives/repeat', 'sap/ui/webc/common/thirdparty/lit-html/directives/class-map', 'sap/ui/webc/common/thirdparty/lit-html/directives/if-defined', 'sap/ui/webc/common/thirdparty/lit-html/directives/unsafe-html'], function (exports, styleMap, _static, repeat, classMap, ifDefined, unsafeHtml) { 'use strict';
	...
	const litRender = (templateResult, domNode, styleStrOrHrefsArr, { host } = {}) => {
		...
		styleMap.A(templateResult, domNode, { host });
	};
