sap.ui.define(["exports", "sap/ui/webc/common/thirdparty/base/config/Theme", "./v4/system-exit-2", "./v5/system-exit-2"], function (_exports, _Theme, _systemExit, _systemExit2) {
  "use strict";
