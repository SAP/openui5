sap.ui.define(["exports", "sap/ui/webc/common/thirdparty/base/config/Theme", "./v5/rhombus-milestone-2", "./v4/rhombus-milestone-2"], function (_exports, _Theme, _rhombusMilestone, _rhombusMilestone2) {
  "use strict";
