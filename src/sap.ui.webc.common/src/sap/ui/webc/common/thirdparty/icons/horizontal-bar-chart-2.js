sap.ui.define(["exports", "sap/ui/webc/common/thirdparty/base/config/Theme", "./v5/horizontal-bar-chart-2", "./v4/horizontal-bar-chart-2"], function (_exports, _Theme, _horizontalBarChart, _horizontalBarChart2) {
  "use strict";
