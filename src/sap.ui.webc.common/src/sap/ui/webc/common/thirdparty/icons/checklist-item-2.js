sap.ui.define(["exports", "sap/ui/webc/common/thirdparty/base/config/Theme", "./v5/checklist-item-2", "./v4/checklist-item-2"], function (_exports, _Theme, _checklistItem, _checklistItem2) {
  "use strict";
