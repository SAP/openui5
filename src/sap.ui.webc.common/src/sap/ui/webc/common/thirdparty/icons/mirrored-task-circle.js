sap.ui.define(["exports", "sap/ui/webc/common/thirdparty/base/config/Theme", "./v5/mirrored-task-circle", "./v4/mirrored-task-circle"], function (_exports, _Theme, _mirroredTaskCircle, _mirroredTaskCircle2) {
  "use strict";
