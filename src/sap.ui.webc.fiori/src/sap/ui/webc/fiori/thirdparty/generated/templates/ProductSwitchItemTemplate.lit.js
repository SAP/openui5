sap.ui.define(['sap/ui/webc/common/thirdparty/base/renderer/LitRenderer'], function (litRender) { 'use strict';
	...
	const block2 = (context, tags, suffix) => suffix ? litRender.html`<${litRender.scopeTag("ui5-icon", tags, suffix)} class="ui5-product-switch-item-icon" name="${litRender.ifDefined(context.icon)}"></${litRender.scopeTag("ui5-icon", tags, suffix)}>` : litRender.html`<ui5-icon class="ui5-product-switch-item-icon" name="${litRender.ifDefined(context.icon)}"></ui5-icon>`;
	...
	const block6 = (context, tags, suffix) => suffix ? litRender.html`<${litRender.scopeTag("ui5-icon", tags, suffix)} class="ui5-product-switch-item-icon" name="${litRender.ifDefined(context.icon)}"></${litRender.scopeTag("ui5-icon", tags, suffix)}>` : litRender.html`<ui5-icon class="ui5-product-switch-item-icon" name="${litRender.ifDefined(context.icon)}"></ui5-icon>`;
