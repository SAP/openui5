	...
	sinon
		...
		QUnit.module("Given a designTime and createContainer plugin are instantiated for a Form", {
			...
			QUnit.test("when an overlay has createContainer action designTime metadata, and isEnabled property is function", function(assert) {
				...
				sandbox.stub(this.oCreateContainer, "isAvailable").callsFake(function(bOverlayIsSibling, oOverlay){
				...
				sandbox.stub(this.oCreateContainer, "handleCreate").callsFake(function(bOverlayIsSibling, oOverlay){
				...
				sandbox.stub(this.oCreateContainer, "isEnabled").callsFake(function(bOverlayIsSibling, oOverlay){
