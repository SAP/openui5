sap.ui.define([
	...
	"use strict";
	return Controller.extend("sap.ui.rta.internal.dttool.controller.Code", {
		...
		_onRouteMatched: function (oEvent) {
			...
			if (sRouteName === "home") {
				if (!this.bIFrameReady) {
					this.sCompName = "sap.ui.rta.internal.dttool.emptyView";
				} else {
					this.oPostMessageBus.publish({
						...
						data: {
							compName: "sap.ui.rta.internal.dttool.emptyView"
						}
					});
				}
		...
		retrieveXMLFiles: function (oEvent) {
			...
			if (aFiles) {
				...
				var sRef = this.sSampleId ? sap.ui.require.toUrl(this.sSampleId.replace(/\./g, "/")) : "test-resources/sap/ui/rta/internal/dttool/emptyView";
