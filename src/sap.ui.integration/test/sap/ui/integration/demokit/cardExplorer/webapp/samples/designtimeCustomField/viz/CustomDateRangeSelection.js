sap.ui.define([
	...
	var CustomDateRangeSelection = VizBase.extend("card.explorer.designtime.customfield.viz.CustomDateRangeSelection", {
		metadata: {
			library: "card.explorer.designtime.customfield",
			properties: {
				displayFormat: {
					type: "string",
					defaultValue: ""
