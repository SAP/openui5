	...
	QUnit.module("Translation Mode", {
		...
		QUnit.test("Parameters with parameter syntax will not been seen", function (assert) {
			...
			return new Promise(function (resolve, reject) {
				this.oEditor.attachReady(function () {
					assert.ok(this.oEditor.isReady(), "Editor is ready");
					assert.ok(this.oEditor.getAggregation("_formContent").length === 20, "Content length OK");
					...
					assert.ok(oToday2SyntaxField.getAggregation("_field").getText() === "TODAY_ISO2", "Field: TODAY_ISO2 Value");
					oToday2SyntaxField = this.oEditor.getAggregation("_formContent")[13];
					assert.ok(oToday2SyntaxField.getAggregation("_field").getValue() === "TODAY_ISO2", "Field: TODAY_ISO2 trans Value");
					var oNOW2SyntaxField = this.oEditor.getAggregation("_formContent")[15];
					assert.ok(oNOW2SyntaxField.getAggregation("_field").getText() === "NOW_ISO2", "Field: NOW_ISO2 Value");
					oNOW2SyntaxField = this.oEditor.getAggregation("_formContent")[16];
					assert.ok(oNOW2SyntaxField.getAggregation("_field").getValue() === "NOW_ISO2", "Field: NOW_ISO2 trans Value");
					var oLOCALE2SyntaxField = this.oEditor.getAggregation("_formContent")[18];
					assert.ok(oLOCALE2SyntaxField.getAggregation("_field").getText() === "LOCALE2", "Field: LOCALE2 Value");
					oLOCALE2SyntaxField = this.oEditor.getAggregation("_formContent")[19];
					assert.ok(oLOCALE2SyntaxField.getAggregation("_field").getValue() === "LOCALE2", "Field: LOCALE2 trans Value");
					resolve();
				}.bind(this));
			}.bind(this));
		});
		...
		QUnit.test("Changes from Admin with parameter syntax", function (assert) {
			...
			return new Promise(function (resolve, reject) {
				this.oEditor.attachReady(function () {
					assert.ok(this.oEditor.isReady(), "Editor is ready");
					assert.ok(this.oEditor.getAggregation("_formContent").length === 17, "Content length OK");
					var oStringrField = this.oEditor.getAggregation("_formContent")[3];
					assert.ok(oStringrField.getAggregation("_field").getText() === "stringParameter Value", "Field: stringParameter ori Value");
					oStringrField = this.oEditor.getAggregation("_formContent")[4];
					assert.ok(oStringrField.getAggregation("_field").getValue() === "stringParameter Value", "Field: stringParameter trans Value");
		...
		QUnit.test("Changes from translation with parameter syntax", function (assert) {
			...
			return new Promise(function (resolve, reject) {
				this.oEditor.attachReady(function () {
					...
					assert.ok(oNOW2SyntaxField.getAggregation("_field").getValue() === "NOW_ISO2", "Field: NOW_ISO2 trans Value");
					var oLOCALE2SyntaxField = this.oEditor.getAggregation("_formContent")[18];
					assert.ok(oLOCALE2SyntaxField.getAggregation("_field").getText() === "bbb", "Field: LOCALE2 Value");
					oLOCALE2SyntaxField = this.oEditor.getAggregation("_formContent")[19];
					assert.ok(oLOCALE2SyntaxField.getAggregation("_field").getValue() === "{{parameters.XX}}", "Field: LOCALE2 trans Value");
					resolve();
				}.bind(this));
			}.bind(this));
		});
