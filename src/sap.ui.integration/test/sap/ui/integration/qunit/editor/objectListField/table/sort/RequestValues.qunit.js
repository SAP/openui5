					...
					wait().then(function () {
						...
						wait().then(function () {
							...
							wait().then(function () {
								...
								assert.ok(oValueOfRow1._dt._position === 1, "Table: row 1 position");
								assert.ok(oField._getCurrentProperty("value")[1]._dt._position === 1, "Table: value 3 position");
								...
								assert.ok(oValueOfRow2._dt._position === 2, "Table: row 2 position");
								assert.ok(oField._getCurrentProperty("value")[0]._dt._position === 2, "Table: value 2 position");
								...
								wait().then(function () {
									...
									assert.ok(oValueOfRow1._dt._position === 1, "Table: row 1 position");
									assert.ok(oField._getCurrentProperty("value")[0]._dt._position === 1, "Table: value 2 position");
									assert.ok(oFieldSettings[0]._dt._position === 1, "Editor: Field 1 value 1 position");
					...
					wait().then(function () {
						...
						wait().then(function () {
							...
							wait().then(function () {
								...
								assert.ok(oMoveUpButton.getEnabled(), "Table toolbar: move up button enabled");
								assert.ok(oMoveDownButton.getEnabled(), "Table toolbar: move down button enabled");
								assert.ok(oTable.getSelectedIndex() === 4, "Table toolbar: selected index is 4");

								oMoveDownButton.firePress();
								wait().then(function () {
									assert.ok(oTable.getSelectedIndex() === 5, "Table toolbar: selected index is 5");
									assert.ok(deepEqual(cleanUUIDAndPosition(oField._getCurrentProperty("value")), aObjectsParameterValue2), "Field 1: Value");
									var oSettings = that.oEditor.getCurrentSettings();
									var oFieldSettings = oSettings[oField.getConfiguration().manifestpath];
									assert.ok(deepEqual(cleanUUIDAndPosition(oFieldSettings), aObjectsParameterValue2), "Editor: Field 1 Value");
									...
									assert.ok(oValueOfRow5._dt._position === 5, "Table: row 5 position");
									assert.ok(oField._getCurrentProperty("value")[4]._dt._position === 6, "Table: value 5 position");
									assert.ok(oFieldSettings[4]._dt._position === 5, "Editor: Field 1 value 5 position");
									...
									wait().then(function () {
										...
										assert.ok(oValueOfRow5._dt._position === 5, "Table: row 5 position");
										assert.ok(oField._getCurrentProperty("value")[4]._dt._position === 5, "Table: value 5 position");
										assert.ok(oFieldSettings[4]._dt._position === 5, "Editor: Field 1 value 5 position");
					...
					wait().then(function () {
						...
						wait().then(function () {
							...
							wait().then(function () {
								...
								oMoveUpButton.firePress();
								wait().then(function () {
									assert.ok(oTable.getSelectedIndex() === 4, "Table toolbar: selected index is 5");
									assert.ok(deepEqual(cleanUUIDAndPosition(oField._getCurrentProperty("value")), aObjectsParameterValue2), "Field 1: Value");
									var oSettings = that.oEditor.getCurrentSettings();
									var oFieldSettings = oSettings[oField.getConfiguration().manifestpath];
									assert.ok(deepEqual(cleanUUIDAndPosition(oFieldSettings), aObjectsParameterValue2), "Editor: Field 1 Value");
									...
									oMoveDownButton.firePress();
									wait().then(function () {
										assert.ok(oTable.getSelectedIndex() === 5, "Table toolbar: selected index is 4");
										assert.ok(deepEqual(cleanUUIDAndPosition(oField._getCurrentProperty("value")), aObjectsParameterValue2), "Field 1: Value");
										oSettings = that.oEditor.getCurrentSettings();
										oFieldSettings = oSettings[oField.getConfiguration().manifestpath];
										assert.ok(deepEqual(cleanUUIDAndPosition(oFieldSettings), aObjectsParameterValue2), "Editor: Field 1 Value");
