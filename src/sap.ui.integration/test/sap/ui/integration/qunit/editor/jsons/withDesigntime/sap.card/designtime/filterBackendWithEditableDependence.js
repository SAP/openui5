			...
			"form": {
				"items": {
					...
					"CustomerWithEditableDependent": {
						"manifestpath": "/sap.card/configuration/parameters/CustomerWithEditableDependent/value",
						"type": "string",
					...
					"CustomersWithEditableDependent": {
						"manifestpath": "/sap.card/configuration/parameters/CustomersWithEditableDependent/value",
						"type": "string[]",
						"editable": "{items>booleanVisualization/value}",
						"values": {
							"data": {
					...
					"CustomersInMultiInputWithEditableDependent": {
						"manifestpath": "/sap.card/configuration/parameters/CustomersInMultiInputWithEditableDependent/value",
						"type": "string[]",
						"editable": "{items>booleanVisualization/value}",
						"values": {
							"data": {
