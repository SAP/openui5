												...
												wait().then(function () {
													...
													for (var i = 0; i < oLanguageItems2.length; i++) {
														...
														if (oCustomData && oCustomData.length > 0) {
															...
															assert.ok(sCurrentValue === sExpectedValue, "oTranslationPopover2 Content: item " + i + " " + sLanguage + ", current: " + sCurrentValue + ", expected: " + sExpectedValue);
														}
													}
													...
													wait().then(function () {
														...
														wait().then(function () {
															...
															assert.ok(oFormField3.getValue() === oValueOfObject3InContentChange.text, "SimpleForm 3 field 3: Has value");
