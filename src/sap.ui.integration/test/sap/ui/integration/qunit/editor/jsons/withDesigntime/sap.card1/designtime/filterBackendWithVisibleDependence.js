			...
			"form": {
				"items": {
					...
					"CustomersWithVisibleDependent": {
						"manifestpath": "/sap.card1/configuration/parameters/CustomersWithVisibleDependent/value",
						"type": "string[]",
						"visible": "{items>booleanVisualization/value}",
						"values": {
							"data": {
					...
					"CustomersInMultiInputWithVisibleDependent": {
						"manifestpath": "/sap.card1/configuration/parameters/CustomersInMultiInputWithVisibleDependent/value",
						"type": "string[]",
						"visible": "{items>booleanVisualization/value}",
						"values": {
							"data": {
