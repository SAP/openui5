									...
									wait(1500).then(function () {
										...
										wait().then(function () {
											...
											wait().then(function () {
												...
												assert.ok(oFormField2.getValue() === oObject2InAdminChange.key, "SimpleForm 2 field 1: Has value");
												...
												wait().then(function () {
													...
													wait().then(function () {
														...
														assert.ok(oFormField3.getValue() === oObject3InAdminChange.key, "SimpleForm 3 field 1: Has value");
