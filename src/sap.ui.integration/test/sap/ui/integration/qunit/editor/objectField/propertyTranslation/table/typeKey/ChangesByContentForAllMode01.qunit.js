								...
								wait().then(function () {
									...
									wait().then(function () {
										...
										wait().then(function () {
											...
											assert.ok(oFormField1.getValue() === oValueOfObject2InContentChange.key, "SimpleForm 2 field 1:: Has value");
											...
											wait().then(function () {
												...
												wait().then(function () {
													...
													var oKeyCell1 = oRow1.getCells()[1];
													assert.ok(oKeyCell1.getText() === "string4", "Row 1: key cell value");
													...
													wait().then(function () {
														...
														assert.ok(oFormField1.getValue() === "string4", "SimpleForm 3 field 1:: Has value");
