			...
			"form": {
				"items": {
					...
					"CustomerWithNotEditable": {
						"manifestpath": "/sap.card1/configuration/parameters/CustomerWithNotEditable/value",
						"type": "string",
						"editable": false,
						"values": {
							"data": {
					...
					"CustomerWithNotVisible": {
						"manifestpath": "/sap.card1/configuration/parameters/CustomerWithNotVisible/value",
						"type": "string",
						"visible": false,
						"values": {
							"data": {
