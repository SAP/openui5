						...
						wait().then(function () {
							...
							oEditButton1.onAfterRendering = function(oEvent) {
								...
								wait().then(function () {
									...
									assert.ok(oFormField1.getValue() === oObject1InAdminChange.key, "SimpleForm 1 field 1: Has value");
									...
									wait(1500).then(function () {
										...
										wait().then(function () {
											...
											wait().then(function () {
												...
												assert.ok(oFormField1.getValue() === oObject2InAdminChange.key, "SimpleForm 2 field 1: Has value");
												...
												wait().then(function () {
													...
													wait().then(function () {
														...
														assert.ok(oFormField1.getValue() === oObject3InAdminChange.key, "SimpleForm 3 field 1: Has value");
