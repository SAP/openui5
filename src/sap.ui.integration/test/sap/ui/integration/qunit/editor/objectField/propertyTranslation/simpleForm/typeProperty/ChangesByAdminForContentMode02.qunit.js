				...
				return new Promise(function (resolve, reject) {
					...
					that.oEditor.attachReady(function () {
						...
						wait().then(function () {
							...
							assert.ok(oFormField3.getValue() === "{i18n>string1}", "SimpleForm 1 field 3: Has value");
							...
							wait(1500).then(function () {
								...
								wait().then(function () {
									...
									assert.ok(oFormField3.getValue() === "string2", "SimpleForm 2 field 3: Has value");
									...
									wait(1500).then(function () {
										...
										wait().then(function () {
											...
											assert.ok(oFormField3.getValue() === "string3", "SimpleForm 3 field 3: Has value");
