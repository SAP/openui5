						...
						wait().then(function () {
							...
							oEditButton1.onAfterRendering = function(oEvent) {
								...
								wait().then(function () {
									...
									assert.equal(oFormField3.getValue(), oObject1InAdminChange.text, "SimpleForm 1 field 3: Has value");
									...
									wait(1500).then(function () {
										...
										wait().then(function () {
											...
											wait().then(function () {
												...
												assert.equal(oFormField3.getValue(), oObject2InAdminChange.text, "SimpleForm 2 field 3: Has value");
