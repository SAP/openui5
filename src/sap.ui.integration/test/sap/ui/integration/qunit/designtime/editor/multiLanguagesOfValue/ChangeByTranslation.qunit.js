	...
	QUnit.module("Check the translation mode", {
		...
		_aCheckedLanguages.forEach(function(oCoreLanguage) {
			...
			_aCheckedLanguages.forEach(function(oCardLanguage) {
				...
				var sString1OriValue = sCardLanguageKey === sCoreLanguageKey ? _oExpectedValues["string1"]["default"] : _oExpectedValues["string1"][sCoreLanguageKey] || _oExpectedValues["string1"]["defaultOri_in_trans"];
