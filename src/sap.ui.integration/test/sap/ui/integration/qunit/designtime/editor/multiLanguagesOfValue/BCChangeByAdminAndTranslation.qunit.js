	...
	QUnit.module("Check the translation mode", {
		...
		_aCheckedLanguages.forEach(function(oCoreLanguage) {
			...
			_aCheckedLanguages.forEach(function(oCardLanguage) {
				...
				var sString1OriValue = sCardLanguageKey === sCoreLanguageKey ? _oExpectedValues["string1"]["default"] : _oExpectedValues["string1"]["defaultOri_in_trans"];
				var sString1TransValue = _oExpectedValues["string1"][sCardLanguageKey] || _oExpectedValues["string1"]["default"];
				var sString3TransValue = _oExpectedValues["string3"][sCardLanguageKey] || _oExpectedValues["string3"]["default"];
				var sString4TransValue = _oExpectedValues["string4"][sCardLanguageKey] || _oExpectedValues["string4"]["default"];
