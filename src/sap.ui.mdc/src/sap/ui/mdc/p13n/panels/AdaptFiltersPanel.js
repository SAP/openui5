...
], function(AbstractContainer, AbstractContainerItem, SelectionPanel, GroupView, Library, Filter, Button, Bar, ToolbarSpacer, Select, SegmentedButton, SegmentedButtonItem, SearchField, OverflowToolbarLayoutData, Item, mLibrary, JSONModel) {
    "use strict";
