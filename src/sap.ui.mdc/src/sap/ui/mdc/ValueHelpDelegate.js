...
sap.ui.define([
	...
	ValueHelpDelegate.shouldOpenOnClick = function(oValueHelp, oContainer) {
		...
		if (oContainer.isA("sap.ui.mdc.valuehelp.Popover")) {
			...
			bShouldOpenOnClick = oContainer.isPropertyInitial("opensOnClick") ? !!oContent && oContent.shouldOpenOnClick() : false; //If opensOnClick is not explicitly set,  the content's preference is used instead.
		}
