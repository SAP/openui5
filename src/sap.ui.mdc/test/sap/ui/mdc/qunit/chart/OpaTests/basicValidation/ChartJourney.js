sap.ui.define([
...
], function(Opa5, Arrangement, TestUtil, Action, Assertion, testLibrary, LinkAssertions, ChartActions, PropertyStrictEquals, Press) {
	'use strict';
	...
	return function (opaTestOrSkip) {
		...
		opaTestOrSkip("When I click on a  \"View By\", Chart should open the drill-down window", function(Given, When, Then) {
		...
		opaTestOrSkip("When I click on \"Zoom In\", Chart should zoom in", function(Given, When, Then) {
		...
		opaTestOrSkip("When I click on the  \"ChartType\" button, Chart should open the chart type popover", function(Given, When, Then) {
		...
		opaTestOrSkip("When I change the chart type, the inner chart should change", function(Given, When, Then) {
		...
		opaTestOrSkip("When I drill down, the inner chart should change", function(Given, When, Then) {
		...
		opaTestOrSkip("When I click on \"Legend\", Chart should toggle the legend", function(Given, When, Then) {
		...
		opaTestOrSkip("When I click on a  breadcrumb, Chart should perform a drill-up", function(Given, When, Then) {
		...
		opaTestOrSkip("When I select a datapoint, I can access the details popover", function(Given, When, Then) {
		...
		opaTestOrSkip("When I select a datapoint and drill down, I should see the correct dimensions", function(Given, When, Then) {
			When.onTheMDCChart.iSelectTheDatapoint([{
				index: 0,
				measures: ["averagemetricsWords"]
			}], sChartId);
		...
		opaTestOrSkip("When I personalize the chart, the chart should change", function(Given, When, Then) {
		...
		opaTestOrSkip("Teardown", function(Given, When, Then) {
			Then.onTheMDCChart.iShouldSeeAChart();
