sap.ui.define([
	...
	return function (opaTestOrSkip) {
		...
		opaTestOrSkip("When I select 'Language Visible On First Position' variant, the chart should be changed", function(Given, When, Then) {
			//Actions
		...
		opaTestOrSkip("When I change to the 'Standard' variant, the chart should be changed", function(Given, When, Then) {
			//Actions
		...
		opaTestOrSkip("When I start the 'appUnderTestChart' app again, the chart with some dimensions and measures appears", function(Given, When, Then) {
			Given.iStartMyAppInAFrame({
				source: 'test-resources/sap/ui/mdc/qunit/p13n/OpaTests/appUnderTestChart/ChartOpaApp.html',
				autoWait: true
			});
		...
		opaTestOrSkip("When I deselect 'Genre' and select 'Title', the chart should be changed", function(Given, When, Then) {
		...
		opaTestOrSkip("When I press on 'Define Sort Properties' button and sort ascending by 'Price (average)', the chart should be changed", function(Given, When, Then) {
			//open 'sort' tab
			When.iPressOnButtonWithIcon(Arrangement.P13nDialog.Settings.Icon);
		...
		opaTestOrSkip("When I close the 'Define Sort Properties', the dialog should close", function(Given, When, Then) {

			Then.thePersonalizationDialogShouldBeClosed();
		});
		opaTestOrSkip("When I save the variant as 'Price (average) On First Position', new variant name should appear", function(Given, When, Then) {
