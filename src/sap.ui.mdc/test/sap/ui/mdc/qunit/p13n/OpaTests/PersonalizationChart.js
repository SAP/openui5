sap.ui.define([
	...
	return function (opaTestOrSkip) {
		...
		opaTestOrSkip("When I start the 'appUnderTestChart' app, the chart with some dimensions and measures appears", function(Given, When, Then) {
		...
		opaTestOrSkip("When I press on 'Define Chart Properties' button, the chart-specific-dialog opens", function(Given, When, Then) {
			When.iPressOnButtonWithIcon(Arrangement.P13nDialog.Settings.Icon);

			Then.thePersonalizationDialogOpens();
			Then.iShouldSeeDialogTitle(sViewSettings);

			Then.iShouldSeeChartP13nItems(aChartItems);
		});
		opaTestOrSkip("When I close the 'Define Chart Properties', the chart has not been changed", function(Given, When, Then) {
		...
		opaTestOrSkip("When I press on 'Define Sort Properties' button, sort dialog should open", function(Given, When, Then) {
			When.iPressOnButtonWithIcon(Arrangement.P13nDialog.Settings.Icon);
		...
		opaTestOrSkip("When I close the 'Define Sort Properties', the chart has not been changed", function(Given, When, Then) {
			Device.system.phone ? When.iPressOnButtonWithIcon(Arrangement.P13nDialog.Settings.Back) : When.iPressDialogOk();
		...
		opaTestOrSkip("When I press on 'Define Chart Type' button, a dialog should open", function(Given, When, Then) {
		...
		opaTestOrSkip("When I close the 'Define Chart Type', the chart has not been changed", function(Given, When, Then) {
		...
		// ----------------------------------------------------------------
		opaTestOrSkip("When I start the 'appUnderTestChart' app again and press on 'Define Chart Type' button, the dialog should open", function(Given, When, Then) {
			Given.iStartMyAppInAFrame({
				source: 'test-resources/sap/ui/mdc/qunit/p13n/OpaTests/appUnderTestChart/ChartOpaApp.html',
				autoWait: true
			});
		...
		opaTestOrSkip("When I select the 'Pie Chart' type, the chart should be changed", function(Given, When, Then) {
		...
		// ----------------------------------------------------------------
		opaTestOrSkip("When I start the 'appUnderTestChart' app again and press on on 'Define Chart Properties' button, the chart-specific-dialog opens", function(Given, When, Then) {
			Given.iStartMyAppInAFrame({
				source: 'test-resources/sap/ui/mdc/qunit/p13n/OpaTests/appUnderTestChart/ChartOpaApp.html',
				autoWait: true
			});
		...
		opaTestOrSkip("When I select the 'Words (average)' measure and move the 'Words (average)' to the top, the chart should be changed", function(Given, When, Then) {
		...
		opaTestOrSkip("When I close the 'Define Chart Properties', the dialog should close", function(Given, When, Then) {
			Then.thePersonalizationDialogShouldBeClosed();
		...
		opaTestOrSkip("When I select the 'Language' dimension and move the 'Language' to the top, the chart should be changed", function(Given, When, Then) {
