sap.ui.define([
	...
	opaTest("When I select rows in the personalization dialog, the changes are reflected after confirmation", function (Given, When, Then) {
		When.iSelectColumn("Country", Arrangement.P13nDialog.Titles.adaptFilter, undefined, true);
		When.iSelectColumn("cityOfOrigin_city", Arrangement.P13nDialog.Titles.adaptFilter, undefined, true);
