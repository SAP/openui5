sap.ui.define([
	...
	return function (opaTestOrSkip) {
		...
		opaTestOrSkip("When I hide the FilterFields, I should not be able to use them", function (Given, When, Then) {
		...
		opaTestOrSkip("When I show/hide the FilterFields, I should be able to toggle their visibility", function (Given, When, Then) {
			When.iPressButtonWithText(Arrangement.P13nDialog.AdaptFilter.button);
			When.iChangeAdaptFiltersView("sap-icon://group-2");
