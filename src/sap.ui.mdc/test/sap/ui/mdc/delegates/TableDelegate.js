...
sap.ui.define([
	...
	var TableDelegate = Object.assign(TableDelegateBase, {
		 ...
		 * @private
		 */
		_createColumn: function(sPropertyName, oTable) {
		 ...
		 * @private
		 */
		_getColumnInfo: function(oPropertyInfo, oTable) {
			return {
		 ...
		 * @private
		 */
		_getColumnTemplateInfo: function(oPropertyInfo, oTable) {
			return {
				text: {
		 ...
		 * @private
		 */
		_createColumnTemplate: function(oPropertyInfo, oTable) {
