		...
		return oFetchPropertiesPromise.then(function (aProperties) {
			aProperties.forEach(function(oPropertyInfo){
				...
				if (oPropertyInfo.name === "$search") {
					...
					oPropertyInfo.filterOperators = ["MYDATE", "MYDATERANGE", "EQ", "GE", "LE", "BT", "TODAY", "YESTERDAY", "TOMORROW", "LASTDAYS", "MYNEXTDAYS", "THISWEEK", "THISMONTH", "THISQUARTER", "THISYEAR", "NEXTHOURS", "NEXTMINUTES", "LASTHOURS"];
				}
