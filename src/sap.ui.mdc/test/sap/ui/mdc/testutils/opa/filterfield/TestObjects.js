	...
	Opa5.createPageObjects({
		onTheMDCFilterField: {
			actions: {
				 ...
				 * @param {object} oProperties Properties (e.g. id, label) of the given <code>sap.ui.mdc.FilterField</code>
				 ...
				 * @param {string} oProperties Properties (e.g. id, label) of the given <code>sap.ui.mdc.FilterField</code>
				 * @returns {Promise} OPA waitFor
				 */
			...
			assertions: {
				...
				iShouldSeeTheFilterFieldWithValues: function(oProperties, oValues) {
					return fieldAssertions.iShouldSeeTheFilterFieldWithValues.call(this, oProperties, oValues);
				}
			}
		}
	});
